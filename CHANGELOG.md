...
### Security — D665: `X-Generac-*`/`X-Cummins-*`/`X-Kohler-*`/`X-HigyouHatsuden-*`/`X-JikaHatsuden-*` 等の非常用発電機印自称が未検査

- **問題**: `X-Generac-*`/`X-GeneracPower-*`/`X-Cummins-*`/`X-CumminsGenerator-*`/`X-Kohler-*`/`X-KohlerGenerator-*`/`X-BriggsStratton-*`/`X-Briggs-*`/`X-HondaGenerator-*`/`X-StandbyGenerator-*`/`X-GeneratorPros-*`/`X-GeneratorService-*`/`X-GeneratorExperts-*`/`X-GeneratorDoctors-*`/`X-GeneratorMasters-*`/`X-GeneratorTech-*`/`X-GeneratorWorks-*`/`X-GeneratorTeam-*`/`X-GeneratorForce-*`/`X-GeneratorUSA-*`/`X-GeneratorSolutions-*`/`X-GeneratorInstall-*`/`X-GeneratorRepair-*`/`X-BackupGenerator-*`/`X-HomeGenerator-*`/`X-WholeHouseGenerator-*`、JP は `X-HigyouHatsuden-*`/`X-HigyouHatsudenki-*`/`X-JikaHatsuden-*`/`X-JikaHatsudenki-*`/`X-HatsudenKi-*`/`X-HatsudenkiYasan-*`/`X-HatsudenkiKouji-*`/`X-HatsudenkiSeibi-*`/`X-HatsudenkiPro-*`/`X-HatsudenkiDoctors-*`/`X-HatsudenkiTeam-*`/`X-KoyuuHatsuden-*`/`X-HijouHatsuden-*`/`X-BachuHatsuden-*`/`X-HatsudenYasan-*`/`X-HatsudenGyosha-*`/`X-HatsudenSenmon-*`/`X-DenkiHatsuden-*`/`X-HatsudenShiage-*`/`X-StandbyJP-*`/`X-GeneratorJP-*`/`X-HatsudenkiGijutsu-*`/`X-HatsudenManten-*`/`X-HatsudenkiKensa-*`/`X-KenetsuHatsuden-*`/`X-OkujoHatsuden-*` 等 は発機の通知記録 — 送信側が書くことは自称。非常用発電機・スタンバイ発電機・停電対策・定期点検の偽装は発電機業者なりすましの典型手口 (災害時の便乗販売で有名)。(太陽光は solar 機、電気工事は electrician 機、電力は utility 機で検出済み)
- **修正**: `Envelope` に `generator_marks` + `has_generator_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 発印の自署を問え。

### Security — D666: `X-Otis-*`/`X-Kone-*`/`X-Schindler-*`/`X-ErebetaHoshu-*`/`X-Shoukouki-*` 等のエレベーター・昇降機保守印自称が未検査

- **問題**: `X-Otis-*`/`X-OtisElevator-*`/`X-Kone-*`/`X-KoneElevator-*`/`X-Schindler-*`/`X-SchindlerElevator-*`/`X-ThyssenKrupp-*`/`X-ThyssenKruppElevator-*`/`X-TKElevator-*`/`X-Fujitec-*`/`X-FujitecElevator-*`/`X-MitsubishiElevator-*`/`X-ElevatorPros-*`/`X-ElevatorService-*`/`X-ElevatorWorks-*`/`X-ElevatorTech-*`/`X-ElevatorExperts-*`/`X-ElevatorDoctors-*`/`X-ElevatorTeam-*`/`X-ElevatorMasters-*`/`X-ElevatorInspection-*`/`X-ElevatorRepair-*`/`X-ElevatorMaintenance-*`/`X-ElevatorSolutions-*`/`X-LiftService-*`/`X-LiftPros-*`、JP は `X-ErebetaHoshu-*`/`X-ErebetaSeibi-*`/`X-ErebetaYasan-*`/`X-ErebetaKenshin-*`/`X-Erebeta-*`/`X-Shoukouki-*`/`X-ShoukoukiSeibi-*`/`X-ErebetaDoctors-*`/`X-ErebetaTeam-*`/`X-ErebetaPro-*`/`X-ErebetaSenmon-*`/`X-ErebetaGyosha-*`/`X-ErebetaGijutsu-*`/`X-ErebetaTenken-*`/`X-ErebetaShindan-*`/`X-ErebetaRepair-*`/`X-ErebetaManten-*`/`X-EscalatorSeibi-*`/`X-ShoukoukiKenshin-*`/`X-ErebetaKouji-*`/`X-ErebetaJP-*`/`X-HomeElevator-*`/`X-ErebetaShiage-*`/`X-ErebetaKensa-*`/`X-ErebetaHokatsu-*`/`X-ErebetaKirikae-*`/`X-ShoukoukiGyosha-*` 等 は昇機の通知記録 — 送信側が書くことは自称。エレベーター保守点検・法定点検・昇降機検査・リニューアルの偽装はエレベーター保守業者なりすましの典型手口。(建物設備は facility 機、管理は housing 機で検出済み)
- **修正**: `Envelope` に `elevator_marks` + `has_elevator_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 昇印の自署を問え。

### Security — D667: `X-LeafFilter-*`/`X-GutterShutter-*`/`X-GutterPros-*`/`X-Amadoi-*`/`X-ToiKouji-*` 等の雨樋・ガター印自称が未検査

- **問題**: `X-LeafFilter-*`/`X-LeafFilterGutter-*`/`X-GutterShutter-*`/`X-GutterHelmet-*`/`X-GutterGlove-*`/`X-GutterPros-*`/`X-GutterGuards-*`/`X-GutterDoctors-*`/`X-GutterExperts-*`/`X-GutterMasters-*`/`X-GutterWorks-*`/`X-GutterTech-*`/`X-GutterTeam-*`/`X-GutterForce-*`/`X-GutterSolutions-*`/`X-GutterUSA-*`/`X-GutterCleaning-*`/`X-GutterRepair-*`/`X-GutterInstall-*`/`X-SeamlessGutter-*`/`X-LeafGuard-*`/`X-GutterGuard-*`/`X-GutterTopper-*`/`X-AllWeatherGutter-*`/`X-GutterCleaningPros-*`、JP は `X-Amadoi-*`/`X-AmadoiKouji-*`/`X-AmadoiYasan-*`/`X-ToiKouji-*`/`X-ToiYasan-*`/`X-ToiKoujiPro-*`/`X-AmadoiSeibi-*`/`X-AmadoiRepair-*`/`X-AmadoiDoctors-*`/`X-AmadoiTeam-*`/`X-AmadoiPro-*`/`X-Darakake-*`/`X-RainToi-*`/`X-TateToi-*`/`X-ToiSeibi-*`/`X-AmadoiGijutsu-*`/`X-AmadoiGyosha-*`/`X-ToiDoctors-*`/`X-AmadoiKensa-*`/`X-YokoToi-*`/`X-AmadoiShiage-*`/`X-AmadoiKirei-*`/`X-ToiManten-*`/`X-GutterJP-*`/`X-AmadoiJP-*`/`X-ToiRepair-*`/`X-AmadoiSenmon-*` 等 は樋機の通知記録 — 送信側が書くことは自称。雨樋修理・ガター清掃・樋交換・ガターガード設置の偽装は雨樋業者なりすましの典型手口。(屋根は roofing 機、外壁は painting 機、造園は landscape 機で検出済み)
- **修正**: `Envelope` に `gutter_marks` + `has_gutter_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 樋印の自署を問え。
