...
### Security — D677: `X-Carport-*`/`X-MetalCarport-*`/`X-CarportKouji-*`/`X-ShakoKouji-*`/`X-VersaTube-*` 等のカーポート印自称が未検査

- **問題**: `X-Carport-*`/`X-Carports-*`/`X-CarportPros-*`/`X-CarportCentral-*`/`X-CarportDirect-*`/`X-CarportKing-*`/`X-CarportDoctor-*`/`X-MetalCarport-*`/`X-SteelCarport-*`/`X-AluminumCarport-*`/`X-CarportUSA-*`/`X-CarportEmpire-*`/`X-CarportSupply-*`/`X-CarportGarage-*`/`X-CarportExpress-*`/`X-EagleCarport-*`/`X-VersaTube-*`/`X-MetalCarports-*`/`X-CarportRepair-*`/`X-CarportInstall-*`/`X-RVCarport-*`/`X-CarportKit-*`/`X-CarportKits-*`/`X-CarportOutlet-*`、JP は `X-CarportKouji-*`/`X-CarportYasan-*`/`X-CarportPro-*`/`X-CarportTeam-*`/`X-CarportGyosha-*`/`X-CarportSeibi-*`/`X-CarportKensa-*`/`X-CarportManten-*`/`X-CarportNomi-*`/`X-CarportJP-*`/`X-CarportSenmon-*`/`X-CarportShuri-*`/`X-CarportDoctors-*`/`X-ShakoKouji-*`/`X-ShakoNomi-*`/`X-ShakoTate-*`/`X-GarageKenchiku-*`/`X-GarageKouji-*`/`X-GarageYasan-*`/`X-GaragePro-*`/`X-Kasayane-*`/`X-CarportTeiki-*`/`X-CarportTenken-*`/`X-CarportMitsumori-*`/`X-CarportOtoiawase-*`/`X-CarportSagyou-*`/`X-CarportKaitei-*`/`X-CarportShinchiku-*` 等 は泊機の通知記録 — 送信側が書くことは自称。カーポート・車庫建設・ガレージ新築の偽装は、高額外構工事のなりすまし・訪問販売の典型手口。(ガレージドア修理は garagedoor 機、住宅建材は housing 機、サンルームは sunroom 機で検出済み)
- **修正**: `Envelope` に `carport_marks` + `has_carport_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 泊印の自署を問え。

### Security — D678: `X-TuffShed-*`/`X-ShedDepot-*`/`X-Monooki-*`/`X-InabaMono-*`/`X-PurehabuKoya-*` 等の物置・倉庫印自称が未検査

- **問題**: `X-TuffShed-*`/`X-ShedsUSA-*`/`X-ShedPros-*`/`X-ShedDepot-*`/`X-ShedKing-*`/`X-ShedDoctor-*`/`X-ShedWorks-*`/`X-ShedSupply-*`/`X-ShedStore-*`/`X-ShedShop-*`/`X-ShedUSA-*`/`X-BackyardShed-*`/`X-StorageShed-*`/`X-GardenShed-*`/`X-ToolShed-*`/`X-ShedBuilder-*`/`X-ShedBuilders-*`/`X-ShedInstall-*`/`X-ShedRepair-*`/`X-ShedNation-*`/`X-ShedLine-*`/`X-ShedForce-*`/`X-ShedTeam-*`/`X-ShedMasters-*`、JP は `X-Monooki-*`/`X-MonookiKouji-*`/`X-MonookiYasan-*`/`X-MonookiPro-*`/`X-MonookiSeibi-*`/`X-MonookiKensa-*`/`X-MonookiManten-*`/`X-MonookiNomi-*`/`X-MonookiJP-*`/`X-MonookiSenmon-*`/`X-MonookiShuri-*`/`X-MonookiDoctors-*`/`X-MonookiTeam-*`/`X-MonookiGyosha-*`/`X-InabaMono-*`/`X-YodoMono-*`/`X-TakuboMono-*`/`X-Okigura-*`/`X-Soukoya-*`/`X-Soukoyasan-*`/`X-PurehabuKoya-*`/`X-KoyaYasan-*`/`X-MonookiKura-*`/`X-MonookiTenken-*`/`X-MonookiTeiki-*`/`X-MonookiSekou-*`/`X-MonookiHaiki-*` 等 は蔵機の通知記録 — 送信側が書くことは自称。物置・プレハブ倉庫・バックヤード小屋の偽装は、倉庫設置・撤去費用を装ったなりすましの典型手口。(セルフストレージは storage 機、建材は housing 機で検出済み)
- **修正**: `Envelope` に `shed_marks` + `has_shed_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 蔵印の自署を問え。

### Security — D679: `X-Radonova-*`/`X-Airthings-*`/`X-RadonKensa-*`/`X-RadonTaisaku-*`/`X-RadonMitigation-*` 等のラドン測定印自称が未検査

- **問題**: `X-Radonova-*`/`X-AccuStar-*`/`X-Airthings-*`/`X-AirChek-*`/`X-RadonAway-*`/`X-FestaRadon-*`/`X-RadonPro-*`/`X-RadonPros-*`/`X-RadonMitigation-*`/`X-RadonMitig-*`/`X-RadonControl-*`/`X-RadonSys-*`/`X-RadonRemoval-*`/`X-RadonAbate-*`/`X-RadonReduce-*`/`X-RadonFree-*`/`X-RadonTest-*`/`X-RadonInspect-*`/`X-RadonCheck-*`/`X-RadonLab-*`/`X-RadonWorks-*`/`X-RadonTeam-*`/`X-RadonDoctor-*`/`X-RadonExperts-*`/`X-RadonMasters-*`/`X-RadonSafe-*`/`X-ProLab-*`/`X-SunRadon-*`/`X-Corentium-*`/`X-SpruceLabs-*`、JP は `X-RadonKensa-*`/`X-RadonTaisaku-*`/`X-RadonSokutei-*`/`X-RadonYasan-*`/`X-RadonProJP-*`/`X-RadonTeamJP-*`/`X-RadonGyosha-*`/`X-RadonSenmon-*`/`X-RadonShinsa-*`/`X-RadonKaizen-*`/`X-RadonBoshi-*`/`X-RadonKeigen-*`/`X-RadonJP-*`/`X-RadonServiceJP-*`/`X-RadonChousa-*`/`X-RadonKanki-*`/`X-RadonTeiki-*`/`X-RadonNomi-*` 等 は測機の通知記録 — 送信側が書くことは自称。ラドン測定・ラドン低減工事の偽装は、健康不安を煽る測定・対策費用詐欺の典型手口。(アスベストは asbestos 機、カビは mold 機、空調は hvac 機で検出済み)
- **修正**: `Envelope` に `radon_marks` + `has_radon_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 測印の自署を問え。
