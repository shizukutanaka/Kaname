...
### Security — D683: `X-Concrete-*`/`X-ReadyMix-*`/`X-KonkuritoKouji-*`/`X-StampedConcrete-*`/`X-ConcretePump-*` 等のコンクリート印自称が未検査

- **問題**: `X-Concrete-*`/`X-ConcretePros-*`/`X-ConcreteWorks-*`/`X-ConcreteDoc-*`/`X-ConcreteTeam-*`/`X-ConcreteExperts-*`/`X-ConcreteMasters-*`/`X-ConcreteForce-*`/`X-ReadyMix-*`/`X-ReadyMixPro-*`/`X-ReadyMixUSA-*`/`X-CementWorks-*`/`X-CementPros-*`/`X-ConcreteFlatwork-*`/`X-FlatworkPros-*`/`X-ConcretePouring-*`/`X-ConcreteDelivery-*`/`X-ConcretePump-*`/`X-ConcretePumping-*`/`X-ConcreteContractor-*`/`X-ConcreteCompany-*`/`X-DrivewayConcrete-*`/`X-PatioConcrete-*`/`X-SlabConcrete-*`/`X-StampedConcrete-*`/`X-ConcreteRepair-*`/`X-ConcreteLevel-*`/`X-ConcreteCoat-*`、JP は `X-Konkurito-*`/`X-Namakon-*`/`X-Konkureto-*`/`X-ConcreteSagyou-*`/`X-ConcreteKouji-*`/`X-ConcreteYasan-*`/`X-ConcretePro-*`/`X-KonkuritoKouji-*`/`X-NamakonYasan-*`/`X-NamakonDeliver-*`/`X-SementoKouji-*`/`X-SementoYasan-*`/`X-KonkuKouji-*`/`X-DasseiKon-*`/`X-ConcreteJP-*`/`X-ConcreteSenmon-*`/`X-ConcreteManten-*`/`X-ConcreteTenken-*`/`X-ConcreteMitsumori-*`/`X-ConcreteChousa-*`/`X-ConcreteTeiki-*` 等 は混機の通知記録 — 送信側が書くことは自称。生コン打設・スタンプコンクリート・スラブ工事の偽装は、見積後の手付金持ち逃げ・出来高水増し請求の典型手口。(舗装は sealcoat 機、基礎は foundation 機で検出済み)
- **修正**: `Envelope` に `concrete_marks` + `has_concrete_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 混印の自署を問え。

### Security — D684: `X-Masonry-*`/`X-Tuckpoint-*`/`X-IshiKouji-*`/`X-RengaKouji-*`/`X-StoneVeneer-*` 等の石積み印自称が未検査

- **問題**: `X-Masonry-*`/`X-MasonPros-*`/`X-MasonryPros-*`/`X-MasonryWorks-*`/`X-MasonryTeam-*`/`X-MasonryExperts-*`/`X-MasonryMasters-*`/`X-MasonContractor-*`/`X-Brickwork-*`/`X-BrickworkPros-*`/`X-BrickMasonry-*`/`X-Stonework-*`/`X-StoneworkPros-*`/`X-StoneMasonry-*`/`X-Tuckpoint-*`/`X-Tuckpointing-*`/`X-TuckpointPros-*`/`X-MortarRepair-*`/`X-BrickRepair-*`/`X-StoneVeneer-*`/`X-BrickVeneer-*`/`X-ChimneyMasonry-*`/`X-MasonryRepair-*`/`X-MasonryRestore-*`/`X-BrickDoctor-*`/`X-StoneDoctor-*`、JP は `X-Sekkii-*`/`X-Sekizai-*`/`X-IshiKouji-*`/`X-Sekkou-*`/`X-Renga-*`/`X-RengaKouji-*`/`X-RengaYasan-*`/`X-BrickKouji-*`/`X-Ishizumi-*`/`X-Ishigar-*`/`X-IshiYasan-*`/`X-SekizaiKouji-*`/`X-SekizaiYasan-*`/`X-MasonKouji-*`/`X-MeisonKouji-*`/`X-BurikkuYasan-*`/`X-RengaShuri-*`/`X-IshiKouzou-*`/`X-Ishigaki-*`/`X-IshigakiKouji-*`/`X-SekkiiMitsumori-*`/`X-RengaMitsumori-*`/`X-IshiMitsumori-*`/`X-SekkiiTeiki-*` 等 は石機の通知記録 — 送信側が書くことは自称。石積み・レンガ・タックポイント・石材ベニヤの偽装は、外壁修繕を装った高額リフォーム詐欺の典型手口。(サイディングは siding 機、煙突は chimney 機、基礎は foundation 機で検出済み)
- **修正**: `Envelope` に `masonry_marks` + `has_masonry_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 石印の自署を問え。

### Security — D685: `X-UniFirst-*`/`X-Alsco-*`/`X-RinenSapurai-*`/`X-YunifomuRentaru-*`/`X-LinenSupply-*` 等のリネンサプライ印自称が未検査

- **問題**: `X-UniFirst-*`/`X-Alsco-*`/`X-Vestis-*`/`X-MissionLinen-*`/`X-AmeriPrideUni-*`/`X-CintasUni-*`/`X-AramarkUni-*`/`X-LinenSupply-*`/`X-LinenRental-*`/`X-LinenPros-*`/`X-LinenService-*`/`X-LinenTeam-*`/`X-LinenWorks-*`/`X-LinenExpress-*`/`X-UniformRental-*`/`X-UniformService-*`/`X-UniformPros-*`/`X-UniformTeam-*`/`X-WorkwearRental-*`/`X-WorkwearPros-*`/`X-GarmentRental-*`/`X-TowelService-*`/`X-MatService-*`/`X-MopRental-*`/`X-ShopRagRental-*`/`X-LinenKing-*`/`X-UniformKing-*`/`X-TotalLinen-*`/`X-LinenMaster-*`、JP は `X-RinenSapurai-*`/`X-Rinensa-*`/`X-YunifomuRentaru-*`/`X-YunifomuPro-*`/`X-YunifomuKouji-*`/`X-YunifomuYasan-*`/`X-SeifukuRentaru-*`/`X-Seifuku-*`/`X-Sagyoufuku-*`/`X-RinenKensa-*`/`X-RinenPro-*`/`X-RinenTenken-*`/`X-RinenMitsumori-*`/`X-RinenJP-*`/`X-RinenTeam-*`/`X-RinenSenmon-*`/`X-RinenChousa-*`/`X-RinenTeiki-*`/`X-RinenTaisaku-*`/`X-RinenSagyou-*` 等 は衣機の通知記録 — 送信側が書くことは自称。リネンサプライ・ユニフォームレンタル・作業服レンタルの偽装は、長期契約・解約違約金を装った法人営業詐欺の典型手口。(クリーニング店は cleaning 機、施設管理は facility 機で検出済み — `x-cintas-`/`x-aramark-` は facility 族所有のため `x-cintasuni-`/`x-aramarkuni-` 形のみ収録)
- **修正**: `Envelope` に `linenrental_marks` + `has_linenrental_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 衣印の自署を問え。
