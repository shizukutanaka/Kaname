...
### Security — D764: `X-Factoring-*`/`X-Kyuuyomae-*`/`X-Saikenjoto-*`/`X-InvoiceFinance-*` 等のファクタリング・給与前払い印自称が未検査

- **問題**: `X-Factoring-*`/`X-FactorYasan-*`/`X-FactorPro-*`/`X-FactorTeam-*`/`X-FactorKensa-*`/`X-FactorManten-*`/`X-FactorNomi-*`/`X-FactorJP-*`/`X-FactorSenmon-*`/`X-FactorMitsumori-*`/`X-FactorChousa-*`/`X-FactorTeiki-*`/`X-FactorShuri-*`/`X-FactorMart-*`/`X-FactorBank-*`/`X-Kyuuyomae-*`/`X-KyuuyomaeYasan-*`/`X-KyuuyomaePro-*`/`X-KyuuyomaeTeam-*`/`X-KyuuyomaeKensa-*`/`X-KyuuyomaeManten-*`/`X-KyuuyomaeNomi-*`/`X-KyuuyomaeJP-*`/`X-KyuuyomaeSenmon-*`/`X-KyuuyomaeMitsumori-*`/`X-KyuuyomaeChousa-*`/`X-Saikenjoto-*`/`X-SaikenjotoYasan-*`/`X-SaikenjotoPro-*`/`X-SaikenjotoTeam-*`/`X-SaikenjotoJP-*`/`X-SaikenjotoSenmon-*`/`X-InvoiceFinancePros-*`/`X-InvoiceFinanceTeam-*`/`X-InvoiceFinanceWorks-*`/`X-InvoiceFinanceExperts-*`/`X-InvoiceFinanceSvc-*`/`X-InvoiceFinanceHQ-*`/`X-FactoringPros-*`/`X-FactoringWorks-*`/`X-FactoringExperts-*`/`X-FactoringSvc-*`/`X-FactoringHQ-*`/`X-FactoringDoctors-*`/`X-FactoringRescue-*`/`X-KyuuyomaePros-*`/`X-KyuuyomaeDoctors-*`/`X-KyuuyomaeRescue-*` 等 は譲機の通知記録 — 送信側が書くことは自称。ファクタリング・給与前払い・売掛債権譲渡の偽装は、手数料・審査料・入金保証を装ったなりすましの典型手口。(消費者金融は consumerloan 機、証券は securities 機で検出済み)
- **修正**: `Envelope` に `factoring_marks` + `has_factoring_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 譲印の自署を問え。

### Security — D765: `X-Cpa-*`/`X-Kouninkaikeishi-*`/`X-Kaikeishi-*` 等の公認会計士・CPA印自称が未検査

- **問題**: `X-Cpa-*`/`X-CpaYasan-*`/`X-CpaPro-*`/`X-CpaTeam-*`/`X-CpaKensa-*`/`X-CpaManten-*`/`X-CpaNomi-*`/`X-CpaJP-*`/`X-CpaSenmon-*`/`X-CpaMitsumori-*`/`X-CpaChousa-*`/`X-CpaTeiki-*`/`X-CpaShuri-*`/`X-CpaSchool-*`/`X-CpaKoubou-*`/`X-CpaMart-*`/`X-CpaBank-*`/`X-Kouninkaikeishi-*`/`X-KouninkaikeishiYasan-*`/`X-KouninkaikeishiPro-*`/`X-KouninkaikeishiTeam-*`/`X-KouninkaikeishiKensa-*`/`X-KouninkaikeishiManten-*`/`X-KouninkaikeishiNomi-*`/`X-KouninkaikeishiJP-*`/`X-KouninkaikeishiSenmon-*`/`X-KouninkaikeishiMitsumori-*`/`X-Kaikeishi-*`/`X-KaikeishiYasan-*`/`X-KaikeishiPro-*`/`X-KaikeishiTeam-*`/`X-KaikeishiJP-*`/`X-KaikeishiSenmon-*`/`X-CpaPros-*`/`X-CpaWorks-*`/`X-CpaExperts-*`/`X-CpaSvc-*`/`X-CpaHQ-*`/`X-CpaDoctors-*`/`X-CpaRescue-*`/`X-KouninkaikeishiPros-*`/`X-KouninkaikeishiDoctors-*`/`X-KouninkaikeishiRescue-*`/`X-KaikeishiPros-*`/`X-KaikeishiDoctors-*`/`X-KaikeishiRescue-*` 等 は会機の通知記録 — 送信側が書くことは自称。公認会計士事務所・監査法人の偽装は、監査費・税務顧問料・決算代行費を装ったなりすましの典型手口。(税理士は taxfiling 機、司法書士は shiho 機で検出済み)
- **修正**: `Envelope` に `cpa_marks` + `has_cpa_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 会印の自署を問え。

### Security — D766: `X-Fukugyou-*`/`X-Naishoku-*`/`X-Sidejob-*`/`X-Sidehustle-*` 等の副業・内職斡旋印自称が未検査

- **問題**: `X-Fukugyou-*`/`X-FukugyouYasan-*`/`X-FukugyouPro-*`/`X-FukugyouTeam-*`/`X-FukugyouKensa-*`/`X-FukugyouManten-*`/`X-FukugyouNomi-*`/`X-FukugyouJP-*`/`X-FukugyouSenmon-*`/`X-FukugyouMitsumori-*`/`X-FukugyouChousa-*`/`X-FukugyouTeiki-*`/`X-FukugyouShuri-*`/`X-FukugyouSchool-*`/`X-FukugyouKoubou-*`/`X-FukugyouMart-*`/`X-FukugyouBank-*`/`X-Naishoku-*`/`X-NaishokuYasan-*`/`X-NaishokuPro-*`/`X-NaishokuTeam-*`/`X-NaishokuKensa-*`/`X-NaishokuManten-*`/`X-NaishokuNomi-*`/`X-NaishokuJP-*`/`X-NaishokuSenmon-*`/`X-NaishokuMitsumori-*`/`X-NaishokuChousa-*`/`X-SidejobPros-*`/`X-SidejobTeam-*`/`X-SidejobWorks-*`/`X-SidejobExperts-*`/`X-SidejobSvc-*`/`X-SidejobHQ-*`/`X-SidejobNavi-*`/`X-SidehustlePros-*`/`X-SidehustleTeam-*`/`X-SidehustleWorks-*`/`X-SidehustleExperts-*`/`X-FukugyouPros-*`/`X-FukugyouWorks-*`/`X-FukugyouExperts-*`/`X-FukugyouSvc-*`/`X-FukugyouHQ-*`/`X-FukugyouDoctors-*`/`X-FukugyouRescue-*`/`X-NaishokuPros-*`/`X-NaishokuDoctors-*`/`X-NaishokuRescue-*` 等 は副機の通知記録 — 送信側が書くことは自称。副業紹介・内職斡旋の偽装は、登録料・研修費・保証金を装ったなりすましの典型手口。(求人情報は jobs 機、派遣は hr 機、FC募集は franchise 機で検出済み)
