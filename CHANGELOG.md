...
### Security — D674: `X-InterNACHI-*`/`X-AmeriSpec-*`/`X-JutakuShindan-*`/`X-IeShindan-*`/`X-HomeInspect-*` 等の住宅診断印自称が未検査

- **問題**: `X-InterNACHI-*`/`X-ASHIInspect-*`/`X-AHITInspect-*`/`X-AmeriSpec-*`/`X-PillarToPost-*`/`X-PillarPost-*`/`X-WINHomeInsp-*`/`X-HouseMaster-*`/`X-NatlProperty-*`/`X-USInspect-*`/`X-HomeGauge-*`/`X-Spectora-*`/`X-HomeInspPro-*`/`X-TapInspect-*`/`X-InspectPedia-*`/`X-HomeInspect-*`/`X-HomeInspector-*`/`X-HomeInspectPros-*`/`X-InspectAll-*`/`X-PropertyInspect-*`/`X-HomeCheckup-*`/`X-InspectionPros-*`/`X-InspectForce-*`/`X-GuardianInsp-*`/`X-BuyersInsp-*`/`X-PrePurchaseInsp-*`、JP は `X-JutakuShindan-*`/`X-JutakuKensa-*`/`X-JutakuInspect-*`/`X-HomeShindan-*`/`X-KizokuShindan-*`/`X-JutakuShindanY-*`/`X-ShindanYasan-*`/`X-IeShindan-*`/`X-IeKensa-*`/`X-JutakuDokuta-*`/`X-HomeDokuta-*`/`X-ShindanPro-*`/`X-KensaPro-*`/`X-JutakuKensaJP-*`/`X-HomeCheckJP-*`/`X-NijuCheck-*`/`X-KenchikuKensa-*`/`X-JutakuSensei-*`/`X-JutakuTeiki-*`/`X-JutakuManten-*`/`X-JutakuNomi-*`/`X-JutakuJP-*`/`X-JutakuSenmon-*`/`X-JutakuTeam-*`/`X-JutakuDoctors-*`/`X-JutakuGyosha-*`/`X-JutakuShuri-*` 等 は査機の通知記録 — 送信側が書くことは自称。住宅診断・ホームインスペクション・既存住宅状況調査の偽装は、診断費用・修繕斡旋を装ったなりすましの典型手口。(住宅販売は housing 機、損保は insurance 機で検出済み)
- **修正**: `Envelope` に `homeinspect_marks` + `has_homeinspect_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 査印の自署を問え。

### Security — D675: `X-WellDrill-*`/`X-WaterWell-*`/`X-IdoKouji-*`/`X-PumpKoukan-*`/`X-WellPump-*` 等の井戸掘削印自称が未検査

- **問題**: `X-WellDrill-*`/`X-WellDrilling-*`/`X-WellPump-*`/`X-WellPumpPros-*`/`X-WaterWell-*`/`X-WaterWellPros-*`/`X-AquiferWell-*`/`X-SubmersibleWell-*`/`X-WellService-*`/`X-WellPro-*`/`X-WellDoctor-*`/`X-PumpDoctor-*`/`X-WellMasters-*`/`X-WellWorks-*`/`X-WellExperts-*`/`X-DeepWell-*`/`X-ShallowWell-*`/`X-WellRehab-*`/`X-WellClean-*`/`X-WellTest-*`/`X-PumpService-*`/`X-WellPumpService-*`/`X-WellTeam-*`/`X-WellForce-*`、JP は `X-IdoHorisaku-*`/`X-IdoHoriku-*`/`X-IdoKouji-*`/`X-IdoYasan-*`/`X-IdoSeibi-*`/`X-IdoKensa-*`/`X-IdoPro-*`/`X-IdoGyosha-*`/`X-PumpKoukan-*`/`X-PumpShuri-*`/`X-PumpTenken-*`/`X-YusuiKouji-*`/`X-YusuiKensa-*`/`X-FukaidoKouji-*`/`X-AsaidoKouji-*`/`X-IdoManten-*`/`X-IdoSenmon-*`/`X-IdoTeam-*`/`X-IdoJP-*`/`X-IdoDoctors-*`/`X-IdoKirei-*`/`X-IdoShuri-*`/`X-IdoNomi-*`/`X-IdoSagyou-*`/`X-IdoChousa-*`/`X-IdoTeiki-*`/`X-IdoBoring-*`/`X-IdoBori-*` 等 は井機の通知記録 — 送信側が書くことは自称。井戸掘削・ポンプ交換・揚水設備工事の偽装は、高額井戸工事・水質不安を煽るなりすましの典型手口 (地方部・農村部の高齢世帯を狙う訪販で有名)。(水道は plumbing 機、浄水器は waterserver 機で検出済み)
- **修正**: `Envelope` に `welldrill_marks` + `has_welldrill_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 井印の自署を問え。

### Security — D676: `X-Sunroom-*`/`X-PatioEnclosures-*`/`X-Sanruumu-*`/`X-TerasuEn-*`/`X-ConservatoryPro-*` 等のサンルーム印自称が未検査

- **問題**: `X-Sunroom-*`/`X-Sunrooms-*`/`X-SunroomPros-*`/`X-FourSeasonsSunroom-*`/`X-PatioEnclosure-*`/`X-PatioEnclosures-*`/`X-SunPorch-*`/`X-SunSpace-*`/`X-LanaiRoom-*`/`X-ConservatoryPro-*`/`X-ConservatoryPros-*`/`X-GardenRoom-*`/`X-GardenRooms-*`/`X-Solarium-*`/`X-SolariumPros-*`/`X-EnclosedPatio-*`/`X-ThreeSeasonRoom-*`/`X-AllSeasonSunroom-*`/`X-SunroomDoctor-*`/`X-SunroomExperts-*`/`X-SunroomMasters-*`/`X-SunroomTeam-*`/`X-SunroomWorks-*`/`X-SunroomRepair-*`、JP は `X-Sanruumu-*`/`X-SanruumuKouji-*`/`X-SanruumuYasan-*`/`X-SanruumuPro-*`/`X-GadenRuumu-*`/`X-GadenRuumuKouji-*`/`X-OnshitsuKouji-*`/`X-OnshitsuSekkei-*`/`X-TerasuEn-*`/`X-TerasuYane-*`/`X-TerasuKouji-*`/`X-EkusuteriaSun-*`/`X-Ekusuteria-*`/`X-SanruumuSeibi-*`/`X-SanruumuKensa-*`/`X-SanruumuManten-*`/`X-SanruumuTeam-*`/`X-SanruumuDoctors-*`/`X-SanruumuGyosha-*`/`X-SanruumuNomi-*`/`X-SanruumuJP-*`/`X-SanruumuSenmon-*`/`X-GarasuSanruumu-*`/`X-GarasuOnshitsu-*`/`X-GarasuPatio-*`/`X-SanruumuShuri-*`/`X-SanruumuNawate-*`/`X-SanruumuTeiki-*` 等 は室機の通知記録 — 送信側が書くことは自称。サンルーム・テラス囲い・ガーデンルームの偽装は、高額エクステリア工事のなりすまし・訪問販売の典型手口。(住宅建材は housing 機、窓サッシは window 機、ガーデニングは garden 機で検出済み)
- **修正**: `Envelope` に `sunroom_marks` + `has_sunroom_marks` 追加; `commands.rs` で render_risks 兆候報告。
