...
### Security — D710: `X-CosmeticPros-*`/`X-PlasticSurgeryPros-*`/`X-Seikei-*`/`X-Biyougeka-*` 等の美容整形印自称が未検査

- **問題**: `X-CosmeticPros-*`/`X-CosmeticTeam-*`/`X-CosmeticWorks-*`/`X-CosmeticForce-*`/`X-CosmeticNation-*`/`X-CosmeticExperts-*`/`X-CosmeticDoctors-*`/`X-CosmeticMasters-*`/`X-CosmeticSvc-*`/`X-CosmeticHQ-*`/`X-PlasticSurgeryPros-*`/`X-PlasticSurgeryTeam-*`/`X-PlasticSurgeryWorks-*`/`X-PlasticSurgeryExperts-*`/`X-PlasticSurgeryDoctors-*`/`X-PlasticSurgeryMasters-*`/`X-SbcSeikei-*`/`X-TakasuClinic-*`/`X-JiyuugaokaClinic-*`/`X-SeikeiClinic-*`/`X-BiyouClinic-*`、JP は `X-Biyougeka-*`/`X-BiyouSeikei-*`/`X-SeikeiGeka-*`/`X-SeikeiYasan-*`/`X-SeikeiPro-*`/`X-SeikeiTeam-*`/`X-SeikeiGyo-*`/`X-SeikeiKensa-*`/`X-SeikeiManten-*`/`X-SeikeiNomi-*`/`X-SeikeiJP-*`/`X-SeikeiSenmon-*`/`X-SeikeiMitsumori-*`/`X-SeikeiChousa-*`/`X-SeikeiTeiki-*`/`X-SeikeiShuri-*`/`X-BiyouTeam-*`/`X-BiyouWorks-*`/`X-BiyouForce-*`/`X-BiyouNation-*`/`X-BiyouExperts-*`/`X-BiyouDoctors-*`/`X-BiyouMasters-*`/`X-BiyouSvc-*`/`X-BiyouHQ-*`/`X-SeikeiRescue-*`/`X-SeikeiDoctors-*` 等 は容機の通知記録 — 送信側が書くことは自称。美容整形・形成外科クリニックの偽装は、手術費用・モニター募集・カウンセリング料を装ったなりすましの典型手口。(エステは esthe 機、医科は medical 機で検出済み)
- **修正**: `Envelope` に `cosmeticsurgery_marks` + `has_cosmeticsurgery_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 容印の自署を問え。

### Security — D711: `X-CareCom-*`/`X-SitterCity-*`/`X-Hoiku-*`/`X-NannyPros-*`/`X-BabysitterPros-*` 等の保育・ベビーシッター印自称が未検査

- **問題**: `X-CareCom-*`/`X-SitterCity-*`/`X-UrbanSitter-*`/`X-Bambino-*`/`X-BabysitterPros-*`/`X-BabysitterTeam-*`/`X-BabysitterWorks-*`/`X-BabysitterForce-*`/`X-BabysitterNation-*`/`X-BabysitterExperts-*`/`X-BabysitterDoctors-*`/`X-BabysitterSvc-*`/`X-BabysitterHQ-*`/`X-NannyPros-*`/`X-NannyTeam-*`/`X-NannyWorks-*`/`X-NannyForce-*`/`X-NannyNation-*`/`X-NannyExperts-*`/`X-NannyDoctors-*`/`X-NannyMasters-*`/`X-NannySvc-*`/`X-NannyHQ-*`/`X-ChildcarePros-*`/`X-ChildcareTeam-*`/`X-ChildcareWorks-*`/`X-ChildcareForce-*`/`X-ChildcareNation-*`/`X-ChildcareExperts-*`/`X-ChildcareSvc-*`/`X-ChildcareHQ-*`、JP は `X-HoikuPros-*`/`X-HoikuTeam-*`/`X-HoikuWorks-*`/`X-HoikuForce-*`/`X-HoikuExperts-*`/`X-HoikuDoctors-*`/`X-HoikuJP-*`/`X-HoikuHoiku-*`/`X-BabysitterYasan-*`/`X-Bebishi-*`/`X-BebishiPro-*`/`X-BebishiTeam-*`/`X-BebishiKensa-*`/`X-BebishiManten-*`/`X-BebishiNomi-*`/`X-BebishiJP-*`/`X-BebisiSenmon-*`/`X-KodomoPro-*`/`X-Kosodate-*`/`X-KosodatePro-*`/`X-KosodateTeam-*`/`X-KosodateSvc-*` 等 は育機の通知記録 — 送信側が書くことは自称。保育園・ベビーシッター・ナニーの偽装は、保育料・入会金・緊急対応費を装ったなりすましの典型手口。(託児家事は housekeeping 機、介護は eldercare 機で検出済み)
- **修正**: `Envelope` に `childcare_marks` + `has_childcare_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 育印の自署を問え。

### Security — D712: `X-iCracked-*`/`X-uBreakiFix-*`/`X-Sumaho-*`/`X-PhoneRepairPros-*`/`X-Keitai-*` 等のスマホ・携帯修理印自称が未検査

- **問題**: `X-iCracked-*`/`X-uBreakiFix-*`/`X-AsurionTech-*`/`X-PhoneRepairPros-*`/`X-PhoneRepairTeam-*`/`X-PhoneRepairWorks-*`/`X-PhoneRepairForce-*`/`X-PhoneRepairNation-*`/`X-PhoneRepairExperts-*`/`X-PhoneRepairDoctors-*`/`X-PhoneRepairMasters-*`/`X-PhoneRepairSvc-*`/`X-PhoneRepairHQ-*`/`X-iFonRepair-*`/`X-iFonPros-*`/`X-iFonTeam-*`/`X-iFonWorks-*`、JP は `X-SumahoShuri-*`/`X-Sumaho-*`/`X-SumahoYasan-*`/`X-SumahoPro-*`/`X-SumahoTeam-*`/`X-SumahoKensa-*`/`X-SumahoManten-*`/`X-SumahoNmi-*`/`X-SumahoJP-*`/`X-SumahoSenmon-*`/`X-SumahoMitsumori-*`/`X-SumahoChousa-*`/`X-SumahoTeiki-*`/`X-SumahoShuriya-*`/`X-SumahoRescue-*`/`X-SumahoDoctors-*`/`X-SumahoSagyou-*`/`X-SumahoTeikyu-*`/`X-SumahoOrder-*`/`X-KeitaiShuri-*`/`X-Keitai-*`/`X-KeitaiYasan-*`/`X-KeitaiPro-*`/`X-KeitaiTeam-*`/`X-KeitaiKensa-*`/`X-KeitaiManten-*`/`X-KeitaiNomi-*`/`X-KeitaiJP-*`/`X-KeitaiSenmon-*`/`X-KeitaiMitsumori-*`/`X-KeitaiChousa-*`/`X-KeitaiTeiki-*` 等 は携機の通知記録 — 送信側が書くことは自称。スマホ・携帯修理店の偽装は、画面割れ修理・バッテリー交換・データ移行料金を装ったなりすましの典型手口。(家電修理は appliance 機、メーカーは device 機で検出済み)
- **修正**: `Envelope` に `phonerepair_marks` + `has_phonerepair_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 携印の自署を問え。
