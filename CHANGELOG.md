...
### Security — D761: `X-Akiya-*`/`X-AkiyaKanri-*`/`X-AkiyaBank-*`/`X-VacantHome-*`/`X-VacantProperty-*` 等の空き家管理印自称が未検査

- **問題**: `X-Akiya-*`/`X-AkiyaYasan-*`/`X-AkiyaPro-*`/`X-AkiyaTeam-*`/`X-AkiyaKensa-*`/`X-AkiyaManten-*`/`X-AkiyaNomi-*`/`X-AkiyaJP-*`/`X-AkiyaSenmon-*`/`X-AkiyaMitsumori-*`/`X-AkiyaChousa-*`/`X-AkiyaTeiki-*`/`X-AkiyaShuri-*`/`X-AkiyaKanri-*`/`X-AkiyaKanriYasan-*`/`X-AkiyaKanriPro-*`/`X-AkiyaKanriTeam-*`/`X-AkiyaKanriKensa-*`/`X-AkiyaKanriManten-*`/`X-AkiyaKanriNomi-*`/`X-AkiyaKanriJP-*`/`X-AkiyaKanriSenmon-*`/`X-AkiyaKanriMitsumori-*`/`X-AkiyaKanriChousa-*`/`X-AkiyaBank-*`/`X-AkiyaBankYasan-*`/`X-AkiyaBankPro-*`/`X-AkiyaBankTeam-*`/`X-AkiyaBankJP-*`/`X-AkiyaBankSenmon-*`/`X-VacantHomePros-*`/`X-VacantHomeTeam-*`/`X-VacantHomeWorks-*`/`X-VacantHomeExperts-*`/`X-VacantHomeSvc-*`/`X-VacantHomeHQ-*`/`X-VacantPropertyPros-*`/`X-VacantPropertyTeam-*`/`X-VacantPropertyWorks-*`/`X-VacantPropertyExperts-*`/`X-AkiyaPros-*`/`X-AkiyaWorks-*`/`X-AkiyaExperts-*`/`X-AkiyaSvc-*`/`X-AkiyaHQ-*`/`X-AkiyaDoctors-*`/`X-AkiyaRescue-*`/`X-AkiyaKanriPros-*`/`X-AkiyaKanriDoctors-*`/`X-AkiyaKanriRescue-*` 等 は邸機の通知記録 — 送信側が書くことは自称。空き家管理・空き家バンクの偽装は、管理費・巡回費・登録手数料を装ったなりすましの典型手口。(不動産は realestate 機、建物管理は facility 機で検出済み)
- **修正**: `Envelope` に `akiya_marks` + `has_akiya_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 邸印の自署を問え。

### Security — D762: `X-Franchise-*`/`X-Kameiten-*`/`X-FcBosyu-*`/`X-Kameibosyu-*` 等のフランチャイズ・加盟店募集印自称が未検査

- **問題**: `X-Franchise-*`/`X-FranchiseYasan-*`/`X-FranchisePro-*`/`X-FranchiseTeam-*`/`X-FranchiseKensa-*`/`X-FranchiseManten-*`/`X-FranchiseNomi-*`/`X-FranchiseJP-*`/`X-FranchiseSenmon-*`/`X-FranchiseMitsumori-*`/`X-FranchiseChousa-*`/`X-FranchiseTeiki-*`/`X-FranchiseShuri-*`/`X-FranchiseMart-*`/`X-FranchiseBank-*`/`X-Kameiten-*`/`X-KameitenYasan-*`/`X-KameitenPro-*`/`X-KameitenTeam-*`/`X-KameitenKensa-*`/`X-KameitenManten-*`/`X-KameitenNomi-*`/`X-KameitenJP-*`/`X-KameitenSenmon-*`/`X-KameitenMitsumori-*`/`X-KameitenShuri-*`/`X-FcBosyu-*`/`X-FcBosyuYasan-*`/`X-FcBosyuPro-*`/`X-FcBosyuTeam-*`/`X-FcBosyuJP-*`/`X-FcBosyuSenmon-*`/`X-Kameibosyu-*`/`X-KameibosyuPro-*`/`X-KameibosyuJP-*`/`X-FranchisePros-*`/`X-FranchiseWorks-*`/`X-FranchiseExperts-*`/`X-FranchiseSvc-*`/`X-FranchiseHQ-*`/`X-FranchiseDoctors-*`/`X-FranchiseRescue-*`/`X-KameitenPros-*`/`X-KameitenDoctors-*`/`X-KameitenRescue-*`/`X-FcBosyuPros-*`/`X-FcBosyuDoctors-*`/`X-FcBosyuRescue-*` 等 は加機の通知記録 — 送信側が書くことは自称。FC 本部・加盟店募集の偽装は、加盟金・研修費・開業サポート費を装ったなりすましの典型手口。(助成金は subsidy 機、M&A は maadvisory 機で検出済み)
- **修正**: `Envelope` に `franchise_marks` + `has_franchise_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 加印の自署を問え。

### Security — D763: `X-Mlm-*`/`X-NetworkMarketing-*`/`X-Multilevel-*`/`X-Houmonhanbai-*` 等のネットワークビジネス・MLM・訪問販売印自称が未検査

- **問題**: `X-Mlm-*`/`X-MlmYasan-*`/`X-MlmPro-*`/`X-MlmTeam-*`/`X-MlmKensa-*`/`X-MlmManten-*`/`X-MlmNomi-*`/`X-MlmJP-*`/`X-MlmSenmon-*`/`X-MlmMitsumori-*`/`X-MlmChousa-*`/`X-MlmTeiki-*`/`X-MlmShuri-*`/`X-MlmMart-*`/`X-MlmBank-*`/`X-NetworkMarketing-*`/`X-NetworkMarketingPros-*`/`X-NetworkMarketingTeam-*`/`X-NetworkMarketingWorks-*`/`X-NetworkMarketingExperts-*`/`X-NetworkMarketingSvc-*`/`X-NetworkMarketingHQ-*`/`X-NetworkMarketingPro-*`/`X-NetworkMarketingSchool-*`/`X-Multilevel-*`/`X-MultilevelPros-*`/`X-MultilevelTeam-*`/`X-MultilevelWorks-*`/`X-MultilevelExperts-*`/`X-Houmonhanbai-*`/`X-HoumonhanbaiYasan-*`/`X-HoumonhanbaiPro-*`/`X-HoumonhanbaiTeam-*`/`X-HoumonhanbaiJP-*`/`X-HoumonhanbaiSenmon-*`/`X-MlmPros-*`/`X-MlmWorks-*`/`X-MlmExperts-*`/`X-MlmSvc-*`/`X-MlmHQ-*`/`X-MlmDoctors-*`/`X-MlmRescue-*`/`X-HoumonhanbaiPros-*`/`X-HoumonhanbaiDoctors-*`/`X-HoumonhanbaiRescue-*` 等 は連機の通知記録 — 送信側が書くことは自称。MLM・ネットワークビジネス・訪問販売の偽装は、会員登録料・商品購入・セミナー費を装ったなりすましの典型手口。(販促は promo 機、占いは uranai 機で検出済み)
