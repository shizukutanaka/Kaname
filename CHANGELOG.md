...
### Security — D668: `X-DryerVentWizard-*`/`X-VentWizard-*`/`X-KansoukiHaiki-*`/`X-HaikiDansu-*`/`X-DryerVent-*` 等の乾燥機排気管清掃印自称が未検査

- **問題**: `X-DryerVentWizard-*`/`X-VentWizard-*`/`X-VentPros-*`/`X-DryerVent-*`/`X-DryerVentPros-*`/`X-DryerVentExperts-*`/`X-DryerVentDoctors-*`/`X-DryerVentTech-*`/`X-DryerVentMasters-*`/`X-DryerVentTeam-*`/`X-DryerVentForce-*`/`X-DryerVentUSA-*`/`X-VentCleaning-*`/`X-VentCleaningPros-*`/`X-DryerDuct-*`/`X-DryerDuctPros-*`/`X-DuctPros-*`/`X-DryerLint-*`/`X-LintTrap-*`/`X-VentSafety-*`/`X-VentInspectors-*`/`X-DryerSafety-*`/`X-VentForce-*`/`X-VentTeam-*`/`X-VentMasters-*`、JP は `X-KansoukiHaiki-*`/`X-KansoukiDansu-*`/`X-HaikiDansu-*`/`X-HaikiKouji-*`/`X-KansoukiSeibi-*`/`X-HaikiSeibi-*`/`X-KansoukiYasan-*`/`X-HaikiYasan-*`/`X-KansoukiDoctors-*`/`X-KansoukiTeam-*`/`X-KansoukiPro-*`/`X-HaikiDoctors-*`/`X-KansoukiGyosha-*`/`X-HaikiGyosha-*`/`X-HaikiKensa-*`/`X-HaikiKirei-*`/`X-KansoukiKirei-*`/`X-HaikiManten-*`/`X-KansoukiManten-*`/`X-DansuHaiki-*`/`X-KansoukiNomi-*`/`X-DansuSeibi-*`/`X-DansuKouji-*`/`X-DansuYasan-*`/`X-DansuDoctors-*`/`X-DansuTeam-*`/`X-DansuPro-*`/`X-DansuGyosha-*`/`X-DansuKensa-*`/`X-DansuKirei-*`/`X-DansuManten-*`/`X-DansuNomi-*`/`X-DansuJP-*`/`X-DansuSenmon-*` 等 は排機の通知記録 — 送信側が書くことは自称。乾燥機排気管・ランドリーダクト・リント除去の偽装は排気管清掃業者なりすましの典型手口 (火災リスクを煽る訪販で有名)。(空調ダクトは duct 機、家電は appliance 機で検出済み)
- **修正**: `Envelope` に `dryervent_marks` + `has_dryervent_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 排印の自署を問え。

### Security — D669: `X-BathFitter-*`/`X-ReBath-*`/`X-FuroRifo-*`/`X-FuroKouji-*`/`X-UnitBath-*` 等の浴室・風呂リフォーム印自称が未検査

- **問題**: `X-BathFitter-*`/`X-ReBath-*`/`X-BathtubPros-*`/`X-BathPlanet-*`/`X-BathPlanetUSA-*`/`X-BathroomPros-*`/`X-BathWraps-*`/`X-BathExperts-*`/`X-BathDoctors-*`/`X-BathMasters-*`/`X-BathWorks-*`/`X-BathTeam-*`/`X-BathForce-*`/`X-BathSolutions-*`/`X-BathUSA-*`/`X-ShowerPros-*`/`X-TubPros-*`/`X-TubToShower-*`/`X-WalkInTub-*`/`X-WalkInShower-*`/`X-SafeStepTub-*`/`X-BathSafety-*`/`X-TileBath-*`、JP は `X-FuroRifo-*`/`X-FuroKouji-*`/`X-FuroYasan-*`/`X-Basurifu-*`/`X-YokusouRifo-*`/`X-FuroSeibi-*`/`X-FuroRepair-*`/`X-FuroDoctors-*`/`X-FuroTeam-*`/`X-FuroPro-*`/`X-FuroGyosha-*`/`X-FuroKensa-*`/`X-FuroKirei-*`/`X-FuroManten-*`/`X-YokusouKouji-*`/`X-YokusouYasan-*`/`X-YokusouSeibi-*`/`X-YokusouPro-*`/`X-ShowerKouji-*`/`X-ShowerRifo-*`/`X-UnitBath-*`/`X-UnitBathKouji-*`/`X-YokusouGyosha-*`/`X-OfuroRifo-*`/`X-OfuroKouji-*`/`X-OfuroYasan-*`/`X-BathRifu-*`/`X-FuroNomi-*`/`X-YokusouNomi-*`/`X-FuroJP-*`/`X-YokusouJP-*`/`X-FuroSenmon-*`/`X-YokusouSenmon-*` 等 は浴機の通知記録 — 送信側が書くことは自称。風呂リフォーム・ユニットバス・バリアフリー浴室・給湯器交換の偽装は浴室リフォーム業者なりすましの典型手口 (高額浴室工事の飛び込み営業で有名)。(リフォームは renovation 機、水道は plumbing 機で検出済み)
- **修正**: `Envelope` に `bathroom_marks` + `has_bathroom_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 浴印の自署を問え。

### Security — D670: `X-BudgetBlinds-*`/`X-HunterDouglas-*`/`X-Buraindo-*`/`X-BlindKouji-*`/`X-KatenReru-*` 等のブラインド・窓装飾印自称が未検査

- **問題**: `X-BudgetBlinds-*`/`X-HunterDouglas-*`/`X-BlindsGalore-*`/`X-BlindsPros-*`/`X-BlindsUSA-*`/`X-BlindsExperts-*`/`X-BlindsDoctors-*`/`X-BlindsMasters-*`/`X-BlindsWorks-*`/`X-BlindsTeam-*`/`X-BlindsForce-*`/`X-BlindsSolutions-*`/`X-BlindsInstall-*`/`X-BlindsRepair-*`/`X-ShadePros-*`/`X-ShadeStore-*`/`X-ShadeExperts-*`/`X-ShutterPros-*`/`X-PlantationShutter-*`/`X-WindowTreatment-*`/`X-CustomBlinds-*`/`X-MotorBlinds-*`/`X-SmartBlinds-*`/`X-VerticalBlinds-*`、JP は `X-Buraindo-*`/`X-BuraindoKouji-*`/`X-BuraindoYasan-*`/`X-BlindKouji-*`/`X-BlindYasan-*`/`X-BuraindoSeibi-*`/`X-BuraindoRepair-*`/`X-BuraindoPro-*`/`X-BuraindoTeam-*`/`X-BuraindoDoctors-*`/`X-KatenReru-*`/`X-KatenReruKouji-*`/`X-CurtainRail-*`/`X-CurtainRailKouji-*`/`X-BuraindoGyosha-*`/`X-BuraindoKensa-*`/`X-BuraindoManten-*`/`X-RollScreen-*`/`X-RollScreenKouji-*`/`X-RomanShade-*`/`X-ShadeKouji-*`/`X-ShutterKouji-*`/`X-ShutterYasan-*`/`X-BuraindoNomi-*`/`X-BuraindoJP-*`/`X-BlindJP-*`/`X-BuraindoSenmon-*` 等 は帳機の通知記録 — 送信側が書くことは自称。ブラインド交換・カーテンレール取付・シャッター・ロールスクリーンの偽装は窓装飾業者なりすましの典型手口。(窓サッシは window 機、シャッターは garagedoor 機で検出済み)
- **修正**: `Envelope` に `blinds_marks` + `has_blinds_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 帳印の自署を問え。
