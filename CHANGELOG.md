...
### Security — D689: `X-Vending-*`/`X-VendingPros-*`/`X-Jihanki-*`/`X-MyVending-*`/`X-VendingGroup-*` 等の自動販売機印自称が未検査

- **問題**: `X-Vending-*`/`X-VendingMachine-*`/`X-VendingPros-*`/`X-VendingService-*`/`X-VendingWorks-*`/`X-VendingTeam-*`/`X-MyVending-*`/`X-OfficeVending-*`/`X-HealthyVending-*`/`X-HealthyYOU-*`/`X-Naturals2Go-*`/`X-VendingGroup-*`/`X-SelectaVend-*`/`X-ExpressVending-*`/`X-Azkoyen-*`/`X-VendingExperts-*`/`X-VendingDoctors-*`/`X-VendingMasters-*`/`X-VendingForce-*`/`X-VendingNation-*`/`X-VendPros-*`/`X-VendService-*`/`X-VendTeam-*`/`X-VendWorks-*`/`X-VendExperts-*`/`X-CanteenVending-*`/`X-VendingRoute-*`/`X-VendingLocator-*`、JP は `X-Jihanki-*`/`X-JidouhanBaiki-*`/`X-Jidouhan-*`/`X-VendYa-*`/`X-VendPro-*`/`X-VendSenmon-*`/`X-VendMitsumori-*`/`X-VendChousa-*`/`X-VendTeiki-*`/`X-VendShuri-*`/`X-JihankiKouji-*`/`X-JihankiYasan-*`/`X-JihankiPro-*`/`X-JihankiTeam-*`/`X-JihankiGyosha-*`/`X-JihankiSeibi-*`/`X-JihankiKensa-*`/`X-JihankiManten-*`/`X-JihankiJP-*`/`X-JihankiSenmon-*` 等 は販機の通知記録 — 送信側が書くことは自称。自動販売機設置・ルート販売・オフィスベンダーの偽装は、設置料・ロケーション権利金を装った法人なりすましの典型手口。(飲料メーカーは drink 機、オフィスは office 機で検出済み)
- **修正**: `Envelope` に `vending_marks` + `has_vending_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 販印の自署を問え。

### Security — D690: `X-CopierLease-*`/`X-CopyTech-*`/`X-Fukugouki-*`/`X-MfpService-*`/`X-ManagedPrint-*` 等の複合機印自称が未検査

- **問題**: `X-CopierLease-*`/`X-CopierService-*`/`X-CopierPros-*`/`X-CopierTeam-*`/`X-CopierWorks-*`/`X-CopierExperts-*`/`X-CopierDoctors-*`/`X-CopierMasters-*`/`X-CopierForce-*`/`X-CopyTech-*`/`X-CopyService-*`/`X-PrintFleet-*`/`X-MfpService-*`/`X-MfpNavi-*`/`X-MfpRental-*`/`X-PrinterLease-*`/`X-LeasePrinter-*`/`X-CopierRental-*`/`X-CopierDoctor-*`/`X-CopierNation-*`/`X-CopyNation-*`/`X-MpsPartner-*`/`X-ManagedPrint-*`/`X-PrintAudit-*`/`X-PrintCare-*`、JP は `X-Fukugouki-*`/`X-FukugoukiYasan-*`/`X-FukugoukiPro-*`/`X-FukugoukiTeam-*`/`X-FukugoukiGyosha-*`/`X-FukugoukiSeibi-*`/`X-FukugoukiKensa-*`/`X-FukugoukiManten-*`/`X-FukugoukiNomi-*`/`X-FukugoukiJP-*`/`X-FukugoukiSenmon-*`/`X-FukugoukiMitsumori-*`/`X-FukugoukiChousa-*`/`X-FukugoukiTeiki-*`/`X-FukugoukiShuri-*`/`X-FukugoukiDoctors-*`/`X-FukugoukiSagyou-*`/`X-FukugoukiRescue-*`/`X-FukugoukiTeikyu-*`/`X-FukugoukiOrder-*`/`X-Koppiki-*`/`X-KoppikiYasan-*`/`X-KoppikiKouji-*` 等 は複機の通知記録 — 送信側が書くことは自称。複合機・コピー機リース・MPS 保守の偽装は、カウンター料金・保守契約詐欺の典型手口 (いわゆる「コピー機ビジネス」)。(機器メーカーは device 機、用紙・トナーは stationery 機で検出済み)
- **修正**: `Envelope` に `copierlease_marks` + `has_copierlease_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 複印の自署を問え。

### Security — D691: `X-Janitorial-*`/`X-JanPro-*`/`X-Birumen-*`/`X-Coverall-*`/`X-BuildingClean-*` 等のビル清掃印自称が未検査

- **問題**: `X-Janitorial-*`/`X-JanitorPros-*`/`X-JanPro-*`/`X-ABMIndustries-*`/`X-Coverall-*`/`X-JaniKing-*`/`X-VanguardClean-*`/`X-JanitorService-*`/`X-JanitorWorks-*`/`X-JanitorTeam-*`/`X-JanitorExperts-*`/`X-JanitorDoctors-*`/`X-JanitorMasters-*`/`X-JanitorForce-*`/`X-JanitorNation-*`/`X-KleenPros-*`/`X-KleenTeam-*`/`X-KleenService-*`/`X-BmsClean-*`/`X-CommercialClean-*`/`X-BuildingClean-*`/`X-OfficeCleanPros-*`/`X-DayPorter-*`/`X-PorterPros-*`、JP は `X-Birumen-*`/`X-BirumenPro-*`/`X-BirumenTeam-*`/`X-BirumenGyosha-*`/`X-BirumenSeibi-*`/`X-BirumenKensa-*`/`X-BirumenManten-*`/`X-BirumenNomi-*`/`X-BirumenJP-*`/`X-BirumenSenmon-*`/`X-BirumenMitsumori-*`/`X-BirumenChousa-*`/`X-BirumenTeiki-*`/`X-BirumenShuri-*`/`X-BirumenDoctors-*`/`X-BirumenSagyou-*`/`X-BirumenRescue-*`/`X-BirumenTeikyu-*`/`X-BirumenOrder-*`/`X-SoujiYasan-*`/`X-SoujiKouji-*`/`X-SeisouGyousha-*`/`X-SeisouPuro-*`/`X-SoujiPuro-*` 等 は清機の通知記録 — 送信側が書くことは自称。ビルメン・商業清掃・定期清掃契約の偽装は、清掃料金・契約更新詐欺の典型手口。(クリーニング店は cleaning 機、施設管理は facility 機、排水管は plumbing 機で検出済み)
- **修正**: `Envelope` に `janitorial_marks` + `has_janitorial_marks` 追加; `commands.rs` で render_risks 兆候報告。
