...
### Security — D653: `X-SuperiorFence-*`/`X-FenceTrac-*`/`X-FensuKouji-*`/`X-WoodDeck-*`/`X-HeiKouji-*` 等のフェンス・デッキ・塀工事印自称が未検査

- **問題**: `X-SuperiorFence-*`/`X-FenceTrac-*`/`X-FencePros-*`/`X-FenceCompany-*`/`X-FenceBuilders-*`/`X-FenceInstallers-*`/`X-FenceWorks-*`/`X-LongFence-*`/`X-FenceSupply-*`/`X-FenceDoctors-*`/`X-FenceTech-*`/`X-FenceMasters-*`/`X-FenceSolutions-*`/`X-DeckBuilders-*`/`X-DeckPros-*`/`X-DeckWorks-*`/`X-DeckMasters-*`/`X-Deckorators-*`/`X-TimberTech-*`/`X-DeckDoctors-*`/`X-PatioBuilders-*`/`X-RailingPros-*`/`X-PergolaPros-*`、JP は `X-FensuKouji-*`/`X-FensuYasan-*`/`X-FenceYasan-*`/`X-HeiKouji-*`/`X-WoodDeck-*`/`X-WoodDeckKouji-*`/`X-DeckKouji-*`/`X-Fenchikouji-*`/`X-Mekakushi-*`/`X-MekakushiFensu-*`/`X-ShikiriKouji-*`/`X-KakouKouji-*`/`X-NukigakiKouji-*`/`X-BeiKouji-*`/`X-FensuRepair-*`/`X-FensuSeibi-*`/`X-FenceKoujiya-*`/`X-KirituKouji-*`/`X-SakuKouji-*`/`X-RailingKouji-*`/`X-TeiranKouji-*`/`X-DaiToDai-*`/`X-FensuPro-*`/`X-SoukakuKouji-*`/`X-SageKouji-*`/`X-OtogakiKouji-*`/`X-FensuRepairJP-*` 等 は塀機の通知記録 — 送信側が書くことは自称。フェンス見積・ウッドデッキ設置・塀修繕・目隠しフェンスの偽装は外構工事業者なりすましの典型手口。(外構は landscape 機、建材は housing 機、門扉は locksmith 機で検出済み)
- **修正**: `Envelope` に `fence_marks` + `has_fence_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 塀印の自署を問え。

### Security — D654: `X-RollingSuds-*`/`X-PressureWash-*`/`X-KouatsuSenjou-*`/`X-GaiheiSenjou-*`/`X-SoftWash-*` 等の高圧洗浄印自称が未検査

- **問題**: `X-RollingSuds-*`/`X-MenInKilts-*`/`X-WickedPressure-*`/`X-PressureWash-*`/`X-PressureWashing-*`/`X-PressureWashPros-*`/`X-PowerWash-*`/`X-PowerWashPros-*`/`X-PowerWashing-*`/`X-SoftWash-*`/`X-SoftWashPros-*`/`X-WashCo-*`/`X-WashPro-*`/`X-ClearChoiceWash-*`/`X-CrystalWash-*`/`X-ShineWash-*`/`X-BlastWash-*`/`X-Hotsy-*`/`X-WaterBlast-*`/`X-StreamWash-*`/`X-ExteriorWash-*`/`X-SidewalkWash-*`/`X-DrivewayWash-*`/`X-RoofWash-*`/`X-DeckWash-*`、JP は `X-KouatsuSenjou-*`/`X-KouatsuSenjouGyosha-*`/`X-KouatsuSenjouYasan-*`/`X-GaiheiSenjou-*`/`X-YaneSenjou-*`/`X-WashiSenjou-*`/`X-SenjouYasan-*`/`X-SenjouKouji-*`/`X-DeiSenjou-*`/`X-ExteriorSenjou-*`/`X-SeawallSenjou-*`/`X-WashTer-*`/`X-KouatsuClean-*`/`X-SenjouPro-*`/`X-KireiSenjou-*`/`X-PowerWashJP-*`/`X-GekisenYasan-*`/`X-OgataSenjou-*`/`X-KabuShimano-*`/`X-KireiMigaki-*`/`X-KirameiSenjou-*`/`X-MigakiYasan-*`/`X-SennetsuSenjou-*` 等 は圧機の通知記録 — 送信側が書くことは自称。外壁洗浄・屋根洗浄・駐車場洗浄・苔落としの偽装は高圧洗浄業者なりすましの典型手口。(清掃は cleaning 機、塗装は painting 機、屋根修理は roofing 機で検出済み)
- **修正**: `Envelope` に `pressurewash_marks` + `has_pressurewash_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 圧印の自署を問え。

### Security — D655: `X-AmeriGas-*`/`X-Ferrellgas-*`/`X-LPGas-*`/`X-Nichigas-*`/`X-Iwatani-*` 等のLPガス・プロパン印自称が未検査

- **問題**: `X-AmeriGas-*`/`X-Ferrellgas-*`/`X-SuburbanPropane-*`/`X-ThompsonGas-*`/`X-ParacoGas-*`/`X-Paraco-*`/`X-BlossmanGas-*`/`X-DCCPropane-*`/`X-DomasGas-*`/`X-PropanePros-*`/`X-PropaneService-*`/`X-PropaneDelivery-*`/`X-PropaneExperts-*`/`X-PropaneCentral-*`/`X-ValleyPropane-*`/`X-CoastalPropane-*`/`X-NorthStarPropane-*`/`X-TrianglePropane-*`/`X-PinnaclePropane-*`/`X-PropaneTank-*`/`X-PropaneFill-*`/`X-PropaneCo-*`、JP は `X-LPGas-*`/`X-ElPeeGas-*`/`X-Nichigas-*`/`X-Iwatani-*`/`X-PropaneYa-*`/`X-PropanYa-*`/`X-GasMeter-*`/`X-GasAnzen-*`/`X-GasKenshin-*`/`X-GasAnzenYasan-*`/`X-GassuSeihi-*`/`X-SaihakuGas-*`/`X-GasYa-*`/`X-GasProsJP-*`/`X-LPPropane-*`/`X-TosaiGas-*`/`X-TobuGas-*`/`X-ShowaGas-*`/`X-ShinGas-*`/`X-GasSeihi-*`/`X-HokuzanGas-*`/`X-MaruGas-*`/`X-KazuyoGas-*`/`X-MichiGas-*`/`X-GasSupply-*` 等 は燃機の通知記録 — 送信側が書くことは自称。LPガス検針・安全点検・配達・切替勧誘・ガス漏れ連絡の偽装はガス業者なりすましの典型手口 (検針員便乗商法で有名)。(都市ガス・電気は utility 機、警備は facility 機で検出済み)
- **修正**: `Envelope` に `propane_marks` + `has_propane_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 燃印の自署を問え。
