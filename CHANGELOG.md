...
### Security — D767: `X-Toushikomon-*`/`X-Shisanunyou-*`/`X-Assetmanage-*`/`X-Fundadvisor-*`/`X-Investmentadvisor-*` 等の投資顧問・資産運用相談印自称が未検査

- **問題**: `X-Toushikomon-*`/`X-ToushikomonPro-*`/`X-ToushikomonTeam-*`/`X-ToushikomonKensa-*`/`X-ToushikomonManten-*`/`X-ToushikomonNomi-*`/`X-ToushikomonJP-*`/`X-ToushikomonSenmon-*`/`X-ToushikomonMitsumori-*`/`X-ToushikomonChousa-*`/`X-ToushikomonPros-*`/`X-ToushikomonDoctors-*`/`X-ToushikomonRescue-*`/`X-Shisanunyou-*`/`X-ShisanunyouYasan-*`/`X-ShisanunyouPro-*`/`X-ShisanunyouTeam-*`/`X-ShisanunyouJP-*`/`X-ShisanunyouSenmon-*`/`X-ShisanunyouPros-*`/`X-ShisanunyouDoctors-*`/`X-ShisanunyouRescue-*`/`X-AssetmanagePros-*`/`X-AssetmanageTeam-*`/`X-AssetmanageWorks-*`/`X-AssetmanageExperts-*`/`X-AssetmanageSvc-*`/`X-AssetmanageHQ-*`/`X-FundadvisorPros-*`/`X-FundadvisorTeam-*`/`X-FundadvisorWorks-*`/`X-FundadvisorExperts-*`/`X-FundadvisorSvc-*`/`X-FundadvisorHQ-*`/`X-InvestmentadvisorPros-*`/`X-InvestmentadvisorTeam-*`/`X-InvestmentadvisorWorks-*`/`X-InvestmentadvisorExperts-*`/`X-InvestmentadvisorSvc-*`/`X-InvestmentadvisorHQ-*` 等 は投機の通知記録 — 送信側が書くことは自称。投資顧問・資産運用相談・ファンドアドバイザーの偽装は、運用利回り・顧問料・情報料を装ったなりすましの典型手口。(証券は securities 機、年金・FP は nenkin 機で検出済み)
- **修正**: `Envelope` に `toushikomon_marks` + `has_toushikomon_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 投印の自署を問え。

### Security — D768: `X-Fudosanhyouka-*`/`X-Tochikatate-*`/`X-Chikatatechoushi-*`/`X-Landappraisal-*`/`X-Propertyappraisal-*` 等の不動産鑑定・土地家屋調査士印自称が未検査

- **問題**: `X-Fudosanhyouka-*`/`X-FudosanhyoukaPro-*`/`X-FudosanhyoukaTeam-*`/`X-FudosanhyoukaKensa-*`/`X-FudosanhyoukaManten-*`/`X-FudosanhyoukaNomi-*`/`X-FudosanhyoukaJP-*`/`X-FudosanhyoukaSenmon-*`/`X-FudosanhyoukaMitsumori-*`/`X-FudosanhyoukaChousa-*`/`X-FudosanhyoukaTeiki-*`/`X-FudosanhyoukaShuri-*`/`X-FudosanhyoukaPros-*`/`X-FudosanhyoukaDoctors-*`/`X-FudosanhyoukaRescue-*`/`X-Tochikatate-*`/`X-TochikatateYasan-*`/`X-TochikatatePro-*`/`X-TochikatateTeam-*`/`X-TochikatateJP-*`/`X-TochikatateSenmon-*`/`X-TochikatatePros-*`/`X-TochikatateDoctors-*`/`X-TochikatateRescue-*`/`X-Chikatatechoushi-*`/`X-ChikatatechoushiYasan-*`/`X-ChikatatechoushiPro-*`/`X-ChikatatechoushiTeam-*`/`X-ChikatatechoushiJP-*`/`X-ChikatatechoushiSenmon-*`/`X-LandappraisalPros-*`/`X-LandappraisalTeam-*`/`X-LandappraisalWorks-*`/`X-LandappraisalExperts-*`/`X-LandappraisalSvc-*`/`X-LandappraisalHQ-*`/`X-PropertyappraisalPros-*`/`X-PropertyappraisalTeam-*`/`X-PropertyappraisalWorks-*`/`X-PropertyappraisalExperts-*`/`X-PropertyappraisalSvc-*`/`X-PropertyappraisalHQ-*` 等 は評機の通知記録 — 送信側が書くことは自称。不動産鑑定・土地家屋調査士の偽装は、鑑定料・調査費・登記申請代行費を装ったなりすましの典型手口。(不動産仲介は realestate 機、住宅診断は homeinspect 機で検出済み)
- **修正**: `Envelope` に `fudosanhyouka_marks` + `has_fudosanhyouka_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 評印の自署を問え。

### Security — D769: `X-Ihinseiri-*`/`X-Shuukatsu-*`/`X-Endingnote-*`/`X-Estatecleanout-*`/`X-Houseclearance-*` 等の遺品整理・終活印自称が未検査

- **問題**: `X-Ihinseiri-*`/`X-IhinseiriYasan-*`/`X-IhinseiriPro-*`/`X-IhinseiriTeam-*`/`X-IhinseiriKensa-*`/`X-IhinseiriManten-*`/`X-IhinseiriNomi-*`/`X-IhinseiriJP-*`/`X-IhinseiriSenmon-*`/`X-IhinseiriMitsumori-*`/`X-IhinseiriChousa-*`/`X-IhinseiriPros-*`/`X-IhinseiriDoctors-*`/`X-IhinseiriRescue-*`/`X-Shuukatsu-*`/`X-ShuukatsuYasan-*`/`X-ShuukatsuPro-*`/`X-ShuukatsuTeam-*`/`X-ShuukatsuJP-*`/`X-ShuukatsuSenmon-*`/`X-ShuukatsuPros-*`/`X-ShuukatsuDoctors-*`/`X-ShuukatsuRescue-*`/`X-EndingnotePros-*`/`X-EndingnoteTeam-*`/`X-EndingnoteWorks-*`/`X-EndingnoteExperts-*`/`X-EndingnoteSvc-*`/`X-EndingnoteHQ-*`/`X-EstatecleanoutPros-*`/`X-EstatecleanoutTeam-*`/`X-EstatecleanoutWorks-*`/`X-EstatecleanoutExperts-*`/`X-EstatecleanoutSvc-*`/`X-EstatecleanoutHQ-*`/`X-HouseclearancePros-*`/`X-HouseclearanceTeam-*`/`X-HouseclearanceWorks-*`/`X-HouseclearanceExperts-*`/`X-HouseclearanceSvc-*`/`X-HouseclearanceHQ-*` 等 は遺機の通知記録 — 送信側が書くことは自称。遺品整理・終活支援・実家片付けの偽装は、見積料・処分費・保証金を装ったなりすましの典型手口。(葬儀は funeral 機、不用品回収は junkremoval 機で検出済み)
- **修正**: `Envelope` に `ihinseiri_marks` + `has_ihinseiri_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 遺印の自署を問え。
