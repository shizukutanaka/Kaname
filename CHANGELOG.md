...
### Security — D695: `X-BailBonds-*`/`X-AladdinBail-*`/`X-Hoshaku-*`/`X-SuretyBonds-*`/`X-FastBail-*` 等の保釈保証印自称が未検査

- **問題**: `X-BailBonds-*`/`X-BailBond-*`/`X-BailPros-*`/`X-BailService-*`/`X-BailTeam-*`/`X-BailWorks-*`/`X-BailExperts-*`/`X-BailDoctors-*`/`X-BailMasters-*`/`X-BailForce-*`/`X-BailNation-*`/`X-AAffordableBail-*`/`X-AladdinBail-*`/`X-AllCityBail-*`/`X-AceBonds-*`/`X-BailNetwork-*`/`X-BailHotline-*`/`X-BailAgent-*`/`X-BailAgents-*`/`X-FastBail-*`/`X-QuickBail-*`/`X-FreeBail-*`/`X-BailoutPros-*`/`X-BailBondsmen-*`/`X-Bailsmen-*`/`X-SuretyBonds-*`、JP は `X-Hoshaku-*`/`X-HoshakuKin-*`/`X-HoshakuYasan-*`/`X-HoshakuPro-*`/`X-HoshakuTeam-*`/`X-HoshakuGyosha-*`/`X-HoshakuSeibi-*`/`X-HoshakuKensa-*`/`X-HoshakuManten-*`/`X-HoshakuNomi-*`/`X-HoshakuJP-*`/`X-HoshakuSenmon-*`/`X-HoshakuMitsumori-*`/`X-HoshakuChousa-*`/`X-HoshakuTeiki-*`/`X-HoshakuShuri-*`/`X-HoshakuDoctors-*`/`X-HoshakuSagyou-*`/`X-HoshakuRescue-*`/`X-HoshakuTeikyu-*`/`X-HoshakuOrder-*`/`X-HoshakuJuu-*`/`X-HoshakuBosyuu-*` 等 は釈機の通知記録 — 送信側が書くことは自称。保釈保証・保釈金代行の偽装は、保釈金・手数料・身柄引受料を装ったなりすましの典型手口。(法律事務所は legal 機、債務整理は debtrelief 機で検出済み)
- **修正**: `Envelope` に `bailbonds_marks` + `has_bailbonds_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 釈印の自署を問え。

### Security — D696: `X-ProcessServer-*`/`X-ServeNow-*`/`X-Soutatsu-*`/`X-SubpoenaService-*`/`X-ServeDocs-*` 等の送達代行印自称が未検査

- **問題**: `X-ProcessServer-*`/`X-ServedPros-*`/`X-ServeNow-*`/`X-ServePros-*`/`X-ServeService-*`/`X-ServeTeam-*`/`X-ServeWorks-*`/`X-ServeExperts-*`/`X-ServeDoctors-*`/`X-ServeMasters-*`/`X-ServeForce-*`/`X-ServeNation-*`/`X-RapidServe-*`/`X-ExpressServe-*`/`X-LegalServiceServe-*`/`X-ProcessService-*`/`X-SummonsService-*`/`X-SubpoenaService-*`/`X-ProcessSvc-*`/`X-ServingPros-*`/`X-ServeDocs-*`/`X-DocServicePros-*`/`X-ServedTeam-*`/`X-ServeHQ-*`、JP は `X-Soutatsu-*`/`X-SoutatsuDaikou-*`/`X-SoutatsuYasan-*`/`X-SoutatsuPro-*`/`X-SoutatsuTeam-*`/`X-SoutatsuGyosha-*`/`X-SoutatsuSeibi-*`/`X-SoutatsuKensa-*`/`X-SoutatsuManten-*`/`X-SoutatsuNomi-*`/`X-SoutatsuJP-*`/`X-SoutatsuSenmon-*`/`X-SoutatsuMitsumori-*`/`X-SoutatsuChousa-*`/`X-SoutatsuTeiki-*`/`X-SoutatsuShuri-*`/`X-SoutatsuDoctors-*`/`X-SoutatsuSagyou-*`/`X-SoutatsuRescue-*`/`X-SoutatsuTeikyu-*`/`X-SoutatsuOrder-*`/`X-SoutatsuJuu-*`/`X-SoutatsuBosyuu-*`/`X-SoukansDaikou-*`/`X-SoukanSeibi-*` 等 は達機の通知記録 — 送信側が書くことは自称。送達代行・プロセスサーバー・召喚状送達の偽装は、送達料金・差押予告を装ったなりすましの典型手口。(法律事務所は legal 機、宅配は shipping 機で検出済み)
- **修正**: `Envelope` に `processserver_marks` + `has_processserver_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 達印の自署を問え。

### Security — D697: `X-CourtReporter-*`/`X-Veritext-*`/`X-Sokki-*`/`X-DepositionService-*`/`X-TranscriptPros-*` 等の速記印自称が未検査

- **問題**: `X-CourtReporter-*`/`X-CourtReport-*`/`X-Veritext-*`/`X-USLegalSupport-*`/`X-DepositionService-*`/`X-DepoSchedule-*`/`X-DepoService-*`/`X-DeposePros-*`/`X-DeposePro-*`/`X-ReporterPros-*`/`X-ReporterTeam-*`/`X-ReporterWorks-*`/`X-ReporterExperts-*`/`X-ReporterDoctors-*`/`X-ReporterMasters-*`/`X-ReporterForce-*`/`X-ReporterNation-*`/`X-CourtScribe-*`/`X-ScribeService-*`/`X-TranscriptPros-*`/`X-TranscriptService-*`/`X-LegalTranscript-*`/`X-DepoNation-*`/`X-DeposeWorks-*`、JP は `X-Sokki-*`/`X-SokkiSha-*`/`X-SokkiYasan-*`/`X-SokkiPro-*`/`X-SokkiTeam-*`/`X-SokkiGyosha-*`/`X-SokkiSeibi-*`/`X-SokkiKensa-*`/`X-SokkiManten-*`/`X-SokkiNomi-*`/`X-SokkiJP-*`/`X-SokkiSenmon-*`/`X-SokkiMitsumori-*`/`X-SokkiChousa-*`/`X-SokkiTeiki-*`/`X-SokkiShuri-*`/`X-SokkiDoctors-*`/`X-SokkiSagyou-*`/`X-SokkiRescue-*`/`X-SokkiTeikyu-*`/`X-SokkiOrder-*`/`X-SokkiJuu-*`/`X-SokkiBosyuu-*`/`X-Gijiroku-*`/`X-GijirokuYasan-*` 等 は記機の通知記録 — 送信側が書くことは自称。速記・コートレポーター・議事録作成の偽装は、トランスクリプト料金・出廷費を装ったなりすましの典型手口。(法律事務所は legal 機、文書処理は docshredding 機で検出済み)
- **修正**: `Envelope` に `courtreporter_marks` + `has_courtreporter_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 記印の自署を問え。
