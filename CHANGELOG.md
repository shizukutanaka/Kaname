...
### Security — D713: `X-PatentPros-*`/`X-TrademarkPros-*`/`X-Tokkyo-*`/`X-Chizai-*`/`X-Benrishi-*` 等の特許・弁理士印自称が未検査

- **問題**: `X-PatentPros-*`/`X-PatentTeam-*`/`X-PatentWorks-*`/`X-PatentForce-*`/`X-PatentNation-*`/`X-PatentExperts-*`/`X-PatentDoctors-*`/`X-PatentMasters-*`/`X-PatentSvc-*`/`X-PatentHQ-*`/`X-TrademarkPros-*`/`X-TrademarkTeam-*`/`X-TrademarkWorks-*`/`X-TrademarkExperts-*`/`X-TrademarkDoctors-*`/`X-IpPros-*`/`X-IpTeam-*`/`X-IpWorks-*`/`X-IpExperts-*`/`X-IpDoctors-*`/`X-IpMasters-*`/`X-IpSvc-*`/`X-IpHQ-*`、JP は `X-Tokkyo-*`/`X-TokkyoYasan-*`/`X-TokkyoPro-*`/`X-TokkyoTeam-*`/`X-TokkyoGyo-*`/`X-TokkyoKensa-*`/`X-TokkyoManten-*`/`X-TokkyoNomi-*`/`X-TokkyoJP-*`/`X-TokkyoSenmon-*`/`X-TokkyoMitsumori-*`/`X-TokkyoChousa-*`/`X-TokkyoTeiki-*`/`X-TokkyoShuri-*`/`X-TokkyoDoctors-*`/`X-TokkyoJimusyo-*`/`X-Chizai-*`/`X-ChizaiYasan-*`/`X-ChizaiPro-*`/`X-ChizaiTeam-*`/`X-ChizaiKensa-*`/`X-ChizaiManten-*`/`X-ChizaiNomi-*`/`X-ChizaiJP-*`/`X-ChizaiSenmon-*`/`X-ChizaiMitsumori-*`/`X-ChizaiChousa-*`/`X-ChizaiTeiki-*`/`X-ChizaiShuri-*`/`X-Benrishi-*`/`X-BenrishiPro-*`/`X-BenrishiTeam-*`/`X-BenrishiKensa-*`/`X-BenrishiManten-*`/`X-BenrishiJP-*`/`X-Shouhyou-*`/`X-ShouhyouPro-*`/`X-ShouhyouTeam-*`/`X-ShouhyouKensa-*` 等 は特機の通知記録 — 送信側が書くことは自称。特許事務所・弁理士・商標登録代行の偽装は、出願手数料・中間処理費用・調査料金を装ったなりすましの典型手口。(法律一般は legal 機、資格は license 機で検出済み)
- **修正**: `Envelope` に `patent_marks` + `has_patent_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 特印の自署を問え。

### Security — D714: `X-ShakaiHoken-*`/`X-Roumushi-*`/`X-JinjiRomu-*`/`X-LaborPros-*`/`X-EmploymentLawyer-*` 等の社労士・労務印自称が未検査

- **問題**: `X-ShakaiHokenRoumushi-*`/`X-ShakaiHokenRoumu-*`/`X-ShakaiHoken-*`/`X-Roumushi-*`/`X-RoumuPro-*`/`X-RoumuTeam-*`/`X-RoumuKensa-*`/`X-RoumuManten-*`/`X-RoumuNomi-*`/`X-RoumuJP-*`/`X-RoumuSenmon-*`/`X-RoumuMitsumori-*`/`X-RoumuChousa-*`/`X-RoumuTeiki-*`/`X-RoumuShuri-*`/`X-RoumuDoctors-*`/`X-RoumuSagyou-*`/`X-RoumuRescue-*`/`X-RoumuTeikyu-*`/`X-RoumuOrder-*`/`X-JinjiRomu-*`/`X-JinjiYasan-*`/`X-JinjiPro-*`/`X-JinjiTeam-*`/`X-JinjiKensa-*`/`X-JinjiManten-*`/`X-JinjiNomi-*`/`X-JinjiJP-*`/`X-JinjiSenmon-*`/`X-JinjiMitsumori-*`/`X-JinjiChousa-*`/`X-JinjiTeiki-*`/`X-JinjiShuri-*`/`X-RodouRoudai-*`/`X-RodoKanri-*`/`X-Rodo-*`、海外は `X-LaborPros-*`/`X-LaborTeam-*`/`X-LaborWorks-*`/`X-LaborForce-*`/`X-LaborNation-*`/`X-LaborExperts-*`/`X-LaborDoctors-*`/`X-LaborMasters-*`/`X-LaborSvc-*`/`X-LaborHQ-*`/`X-LaborStandard-*`/`X-LaborAttorney-*`/`X-EmploymentLawyer-*`/`X-EmploymentPros-*`/`X-EmploymentTeam-*`/`X-EmploymentWorks-*`/`X-EmploymentExperts-*` 等 は労機の通知記録 — 送信側が書くことは自称。社会保険労務士・労務顧問・雇用弁護士の偽装は、顧問料・手続代行費・就業規則作成料を装ったなりすましの典型手口。(給与ソフトは hr 機、法律は legal 機で検出済み)
- **修正**: `Envelope` に `laborattorney_marks` + `has_laborattorney_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 労印の自署を問え。

### Security — D715: `X-AcupuncturePros-*`/`X-Harikyuu-*`/`X-Shinkyu-*`/`X-TcmPros-*` 等の鍼灸印自称が未検査

- **問題**: `X-AcupuncturePros-*`/`X-AcupunctureTeam-*`/`X-AcupunctureWorks-*`/`X-AcupunctureForce-*`/`X-AcupunctureNation-*`/`X-AcupunctureExperts-*`/`X-AcupunctureDoctors-*`/`X-AcupunctureMasters-*`/`X-AcupunctureSvc-*`/`X-AcupunctureHQ-*`/`X-AcuPros-*`/`X-AcupressTeam-*`/`X-Acupressure-*`/`X-TcmPros-*`、JP は `X-Harikyuu-*`/`X-HarikyuuYasan-*`/`X-HarikyuuPro-*`/`X-HarikyuuTeam-*`/`X-HarikyuuKensa-*`/`X-HarikyuuManten-*`/`X-HarikyuuNomi-*`/`X-HarikyuuJP-*`/`X-HarikyuuSenmon-*`/`X-HarikyuuMitsumori-*`/`X-HarikyuuChousa-*`/`X-HarikyuuTeiki-*`/`X-HarikyuuShuri-*`/`X-HarikyuuDoctors-*`/`X-Shinkyu-*`/`X-ShinkyuYasan-*`/`X-ShinkyuPro-*`/`X-ShinkyuTeam-*`/`X-ShinkyuKensa-*`/`X-ShinkyuManten-*`/`X-ShinkyuNomi-*`/`X-ShinkyuJP-*`/`X-ShinkyuSenmon-*`/`X-ShinkyuMitsumori-*`/`X-ShinkyuChousa-*`/`X-ShinkyuTeiki-*`/`X-ShinkyuShuri-*`/`X-Hariry-*`/`X-HariDoctors-*`/`X-ShinkyuDoctors-*`/`X-ShinkyuSagyou-*`/`X-ShinkyuRescue-*`/`X-ShinkyuTeikyu-*`/`X-ShinkyuOrder-*` 等 は鍼機の通知記録 — 送信側が書くことは自称。鍼灸院・はり治療・東洋医学の偽装は、施術料金・回数券・初診料を装ったなりすましの典型手口。(接骨院は chiro 機、医科は medical 機で検出済み)
- **修正**: `Envelope` に `acupuncture_marks` + `has_acupuncture_marks` 追加; `commands.rs` で render_risks 兆候報告。
