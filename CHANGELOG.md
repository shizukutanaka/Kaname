...
### Security — D692: `X-ShredIt-*`/`X-ProShred-*`/`X-Kimitsubunsho-*`/`X-IronMountain-*`/`X-SecureShredding-*` 等の機密文書処理印自称が未検査

- **問題**: `X-ShredIt-*`/`X-IronMountain-*`/`X-ShredNations-*`/`X-ProShred-*`/`X-UShred-*`/`X-CintasShred-*`/`X-AccessCorp-*`/`X-Shredding-*`/`X-DocShredding-*`/`X-PaperShredding-*`/`X-ShredPros-*`/`X-ShredService-*`/`X-ShredTeam-*`/`X-ShredWorks-*`/`X-ShredExperts-*`/`X-ShredDoctors-*`/`X-ShredMasters-*`/`X-ShredForce-*`/`X-ShredNation-*`/`X-SecureShredding-*`/`X-DataDestruction-*`/`X-DestructionPros-*`/`X-MediaDestruction-*`/`X-HardDriveDestruction-*`/`X-DocumentShredding-*`、JP は `X-Kimitsubunsho-*`/`X-BunshoShori-*`/`X-Shuredda-*`/`X-YoukaiShori-*`/`X-KimitsuShori-*`/`X-BunshoShredder-*`/`X-BunshoShorigyo-*`/`X-KimitsuYasan-*`/`X-ShredderYasan-*`/`X-KimitsuPro-*`/`X-KimitsuTeam-*`/`X-KimitsuGyosha-*`/`X-KimitsuSeibi-*`/`X-KimitsuKensa-*`/`X-KimitsuManten-*`/`X-KimitsuNomi-*`/`X-KimitsuJP-*`/`X-KimitsuSenmon-*`/`X-KimitsuMitsumori-*`/`X-KimitsuChousa-*`/`X-KimitsuTeiki-*`/`X-KimitsuShuri-*` 等 は紙機の通知記録 — 送信側が書くことは自称。機密文書処理・溶解処理・定期回収の偽装は、処理料金・証明書発行手数料を装った法人なりすましの典型手口。(文書保管は archive 機、廃棄物は junkremoval 機で検出済み)
- **修正**: `Envelope` に `docshredding_marks` + `has_docshredding_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 紙印の自署を問え。

### Security — D693: `X-FastSigns-*`/`X-Signarama-*`/`X-Kanban-*`/`X-NeonSign-*`/`X-VehicleWrap-*` 等の看板製作印自称が未検査

- **問題**: `X-FastSigns-*`/`X-Signarama-*`/`X-SignShop-*`/`X-SignPros-*`/`X-SignService-*`/`X-SignTeam-*`/`X-SignWorks-*`/`X-SignExperts-*`/`X-SignDoctors-*`/`X-SignMasters-*`/`X-SignForce-*`/`X-SignNation-*`/`X-SignDept-*`/`X-SignGraphics-*`/`X-SignCompany-*`/`X-SignCraft-*`/`X-SignMakers-*`/`X-SignBuilder-*`/`X-SignInstall-*`/`X-SignRepair-*`/`X-SignFactory-*`/`X-SignStudio-*`/`X-SignHub-*`/`X-NeonSign-*`/`X-LedSign-*`/`X-ChannelLetter-*`/`X-MonumentSign-*`/`X-PylonSign-*`/`X-BannerShop-*`/`X-VehicleWrap-*`/`X-WrapService-*`/`X-SpeedySigns-*`、JP は `X-Kanban-*`/`X-KanbanYasan-*`/`X-KanbanKouji-*`/`X-KanbanPro-*`/`X-KanbanTeam-*`/`X-KanbanGyosha-*`/`X-KanbanSeibi-*`/`X-KanbanKensa-*`/`X-KanbanManten-*`/`X-KanbanNomi-*`/`X-KanbanJP-*`/`X-KanbanSenmon-*`/`X-KanbanMitsumori-*`/`X-KanbanChousa-*`/`X-KanbanTeiki-*`/`X-KanbanShuri-*`/`X-KanbanSeisaku-*`/`X-KanbanSetsubi-*`/`X-SignKouji-*`/`X-SainKouji-*` 等 は看機の通知記録 — 送信側が書くことは自称。看板・サイン製作・車両ラッピングの偽装は、製作費・設置費・訂正料を装った法人なりすましの典型手口。(印刷は printing 機、電子署名は esign 機で検出済み)
- **修正**: `Envelope` に `signshop_marks` + `has_signshop_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 看印の自署を問え。

### Security — D694: `X-AnswerConnect-*`/`X-PatLive-*`/`X-Denwadaikou-*`/`X-VirtualReception-*`/`X-Hishodaikou-*` 等の電話代行印自称が未検査

- **問題**: `X-AnswerConnect-*`/`X-RubyReception-*`/`X-PatLive-*`/`X-AbbyConnect-*`/`X-Moneypenny-*`/`X-Conversational-*`/`X-SmithAi-*`/`X-Answering-*`/`X-AnsweringService-*`/`X-AnswerPros-*`/`X-AnswerTeam-*`/`X-AnswerWorks-*`/`X-AnswerExperts-*`/`X-AnswerNation-*`/`X-AnswerDoctors-*`/`X-AnswerMasters-*`/`X-AnswerForce-*`/`X-ReceptionistPros-*`/`X-VirtualReception-*`/`X-PoshVirtual-*`/`X-AnswerUS-*`/`X-VoicePlus-*`/`X-CallAnswer-*`/`X-CallProsTeam-*`、JP は `X-Denwadaikou-*`/`X-Denwadaiko-*`/`X-DenwaYasan-*`/`X-DenwaPro-*`/`X-DenwaTeam-*`/`X-DenwaGyosha-*`/`X-DenwaSeibi-*`/`X-DenwaKensa-*`/`X-DenwaManten-*`/`X-DenwaNomi-*`/`X-DenwaJP-*`/`X-DenwaSenmon-*`/`X-DenwaMitsumori-*`/`X-DenwaChousa-*`/`X-DenwaTeiki-*`/`X-DenwaShuri-*`/`X-DenwaDoctors-*`/`X-DenwaSagyou-*`/`X-DenwaRescue-*`/`X-DenwaTeikyu-*`/`X-DenwaOrder-*`/`X-DenwaJuu-*`/`X-DenwaBosyuu-*`/`X-Hishodaikou-*`/`X-HishoYasan-*` 等 は話機の通知記録 — 送信側が書くことは自称。電話代行・秘書代行・バーチャル受付の偽装は、月額料金・オプション料金詐欺の典型手口。(通信キャリアは telecom 機、コールセンター基盤は contactcenter 機で検出済み)
- **修正**: `Envelope` に `answering_marks` + `has_answering_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 話印の自署を問え。
