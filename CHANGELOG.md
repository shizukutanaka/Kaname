...
### Security — D749: `X-Tougei-*`/`X-Yakimono-*`/`X-Ceramic-*`/`X-Pottery-*` 等の陶芸・陶磁器教室印自称が未検査

- **問題**: `X-Tougei-*`/`X-TougeiYasan-*`/`X-TougeiPro-*`/`X-TougeiTeam-*`/`X-TougeiKensa-*`/`X-TougeiManten-*`/`X-TougeiNomi-*`/`X-TougeiJP-*`/`X-TougeiSenmon-*`/`X-TougeiMitsumori-*`/`X-TougeiChousa-*`/`X-TougeiTeiki-*`/`X-TougeiShuri-*`/`X-TougeiSchool-*`/`X-TougeiKoubou-*`/`X-TougeiMart-*`/`X-TougeiBank-*`/`X-Yakimono-*`/`X-YakimonoYasan-*`/`X-YakimonoPro-*`/`X-YakimonoTeam-*`/`X-YakimonoKensa-*`/`X-YakimonoManten-*`/`X-YakimonoMi-*`/`X-YakimonoJP-*`/`X-YakimonoSenmon-*`/`X-YakimonoMitsumori-*`/`X-YakimonoKoubou-*`/`X-YakimonoMart-*`/`X-Ceramic-*`/`X-CeramicPros-*`/`X-CeramicTeam-*`/`X-CeramicWorks-*`/`X-CeramicExperts-*`/`X-CeramicSvc-*`/`X-CeramicHQ-*`/`X-CeramicStudio-*`/`X-CeramicStudioPros-*`/`X-CeramicStudioTeam-*`/`X-PotteryPros-*`/`X-PotteryTeam-*`/`X-PotteryWorks-*`/`X-PotteryExperts-*`/`X-PotterySvc-*`/`X-PotteryHQ-*`/`X-PotteryStudio-*`/`X-PotteryStudioPros-*`/`X-TougeiPros-*`/`X-TougeiDoctors-*`/`X-TougeiRescue-*`/`X-YakimonoPros-*`/`X-YakimonoDoctors-*`/`X-YakimonoRescue-*` 等 は陶機の通知記録 — 送信側が書くことは自称。陶芸・陶磁器教室の偽装は、受講料・焼成費・材料費を装ったなりすましの典型手口。(語学塾は cram 機で検出済み)
- **修正**: `Envelope` に `tougei_marks` + `has_tougei_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 陶印の自署を問え。

### Security — D750: `X-Ikebana-*`/`X-Kado-*`/`X-Sado-*`/`X-TeaCeremony-*`/`X-FlowerArrangement-*` 等の生け花・茶道教室印自称が未検査

- **問題**: `X-Ikebana-*`/`X-IkebanaYasan-*`/`X-IkebanaPro-*`/`X-IkebanaTeam-*`/`X-IkebanaKensa-*`/`X-IkebanaManten-*`/`X-IkebanaNomi-*`/`X-IkebanaJP-*`/`X-IkebanaSenmon-*`/`X-IkebanaMitsumori-*`/`X-IkebanaChousa-*`/`X-IkebanaTeiki-*`/`X-IkebanaShuri-*`/`X-IkebanaSchool-*`/`X-IkebanaKoubou-*`/`X-IkebanaMart-*`/`X-IkebanaBank-*`/`X-Kado-*`/`X-KadoYasan-*`/`X-KadoPro-*`/`X-KadoTeam-*`/`X-KadoKoubou-*`/`X-KadoSenmon-*`/`X-Sado-*`/`X-SadoYasan-*`/`X-SadoPro-*`/`X-SadoTeam-*`/`X-SadoKoubou-*`/`X-SadoSenmon-*`/`X-SadoSchool-*`/`X-TeaCeremonyPros-*`/`X-TeaCeremonyTeam-*`/`X-TeaCeremonyWorks-*`/`X-TeaCeremonyExperts-*`/`X-TeaCeremonySvc-*`/`X-TeaCeremonyHQ-*`/`X-TeaCeremonySchool-*`/`X-FlowerArrangementPros-*`/`X-FlowerArrangementTeam-*`/`X-FlowerArrangementWorks-*`/`X-FlowerArrangementExperts-*`/`X-IkebanaPros-*`/`X-IkebanaWorks-*`/`X-IkebanaExperts-*`/`X-IkebanaSvc-*`/`X-IkebanaHQ-*`/`X-IkebanaDoctors-*`/`X-IkebanaRescue-*`/`X-SadoPros-*`/`X-SadoDoctors-*`/`X-SadoRescue-*` 等 は華機の通知記録 — 送信側が書くことは自称。生け花・茶道教室の偽装は、受講料・道具費・免状料を装ったなりすましの典型手口。(生花店は flower 機、語学塾は cram 機で検出済み)
- **修正**: `Envelope` に `ikebana_marks` + `has_ikebana_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 華印の自署を問え。

### Security — D751: `X-Ryouri-*`/`X-Cooking-*`/`X-CookingClass-*`/`X-KitchenStudio-*` 等の料理教室印自称が未検査

- **問題**: `X-Ryouri-*`/`X-RyouriYasan-*`/`X-RyouriPro-*`/`X-RyouriTeam-*`/`X-RyouriKensa-*`/`X-RyouriManten-*`/`X-RyouriNomi-*`/`X-RyouriJP-*`/`X-RyouriSenmon-*`/`X-RyouriMitsumori-*`/`X-RyouriChousa-*`/`X-RyouriTeiki-*`/`X-RyouriShuri-*`/`X-RyouriSchool-*`/`X-RyouriKoubou-*`/`X-RyouriMart-*`/`X-RyouriBank-*`/`X-Cooking-*`/`X-CookingSchool-*`/`X-CookingPro-*`/`X-CookingTeam-*`/`X-CookingKoubou-*`/`X-CookingSenmon-*`/`X-CookingLesson-*`/`X-CookingLessonPros-*`/`X-CookingLessonTeam-*`/`X-CookingClass-*`/`X-CookingClassPros-*`/`X-CookingClassTeam-*`/`X-CookingClassWorks-*`/`X-CookingClassExperts-*`/`X-CookingClassSvc-*`/`X-CookingClassHQ-*`/`X-KitchenStudio-*`/`X-KitchenStudioPros-*`/`X-KitchenStudioTeam-*`/`X-KitchenStudioWorks-*`/`X-KitchenStudioExperts-*`/`X-KitchenStudioSvc-*`/`X-KitchenStudioHQ-*`/`X-RyouriPros-*`/`X-RyouriWorks-*`/`X-RyouriExperts-*`/`X-RyouriSvc-*`/`X-RyouriHQ-*`/`X-RyouriDoctors-*`/`X-RyouriRescue-*`/`X-CookingPros-*`/`X-CookingExperts-*`/`X-CookingHQ-*`/`X-CookingDoctors-*`/`X-CookingRescue-*` 等 は料機の通知記録 — 送信側が書くことは自称。料理教室・キッチンスタジオの偽装は、受講料・食材費・資格認定料を装ったなりすましの典型手口。(ケータリングは catering 機、語学塾は cram 機で検出済み)
- **修正**: `Envelope` に `cooking_marks` + `has_cooking_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 料印の自署を問え。
