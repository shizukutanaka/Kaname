...
### Security — D731: `X-ShihoShoshi-*`/`X-Scrivener-*`/`X-Registry-*` 等の司法書士印自称が未検査

- **問題**: `X-ShihoShoshi-*`/`X-ShihoSho-*`/`X-ShihoShoshiYasan-*`/`X-ShihoShoshiPro-*`/`X-ShihoShoshiTeam-*`/`X-ShihoShoshiKensa-*`/`X-ShihoShoshiManten-*`/`X-ShihoShoshiNomi-*`/`X-ShihoShoshiJP-*`/`X-ShihoShoshiSenmon-*`/`X-ShihoShoshiMitsumori-*`/`X-ShihoShoshiChousa-*`/`X-ShihoShoshiTeiki-*`/`X-ShihoShoshiShuri-*`/`X-ShihoShoshiSho-*`/`X-ShihoShoshiTen-*`/`X-ShihoShoshiKoubou-*`/`X-ShihoShoshiMart-*`/`X-ShihoShoshiBank-*`/`X-JudicialScrivenerPros-*`/`X-JudicialScrivenerTeam-*`/`X-AdminScrivenerPros-*`/`X-AdminScrivenerTeam-*`/`X-ScrivenerPros-*`/`X-ScrivenerTeam-*`/`X-ScrivenerWorks-*`/`X-ScrivenerExperts-*`/`X-ScrivenerSvc-*`/`X-ScrivenerHQ-*`/`X-RegistryPros-*`/`X-RegistryTeam-*`/`X-DocumentFilePros-*`/`X-DocumentFileTeam-*`/`X-ScrivenerDoctors-*`/`X-ScrivenerMart-*`/`X-ScrivenerBank-*`/`X-ScrivenerSho-*` 等 は士機の通知記録 — 送信側が書くことは自称。司法書士・登記代行の偽装は、登記申請報酬・登録免許税の立替金・抵当権設定費を装ったなりすましの典型手口。(弁護士は legal 機、行政書士スクールは license 機の `x-gyoseishoshi-` で検出済みのため行政書士系語幹は未収録)
- **修正**: `Envelope` に `shiho_marks` + `has_shiho_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 士印の自署を問え。

### Security — D732: `X-Shouji-*`/`X-Fusuma-*`/`X-Harikae-*` 等の障子・襖張替え印自称が未検査

- **問題**: `X-Shouji-*`/`X-ShoujiYasan-*`/`X-ShoujiPro-*`/`X-ShoujiTeam-*`/`X-ShoujiKensa-*`/`X-ShoujiManten-*`/`X-ShoujiNomi-*`/`X-ShoujiJP-*`/`X-ShoujiSenmon-*`/`X-ShoujiMitsumori-*`/`X-ShoujiChousa-*`/`X-ShoujiTeiki-*`/`X-ShoujiShuri-*`/`X-ShoujiSho-*`/`X-ShoujiTen-*`/`X-ShoujiKoubou-*`/`X-ShoujiMart-*`/`X-ShoujiBank-*`/`X-Fusuma-*`/`X-FusumaYasan-*`/`X-FusumaPro-*`/`X-FusumaTeam-*`/`X-FusumaKensa-*`/`X-FusumaManten-*`/`X-FusumaNomi-*`/`X-FusumaJP-*`/`X-FusumaSenmon-*`/`X-FusumaMitsumori-*`/`X-FusumaChousa-*`/`X-FusumaTeiki-*`/`X-FusumaShuri-*`/`X-FusumaSho-*`/`X-FusumaTen-*`/`X-FusumaKoubou-*`/`X-FusumaMart-*`/`X-FusumaBank-*`/`X-Harikae-*`/`X-HarikaeYasan-*`/`X-HarikaePro-*`/`X-HarikaeTeam-*`/`X-HarikaeKoubou-*`/`X-HarikaeManten-*`/`X-ShoujiPros-*`/`X-FusumaPros-*`/`X-FusumaDoctors-*`/`X-ShoujiDoctors-*`/`X-ShoujiSagyou-*`/`X-ShoujiRescue-*`/`X-FusumaSagyou-*`/`X-FusumaRescue-*`/`X-HarikaeBank-*` 等 は襖機の通知記録 — 送信側が書くことは自称。障子・襖・張替え業者の偽装は、障子張替え料金・襖紙代・出張費を装ったなりすましの典型手口。(畳は tatami 機、網戸は screendoor 機で検出済み)
- **修正**: `Envelope` に `shouji_marks` + `has_shouji_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 襖印の自署を問え。

### Security — D733: `X-Kaban-*`/`X-Kawa-*`/`X-BagRepair-*`/`X-LeatherRepair-*` 等の鞄・革製品修理印自称が未検査

- **問題**: `X-Kaban-*`/`X-KabanYasan-*`/`X-KabanPro-*`/`X-KabanTeam-*`/`X-KabanKensa-*`/`X-KabanManten-*`/`X-KabanNomi-*`/`X-KabanJP-*`/`X-KabanSenmon-*`/`X-KabanMitsumori-*`/`X-KabanChousa-*`/`X-KabanTeiki-*`/`X-KabanShuri-*`/`X-KabanSho-*`/`X-KabanTen-*`/`X-KabanKoubou-*`/`X-KabanMart-*`/`X-KabanBank-*`/`X-Kawa-*`/`X-KawaYasan-*`/`X-KawaPro-*`/`X-KawaTeam-*`/`X-KawaKensa-*`/`X-KawaManten-*`/`X-KawaNomi-*`/`X-KawaJP-*`/`X-KawaSenmon-*`/`X-KawaMitsumori-*`/`X-KawaChousa-*`/`X-KawaTeiki-*`/`X-KawaShuri-*`/`X-KawaKoubou-*`/`X-KawaMart-*`/`X-BagRepairPros-*`/`X-BagRepairTeam-*`/`X-BagRepairWorks-*`/`X-BagRepairExperts-*`/`X-BagRepairSvc-*`/`X-BagRepairHQ-*`/`X-LeatherRepairPros-*`/`X-LeatherRepairTeam-*`/`X-LeatherRepairWorks-*`/`X-LeatherRepairExperts-*`/`X-LeatherRepairSvc-*`/`X-LeatherRepairHQ-*`/`X-LeatherWorksPros-*`/`X-LeatherWorksTeam-*`/`X-LeatherWorksSvc-*`/`X-LeatherWorksHQ-*`/`X-KabanDoctors-*`/`X-KabanRescue-*` 等 は鞄機の通知記録 — 送信側が書くことは自称。鞄・革製品・レザーグッズ修理店の偽装は、持ち手交換・ファスナー修理・染め直し費を装ったなりすましの典型手口。(靴修理は shoerepair 機、買取は reuse 機で検出済み)
- **修正**: `Envelope` に `kaban_marks` + `has_kaban_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 鞄印の自署を問え。
