...
### Security — D743: `X-Ongaku-*`/`X-MusicLesson-*`/`X-MusicSchool-*`/`X-PianoLesson-*` 等の音楽教室印自称が未検査

- **問題**: `X-Ongaku-*`/`X-OngakuYasan-*`/`X-OngakuPro-*`/`X-OngakuTeam-*`/`X-OngakuKensa-*`/`X-OngakuManten-*`/`X-OngakuNomi-*`/`X-OngakuJP-*`/`X-OngakuSenmon-*`/`X-OngakuMitsumori-*`/`X-OngakuChousa-*`/`X-OngakuTeiki-*`/`X-OngakuShuri-*`/`X-OngakuSchool-*`/`X-OngakuKoubou-*`/`X-OngakuMart-*`/`X-OngakuBank-*`/`X-MusicLesson-*`/`X-MusicLessonPros-*`/`X-MusicLessonTeam-*`/`X-MusicLessonWorks-*`/`X-MusicLessonExperts-*`/`X-MusicLessonSvc-*`/`X-MusicLessonHQ-*`/`X-MusicSchool-*`/`X-MusicSchoolPros-*`/`X-MusicSchoolTeam-*`/`X-MusicSchoolWorks-*`/`X-MusicSchoolExperts-*`/`X-MusicSchoolSvc-*`/`X-MusicSchoolHQ-*`/`X-PianoLesson-*`/`X-PianoLessonPros-*`/`X-PianoLessonTeam-*`/`X-PianoLessonWorks-*`/`X-ViolinLesson-*`/`X-ViolinLessonPros-*`/`X-ViolinLessonTeam-*`/`X-ViolinLessonWorks-*`/`X-GuitarLesson-*`/`X-GuitarLessonPros-*`/`X-GuitarLessonTeam-*`/`X-GuitarLessonWorks-*`/`X-Music-*`/`X-MusicTutor-*`/`X-MusicTeacher-*`/`X-MusicPro-*`/`X-MusicYasan-*`/`X-MusicDoctors-*`/`X-MusicRescue-*`/`X-OngakuPros-*`/`X-OngakuDoctors-*`/`X-OngakuRescue-*`/`X-OngakuWorks-*` 等 は音機の通知記録 — 送信側が書くことは自称。音楽教室・楽器レッスンの偽装は、入会金・月謝・発表会費を装ったなりすましの典型手口。(楽器販売は既存所有の `x-ongakukan-`/`x-guitarplanet-`/`x-pianoplaza-` 等、語学塾は cram 機で検出済み)
- **修正**: `Envelope` に `musiclesson_marks` + `has_musiclesson_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 音印の自署を問え。

### Security — D744: `X-Doujou-*`/`X-Karate-*`/`X-Judo-*`/`X-Kendo-*`/`X-MartialArts-*` 等の武道・道場印自称が未検査

- **問題**: `X-Doujou-*`/`X-DoujouYasan-*`/`X-DoujouPro-*`/`X-DoujouTeam-*`/`X-DoujouKensa-*`/`X-DoujouManten-*`/`X-DoujouNomi-*`/`X-DoujouJP-*`/`X-DoujouSenmon-*`/`X-DoujouMitsumori-*`/`X-DoujouChousa-*`/`X-DoujouTeiki-*`/`X-DoujouShuri-*`/`X-DoujouSho-*`/`X-DoujouTen-*`/`X-DoujouKoubou-*`/`X-DoujouMart-*`/`X-DoujouBank-*`/`X-Dojo-*`/`X-DojoPros-*`/`X-DojoTeam-*`/`X-DojoWorks-*`/`X-DojoExperts-*`/`X-DojoSvc-*`/`X-DojoHQ-*`/`X-Karate-*`/`X-KarateYasan-*`/`X-KaratePro-*`/`X-KarateTeam-*`/`X-KarateKoubou-*`/`X-KarateSenmon-*`/`X-KarateSchool-*`/`X-KarateDojo-*`/`X-Judo-*`/`X-JudoYasan-*`/`X-JudoPro-*`/`X-JudoTeam-*`/`X-JudoKoubou-*`/`X-JudoSenmon-*`/`X-JudoSchool-*`/`X-JudoDojo-*`/`X-Kendo-*`/`X-KendoYasan-*`/`X-KendoPro-*`/`X-KendoTeam-*`/`X-KendoKoubou-*`/`X-KendoSenmon-*`/`X-KendoSchool-*`/`X-KendoDojo-*`/`X-Aikido-*`/`X-AikidoPro-*`/`X-AikidoDojo-*`/`X-MartialArtsPros-*`/`X-MartialArtsTeam-*`/`X-MartialArtsWorks-*`/`X-MartialArtsExperts-*`/`X-MartialArtsSvc-*`/`X-MartialArtsHQ-*`/`X-DoujouPros-*`/`X-DoujouDoctors-*`/`X-DoujouRescue-*` 等 は道機の通知記録 — 送信側が書くことは自称。空手・柔道・剣道道場の偽装は、入門金・道衣代・昇級審査料を装ったなりすましの典型手口。(フィットネスは health/gym 近傍、ヨガは既存 yoga 族で検出済み)
- **修正**: `Envelope` に `dojo_marks` + `has_dojo_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 道印の自署を問え。

### Security — D745: `X-NailSalon-*`/`X-Nail-*`/`X-Matsuge-*`/`X-NailStudio-*`/`X-EyelashSalon-*` 等のネイル・まつ毛サロン印自称が未検査

- **問題**: `X-NailSalon-*`/`X-NailSalonYasan-*`/`X-NailSalonPro-*`/`X-NailSalonTeam-*`/`X-NailSalonKensa-*`/`X-NailSalonManten-*`/`X-NailSalonNomi-*`/`X-NailSalonJP-*`/`X-NailSalonSenmon-*`/`X-NailSalonMitsumori-*`/`X-NailSalonChousa-*`/`X-NailSalonTeiki-*`/`X-NailSalonShuri-*`/`X-NailSalonSho-*`/`X-NailSalonTen-*`/`X-NailSalonKoubou-*`/`X-NailSalonMart-*`/`X-NailSalonBank-*`/`X-Nail-*`/`X-NailYasan-*`/`X-NailPro-*`/`X-NailTeam-*`/`X-NailKoubou-*`/`X-NailSenmon-*`/`X-NailSho-*`/`X-NailTen-*`/`X-NailMart-*`/`X-EyelashSalon-*`/`X-EyelashSalonPro-*`/`X-EyelashSalonTeam-*`/`X-EyelashSalonKoubou-*`/`X-EyelashSalonSenmon-*`/`X-Matsuge-*`/`X-MatsugeYasan-*`/`X-MatsugePro-*`/`X-MatsugeTeam-*`/`X-MatsugeKoubou-*`/`X-MatsugeSenmon-*`/`X-MatsugeSho-*`/`X-MatsugeTen-*`/`X-MatsugeBank-*`/`X-NailStudio-*`/`X-NailStudioPros-*`/`X-NailStudioTeam-*`/`X-NailStudioWorks-*`/`X-NailStudioExperts-*`/`X-NailStudioSvc-*`/`X-NailStudioHQ-*`/`X-NailSalonPros-*`/`X-NailSalonWorks-*`/`X-NailSalonExperts-*`/`X-NailSalonSvc-*`/`X-NailSalonHQ-*`/`X-NailDoctors-*`/`X-NailRescue-*` 等 は爪機の通知記録 — 送信側が書くことは自称。ネイル・まつ毛サロンの偽装は、予約キャンセル料・施術料金・回数券を装ったなりすましの典型手口。(エステは esthe 機、理美容は barber 機、ネイル検定は license 機の `x-nailkentei-` で検出済み)
- **修正**: `Envelope` に `nailsalon_marks` + `has_nailsalon_marks` 追加; `commands.rs` で render_risks 兆候報告。
