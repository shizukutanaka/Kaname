...
### Security — D734: `X-Sekihi-*`/`X-Boseki-*`/`X-Tombstone-*`/`X-Monument-*` 等の墓石・石材店印自称が未検査

- **問題**: `X-Sekihi-*`/`X-SekihiYasan-*`/`X-SekihiPro-*`/`X-SekihiTeam-*`/`X-SekihiKensa-*`/`X-SekihiManten-*`/`X-SekihiNomi-*`/`X-SekihiJP-*`/`X-SekihiSenmon-*`/`X-SekihiMitsumori-*`/`X-SekihiChousa-*`/`X-SekihiTeiki-*`/`X-SekihiShuri-*`/`X-SekihiSho-*`/`X-SekihiTen-*`/`X-SekihiKoubou-*`/`X-SekihiMart-*`/`X-SekihiBank-*`/`X-Boseki-*`/`X-BosekiYasan-*`/`X-BosekiPro-*`/`X-BosekiTeam-*`/`X-BosekiKensa-*`/`X-BosekiManten-*`/`X-BosekiNomi-*`/`X-BosekiJP-*`/`X-BosekiSenmon-*`/`X-BosekiMitsumori-*`/`X-BosekiChousa-*`/`X-BosekiTeiki-*`/`X-BosekiShuri-*`/`X-BosekiSho-*`/`X-BosekiTen-*`/`X-BosekiKoubou-*`/`X-BosekiMart-*`/`X-BosekiBank-*`/`X-TombstonePros-*`/`X-TombstoneTeam-*`/`X-TombstoneWorks-*`/`X-TombstoneExperts-*`/`X-TombstoneSvc-*`/`X-TombstoneHQ-*`/`X-MonumentPros-*`/`X-MonumentTeam-*`/`X-MonumentWorks-*`/`X-MonumentExperts-*`/`X-MonumentSvc-*`/`X-MonumentHQ-*`/`X-GravestonePros-*`/`X-GravestoneTeam-*`/`X-SekihiSagyou-*`/`X-SekihiRescue-*` 等 は墓機の通知記録 — 送信側が書くことは自称。墓石・石材店の偽装は、墓石建立費・戒名彫刻料・追加彫り代を装ったなりすましの典型手口。(葬儀は funeral 機で検出済みのため葬儀社名は未収録)
- **修正**: `Envelope` に `sekihi_marks` + `has_sekihi_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 墓印の自署を問え。

### Security — D735: `X-Shashin-*`/`X-PhotoStudio-*`/`X-Portrait-*`/`X-Dpe-*` 等の写真館・DPE印自称が未検査

- **問題**: `X-Shashin-*`/`X-ShashinYasan-*`/`X-ShashinPro-*`/`X-ShashinTeam-*`/`X-ShashinKensa-*`/`X-ShashinManten-*`/`X-ShashinNomi-*`/`X-ShashinJP-*`/`X-ShashinSenmon-*`/`X-ShashinMitsumori-*`/`X-ShashinChousa-*`/`X-ShashinTeiki-*`/`X-ShashinShuri-*`/`X-ShashinSho-*`/`X-ShashinTen-*`/`X-Shashinkan-*`/`X-ShashinKoubou-*`/`X-ShashinMart-*`/`X-ShashinBank-*`/`X-PhotoStudio-*`/`X-PhotoStudioPros-*`/`X-PhotoStudioTeam-*`/`X-PhotoStudioWorks-*`/`X-PhotoStudioExperts-*`/`X-PhotoStudioSvc-*`/`X-PhotoStudioHQ-*`/`X-PortraitStudioPros-*`/`X-PortraitStudioTeam-*`/`X-PortraitStudioWorks-*`/`X-DpePros-*`/`X-DpeTeam-*`/`X-DpeWorks-*`/`X-DpeSvc-*`/`X-DpeHQ-*`/`X-PhotoFinishPros-*`/`X-PhotoFinishTeam-*`/`X-ShashinSagyou-*`/`X-ShashinRescue-*`/`X-ShashinDoctors-*`/`X-PhotoStudioMart-*`/`X-PhotoStudioBank-*`/`X-ShashinSchool-*`/`X-PortraitPros-*`/`X-PortraitTeam-*`/`X-PortraitWorks-*`/`X-PortraitExperts-*`/`X-PortraitSvc-*`/`X-PortraitHQ-*` 等 は写機の通知記録 — 送信側が書くことは自称。写真館・DPE・ポートレートスタジオの偽装は、七五三撮影料・プリント代・データ納品費を装ったなりすましの典型手口。(ウエディング写真は bridal 機、カメラ機材は device 機で検出済み)
- **修正**: `Envelope` に `shashin_marks` + `has_shashin_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 写印の自署を問え。

### Security — D736: `X-Shichiya-*`/`X-Pawn-*`/`X-PawnShop-*`/`X-PawnBroker-*` 等の質屋印自称が未検査

- **問題**: `X-Shichiya-*`/`X-ShichiyaYasan-*`/`X-ShichiyaPro-*`/`X-ShichiyaTeam-*`/`X-ShichiyaKensa-*`/`X-ShichiyaManten-*`/`X-ShichiyaNomi-*`/`X-ShichiyaJP-*`/`X-ShichiyaSenmon-*`/`X-ShichiyaMitsumori-*`/`X-ShichiyaChousa-*`/`X-ShichiyaTeiki-*`/`X-ShichiyaShuri-*`/`X-ShichiyaSho-*`/`X-ShichiyaTen-*`/`X-ShichiyaKoubou-*`/`X-ShichiyaMart-*`/`X-ShichiyaBank-*`/`X-PawnPros-*`/`X-PawnTeam-*`/`X-PawnWorks-*`/`X-PawnExperts-*`/`X-PawnSvc-*`/`X-PawnHQ-*`/`X-PawnShopPros-*`/`X-PawnShopTeam-*`/`X-PawnShopWorks-*`/`X-PawnShopExperts-*`/`X-PawnShopSvc-*`/`X-PawnShopHQ-*`/`X-PawnBrokerPros-*`/`X-PawnBrokerTeam-*`/`X-PawnBrokerWorks-*`/`X-PawnBrokerExperts-*`/`X-PawnBrokerSvc-*`/`X-PawnBrokerHQ-*`/`X-ShichiyaShinsa-*`/`X-ShichiyaBuyback-*`/`X-ShichiyaDoctors-*`/`X-ShichiyaRescue-*`/`X-PawnMart-*`/`X-PawnBank-*`/`X-PawnDepot-*`/`X-PawnExpress-*`/`X-PawnPlaza-*`/`X-PawnCity-*`/`X-PawnDoctors-*`/`X-PawnRescue-*` 等 は質機の通知記録 — 送信側が書くことは自称。質屋・パンブローカーの偽装は、質預かり査定・延滞利息・買取価格を装ったなりすましの典型手口。(リサイクル店は reuse 機、消費者金融は consumerloan 機で検出済み)
- **修正**: `Envelope` に `pawn_marks` + `has_pawn_marks` 追加; `commands.rs` で render_risks 兆候報告。
