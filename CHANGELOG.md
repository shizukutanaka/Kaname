...
### Security — D725: `X-Futon-*`/`X-Shingu-*`/`X-MattressPros-*`/`X-Bedding-*` 等の布団・寝具印自称が未検査

- **問題**: `X-Futon-*`/`X-FutonYasan-*`/`X-FutonPro-*`/`X-FutonTeam-*`/`X-FutonKensa-*`/`X-FutonManten-*`/`X-FutonNomi-*`/`X-FutonJP-*`/`X-FutonSenmon-*`/`X-FutonMitsumori-*`/`X-FutonChousa-*`/`X-FutonTeiki-*`/`X-FutonShuri-*`/`X-FutonSho-*`/`X-FutonTen-*`/`X-FutonKoubou-*`/`X-FutonMart-*`/`X-FutonBank-*`/`X-Shingu-*`/`X-ShinguYasan-*`/`X-ShinguPro-*`/`X-ShinguTeam-*`/`X-ShinguKensa-*`/`X-ShinguManten-*`/`X-ShinguNomi-*`/`X-ShinguJP-*`/`X-ShinguSenmon-*`/`X-ShinguMitsumori-*`/`X-ShinguChousa-*`/`X-ShinguTeiki-*`/`X-ShinguShuri-*`/`X-MattressPros-*`/`X-MattressTeam-*`/`X-MattressWorks-*`/`X-MattressForce-*`/`X-MattressNation-*`/`X-MattressExperts-*`/`X-MattressDoctors-*`/`X-MattressMasters-*`/`X-MattressSvc-*`/`X-MattressHQ-*`/`X-MattressFirm-*`/`X-BeddingPros-*`/`X-BeddingTeam-*`/`X-BeddingWorks-*`/`X-BeddingExperts-*`/`X-BeddingSvc-*`/`X-BeddingHQ-*`/`X-BeddingMart-*`/`X-BeddingBank-*`/`X-SleepPros-*` 等 は寝機の通知記録 — 送信側が書くことは自称。布団・寝具・マットレス販売の偽装は、マットレス購入・敷布団丸洗い料・睡眠グッズ販売を装ったなりすましの典型手口。(布団クリーニングは cleaning 機、家具は furniture 機で検出済み)
- **修正**: `Envelope` に `futon_marks` + `has_futon_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 寝印の自署を問え。

### Security — D726: `X-Gakubuchi-*`/`X-Gakusou-*`/`X-FrameShop-*`/`X-PictureFrame-*` 等の額縁・額装印自称が未検査

- **問題**: `X-Gakubuchi-*`/`X-GakubuchiYasan-*`/`X-GakubuchiPro-*`/`X-GakubuchiTeam-*`/`X-GakubuchiKensa-*`/`X-GakubuchiManten-*`/`X-GakubuchiNomi-*`/`X-GakubuchiJP-*`/`X-GakubuchiSenmon-*`/`X-GakubuchiMitsumori-*`/`X-GakubuchiChousa-*`/`X-GakubuchiTeiki-*`/`X-GakubuchiShuri-*`/`X-GakubuchiSho-*`/`X-GakubuchiTen-*`/`X-GakubuchiKoubou-*`/`X-GakubuchiMart-*`/`X-GakubuchiBank-*`/`X-GakubuchiDoctors-*`/`X-GakubuchiSagyou-*`/`X-GakubuchiRescue-*`/`X-Gakusou-*`/`X-GakusouYasan-*`/`X-GakusouPro-*`/`X-GakusouTeam-*`/`X-GakusouKensa-*`/`X-GakusouManten-*`/`X-GakusouNomi-*`/`X-GakusouJP-*`/`X-GakusouSenmon-*`/`X-GakusouMitsumori-*`/`X-GakusouChousa-*`/`X-GakusouTeiki-*`/`X-GakusouShuri-*`/`X-FramePros-*`/`X-FrameTeam-*`/`X-FrameworksExperts-*`/`X-FrameShopPros-*`/`X-FrameShopTeam-*`/`X-FrameShopWorks-*`/`X-FrameShopExperts-*`/`X-FrameShopSvc-*`/`X-FrameShopHQ-*`/`X-PictureFramePros-*`/`X-PictureFrameTeam-*`/`X-PictureFrameWorks-*`/`X-PictureFrameExperts-*`/`X-PictureFrameSvc-*`/`X-PictureFrameHQ-*` 等 は額機の通知記録 — 送信側が書くことは自称。額縁・額装・オーダーフレーム店の偽装は、額装費用・特注フレーム代・修復費を装ったなりすましの典型手口。(美術品は art 機、印刷は printing 機で検出済み)
- **修正**: `Envelope` に `frame_marks` + `has_frame_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 額印の自署を問え。

### Security — D727: `X-Uranai-*`/`X-FortunePros-*`/`X-Psychic-*`/`X-Tarot-*` 等の占い・霊感印自称が未検査

- **問題**: `X-Uranai-*`/`X-UranaiYasan-*`/`X-UranaiPro-*`/`X-UranaiTeam-*`/`X-UranaiKensa-*`/`X-UraniManten-*`/`X-UranaiNomi-*`/`X-UranaiJP-*`/`X-UranaiSenmon-*`/`X-UranaiMitsumori-*`/`X-UranaiChousa-*`/`X-UranaiTeiki-*`/`X-UranaiShuri-*`/`X-UranaiSho-*`/`X-UranaiTen-*`/`X-UranaiKoubou-*`/`X-UraniMart-*`/`X-UranaiBank-*`/`X-UranaiKantei-*`/`X-UranaiDoctors-*`/`X-UranaiSagyou-*`/`X-UranaiRescue-*`/`X-FortunePros-*`/`X-FortuneTeam-*`/`X-FortuneWorks-*`/`X-FortuneExperts-*`/`X-FortuneDoctors-*`/`X-FortuneSvc-*`/`X-FortuneHQ-*`/`X-FortuneMart-*`/`X-FortuneBank-*`/`X-PsychicPros-*`/`X-PsychicTeam-*`/`X-PsychicWorks-*`/`X-PsychicExperts-*`/`X-PsychicDoctors-*`/`X-PsychicSvc-*`/`X-PsychicHQ-*`/`X-PsychicMart-*`/`X-PsychicBank-*`/`X-PsychicSho-*`/`X-PsychicTen-*`/`X-TarotPros-*`/`X-TarotTeam-*`/`X-TarotWorks-*`/`X-TarotExperts-*`/`X-TarotSvc-*`/`X-TarotHQ-*` 等 は占機の通知記録 — 送信側が書くことは自称。占い・霊感・タロット鑑定の偽装は、鑑定料・開運グッズ・除霊費を装ったなりすましの典型手口。
- **修正**: `Envelope` に `uranai_marks` + `has_uranai_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 占印の自署を問え。
