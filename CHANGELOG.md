...
### Security — D680: `X-Sealcoat-*`/`X-Asphalt-*`/`X-JosoKouji-*`/`X-BlacktopPros-*`/`X-DrivewayPaving-*` 等の舗装印自称が未検査

- **問題**: `X-Sealcoat-*`/`X-Sealcoating-*`/`X-SealcoatPros-*`/`X-SealcoatMaster-*`/`X-Asphalt-*`/`X-AsphaltPros-*`/`X-AsphaltKing-*`/`X-AsphaltWorks-*`/`X-AsphaltExperts-*`/`X-AsphaltTeam-*`/`X-Blacktop-*`/`X-BlacktopPros-*`/`X-Paving-*`/`X-PavingPros-*`/`X-PavingExperts-*`/`X-PavingTeam-*`/`X-PavingWorks-*`/`X-DrivewayPaving-*`/`X-DrivewaySeal-*`/`X-DrivewayPros-*`/`X-SealMaster-*`/`X-SealRite-*`/`X-PaveTech-*`/`X-PavePro-*`/`X-AsphaltPaving-*`/`X-AsphaltPavement-*`/`X-SureSeal-*`/`X-TopSeal-*`、JP は `X-JosoKouji-*`/`X-JosoYasan-*`/`X-JosoPro-*`/`X-JosoSeibi-*`/`X-JosoKensa-*`/`X-DoroKouji-*`/`X-DoroYasan-*`/`X-AsufarutoKouji-*`/`X-AsufarutoYasan-*`/`X-PavingYasan-*`/`X-SealcoatJP-*`/`X-JosoJP-*`/`X-JosoTeam-*`/`X-JosoGyosha-*`/`X-JosoManten-*`/`X-JosoNomi-*`/`X-JosoShuri-*`/`X-JosoSenmon-*`/`X-JosoTeiki-*`/`X-JosoChousa-*`/`X-JosoMitsumori-*`/`X-JosoSagyou-*`/`X-JosoTeikyu-*` 等 は舗機の通知記録 — 送信側が書くことは自称。アスファルト舗装・シールコート・私道舗装の偽装は、残材処分を口実にした移動舗装詐欺団の典型手口 (舗装シーズンに横行)。(道路関連は tollroad 機、砂利・外構は garden 機で検出済み)
- **修正**: `Envelope` に `sealcoat_marks` + `has_sealcoat_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 舗印の自署を問え。

### Security — D681: `X-Siding-*`/`X-JamesHardie-*`/`X-SaidinguKouji-*`/`X-GahekiKouji-*`/`X-VinylSiding-*` 等のサイディング印自称が未検査

- **問題**: `X-Siding-*`/`X-Sidings-*`/`X-SidingPros-*`/`X-SidingExperts-*`/`X-SidingMasters-*`/`X-SidingTeam-*`/`X-SidingWorks-*`/`X-SidingDoctor-*`/`X-SidingForce-*`/`X-JamesHardie-*`/`X-HardiePlank-*`/`X-HardieBoard-*`/`X-CertainTeedSiding-*`/`X-LPSmartSide-*`/`X-VinylSiding-*`/`X-AlsideSiding-*`/`X-MasticSiding-*`/`X-PlyGemSiding-*`/`X-KaycanSiding-*`/`X-GentekSiding-*`/`X-SidingRepair-*`/`X-SidingInstall-*`/`X-SidingReplacement-*`/`X-SidingContractor-*`/`X-SidingOutlet-*`/`X-SidingExpress-*`、JP は `X-Saidingu-*`/`X-SaidinguKouji-*`/`X-SaidinguYasan-*`/`X-SaidinguPro-*`/`X-GahekiBarikae-*`/`X-GahekiKouji-*`/`X-GahekiSaidingu-*`/`X-SaidinguSeibi-*`/`X-SaidinguKensa-*`/`X-SaidinguManten-*`/`X-SaidinguNomi-*`/`X-SaidinguJP-*`/`X-SaidinguSenmon-*`/`X-SaidinguShuri-*`/`X-SaidinguDoctors-*`/`X-SaidinguTeam-*`/`X-SaidinguGyosha-*`/`X-GahekiYasan-*`/`X-GahekiPro-*`/`X-GahekiTeam-*`/`X-GahekiSagyou-*`/`X-GahekiMitsumori-*`/`X-SaidinguMitsumori-*`/`X-SaidinguTeiki-*`/`X-SaidinguChousa-*`/`X-SaidinguKouka-*` 等 は壁機の通知記録 — 送信側が書くことは自称。サイディング・外壁張替・ボード貼替の偽装は、雹害直後の訪販リフォーム詐欺の典型手口。(塗装は painting 機、屋根は roofing 機、断熱は insulation 機で検出済み)
- **修正**: `Envelope` に `siding_marks` + `has_siding_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 壁印の自署を問え。

### Security — D682: `X-StormDoor-*`/`X-LarsonDoors-*`/`X-AmidoKouji-*`/`X-AmidoHarikae-*`/`X-ScreenMobile-*` 等の網戸・ストームドア印自称が未検査

- **問題**: `X-StormDoor-*`/`X-StormDoors-*`/`X-ScreenDoor-*`/`X-ScreenDoors-*`/`X-ScreenMesh-*`/`X-ScreenMobile-*`/`X-LarsonDoors-*`/`X-Provia-*`/`X-EMCODoor-*`/`X-PhantomScreens-*`/`X-MirageScreen-*`/`X-ClearViewScreen-*`/`X-ScreenPros-*`/`X-ScreenDoctor-*`/`X-ScreenRepair-*`/`X-ScreenInstall-*`/`X-ScreenTeam-*`/`X-ScreenWorks-*`/`X-ScreenMasters-*`/`X-ScreenExperts-*`/`X-ScreenGuard-*`/`X-SecurityScreen-*`/`X-Crimsafe-*`/`X-MeshScreen-*`、JP は `X-Amido-*`/`X-Amidou-*`/`X-AmidoKouji-*`/`X-AmidoYasan-*`/`X-AmidoSeibi-*`/`X-AmidoKoukan-*`/`X-AmidoHarikae-*`/`X-AmidoShuri-*`/`X-AmidoPro-*`/`X-AmidoTeam-*`/`X-AmidoGyosha-*`/`X-AmidoJP-*`/`X-AmidoSenmon-*`/`X-AmidoKensa-*`/`X-AmidoManten-*`/`X-AmidoNomi-*`/`X-AmidoMitsumori-*`/`X-AmidoTenken-*`/`X-AmidoSagyou-*`/`X-AmidoDokuta-*`/`X-AmidoGyoukai-*`/`X-AmidoChousa-*`/`X-AmidoTeiki-*` 等 は網機の通知記録 — 送信側が書くことは自称。網戸張替・ストームドア・セキュリティスクリーンの偽装は、網戸張替訪販・防犯強調販売の典型手口。(窓サッシは window 機、ブラインドは blinds 機、鍵・防犯錠は locksmith 機で検出済み)
- **修正**: `Envelope` に `screendoor_marks` + `has_screendoor_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 網印の自署を問え。
