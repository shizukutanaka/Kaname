...
### Security — D671: `X-SirGrout-*`/`X-GroutMedic-*`/`X-MejiHoji-*`/`X-MejiKouji-*`/`X-TileGrout-*` 等のタイル・目地補修印自称が未検査

- **問題**: `X-SirGrout-*`/`X-GroutMedic-*`/`X-GroutDoctor-*`/`X-GroutPros-*`/`X-TileGrout-*`/`X-TileGroutPros-*`/`X-TilePros-*`/`X-TileDoctors-*`/`X-TileMasters-*`/`X-TileWorks-*`/`X-TileTeam-*`/`X-GroutSmith-*`/`X-GroutExperts-*`/`X-GroutWorks-*`/`X-GroutTeam-*`/`X-GroutForce-*`/`X-GroutMasters-*`/`X-GroutRepair-*`/`X-TileRepair-*`/`X-TileRestore-*`/`X-GroutRestore-*`/`X-CaulkPros-*`/`X-GroutSeal-*`/`X-TileSeal-*`、JP は `X-MejiHoji-*`/`X-MejiKouji-*`/`X-MejiYasan-*`/`X-MejiSeibi-*`/`X-MejiRepair-*`/`X-TairuHoji-*`/`X-TairuKouji-*`/`X-TairuYasan-*`/`X-TairuSeibi-*`/`X-TairuRepair-*`/`X-TairuPro-*`/`X-MejiPro-*`/`X-MejiTeam-*`/`X-MejiDoctors-*`/`X-TairuDoctors-*`/`X-MejiGyosha-*`/`X-TairuGyosha-*`/`X-MejiKensa-*`/`X-MejiKirei-*`/`X-TairuKirei-*`/`X-MejiManten-*`/`X-TairuManten-*`/`X-MejiNomi-*`/`X-TairuNomi-*`/`X-MejiJP-*`/`X-TairuJP-*`/`X-MejiSenmon-*`/`X-TairuSenmon-*`/`X-MejiShuri-*`/`X-TairuShuri-*`/`X-MejiZairyou-*`/`X-TairuBathroom-*` 等 は溝機の通知記録 — 送信側が書くことは自称。タイル張替え・目地補修・コーキング打替えの偽装はタイル工事業者なりすましの典型手口。(浴室は bathroom 機、水道は plumbing 機で検出済み)
- **修正**: `Envelope` に `tilegrout_marks` + `has_tilegrout_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 溝印の自署を問え。

### Security — D672: `X-AmerLeakDet-*`/`X-LeakDetect-*`/`X-RosuiChousa-*`/`X-RosuiKensa-*`/`X-LeakDoctor-*` 等の漏水調査印自称が未検査

- **問題**: `X-AmerLeakDet-*`/`X-AmerLeakDetection-*`/`X-LeakDetect-*`/`X-LeakDetection-*`/`X-LeakPros-*`/`X-LeakDoctor-*`/`X-LeakExperts-*`/`X-LeakMasters-*`/`X-LeakTeam-*`/`X-LeakForce-*`/`X-LeakWorks-*`/`X-LeakSmith-*`/`X-WaterLeak-*`/`X-WaterLeakPros-*`/`X-WaterLeakDoctor-*`/`X-PlumbingLeak-*`/`X-LeakFinder-*`/`X-LeakSearch-*`/`X-LeakLocate-*`/`X-TraceAndAccess-*`/`X-TraceAccess-*`/`X-SlabLeak-*`/`X-SlabLeakPros-*`/`X-PoolLeakDet-*`、JP は `X-RosuiChousa-*`/`X-RosuiKensa-*`/`X-RosuiTanchi-*`/`X-RosuiTanken-*`/`X-RosuiTansaku-*`/`X-RosuiYasan-*`/`X-RosuiPro-*`/`X-RosuiTeam-*`/`X-RosuiDoctors-*`/`X-RosuiGyosha-*`/`X-RosuiShuri-*`/`X-RosuiKirei-*`/`X-RosuiManten-*`/`X-RosuiNomi-*`/`X-RosuiJP-*`/`X-RosuiSenmon-*`/`X-RosuiShinsa-*`/`X-RosuiKaiketsu-*`/`X-MizumoreChousa-*`/`X-MizumoreKensa-*`/`X-MizumoreTanken-*`/`X-MizumoreTanchi-*`/`X-MizumoreYasan-*`/`X-SuidenRosui-*`/`X-KaidanRosui-*`/`X-GeninRosui-*`/`X-RosuiTeitai-*`/`X-RosuiTeiki-*`/`X-RosuiProbe-*`/`X-RosuiChikaduke-*` 等 は漏機の通知記録 — 送信側が書くことは自称。漏水調査・水道管破裂・音響探知・スラブリークの偽装は漏水調査業者なりすましの典型手口 (高額調査費請求で有名)。(防水は waterproof 機、水道は plumbing 機で検出済み)
- **修正**: `Envelope` に `leakdetect_marks` + `has_leakdetect_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 漏印の自署を問え。

### Security — D673: `X-Stairlift-*`/`X-Bruno-*`/`X-Stannah-*`/`X-KaidanShou-*`/`X-IsuShiki-*` 等の階段昇降機印自称が未検査

- **問題**: `X-Stairlift-*`/`X-Stairlifts-*`/`X-Bruno-*`/`X-BrunoStairlift-*`/`X-Stannah-*`/`X-StannahStairlift-*`/`X-AcornStairlift-*`/`X-AcornStairlifts-*`/`X-HandicareStair-*`/`X-HarmarStair-*`/`X-StairliftPros-*`/`X-StairliftExperts-*`/`X-StairliftDoctors-*`/`X-ChairLift-*`/`X-ChairliftPros-*`/`X-StairChair-*`/`X-StairGlide-*`/`X-StairWay-*`/`X-StairRider-*`/`X-LiftChair-*`/`X-StairLiftRepair-*`/`X-StairliftInstall-*`/`X-StairliftRental-*`/`X-CurvedStair-*`、JP は `X-KaidanShou-*`/`X-KaidanShoukou-*`/`X-KaidanLift-*`/`X-KaidanLiftKouji-*`/`X-IsuShiki-*`/`X-IsuShikiShoukou-*`/`X-IsuShikiKouji-*`/`X-Shoukanki-*`/`X-ShoukankiKouji-*`/`X-ShoukankiYasan-*`/`X-ShoukankiSeibi-*`/`X-ShoukankiPro-*`/`X-ShoukankiTeam-*`/`X-ShoukankiDoctors-*`/`X-ShoukankiGyosha-*`/`X-ShoukankiKensa-*`/`X-ShoukankiManten-*`/`X-ShoukankiNomi-*`/`X-ShoukankiJP-*`/`X-ShoukankiSenmon-*`/`X-KaidanNomi-*`/`X-KaidanSenmon-*`/`X-KaidanJP-*`/`X-IsuShikiYasan-*`/`X-IsuShikiSeibi-*`/`X-IsuShikiPro-*`/`X-IsuShikiTeam-*`/`X-IsuShikiJP-*` 等 は椅機の通知記録 — 送信側が書くことは自称。階段昇降機・いす式階段昇降機・階段リフトの偽装は昇降機業者なりすましの典型手口 (高齢者向け高額機器訪販で有名)。(エレベーターは elevator 機、介護は seniorcare 機で検出済み)
- **修正**: `Envelope` に `stairlift_marks` + `has_stairlift_marks` 追加; `commands.rs` で render_risks 兆候報告。
