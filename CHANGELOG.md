...
### Security — D740: `X-Konkatsu-*`/`X-KekkonShoudan-*`/`X-Matchmaker-*`/`X-Matchmaking-*` 等の婚活・結婚相談所印自称が未検査

- **問題**: `X-Konkatsu-*`/`X-KonkatsuYasan-*`/`X-KonkatsuPro-*`/`X-KonkatsuTeam-*`/`X-KonkatsuKensa-*`/`X-KonkatsuManten-*`/`X-KonkatsuNomi-*`/`X-KonkatsuJP-*`/`X-KonkatsuSenmon-*`/`X-KonkatsuMitsumori-*`/`X-KonkatsuChousa-*`/`X-KonkatsuTeiki-*`/`X-KonkatsuShuri-*`/`X-KonkatsuSho-*`/`X-KonkatsuTen-*`/`X-KonkatsuKoubou-*`/`X-KonkatsuMart-*`/`X-KonkatsuBank-*`/`X-KekkonShoudan-*`/`X-KekkonShoudanPro-*`/`X-KekkonShoudanTeam-*`/`X-KekkonShoudanKensa-*`/`X-KekkonShoudanKoubou-*`/`X-KekkonShoudanSenmon-*`/`X-KekkonShoudanSho-*`/`X-KekkonShoudanTen-*`/`X-KekkonSoudan-*`/`X-KekkonSoudanPro-*`/`X-KekkonSoudanSho-*`/`X-MatchmakerPros-*`/`X-MatchmakerTeam-*`/`X-MatchmakerWorks-*`/`X-MatchmakerExperts-*`/`X-MatchmakerSvc-*`/`X-MatchmakerHQ-*`/`X-MatchmakingPros-*`/`X-MatchmakingTeam-*`/`X-MatchmakingWorks-*`/`X-MatchmakingExperts-*`/`X-MatchmakingSvc-*`/`X-MatchmakingHQ-*`/`X-MarriageAgencyPros-*`/`X-MarriageAgencyTeam-*`/`X-MarriageAgencyWorks-*`/`X-MarriageAgencyExperts-*`/`X-MarriageAgencySvc-*`/`X-MarriageAgencyHQ-*`/`X-KonkatsuPros-*`/`X-KonkatsuWorks-*`/`X-KonkatsuExperts-*`/`X-KonkatsuSvc-*`/`X-KonkatsuHQ-*`/`X-KonkatsuDoctors-*`/`X-KonkatsuRescue-*` 等 は縁機の通知記録 — 送信側が書くことは自称。結婚相談所・婚活サービスの偽装は、入会金・月会費・お見合い料を装ったなりすましの典型手口。(婚礼は bridal 機、占いは uranai 機で検出済み)
- **修正**: `Envelope` に `konkatsu_marks` + `has_konkatsu_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 縁印の自署を問え。

### Security — D741: `X-Reien-*`/`X-Bochi-*`/`X-Cemetery-*`/`X-MemorialPark-*` 等の霊園・墓地印自称が未検査

- **問題**: `X-Reien-*`/`X-ReienYasan-*`/`X-ReienPro-*`/`X-ReienTeam-*`/`X-ReienKensa-*`/`X-ReienManten-*`/`X-ReienNomi-*`/`X-ReienJP-*`/`X-ReienSenmon-*`/`X-ReienMitsumori-*`/`X-ReienChousa-*`/`X-ReienTeiki-*`/`X-ReienShuri-*`/`X-ReienSho-*`/`X-ReienTen-*`/`X-ReienKoubou-*`/`X-ReienMart-*`/`X-ReienBank-*`/`X-Bochi-*`/`X-BochiYasan-*`/`X-BochiPro-*`/`X-BochiTeam-*`/`X-BochiKensa-*`/`X-BochiManten-*`/`X-BochiNomi-*`/`X-BochiJP-*`/`X-BochiSenmon-*`/`X-BochiMitsumori-*`/`X-BochiChousa-*`/`X-BochiTeiki-*`/`X-BochiShuri-*`/`X-BochiSho-*`/`X-BochiTen-*`/`X-BochiKoubou-*`/`X-BochiMart-*`/`X-BochiBank-*`/`X-CemeteryPros-*`/`X-CemeteryTeam-*`/`X-CemeteryWorks-*`/`X-CemeteryExperts-*`/`X-CemeterySvc-*`/`X-CemeteryHQ-*`/`X-MemorialParkPros-*`/`X-MemorialParkTeam-*`/`X-MemorialParkWorks-*`/`X-MemorialParkExperts-*`/`X-MemorialParkSvc-*`/`X-MemorialParkHQ-*`/`X-ReienPros-*`/`X-ReienWorks-*`/`X-ReienExperts-*`/`X-ReienSvc-*`/`X-ReienHQ-*`/`X-ReienDoctors-*`/`X-ReienRescue-*` 等 は霊機の通知記録 — 送信側が書くことは自称。霊園・墓地・メモリアルパークの偽装は、墓地区画代・永代使用料・管理費を装ったなりすましの典型手口。(墓石は sekihi 機、葬儀は funeral 機、仏壇は butsudan 機で検出済み)
- **修正**: `Envelope` に `reien_marks` + `has_reien_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 霊印の自署を問え。

### Security — D742: `X-Nouki-*`/`X-Nougyou-*`/`X-FarmMachinery-*`/`X-FarmEquipment-*` 等の農機印自称が未検査

- **問題**: `X-Nouki-*`/`X-NoukiYasan-*`/`X-NoukiPro-*`/`X-NoukiTeam-*`/`X-NoukiKensa-*`/`X-NoukiManten-*`/`X-NoukiNomi-*`/`X-NoukiJP-*`/`X-NoukiSenmon-*`/`X-NoukiMart-*`/`X-NoukiMitsumori-*`/`X-NoukiChousa-*`/`X-NoukiTeiki-*`/`X-NoukiShuri-*`/`X-NoukiSho-*`/`X-NoukiTen-*`/`X-NoukiKoubou-*`/`X-NoukiBank-*`/`X-Nougyou-*`/`X-NougyouYasan-*`/`X-NougyouPro-*`/`X-NougyouTeam-*`/`X-NougyouKensa-*`/`X-NougyouManten-*`/`X-NougyouNomi-*`/`X-NougyouJP-*`/`X-NougyouSenmon-*`/`X-NougyouMitsumori-*`/`X-NougyouChousa-*`/`X-NougyouTeiki-*`/`X-NougyouShuri-*`/`X-FarmMachineryPros-*`/`X-FarmMachineryTeam-*`/`X-FarmMachineryWorks-*`/`X-FarmMachineryExperts-*`/`X-FarmMachinerySvc-*`/`X-FarmMachineryHQ-*`/`X-FarmEquipmentPros-*`/`X-FarmEquipmentTeam-*`/`X-FarmEquipmentWorks-*`/`X-FarmEquipmentExperts-*`/`X-FarmEquipmentSvc-*`/`X-FarmEquipmentHQ-*`/`X-AgriEquipmentPros-*`/`X-AgriEquipmentTeam-*`/`X-AgriEquipmentWorks-*`/`X-AgriEquipmentExperts-*`/`X-AgriEquipmentSvc-*`/`X-AgriEquipmentHQ-*`/`X-TractorRepairPros-*`/`X-TractorRepairTeam-*`/`X-TractorRepairWorks-*`/`X-TractorRepairSvc-*`/`X-TractorRepairHQ-*`/`X-NoukiPros-*`/`X-NoukiDoctors-*`/`X-NoukiRescue-*` 等 は農機の通知記録 — 送信側が書くことは自称。農機具店・トラクター修理・農業機械販売の偽装は、中古農機販売代・修理部品代・整備費を装ったなりすましの典型手口。(資材小売は retail 機の `x-tractorsupply-`、建機レンタルは heavyequip 機で検出済み)
- **修正**: `Envelope` に `nouki_marks` + `has_nouki_marks` 追加; `commands.rs` で render_risks 兆候報告。
