...
### Security — D746: `X-Shodo-*`/`X-Shuuji-*`/`X-Calligraphy-*` 等の書道・習字教室印自称が未検査

- **問題**: `X-Shodo-*`/`X-ShodoYasan-*`/`X-ShodoPro-*`/`X-ShodoTeam-*`/`X-ShodoKensa-*`/`X-ShodoManten-*`/`X-ShodoNomi-*`/`X-ShodoJP-*`/`X-ShodoSenmon-*`/`X-ShodoMitsumori-*`/`X-ShodoChousa-*`/`X-ShodoTeiki-*`/`X-ShodoShuri-*`/`X-ShodoSchool-*`/`X-ShodoKoubou-*`/`X-ShodoMart-*`/`X-ShodoBank-*`/`X-Shuuji-*`/`X-ShuujiYasan-*`/`X-ShuujiPro-*`/`X-ShuujiTeam-*`/`X-ShuujiKensa-*`/`X-ShuujiManten-*`/`X-ShuujiNomi-*`/`X-ShuujiJP-*`/`X-ShuujiSenmon-*`/`X-ShuujiMitsumori-*`/`X-ShuujiChousa-*`/`X-ShuujiTeiki-*`/`X-ShuujiShuri-*`/`X-ShuujiSchool-*`/`X-ShuujiKoubou-*`/`X-ShuujiMart-*`/`X-ShuujiBank-*`/`X-CalligraphyPros-*`/`X-CalligraphyTeam-*`/`X-CalligraphyWorks-*`/`X-CalligraphyExperts-*`/`X-CalligraphySvc-*`/`X-CalligraphyHQ-*`/`X-CalligraphyLesson-*`/`X-CalligraphyLessonPros-*`/`X-CalligraphyLessonTeam-*`/`X-ShodoPros-*`/`X-ShodoWorks-*`/`X-ShodoExperts-*`/`X-ShodoSvc-*`/`X-ShodoHQ-*`/`X-ShodoDoctors-*`/`X-ShodoRescue-*`/`X-ShuujiPros-*`/`X-ShuujiDoctors-*`/`X-ShuujiRescue-*` 等 は字機の通知記録 — 送信側が書くことは自称。書道・習字教室の偽装は、入会金・月謝・昇段審査料を装ったなりすましの典型手口。(そろばんは既存 `x-abacus-`/`x-abacuslaw-` 所有、語学塾は cram 機で検出済み)
- **修正**: `Envelope` に `shodo_marks` + `has_shodo_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 字印の自署を問え。

### Security — D747: `X-Dansu-*`/`X-Dance-*`/`X-Ballet-*`/`X-DanceStudio-*` 等のダンス教室印自称が未検査

- **問題**: `X-Dansu-*`/`X-DansuYasan-*`/`X-DansuPro-*`/`X-DansuTeam-*`/`X-DansuKensa-*`/`X-DansuManten-*`/`X-DansuNomi-*`/`X-DansuJP-*`/`X-DansuSenmon-*`/`X-DansuMitsumori-*`/`X-DansuChousa-*`/`X-DansuTeiki-*`/`X-DansuShuri-*`/`X-DansuSchool-*`/`X-DansuKoubou-*`/`X-DansuMart-*`/`X-DansuBank-*`/`X-Dance-*`/`X-DanceYasan-*`/`X-DancePro-*`/`X-DanceTeam-*`/`X-DanceKoubou-*`/`X-DanceSenmon-*`/`X-DanceSchool-*`/`X-DanceAcademy-*`/`X-DanceStudio-*`/`X-DanceStudioPros-*`/`X-DanceStudioTeam-*`/`X-DanceStudioWorks-*`/`X-DanceStudioExperts-*`/`X-DanceStudioSvc-*`/`X-DanceStudioHQ-*`/`X-DanceLesson-*`/`X-DanceLessonPros-*`/`X-DanceLessonTeam-*`/`X-DanceLessonWorks-*`/`X-Ballet-*`/`X-BalletPro-*`/`X-BalletTeam-*`/`X-BalletKoubou-*`/`X-BalletSenmon-*`/`X-BalletStudio-*`/`X-BalletAcademy-*`/`X-Hiphop-*`/`X-HiphopDance-*`/`X-HiphopSchool-*`/`X-Jazzdance-*`/`X-JazzdanceSchool-*`/`X-DancePros-*`/`X-DanceWorks-*`/`X-DanceExperts-*`/`X-DanceSvc-*`/`X-DanceHQ-*`/`X-DanceDoctors-*`/`X-DanceRescue-*`/`X-DansuPros-*`/`X-DansuDoctors-*`/`X-DansuRescue-*` 等 は舞機の通知記録 — 送信側が書くことは自称。ダンス・バレエ教室の偽装は、入会金・月謝・発表会費を装ったなりすましの典型手口。(水泳教室は既存 `x-swimschool-`/`x-balletschool-` 所有、ヨガは yoga 族で検出済み)
- **修正**: `Envelope` に `dance_marks` + `has_dance_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 舞印の自署を問え。

### Security — D748: `X-Nenkin-*`/`X-Fp-*`/`X-FinancialPlan*-*`/`X-EstatePlan-*`/`X-Pension-*` 等の年金・FP・相続相談印自称が未検査

- **問題**: `X-Nenkin-*`/`X-NenkinPro-*`/`X-NenkinTeam-*`/`X-NenkinKensa-*`/`X-NenkinManten-*`/`X-NenkinNomi-*`/`X-NenkinJP-*`/`X-NenkinSenmon-*`/`X-NenkinMitsumori-*`/`X-NenkinChousa-*`/`X-NenkinTeiki-*`/`X-NenkinShuri-*`/`X-NenkinSho-*`/`X-NenkinKoubou-*`/`X-NenkinMart-*`/`X-NenkinBank-*`/`X-FpKoubou-*`/`X-FpPro-*`/`X-FpTeam-*`/`X-FpKensa-*`/`X-FpManten-*`/`X-FpNomi-*`/`X-FpJP-*`/`X-FpSenmon-*`/`X-FpMitsumori-*`/`X-FpChousa-*`/`X-FpTeiki-*`/`X-FpShuri-*`/`X-FpSho-*`/`X-FpMart-*`/`X-FpBank-*`/`X-FinancialPlannerPros-*`/`X-FinancialPlannerTeam-*`/`X-FinancialPlannerWorks-*`/`X-FinancialPlannerExperts-*`/`X-FinancialPlannerSvc-*`/`X-FinancialPlannerHQ-*`/`X-FinancialPlanningPros-*`/`X-FinancialPlanningTeam-*`/`X-FinancialPlanningWorks-*`/`X-FinancialPlanningExperts-*`/`X-FinancialPlanningSvc-*`/`X-FinancialPlanningHQ-*`/`X-EstatePlanPros-*`/`X-EstatePlanTeam-*`/`X-EstatePlanWorks-*`/`X-EstatePlanExperts-*`/`X-EstatePlanSvc-*`/`X-EstatePlanHQ-*`/`X-PensionPros-*`/`X-PensionTeam-*`/`X-PensionWorks-*`/`X-PensionExperts-*`/`X-PensionSvc-*`/`X-PensionHQ-*`/`X-NenkinPros-*`/`X-NenkinDoctors-*`/`X-NenkinRescue-*`/`X-FpPros-*`/`X-FpDoctors-*`/`X-FpRescue-*` 等 は年機の通知記録 — 送信側が書くことは自称。年金相談・ファイナンシャルプランナー・遺産計画の偽装は、相談料・プラン作成費・年金試算代を装ったなりすましの典型手口。(保険は insurance 機、証券は securities 機、税務は taxfiling 機、社労士は roumu 機で検出済み)
