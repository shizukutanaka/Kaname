...
### Security — D650: `X-GotJunk-*`/`X-JunkKing-*`/`X-Fuyouhin-*`/`X-Sodaigomi-*`/`X-GomiYashiki-*` 等の不用品回収・ジャンク除去印自称が未検査

- **問題**: `X-GotJunk-*`/`X-JunkKing-*`/`X-CollegeHunks-*`/`X-JunkLuggers-*`/`X-LoadUp-*`/`X-JDog-*`/`X-BinThereDumpThat-*`/`X-JunkBuddy-*`/`X-JunkRemoval-*`/`X-JunkRemovalPros-*`/`X-JunkHaul-*`/`X-JunkHaulPros-*`/`X-TrashRemoval-*`/`X-DebrisRemoval-*`/`X-CleanoutPros-*`/`X-EstateCleanout-*`/`X-HoarderCleanout-*`/`X-GarageCleanout-*`/`X-AtticCleanout-*`/`X-BasementCleanout-*`/`X-JunkDump-*`/`X-HaulingPros-*`/`X-DumpsterRental-*`/`X-RollOff-*`/`X-JunkForce-*`/`X-TrashJunk-*`、JP は `X-Fuyouhin-*`/`X-FuyouhinKaishu-*`/`X-FuyouhinYasan-*`/`X-Sodaigomi-*`/`X-SodaigomiShori-*`/`X-GomiYashiki-*`/`X-GomiYashikiTaiji-*`/`X-HaihinKaishu-*`/`X-Haikibutsu-*`/`X-IhinSeiri-*`/`X-KadennokiKaishu-*`/`X-DansuSeiri-*`/`X-NukiHaki-*`/`X-KatazukeShori-*`/`X-JunkSeiri-*`/`X-FuyouhinSeiri-*`/`X-Daihaku-*`/`X-Katazukeya-*`/`X-NarukiSouji-*`/`X-GaichuKaishu-*`/`X-JunkRemovalJP-*`/`X-HidoKaishu-*` 等 は回機の通知記録 — 送信側が書くことは自称。無料回収勧誘・積載量詐欺・廃品高額請求・ゴミ屋敷片付けの偽装は不用品回収業者なりすましの典型手口 (高齢者狙いの粗大ゴミ詐欺で有名)。(買取は reuse 機、遺品整理は funeral 機、清掃は cleaning 機で検出済み)
- **修正**: `Envelope` に `junkremoval_marks` + `has_junkremoval_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 回印の自署を問え。

### Security — D651: `X-MrAppliance-*`/`X-SearsHomeServices-*`/`X-KadenShuuri-*`/`X-DenkiShuuri-*` 等の家電修理印自称が未検査

- **問題**: `X-MrAppliance-*`/`X-SearsHomeServices-*`/`X-ApplianceFactory-*`/`X-ApplianceDoctor-*`/`X-FredSappliance-*`/`X-Accufix-*`/`X-ApplianceRepair-*`/`X-ApplianceRepairPros-*`/`X-HomeAppliance-*`/`X-ApplianceService-*`/`X-AppliancePros-*`/`X-FixAppliance-*`/`X-ApplianceForce-*`/`X-DishwasherRepair-*`/`X-WasherRepair-*`/`X-DryerRepair-*`/`X-FridgeRepair-*`/`X-RefrigeratorRepair-*`/`X-OvenRepair-*`/`X-RangeRepair-*`/`X-MicrowaveRepair-*`/`X-FreezerRepair-*`/`X-HDTVRepair-*`/`X-TelevisionRepair-*`/`X-ApplianceTech-*`、JP は `X-KadenShuuri-*`/`X-DenkiShuuri-*`/`X-DenkiYashuuri-*`/`X-KadenDoctor-*`/`X-SensoukiShuuri-*`/`X-ReizoukoShuuri-*`/`X-SentakkiShuuri-*`/`X-SentakukiShuuri-*`/`X-EakonShuuri-*`/`X-Dishshuuri-*`/`X-ShuuriYa-*`/`X-Kadenrepaia-*`/`X-OshareShuuri-*`/`X-KadenSupotto-*`/`X-DensetsuShuuri-*`/`X-TeresaShuuri-*`/`X-EletroShuuri-*`/`X-KadenKanri-*`/`X-SyuuriPro-*` 等 は家機の通知記録 — 送信側が書くことは自称。洗濯機・冷蔵庫・エアコン・食洗機修理・延長保証・訪問修理予約の偽装は家電修理業者なりすましの典型手口。(量販店は retail 機、携帯修理は recovery 機、整備は autoservice 機で検出済み)
- **修正**: `Envelope` に `appliance_marks` + `has_appliance_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 家印の自署を問え。

### Security — D652: `X-MoldPros-*`/`X-MoldDoctor-*`/`X-Kabibusters-*`/`X-KabiTori-*`/`X-KabiKujo-*` 等のカビ・黴処理印自称が未検査

- **問題**: `X-MoldPros-*`/`X-MoldDoctor-*`/`X-EliteMold-*`/`X-ActionMold-*`/`X-MoldInspection-*`/`X-MoldInspectionPros-*`/`X-MoldRemediation-*`/`X-MoldRemoval-*`/`X-MoldRemovalPros-*`/`X-MoldFree-*`/`X-MoldMaster-*`/`X-MoldTech-*`/`X-Aseptair-*`/`X-MoldExperts-*`/`X-MoldLab-*`/`X-MoldCheck-*`/`X-MoldBusters-*`/`X-BlackMold-*`/`X-MoldRemover-*`/`X-MoldSense-*`/`X-MoldProtection-*`/`X-MoldSolutions-*`/`X-MoldSafe-*`、JP は `X-Kabibusters-*`/`X-KabiTori-*`/`X-KabiYa-*`/`X-KabiToriYasan-*`/`X-KabiKujo-*`/`X-KabiSenmon-*`/`X-KabiDoctor-*`/`X-KabiSeiri-*`/`X-KabiSekkai-*`/`X-KabiSupport-*`/`X-KabiNeko-*`/`X-KabiNekoBusters-*`/`X-KabiTaisaku-*`/`X-BlackMoldJP-*`/`X-KabiHakken-*`/`X-KabiMansion-*`/`X-KaabikuJO-*` 等 は黴機の通知記録 — 送信側が書くことは自称。カビ発見・黴検査・浴室カビ取り・結露カビ対策・除湿工事の偽装はカビ処理業者なりすましの典型手口 (健康不安を煽る訪販で有名)。(災害復旧は restoration 機、清掃は cleaning 機、防水は waterproof 機で検出済み)
- **修正**: `Envelope` に `mold_marks` + `has_mold_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 黴印の自署を問え。
