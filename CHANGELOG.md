...
### Security — D647: `X-USAInsulation-*`/`X-KoalaInsulation-*`/`X-DannetsuKouji-*`/`X-Yukadanbo-*` 等の断熱・気密印自称が未検査

- **問題**: `X-USAInsulation-*`/`X-KoalaInsulation-*`/`X-AtticDams-*`/`X-InjectionFoam-*`/`X-RetroFoam-*`/`X-DrEnergySaver-*`/`X-DuctWorksInsulation-*`/`X-InsulationPros-*`/`X-InsulationExperts-*`/`X-AtticInsulation-*`/`X-BlowInInsulation-*`/`X-SprayFoamPros-*`/`X-SprayFoamExperts-*`/`X-ThermaSeal-*`/`X-RaFactor-*`/`X-BlanketInsulation-*`/`X-CoastalInsulation-*`/`X-InsulationInstallers-*`/`X-SealTech-*`/`X-FoamRoofs-*`/`X-GreenFiber-*`、JP は `X-DannetsuKouji-*`/`X-DannetsuRifo-*`/`X-KimitsuDan-*`/`X-DannetsuSekkei-*`/`X-DannetsuZai-*`/`X-DannetsuShizai-*`/`X-AtticDan-*`/`X-YaneDannetsu-*`/`X-KabeDannetsu-*`/`X-YukaDanbo-*`/`X-YukaDanbou-*`/`X-NekkoDan-*`/`X-DanetsuKouji-*`/`X-AtticKanki-*`/`X-SoukoDan-*`/`X-DannetsuYasan-*`/`X-KimitsuSoukou-*`/`X-DanNetsuPro-*`/`X-HighDan-*`/`X-EcoDan-*`/`X-NoDan-*`/`X-DannetsuEn-*`/`X-UrbanDannetsu-*` 等 は断機の通知記録 — 送信側が書くことは自称。屋根裏断熱・吹き付け発泡・気密リフォーム・省エネ診断・結露対策見積の偽装は断熱業者なりすましの典型手口。(住宅メーカーは housing 機、リフォームは renovation 機、空調は hvac 機で検出済み)
- **修正**: `Envelope` に `insulation_marks` + `has_insulation_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 断印の自署を問え。

### Security — D648: `X-ConservaIrrigation-*`/`X-IrrigationPros-*`/`X-SprinklerYasan-*`/`X-Mizumake-*` 等の灌漑・スプリンクラー印自称が未検査

- **問題**: `X-ConservaIrrigation-*`/`X-IrrigationPros-*`/`X-WetLawn-*`/`X-LawnIrrigation-*`/`X-SprinklerPros-*`/`X-SprinklerMedics-*`/`X-RainBirdService-*`/`X-RainBirdPro-*`/`X-HunterIrrigation-*`/`X-IrrigationWorks-*`/`X-IrriClean-*`/`X-SprinklerSOS-*`/`X-IrrigationExperts-*`/`X-DripIrrigation-*`/`X-SprinklerRepair-*`/`X-IrrigationDoctors-*`/`X-SmartIrrigation-*`/`X-TurfIrrigation-*`/`X-BluegrassIrrigation-*`/`X-IrrigationWorld-*`/`X-SprinklerTech-*`/`X-WaterWizards-*`/`X-GreenSprinkler-*`/`X-IrrigationTeam-*`、JP は `X-MizumakeSprinkler-*`/`X-SprinklerYasan-*`/`X-SprinklerKouji-*`/`X-SprinklerSeibi-*`/`X-KandenchiMizu-*`/`X-KansuiKouji-*`/`X-HosuiKouji-*`/`X-AutomaticWater-*`/`X-Irigeshon-*`/`X-SprinklerNomi-*`/`X-Mizumake-*`/`X-MizumakeKan-*`/`X-SprinklerDoctors-*`/`X-Suprinka-*`/`X-MizumakePros-*`/`X-RainMaker-*`/`X-IrrigationYasan-*` 等 は灌機の通知記録 — 送信側が書くことは自称。スプリンクラー修理・冬凍結対策・水漏れ・灌漑設計・定期点検の偽装は灌漑業者なりすましの典型手口。(造園・芝生は garden 機、水道修理は plumbing 機で検出済み)
- **修正**: `Envelope` に `irrigation_marks` + `has_irrigation_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 灌印の自署を問え。

### Security — D649: `X-CritterControl-*`/`X-TruTech-*`/`X-WildlifeRemoval-*`/`X-GaichuKujo-*` 等の害獣・野生動物駆除印自称が未検査

- **問題**: `X-CritterControl-*`/`X-TruTech-*`/`X-AAACWildlife-*`/`X-WildlifeRemoval-*`/`X-WildlifeRemovalPros-*`/`X-AnimalPros-*`/`X-AnimalControlPros-*`/`X-Nusujima-*`/`X-WildlifePros-*`/`X-CritterPro-*`/`X-CritterDetective-*`/`X-AnimalTrapper-*`/`X-WildlifeSolution-*`/`X-UrbanWildlife-*`/`X-NaturePest-*`/`X-BatRemoval-*`/`X-RaccoonRemoval-*`/`X-SquirrelRemoval-*`/`X-SkunkRemoval-*`/`X-BirdRemoval-*`/`X-WildlifeDoctors-*`/`X-AnimalAttic-*`/`X-WildlifeInspectors-*`/`X-CritterRid-*`/`X-WildlifeCo-*`/`X-UrbanWildPros-*`、JP は `X-GaichuKujo-*`/`X-GaichuTaisaku-*`/`X-GaichuDansu-*`/`X-GaichuSenmon-*`/`X-NusujimaKujo-*`/`X-YaseiDoubutsu-*`/`X-GaichuHunter-*`/`X-MoriDansu-*`/`X-HebiKujo-*`/`X-HachisuKujo-*`/`X-TanukiKujo-*`/`X-AraigumaKujo-*`/`X-GaichuTech-*`/`X-GaichuDoctor-*`/`X-NekoTaisaku-*`/`X-GaichuMuseum-*`/`X-KabaneKujo-*`/`X-GaichuShiage-*`/`X-KachikuKujo-*` 等 は害機の通知記録 — 送信側が書くことは自称。屋根裏侵入・ハクビシン・アライグマ・コウモリ・ハチの巣駆除・糞尿清掃の偽装は害獣駆除業者なりすましの典型手口。(シロアリ・ゴキブリ等の害虫駆除は pest/facility 機で検出済み)
- **修正**: `Envelope` に `wildlife_marks` + `has_wildlife_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 害印の自署を問え。
