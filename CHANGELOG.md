...
### Security — D707: `X-CallCenterPros-*`/`X-Teleperformance-*`/`X-Kourusenta-*`/`X-Concentrix-*` 等のコールセンター印自称が未検査

- **問題**: `X-CallCenterPros-*`/`X-CallCenterTeam-*`/`X-CallCenterWorks-*`/`X-CallCenterForce-*`/`X-CallCenterNation-*`/`X-CallCenterExperts-*`/`X-CallCenterDoctors-*`/`X-CallCenterMasters-*`/`X-CallCenterSvc-*`/`X-CallCenterHQ-*`/`X-CallCenterYasan-*`/`X-CallCenterMarket-*`/`X-CallCenterPro-*`/`X-CallCenterService-*`/`X-CallCenterWins-*`/`X-CallCenterTech-*`/`X-Teleperformance-*`/`X-Concentrix-*`/`X-Alorica-*`/`X-Sitel-*`/`X-Tdcx-*`/`X-TaskUs-*`/`X-Transcom-*`/`X-BellSystem24-*`/`X-Riraiya-*`/`X-InboundPros-*`/`X-OutboundPros-*`/`X-TeleAgent-*`/`X-TeleSupportPros-*`/`X-ContactCenterTeam-*`/`X-ContactCenterPros-*`/`X-ContactPros-*`/`X-ContactTeam-*`/`X-ContactSupport-*`/`X-CcPros-*`/`X-CcWorks-*`/`X-CcNation-*`/`X-CcExp-*`/`X-CcJP-*`/`X-TeleCenterTeam-*`/`X-SupportTeamPros-*`/`X-CntPros-*`、JP は `X-Kourusenta-*`/`X-DenwaOutsourcing-*`/`X-KouruWorks-*`/`X-KouruTeam-*`/`X-KouruPro-*`/`X-KouruGyo-*`/`X-KouruKensa-*`/`X-KouruManten-*`/`X-KouruJP-*`/`X-KouruSenmon-*`/`X-KouruMitsumori-*`/`X-KouruChousa-*`/`X-KouruTeiki-*`/`X-KouruShuri-*`/`X-DenwaKouru-*` 等 は呼機の通知記録 — 送信側が書くことは自称。コールセンター・テレアポ代行・BPO受託の偽装は、架電代行料・月額委託費・緊急対応費を装ったなりすましの典型手口。(電話代行・秘書代行は answering 機で検出済み)
- **修正**: `Envelope` に `callcenter_marks` + `has_callcenter_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 呼印の自署を問え。

### Security — D708: `X-DisinfectionPros-*`/`X-SterilizePros-*`/`X-Jokin-*`/`X-GermPros-*`/`X-VirusClean-*` 等の除菌・消毒印自称が未検査

- **問題**: `X-DisinfectionPros-*`/`X-DisinfectTeam-*`/`X-DisinfectWorks-*`/`X-DisinfectForce-*`/`X-DisinfectNation-*`/`X-DisinfectExperts-*`/`X-DisinfectDoctors-*`/`X-DisinfectMasters-*`/`X-DisinfectSvc-*`/`X-DisinfectionHQ-*`/`X-SterilizePros-*`/`X-SterilizeTeam-*`/`X-SterilizeWorks-*`/`X-SterilizeExperts-*`/`X-SterilizeDoctors-*`/`X-SanitizeTeam-*`/`X-SanitizePros-*`/`X-GermPros-*`/`X-GermTeam-*`/`X-GermWorks-*`/`X-GermSvc-*`/`X-VirusClean-*`/`X-VirusTeams-*`/`X-VirusCare-*`/`X-GermyDoctors-*`、JP は `X-JoukinPro-*`/`X-Jokin-*`/`X-JokinYasan-*`/`X-JokinPro-*`/`X-JokinTeam-*`/`X-JokinGyo-*`/`X-JokinKensa-*`/`X-JokinManten-*`/`X-JokinNomi-*`/`X-JokinJP-*`/`X-JokinSenmon-*`/`X-JokinMitsumori-*`/`X-JokinChousa-*`/`X-JokinTeiki-*`/`X-JokinShuri-*`/`X-Shoudoku-*`/`X-ShoudokuYasan-*`/`X-ShoudokuPro-*`/`X-ShoudokuTeam-*`/`X-ShoudokuKensa-*`/`X-ShoudokuManten-*`/`X-ShoudokuNomi-*`/`X-ShoudokuJP-*`/`X-ShoudokuSenmon-*` 等 は菌機の通知記録 — 送信側が書くことは自称。除菌・消毒・ウイルス除去作業の偽装は、消毒料金・除染費用・衛生証明手数料を装ったなりすましの典型手口。(清掃一般は cleaning/janitorial 機、カビは mold 機で検出済み)
- **修正**: `Envelope` に `disinfection_marks` + `has_disinfection_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 菌印の自署を問え。

### Security — D709: `X-TscmPros-*`/`X-BugSweepPros-*`/`X-Tochouki-*`/`X-SpySweep-*`/`X-BugDetector-*` 等の盗聴器発見印自称が未検査

- **問題**: `X-TscmPros-*`/`X-TscmTeam-*`/`X-TscmWorks-*`/`X-TscmExperts-*`/`X-TscmSvc-*`/`X-TscmHQ-*`/`X-BugSweepPros-*`/`X-BugSweepTeam-*`/`X-BugSweepWorks-*`/`X-BugDoctors-*`/`X-SpySweep-*`/`X-SpyTeam-*`/`X-SpyWorks-*`/`X-SpyExperts-*`/`X-SpyDoctors-*`/`X-BugSweepCity-*`/`X-BugTeam-*`/`X-BugWorks-*`/`X-BugForce-*`/`X-BugNation-*`/`X-BugExperts-*`/`X-BugMasters-*`/`X-BugSvc-*`/`X-BugHQ-*`/`X-BugPro-*`/`X-SweepPros-*`/`X-SweepTeam-*`/`X-SweepWorks-*`/`X-SweepExperts-*`/`X-SweepDoctors-*`/`X-SweepMasters-*`/`X-BugDetector-*`/`X-ProSweep-*`/`X-EspyPros-*`/`X-CounterSurv-*`/`X-AntiSurveil-*`/`X-EsurveilSweep-*`、JP は `X-TochoukiHakken-*`/`X-Tochouki-*`/`X-TochoukiYasan-*`/`X-TochoukiPro-*`/`X-TochoukiTeam-*`/`X-TochoukiKensa-*`/`X-TochoukiManten-*`/`X-TochoukiNomi-*`/`X-TochoukiJP-*`/`X-TochoukiSenmon-*`/`X-TochoukiDoctors-*`/`X-TochoukiSagyou-*`/`X-TochoukiRescue-*`/`X-TochoukiTeikyu-*`/`X-TochoukiOrder-*`/`X-Toushouki-*`/`X-Toubouki-*`/`X-ToushoukiPro-*`/`X-ToushoukiTeam-*`/`X-ToushoukiKensa-*`/`X-ToushoukiJP-*` 等 は聴機の通知記録 — 送信側が書くことは自称。盗聴器発見・TSCM・カウンターサーベイランスの偽装は、発見調査料・スイープ費用・緊急対応費を装ったなりすましの典型手口。(探偵・興信所は detective 機、警報設置は securitysys 機で検出済み)
- **修正**: `Envelope` に `tscm_marks` + `has_tscm_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 聴印の自署を問え。
