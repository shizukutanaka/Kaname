...
### Security — D686: `X-UnitedRentals-*`/`X-SunbeltRentals-*`/`X-KenkiRental-*`/`X-Aktio-*`/`X-HercRentals-*` 等の建機レンタル印自称が未検査

- **問題**: `X-UnitedRentals-*`/`X-SunbeltRentals-*`/`X-HercRentals-*`/`X-BigRentz-*`/`X-EquipmentShare-*`/`X-RentEquip-*`/`X-EquipmentRental-*`/`X-EquipRental-*`/`X-HeavyRental-*`/`X-MachineryRental-*`/`X-RentalWorks-*`/`X-RentalPros-*`/`X-RentalTeam-*`/`X-EquipmentPros-*`/`X-HeavyEquipRental-*`/`X-ConstructionRental-*`/`X-RentalForce-*`/`X-RentalExperts-*`/`X-RentalDoctors-*`/`X-RentalMasters-*`/`X-EquipmentDoctors-*`、JP は `X-KenkiRental-*`/`X-KenkiYasan-*`/`X-KenkiPro-*`/`X-KenkiTeam-*`/`X-KenkiGyosha-*`/`X-KenkiSeibi-*`/`X-KenkiKensa-*`/`X-KenkiManten-*`/`X-KenkiNomi-*`/`X-KenkiJP-*`/`X-KenkiSenmon-*`/`X-Aktio-*`/`X-AktioRental-*`/`X-NishioRental-*`/`X-KanamotoRental-*`/`X-AkiseiRental-*`/`X-NikkenRental-*`/`X-KoukenRental-*`/`X-KenkiMitsumori-*`/`X-KenkiChousa-*`/`X-KenkiTeiki-*`/`X-KenkiShuri-*`/`X-KenkiDoctors-*`/`X-KenkiSagyou-*`/`X-KenkiRescue-*`/`X-KenkiTeikyu-*`/`X-KenkiOrder-*`/`X-KenkiJuu-*`/`X-KenkiBosyuu-*` 等 は械機の通知記録 — 送信側が書くことは自称。建機・重機レンタル・アクティオ/西尾レントオールの偽装は、レンタル料金・運搬費・破損請求を装った法人なりすましの典型手口。(コマツ製機は industrial、動力工具は diytool、足場は scaffold で検出済み)
- **修正**: `Envelope` に `equiprental_marks` + `has_equiprental_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 械印の自署を問え。

### Security — D687: `X-PortaPotty-*`/`X-PolyJohn-*`/`X-KasetsuToire-*`/`X-UnitedSiteServices-*`/`X-RestroomRental-*` 等の仮設トイレ印自称が未検査

- **問題**: `X-PortaPotty-*`/`X-PortableToilet-*`/`X-PortableJohn-*`/`X-PolyJohn-*`/`X-SatelliteInd-*`/`X-SatelliteSuite-*`/`X-UnitedSiteServices-*`/`X-USSRestrooms-*`/`X-Zters-*`/`X-NationalRental-*`/`X-PortaJohn-*`/`X-HoneyBucket-*`/`X-HoneypotRestroom-*`/`X-PortoSan-*`/`X-Arisal-*`/`X-PortaLet-*`/`X-RestroomRental-*`/`X-RestroomPros-*`/`X-RestroomTrailer-*`/`X-SanitationPros-*`/`X-HandWashStation-*`/`X-PortableLava-*`/`X-RestroomTeam-*`/`X-RestroomWorks-*`、JP は `X-KasetsuToire-*`/`X-ToireSagyou-*`/`X-KasetsuYasan-*`/`X-ToireKouji-*`/`X-ToirePro-*`/`X-ToireTeam-*`/`X-ToireGyosha-*`/`X-ToireSeibi-*`/`X-ToireKensa-*`/`X-ToireManten-*`/`X-ToireNomi-*`/`X-ToireJP-*`/`X-ToireSenmon-*`/`X-ToireSouji-*`/`X-ToireMitsumori-*`/`X-ToireTeiki-*`/`X-KasetsuKouji-*`/`X-KasetsuSeibi-*`/`X-PotaburuToire-*`/`X-ToireChousa-*`/`X-ToireShuri-*`/`X-ToireTeikyu-*` 等 は便機の通知記録 — 送信側が書くことは自称。仮設トイレ・トレーラートイレ・レンタルトイレの偽装は、イベント・建設現場向けレンタル料金詐欺の典型手口。(不用品は junkremoval 機、施設は facility 機で検出済み)
- **修正**: `Envelope` に `portabletoilet_marks` + `has_portabletoilet_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 便印の自署を問え。

### Security — D688: `X-PartyRental-*`/`X-TentRental-*`/`X-IbentoYougu-*`/`X-BounceHouse-*`/`X-WeddingRental-*` 等のイベント用品印自称が未検査

- **問題**: `X-PartyRental-*`/`X-EventRental-*`/`X-PartyRentals-*`/`X-EventRentals-*`/`X-TentRental-*`/`X-TentRentals-*`/`X-BounceHouse-*`/`X-BounceRental-*`/`X-InflatableRental-*`/`X-FunRental-*`/`X-PartyWorks-*`/`X-EventPros-*`/`X-PartyPros-*`/`X-PartyExperts-*`/`X-TentPros-*`/`X-BigTentEvents-*`/`X-ClassicParty-*`/`X-PartyTime-*`/`X-PartyTimeRental-*`/`X-AbbeyRents-*`/`X-WeddingRental-*`/`X-MarqueeRental-*`/`X-StageRental-*`/`X-TableRental-*`/`X-ChairRental-*`/`X-LinenPartyRental-*`/`X-PartyForce-*`/`X-EventDoctors-*`/`X-EventWorks-*`/`X-EventTeam-*`、JP は `X-IbentoYougu-*`/`X-IbentoSagyou-*`/`X-IbentoYasan-*`/`X-IbentoPro-*`/`X-IbentoTeam-*`/`X-IbentoGyosha-*`/`X-IbentoSeibi-*`/`X-IbentoKensa-*`/`X-IbentoManten-*`/`X-IbentoJP-*`/`X-IbentoSenmon-*`/`X-IbentoMitsumori-*`/`X-PatiRental-*`/`X-PatiYasan-*`/`X-Kashidashiya-*`/`X-KashiYasan-*`/`X-TentoYasan-*`/`X-TentoKouji-*`/`X-TentoSeibi-*`/`X-TentoManten-*` 等 は宴機の通知記録 — 送信側が書くことは自称。イベント用品・テント・バウンスハウス・ウェディングレンタルの偽装は、デポジット持ち逃げ・納品不履行詐欺の典型手口。(婚礼は bridal 機、リネンは linenrental 機、チケットは ticket 機で検出済み)
- **修正**: `Envelope` に `partyrental_marks` + `has_partyrental_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 宴印の自署を問え。
