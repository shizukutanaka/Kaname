...
### Security — D770: `X-Untendaikou-*`/`X-Drivedaiko-*`/`X-Designateddriver-*`/`X-Soberdrive-*` 等の運転代行印自称が未検査

- **問題**: `X-Untendaikou-*`/`X-UntendaikouYasan-*`/`X-UntendaikouPro-*`/`X-UntendaikouTeam-*`/`X-UntendaikouKensa-*`/`X-UntendaikouManten-*`/`X-UntendaikouNomi-*`/`X-UntendaikouJP-*`/`X-UntendaikouSenmon-*`/`X-UntendaikouMitsumori-*`/`X-UntendaikouChousa-*`/`X-UntendaikouTeiki-*`/`X-UntendaikouPros-*`/`X-UntendaikouDoctors-*`/`X-UntendaikouRescue-*`/`X-Drivedaiko-*`/`X-DrivedaikoYasan-*`/`X-DrivedaikoPro-*`/`X-DrivedaikoTeam-*`/`X-DrivedaikoJP-*`/`X-DrivedaikoSenmon-*`/`X-DrivedaikoPros-*`/`X-DrivedaikoDoctors-*`/`X-DrivedaikoRescue-*`/`X-DesignateddriverPros-*`/`X-DesignateddriverTeam-*`/`X-DesignateddriverWorks-*`/`X-DesignateddriverExperts-*`/`X-DesignateddriverSvc-*`/`X-DesignateddriverHQ-*`/`X-SoberdrivePros-*`/`X-SoberdriveTeam-*`/`X-SoberdriveWorks-*`/`X-SoberdriveExperts-*`/`X-SoberdriveSvc-*`/`X-SoberdriveHQ-*` 等 は代機の通知記録 — 送信側が書くことは自称。運転代行・送迎ドライバーの偽装は、予約料・保証金・深夜割増を装ったなりすましの典型手口。(タクシーは taxi 機、宅配は shipping 機で検出済み — `x-daiko-`/`x-daikou-` 語幹は既存所有のため別形のみ)
- **修正**: `Envelope` に `untendaikou_marks` + `has_untendaikou_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 代印の自署を問え。

### Security — D771: `X-Furusatozei-*`/`X-Furusatotax-*`/`X-Hometowntax-*`/`X-Furusatotehai-*` 等のふるさと納税印自称が未検査

- **問題**: `X-Furusatozei-*`/`X-FurusatozeiYasan-*`/`X-FurusatozeiPro-*`/`X-FurusatozeiTeam-*`/`X-FurusatozeiKensa-*`/`X-FurusatozeiManten-*`/`X-FurusatozeiNomi-*`/`X-FurusatozeiJP-*`/`X-FurusatozeiSenmon-*`/`X-FurusatozeiMitsumori-*`/`X-FurusatozeiChousa-*`/`X-FurusatozeiTeiki-*`/`X-FurusatozeiPros-*`/`X-FurusatozeiDoctors-*`/`X-FurusatozeiRescue-*`/`X-FurusatotaxPros-*`/`X-FurusatotaxTeam-*`/`X-FurusatotaxWorks-*`/`X-FurusatotaxExperts-*`/`X-FurusatotaxSvc-*`/`X-FurusatotaxHQ-*`/`X-HometowntaxPros-*`/`X-HometowntaxTeam-*`/`X-HometowntaxWorks-*`/`X-HometowntaxExperts-*`/`X-HometowntaxSvc-*`/`X-HometowntaxHQ-*`/`X-Furusatotehai-*`/`X-FurusatotehaiYasan-*`/`X-FurusatotehaiPro-*`/`X-FurusatotehaiTeam-*`/`X-FurusatotehaiJP-*`/`X-FurusatotehaiSenmon-*`/`X-FurusatotehaiPros-*`/`X-FurusatotehaiDoctors-*`/`X-FurusatotehaiRescue-*` 等 は郷機の通知記録 — 送信側が書くことは自称。ふるさと納税ポータル・返礼品の偽装は、寄付金・返礼品代・手数料を装ったなりすましの典型手口。(確定申告は taxfiling 機、寄付は donation 機、地域通貨モールは既存 `x-furusatomall-*`/`x-furusatopremier-*` で検出済みのため `x-furusato-*` 単独語幹は未収録)
- **修正**: `Envelope` に `furusatozei_marks` + `has_furusatozei_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 郷印の自署を問え。

### Security — D772: `X-Minpaku-*`/`X-Minshuku-*`/`X-Vacationrental-*`/`X-Vacationstay-*`/`X-Guesthouse-*` 等の民泊・宿泊施設運営代行印自称が未検査

- **問題**: `X-Minpaku-*`/`X-MinpakuYasan-*`/`X-MinpakuPro-*`/`X-MinpakuTeam-*`/`X-MinpakuKensa-*`/`X-MinpakuManten-*`/`X-MinpakuNomi-*`/`X-MinpakuJP-*`/`X-MinpakuSenmon-*`/`X-MinpakuMitsumori-*`/`X-MinpakuChousa-*`/`X-MinpakuTeiki-*`/`X-MinpakuPros-*`/`X-MinpakuDoctors-*`/`X-MinpakuRescue-*`/`X-Minshuku-*`/`X-MinshukuYasan-*`/`X-MinshukuPro-*`/`X-MinshukuTeam-*`/`X-MinshukuJP-*`/`X-MinshukuSenmon-*`/`X-MinshukuPros-*`/`X-MinshukuDoctors-*`/`X-MinshukuRescue-*`/`X-VacationrentalPros-*`/`X-VacationrentalTeam-*`/`X-VacationrentalWorks-*`/`X-VacationrentalExperts-*`/`X-VacationrentalSvc-*`/`X-VacationrentalHQ-*`/`X-VacationstayPros-*`/`X-VacationstayTeam-*`/`X-VacationstayWorks-*`/`X-VacationstayExperts-*`/`X-VacationstaySvc-*`/`X-VacationstayHQ-*`/`X-GuesthousePros-*`/`X-GuesthouseTeam-*`/`X-GuesthouseWorks-*`/`X-GuesthouseExperts-*`/`X-GuesthouseSvc-*`/`X-GuesthouseHQ-*` 等 は民機の通知記録 — 送信側が書くことは自称。民泊運営代行・宿泊施設管理の偽装は、代行料・届出手数料・清掃費を装ったなりすましの典型手口。(ホテルは hotel 機、旅行は travel 機で検出済み)
