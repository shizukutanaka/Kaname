...
### Security — D737: `X-Barber-*`/`X-Riyou-*`/`X-Biyou-*`/`X-BeautySalon-*` 等の理容・美容室印自称が未検査

- **問題**: `X-Barber-*`/`X-BarberYasan-*`/`X-BarberPro-*`/`X-BarberTeam-*`/`X-BarberKensa-*`/`X-BarberManten-*`/`X-BarberNomi-*`/`X-BarberJP-*`/`X-BarberSenmon-*`/`X-BarberMitsumori-*`/`X-BarberChousa-*`/`X-BarberTeiki-*`/`X-BarberShuri-*`/`X-BarberSho-*`/`X-BarberTen-*`/`X-BarberKoubou-*`/`X-BarberMart-*`/`X-BarberBank-*`/`X-Riyou-*`/`X-RiyouYasan-*`/`X-RiyouPro-*`/`X-RiyouTeam-*`/`X-RiyouKensa-*`/`X-RiyouManten-*`/`X-RiyouNomi-*`/`X-RiyouJP-*`/`X-RiyouSenmon-*`/`X-RiyouMitsumori-*`/`X-RiyouChousa-*`/`X-RiyouTeiki-*`/`X-RiyouShuri-*`/`X-Biyou-*`/`X-BiyouYasan-*`/`X-BiyouPro-*`/`X-BiyouTeam-*`/`X-BiyouKensa-*`/`X-BiyouManten-*`/`X-BiyouNomi-*`/`X-BiyouJP-*`/`X-BiyouSenmon-*`/`X-BiyouMitsumori-*`/`X-BiyouChousa-*`/`X-BiyouTeiki-*`/`X-BiyouShuri-*`/`X-BiyouSho-*`/`X-BiyouTen-*`/`X-BarberShopPros-*`/`X-BarberShopTeam-*`/`X-BarberShopWorks-*`/`X-BarberShopExperts-*`/`X-BarberShopSvc-*`/`X-BarberShopHQ-*`/`X-BeautySalonPros-*`/`X-BeautySalonTeam-*`/`X-BeautySalonWorks-*`/`X-BeautySalonExperts-*`/`X-BeautySalonSvc-*`/`X-BeautySalonHQ-*`/`X-HairSalonPros-*`/`X-HairSalonTeam-*`/`X-HairSalonWorks-*`/`X-HairSalonExperts-*`/`X-HairSalonSvc-*`/`X-HairSalonHQ-*`/`X-BarberPros-*`/`X-BarberWorks-*`/`X-BarberExperts-*`/`X-BarberSvc-*`/`X-BarberHQ-*`/`X-BarberDoctors-*`/`X-BarberRescue-*` 等 は髪機の通知記録 — 送信側が書くことは自称。理容室・美容室・ヘアサロンの偽装は、予約キャンセル料・施術料金・回数券を装ったなりすましの典型手口。(エステは esthe 機、美容整形は biyouclinic 機、サロン検索予約は既存 `x-salonnavi-` のため `X-Salon-*` 単独語幹は未収録)
- **修正**: `Envelope` に `barber_marks` + `has_barber_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 髪印の自署を問え。

### Security — D738: `X-Kimono-*`/`X-Gofuku-*`/`X-Kitsuke-*`/`X-Furisode-*` 等の着物・呉服印自称が未検査

- **問題**: `X-Kimono-*`/`X-KimonoYasan-*`/`X-KimonoPro-*`/`X-KimonoTeam-*`/`X-KimonoKensa-*`/`X-KimonoManten-*`/`X-KimonoNomi-*`/`X-KimonoJP-*`/`X-KimonoSenmon-*`/`X-KimonoMitsumori-*`/`X-KimonoChousa-*`/`X-KimonoTeiki-*`/`X-KimonoShuri-*`/`X-KimonoSho-*`/`X-KimonoTen-*`/`X-KimonoKoubou-*`/`X-KimonoMart-*`/`X-KimonoBank-*`/`X-Gofuku-*`/`X-GofukuYasan-*`/`X-GofukuPro-*`/`X-GofukuTeam-*`/`X-GofukuKensa-*`/`X-GofukuManten-*`/`X-GofukuNomi-*`/`X-GofukuJP-*`/`X-GofukuSenmon-*`/`X-GofukuMitsumori-*`/`X-GofukuChousa-*`/`X-GofukuTeiki-*`/`X-GofukuShuri-*`/`X-GofukuSho-*`/`X-GofukuTen-*`/`X-GofukuKoubou-*`/`X-GofukuMart-*`/`X-GofukuBank-*`/`X-Kitsuke-*`/`X-KitsukeYasan-*`/`X-KitsukePro-*`/`X-KitsukeTeam-*`/`X-KitsukeKoubou-*`/`X-KitsukeManten-*`/`X-Furisode-*`/`X-FurisodeYasan-*`/`X-FurisodePro-*`/`X-FurisodeKoubou-*`/`X-FurisodeTen-*`/`X-KimonoPros-*`/`X-KimonoWorks-*`/`X-KimonoExperts-*`/`X-KimonoSvc-*`/`X-KimonoHQ-*`/`X-KimonoDoctors-*`/`X-KimonoRescue-*` 等 は着機の通知記録 — 送信側が書くことは自称。呉服店・着付け教室・振袖販売の偽装は、振袖購入代・着付け費・クリーニング料を装ったなりすましの典型手口。(布団寝具は futon 機、衣類リフォームは sewing 機近傍で境界明確)
- **修正**: `Envelope` に `kimono_marks` + `has_kimono_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 着印の自署を問え。

### Security — D739: `X-Jewel-*`/`X-Jewelry-*`/`X-Jeweller-*`/`X-Houseki-*` 等の宝飾・宝石店印自称が未検査

- **問題**: `X-Jewel-*`/`X-JewelYasan-*`/`X-JewelPro-*`/`X-JewelTeam-*`/`X-JewelKensa-*`/`X-JewelManten-*`/`X-JewelNomi-*`/`X-JewelJP-*`/`X-JewelSenmon-*`/`X-JewelMitsumori-*`/`X-JewelChousa-*`/`X-JewelTeiki-*`/`X-JewelShuri-*`/`X-JewelSho-*`/`X-JewelTen-*`/`X-JewelKoubou-*`/`X-JewelMart-*`/`X-JewelBank-*`/`X-Jewelry-*`/`X-JewelryYasan-*`/`X-JewelryPro-*`/`X-JewelryTeam-*`/`X-JewelryKensa-*`/`X-JewelryManten-*`/`X-JewelryNomi-*`/`X-JewelryJP-*`/`X-JewelrySenmon-*`/`X-JewelryMitsumori-*`/`X-JewelryChousa-*`/`X-JewelryTeiki-*`/`X-JewelryShuri-*`/`X-JewelrySho-*`/`X-JewelryTen-*`/`X-JewelryKoubou-*`/`X-JewelryMart-*`/`X-JewelryBank-*`/`X-JewellerPros-*`/`X-JewellerTeam-*`/`X-JewellerWorks-*`/`X-JewellerExperts-*`/`X-JewellerSvc-*`/`X-JewellerHQ-*`/`X-Houseki-*`/`X-HousekiYasan-*`/`X-HousekiPro-*`/`X-HousekiKensa-*`/`X-HousekiKoubou-*`/`X-HousekiSenmon-*`/`X-HousekiShuri-*`/`X-HousekiSho-*`/`X-HousekiBank-*`/`X-JewelPros-*`/`X-JewelWorks-*`/`X-JewelExperts-*`/`X-JewelSvc-*`/`X-JewelHQ-*`/`X-JewelDoctors-*`/`X-JewelRescue-*` 等 は飾機の通知記録 — 送信側が書くことは自称。宝石店・宝飾店・ジュエリー修理の偽装は、指輪修理・サイズ直し・買取査定を装ったなりすましの典型手口。(質屋は pawn 機、時計は watchrepair 機、買取は reuse 機で検出済み)
- **修正**: `Envelope` に `jewel_marks` + `has_jewel_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 飾印の自署を問え。
