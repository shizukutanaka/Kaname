...
### Security — D719: `X-Kutsu-*`/`X-ShoeRepairPros-*`/`X-Cobblers-*`/`X-MisterMinit-*` 等の靴修理印自称が未検査

- **問題**: `X-Kutsu-*`/`X-KutsuYasan-*`/`X-KutsuPro-*`/`X-KutsuTeam-*`/`X-KutsuKensa-*`/`X-KutsuManten-*`/`X-KutsuNomi-*`/`X-KutsuJP-*`/`X-KutsuSenmon-*`/`X-KutsuMitsumori-*`/`X-KutsuChousa-*`/`X-KutsuTeiki-*`/`X-KutsuShuriya-*`/`X-KutsuRescue-*`/`X-KutsuDoctors-*`/`X-KutsuSagyou-*`/`X-KutsuTeikyu-*`/`X-KutsuOrder-*`/`X-KutsuKoubou-*`/`X-KutsuBank-*`/`X-KutsuShuri-*`/`X-MisterMinit-*`/`X-ShoeRepairPros-*`/`X-ShoeRepairTeam-*`/`X-ShoeRepairWorks-*`/`X-ShoeRepairForce-*`/`X-ShoeRepairNation-*`/`X-ShoeRepairExperts-*`/`X-ShoeRepairDoctors-*`/`X-ShoeRepairMasters-*`/`X-ShoeRepairSvc-*`/`X-ShoeRepairHQ-*`/`X-CobblersPros-*`/`X-CobblerTeam-*`/`X-CobblerWorks-*`/`X-CobblerExperts-*`/`X-CobblerDoctors-*`/`X-CobblerSvc-*`/`X-CobblerHQ-*`/`X-CobblerBank-*`/`X-CobblerMart-*`/`X-CobblerSho-*`/`X-CobblerTen-*`/`X-ShoePros-*`/`X-ShoeTeam-*`/`X-ShoeWorks-*`/`X-ShoeHQ-*` 等 は靴機の通知記録 — 送信側が書くことは自称。靴修理・コブラー・ミスターミニットの偽装は、修理料金・合鍵作成費・シューケア用品を装ったなりすましの典型手口。(靴クリーニングは cleaning 機、鍵屋は locksmith 機で検出済み)
- **修正**: `Envelope` に `shoerepair_marks` + `has_shoerepair_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 靴印の自署を問え。

### Security — D720: `X-Sagyoufuku-*`/`X-WorkwearPros-*`/`X-UniformWorks-*`/`X-AnzenGutsu-*` 等の作業服印自称が未検査

- **問題**: `X-Sagyoufuku-*`/`X-Sagyougi-*`/`X-SagyouYasan-*`/`X-SagyouPro-*`/`X-SagyouTeam-*`/`X-SagyouKensa-*`/`X-SagyouManten-*`/`X-SagyouNomi-*`/`X-SagyouJP-*`/`X-SagyouSenmon-*`/`X-SagyouMitsumori-*`/`X-SagyouChousa-*`/`X-SagyouTeiki-*`/`X-SagyouShuri-*`/`X-SagyouDoctors-*`/`X-SagyouRescue-*`/`X-SagyouTeikyu-*`/`X-SagyouOrder-*`/`X-WorkwearPros-*`/`X-WorkwearTeam-*`/`X-WorkwearWorks-*`/`X-WorkwearForce-*`/`X-WorkwearNation-*`/`X-WorkwearExperts-*`/`X-WorkwearDoctrs-*`/`X-WorkwearMasters-*`/`X-WorkwearSvc-*`/`X-WorkwearHQ-*`/`X-UniformPros-*`/`X-UniformTeam-*`/`X-UniformWorks-*`/`X-UniformExperts-*`/`X-UniformSvc-*`/`X-UniformHQ-*`/`X-UniformMart-*`/`X-UniformBank-*`/`X-AnzenGutsu-*`/`X-AnzenYasan-*`/`X-AnzenPro-*`/`X-AnzenTeam-*`/`X-AnzenKensa-*`/`X-AnzenManten-*`/`X-AnzenNomi-*`/`X-AnzenJP-*`/`X-AnzenSenmon-*`/`X-AnzenMitsumori-*`/`X-WorkmanShop-*`/`X-JogaWear-*`/`X-Kuchofuku-*`/`X-TsuuWear-*` 等 は作機の通知記録 — 送信側が書くことは自称。作業服・ワークウェア・安全靴店の偽装は、制服発注・安全靴購入・空調服販売を装ったなりすましの典型手口。(リネンサプライは linenrental 機、工具は diytool 機で検出済み)
- **修正**: `Envelope` に `workwear_marks` + `has_workwear_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 作印の自署を問え。

### Security — D721: `X-FukushiYougu-*`/`X-KaigoYougu-*`/`X-Kurumaisu-*`/`X-WelfarePros-*` 等の福祉用具印自称が未検査

- **問題**: `X-FukushiYougu-*`/`X-FukushiYasan-*`/`X-FukushiPro-*`/`X-FukushiTeam-*`/`X-FukushiKensa-*`/`X-FukushiManten-*`/`X-FukushiNomi-*`/`X-FukushiJP-*`/`X-FukushiSenmon-*`/`X-FukushiMitsumori-*`/`X-FukushiChousa-*`/`X-FukushiTeiki-*`/`X-FukushiShuri-*`/`X-FukushiRental-*`/`X-KaigoYougu-*`/`X-KaigoYasan-*`/`X-KaigoPro-*`/`X-KaigoTeam-*`/`X-KaigoKensa-*`/`X-KaigoManten-*`/`X-KaigoJP-*`/`X-KaigoSenmon-*`/`X-KaigoMitsumori-*`/`X-KaigoChousa-*`/`X-KaigoTeiki-*`/`X-KaigoShuri-*`/`X-KaigoRental-*`/`X-KaigoBed-*`/`X-Kurumaisu-*`/`X-KurumaisuYasan-*`/`X-KurumaisuPro-*`/`X-KurumaisuKensa-*`/`X-KurumaisuManten-*`/`X-KurumaisuNomi-*`/`X-KurumaisuJP-*`/`X-KurumaisuSenmon-*`/`X-KurumaisuMitsumori-*`/`X-KurumaisuChousa-*`/`X-KurumaisuTeiki-*`/`X-KurumaisuShuri-*`/`X-KurumaisuRental-*`/`X-WelfarePros-*`/`X-WelfareTeam-*`/`X-WelfareWorks-*`/`X-WelfareExperts-*`/`X-WelfareDoctors-*`/`X-WelfareSvc-*`/`X-WelfareHQ-*`/`X-CareEquipment-*`/`X-CareRental-*` 等 は福機の通知記録 — 送信側が書くことは自称。福祉用具・介護用品・車椅子レンタルの偽装は、介護ベッドレンタル料・車椅子販売・手すり設置費を装ったなりすましの典型手口。(介護サービスは eldercare 機、医療機器は medical 機で検出済み)
