...
### Security — D704: `X-MspService-*`/`X-ConnectWise-*`/`X-ItMainte-*`/`X-Kaseya-*`/`X-OpsPros-*` 等のMSP・IT運用保守印自称が未検査

- **問題**: `X-MspService-*`/`X-MspPros-*`/`X-MspTeam-*`/`X-MspWorks-*`/`X-MspForce-*`/`X-MspNation-*`/`X-MspExperts-*`/`X-MspDoctors-*`/`X-MspMasters-*`/`X-MspSvc-*`/`X-MspHQ-*`/`X-ConnectWise-*`/`X-Kaseya-*`/`X-Datto-*`/`X-NinjaOne-*`/`X-Atera-*`/`X-Syncro-*`/`X-HaloPsa-*`/`X-Nable-*`/`X-Liongard-*`/`X-Auvik-*`/`X-BarracudaMsp-*`/`X-PulseRobot-*`/`X-ItmSvc-*`/`X-ItserviceGyo-*`/`X-ItKanri-*`/`X-ItSupportPros-*`/`X-ItMainte-*`/`X-SysKanri-*`/`X-SystemKanri-*`/`X-KanriMainte-*`/`X-InfotechSvc-*`/`X-Itsoumu-*`/`X-Itsolu-*`/`X-TechSup-*`/`X-NmsPros-*`/`X-OpsPros-*`/`X-ItUnei-*`/`X-SystemUnei-*`/`X-InfraUnei-*`/`X-UneiIt-*`/`X-MspJapan-*`/`X-ItmsJp-*`/`X-JohoOps-*`/`X-SysUnei-*`/`X-UneiKoutsuu-*`/`X-ItUneiOps-*`/`X-ItKanriService-*`/`X-MsProsJp-*` 等 は運機の通知記録 — 送信側が書くことは自称。MSP・IT運用保守・RMMベンダーの偽装は、保守料金・監視費用・緊急対応費を装ったなりすましの典型手口。(監視OSSは monitoring 機、SaaS一般は saas 機で検出済み)
- **修正**: `Envelope` に `msp_marks` + `has_msp_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 運印の自署を問え。

### Security — D705: `X-WasteHauling-*`/`X-RepublicSvc-*`/`X-Haikibutsu-*`/`X-WastePros-*`/`X-GflEnv-*` 等の廃棄物収集印自称が未検査

- **問題**: `X-WasteHauling-*`/`X-WasteCollection-*`/`X-WasteHauler-*`/`X-WasteTeam-*`/`X-WastePros-*`/`X-WasteWorks-*`/`X-WasteCity-*`/`X-WasteForce-*`/`X-WasteNation-*`/`X-WasteService-*`/`X-WasteSvc-*`/`X-WasteExperts-*`/`X-WasteDoctors-*`/`X-WasteMasters-*`/`X-WasteCo-*`/`X-RepublicSvc-*`/`X-GflEnv-*`/`X-WasteConn-*`/`X-Rumpke-*`/`X-Casella-*`/`X-Recology-*`/`X-Marborg-*`/`X-BfiWaste-*`/`X-ServiceSanitation-*`/`X-TrashTeam-*`/`X-HaulPros-*`/`X-HaulIt-*`/`X-HaulingPros-*`/`X-JunkHaulerDump-*`、JP は `X-SangyouHaikibutsu-*`/`X-Haikibutsu-*`/`X-HaikibutsuYasan-*`/`X-HaikibutsuPro-*`/`X-HaikibutsuTeam-*`/`X-HaikibutsuGyo-*`/`X-HaikibutsuKensa-*`/`X-HaikibutsuManten-*`/`X-HaikibutsuNomi-*`/`X-HaikibutsuJP-*`/`X-HaikibutsuSenmon-*`/`X-HaikibutsuChousa-*`/`X-HaikibutsuTeiki-*`/`X-HaikibutsuShuri-*`/`X-GomiShuushuu-*`/`X-GomiYasan-*`/`X-GomiHiki-*`/`X-HaikibutsuRescue-*`/`X-HaikibutsuDoctors-*`/`X-HaikibutsuSagyou-*`/`X-HaikibutsuTeikyu-*`/`X-HaikibutsuOrder-*`/`X-SangyouHaiki-*` 等 は廃機の通知記録 — 送信側が書くことは自称。廃棄物収集・産業廃棄物処理・ゴミ収集の偽装は、収集料金・処分費用・マニフェスト手数料を装ったなりすましの典型手口。(不用品回収は junkremoval 機、金属買取は reuse 機で検出済み)
- **修正**: `Envelope` に `wastehauling_marks` + `has_wastehauling_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 廃印の自署を問え。

### Security — D706: `X-Joseikin-*`/`X-GrantPros-*`/`X-Hojokin-*`/`X-SubsidyPros-*`/`X-GrantConsulting-*` 等の助成金・補助金印自称が未検査

- **問題**: `X-Joseikin-*`/`X-Hojokin-*`/`X-SubsidyPros-*`/`X-SubsidyTeam-*`/`X-SubsidyWorks-*`/`X-SubsidyExperts-*`/`X-SubsidyDoctors-*`/`X-SubsidyHQ-*`/`X-SubsidySvc-*`/`X-SubsidyConsult-*`/`X-GrantPros-*`/`X-GrantTeam-*`/`X-GrantWorks-*`/`X-GrantExperts-*`/`X-GrantDoctors-*`/`X-GrantMasters-*`/`X-GrantNation-*`/`X-GrantForce-*`/`X-GrantHQ-*`/`X-GrantSvc-*`/`X-GrantWriting-*`/`X-GrantWriter-*`/`X-GrantConsulting-*`/`X-JGrants-*`/`X-HojokinNavi-*`/`X-JoseikinNavi-*`/`X-SeidoKensa-*`/`X-HojokinPro-*`/`X-HojokinTeam-*`/`X-HojokinGyo-*`/`X-HojokinKensa-*`/`X-HojokinManten-*`/`X-HojokinJP-*`/`X-HojokinSenmon-*`/`X-HojokinMitsumori-*`/`X-HojokinChousa-*`/`X-HojokinTeiki-*`/`X-HojokinShuri-*`/`X-HojokinDoctors-*`/`X-HojokinSagyou-*`/`X-HojokinRescue-*`/`X-HojokinTeikyu-*`/`X-HojokinOrder-*`/`X-HojokinShinsei-*`/`X-JoseikinPro-*`/`X-JoseikinTeam-*`/`X-JoseikinGyo-*`/`X-JoseikinJP-*`/`X-JoseikinSenmon-*`/`X-JoseikinMitsumori-*`/`X-JoseikinChousa-*`/`X-JoseikinTeiki-*`/`X-JoseikinShuri-*`/`X-JoseikinDoctors-*`/`X-JoseikinSagyou-*`/`X-JoseikinRescue-*`/`X-JoseikinTeikyu-*`/`X-JoseikinOrder-*` 等 は助機の通知記録 — 送信側が書くことは自称。助成金・補助金・グラント申請代行の偽装は、申請代行料・成功報酬・審査費用を装ったなりすましの典型手口。(行政書士は legal 機、税務申告は taxfiling 機で検出済み)
- **修正**: `Envelope` に `subsidy_marks` + `has_subsidy_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 助印の自署を問え。
