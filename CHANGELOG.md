...
### Security — D701: `X-SecuritySys-*`/`X-AdtPulse-*`/`X-Keihou-*`/`X-AlarmPros-*`/`X-Bohan-*` 等の警報システム印自称が未検査

- **問題**: `X-SecuritySys-*`/`X-AlarmPros-*`/`X-AlarmWorks-*`/`X-AlarmTeam-*`/`X-AlarmService-*`/`X-AlarmForce-*`/`X-AlarmNation-*`/`X-AlarmExperts-*`/`X-AlarmDoctors-*`/`X-AlarmMasters-*`/`X-AlarmInstall-*`/`X-AlarmTech-*`/`X-AlarmSvc-*`/`X-AdtPulse-*`/`X-VivintSmart-*`/`X-SimpliSafeSec-*`/`X-FrontpointSe-*`/`X-LinkInteractive-*`/`X-Monitronic-*`/`X-ProtectionOne-*`/`X-BrinksHome-*`/`X-HomeSecurity-*`/`X-HomeSecPros-*`/`X-HomeSecCity-*`/`X-BurglarAlarm-*`/`X-Intrusion-*`/`X-CctvCamera-*`/`X-CameraSetsubi-*`/`X-SecurityAlarm-*`、JP は `X-Keihou-*`/`X-KeihouYasan-*`/`X-KeihouKouji-*`/`X-KeihouPro-*`/`X-KeihouTeam-*`/`X-KeihouGyosha-*`/`X-KeihouSeibi-*`/`X-KeihouKensa-*`/`X-KeihouManten-*`/`X-KeihouNomi-*`/`X-KeihouJP-*`/`X-KeihouSenmon-*`/`X-KeihouMitsumori-*`/`X-KeihouChousa-*`/`X-KeihouTeiki-*`/`X-KeihouShuri-*`/`X-Bohan-*`/`X-BohanYasan-*`/`X-BohanKouji-*`/`X-BohanPro-*`/`X-BohanTeam-*`/`X-BohanGyosha-*`/`X-BohanSeibi-*`/`X-BohanKensa-*`/`X-BohanManten-*` 等 は警機の通知記録 — 送信側が書くことは自称。警報システム・防犯カメラ設置・ホームセキュリティの偽装は、設置料金・監視料金・機器費用を装ったなりすましの典型手口。(警備会社は facility 機、消防設備は fireprotect 機、監視 SaaS は monitoring 機で検出済み)
- **修正**: `Envelope` に `securitysys_marks` + `has_securitysys_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 警印の自署を問え。

### Security — D702: `X-DebtCollection-*`/`X-CollectionAgency-*`/`X-Saiken-*`/`X-SkipTracing-*`/`X-CreditCollect-*` 等の債権回収印自称が未検査

- **問題**: `X-DebtCollection-*`/`X-CollectionAgency-*`/`X-CollectionPros-*`/`X-CollectionService-*`/`X-CollectionTeam-*`/`X-CollectionWorks-*`/`X-CollectionExperts-*`/`X-CollectionDoctors-*`/`X-CollectionMasters-*`/`X-CollectionForce-*`/`X-CollectionNation-*`/`X-CollectionHQ-*`/`X-CreditCollect-*`/`X-CollectionSvc-*`/`X-DebtCollect-*`/`X-DebtSvc-*`/`X-DebtRecoveryPros-*`/`X-ReceivablesPros-*`/`X-ReceivableService-*`/`X-ArPros-*`/`X-SkiptPros-*`/`X-SkipTracing-*`/`X-DebtorService-*`/`X-DebtSolutionSvc-*`/`X-CollectorPros-*`、JP は `X-Saiken-*`/`X-SaikenKaishuu-*`/`X-SaikenYasan-*`/`X-SaikenPro-*`/`X-SaikenTeam-*`/`X-SaikenGyosha-*`/`X-SaikenSeibi-*`/`X-SaikenKensa-*`/`X-SaikenManten-*`/`X-SaikenNomi-*`/`X-SaikenJP-*`/`X-SaikenSenmon-*`/`X-SaikenMitsumori-*`/`X-SaikenChousa-*`/`X-SaikenTeiki-*`/`X-SaikenShuri-*`/`X-SaikenDoctors-*`/`X-SaikenSagyou-*`/`X-SaikenRescue-*`/`X-SaikenTeikyu-*`/`X-SaikenOrder-*`/`X-SaikenJuu-*`/`X-SaikenBosyuu-*` 等 は収機の通知記録 — 送信側が書くことは自称。債権回収・コレクションエージェンシー・スキップトレースの偽装は、滞納請求・回収手数料・差押予告を装ったなりすましの典型手口。(債務整理は debtrelief 機、金融機関は bank 機で検出済み)
- **修正**: `Envelope` に `debtcollection_marks` + `has_debtcollection_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 収印の自署を問え。

### Security — D703: `X-Checkr-*`/`X-Sterling-*`/`X-MimotoChousa-*`/`X-HireRight-*`/`X-TenantScreen-*` 等の身元調査印自称が未検査

- **問題**: `X-Checkr-*`/`X-Sterling-*`/`X-HireRight-*`/`X-GoodHire-*`/`X-AccurateBg-*`/`X-Certn-*`/`X-SterlingCheck-*`/`X-TransunionScreen-*`/`X-TenantSmart-*`/`X-RentSpree-*`/`X-BackgroundScreen-*`/`X-EmploymentScreen-*`/`X-TenantScreen-*`/`X-ScreeningPros-*`/`X-ScreeningService-*`/`X-ScreeningTeam-*`/`X-ScreeningWorks-*`/`X-ScreeningExperts-*`/`X-ScreeningDoctors-*`/`X-ScreeningMasters-*`/`X-ScreeningForce-*`/`X-ScreeningNation-*`/`X-ScreeningHQ-*`/`X-BgvPros-*`/`X-BgCheckPros-*`/`X-BackCheckPros-*`、JP は `X-SaiyouChousa-*`/`X-Saiyou-*`/`X-MimotoChousa-*`/`X-Mimoto-*`/`X-MimotoYasan-*`/`X-MimotoPro-*`/`X-MimotoTeam-*`/`X-MimotoGyo-*`/`X-MimotoKensa-*`/`X-MimotoManten-*`/`X-MimotoNmi-*`/`X-MimotoJP-*`/`X-MimotoSenmon-*`/`X-MimotoMitsumori-*`/`X-MimotoTeiki-*`/`X-MimotoShuri-*`/`X-MimotoDoctors-*`/`X-MimotoSagyou-*`/`X-MimotoRescue-*`/`X-MimotoTeikyu-*`/`X-MimotoOrder-*`/`X-NyuukyoShinsa-*`/`X-SaiyouKensa-*` 等 は身機の通知記録 — 送信側が書くことは自称。採用調査・入居審査・バックグラウンドチェックの偽装は、審査料金・調査費用・追加レポート料を装ったなりすましの典型手口。(探偵・興信所は detective 機、求人媒体は jobs 機、信用調査は credit 機で検出済み)
- **修正**: `Envelope` に `screening_marks` + `has_screening_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 身印の自署を問え。
