...
### Security — D767: `X-3Dprinter-*`/`X-Bambulab-*`/`X-Ender-*` 等の3Dプリンタ・フィラメント印自称が未検査

- **問題**: `X-3Dprinter-*`/`X-Bambulab-*`/`X-Ender-*`/`X-Voron-*`/`X-Phrozen-*`/`X-Filament-*`/`X-Snapmaker-*`/`X-Qidi-*`/`X-Sovol-*`/`X-Artillery-*`/`X-3Dprinternavi-*`/`X-3Dprintercenter-*`/`X-3Dprintershop-*`/`X-3Dprinterpro-*`/`X-3Dprintermart-*`/`X-3Dprinterplus-*`/`X-3Dprintersmart-*`/`X-3Dprinterfamily-*`/`X-Bambulabnavi-*`/`X-Bambulabcenter-*`/`X-Bambulabshop-*`/`X-Bambulabpro-*`/`X-Bambulabmart-*`/`X-Bambulabplus-*`/`X-Bambulabsmart-*`/`X-Bambulabfamily-*`/`X-Endernavi-*`/`X-Endercenter-*`/`X-Endershop-*`/`X-Enderpro-*`/`X-Endermart-*`/`X-Enderplus-*`/`X-Endersmart-*`/`X-Enderfamily-*`/`X-Voronnavi-*`/`X-Voroncenter-*`/`X-Voronshop-*`/`X-Voronpro-*`/`X-Voronmart-*`/`X-Voronplus-*`/`X-Voronsmart-*`/`X-Voronfamily-*`/`X-Phrozennavi-*`/`X-Phrozencenter-*`/`X-Phrozenshop-*`/`X-Phrozenpro-*`/`X-Phrozenmart-*`/`X-Phrozenplus-*`/`X-Phrozensmart-*`/`X-Phrozenfamily-*`/`X-Filamentnavi-*`/`X-Filamentcenter-*`/`X-Filamentshop-*`/`X-Filamentpro-*`/`X-Filamentmart-*`/`X-Filamentplus-*`/`X-Filamentsmart-*`/`X-Filamentfamily-*`/`X-Snapmakernavi-*`/`X-Snapmakercenter-*`/`X-Snapmakershop-*`/`X-Snapmakerpro-*` 等 は造機の通知記録 — 送信側が書くことは自称。中古プリンタ・フィラメント特売・キット割引の偽装は3Dプリンタ詐欺の典型手口。(開発機は D500)
- **修正**: `Envelope` に `printer3d_marks` + `has_3dprinter_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 造印の自署を問え。

### Security — D768: `X-Vocaloid-*`/`X-Synthv-*`/`X-Cevio-*` 等の音声合成・歌声ライブラリ印自称が未検査

- **問題**: `X-Vocaloid-*`/`X-Synthv-*`/`X-Cevio-*`/`X-Voiceroid-*`/`X-Utau-*`/`X-Voisona-*`/`X-Voidol-*`/`X-Ahsoft-*`/`X-Vocaloidnavi-*`/`X-Vocaloidcenter-*`/`X-Vocaloidshop-*`/`X-Vocaloidpro-*`/`X-Vocaloidmart-*`/`X-Vocaloidplus-*`/`X-Vocaloidsmart-*`/`X-Vocaloidfamily-*`/`X-Synthvnavi-*`/`X-Synthvcenter-*`/`X-Synthvshop-*`/`X-Synthvpro-*`/`X-Synthvmart-*`/`X-Synthvplus-*`/`X-Synthvsmart-*`/`X-Synthvfamily-*`/`X-Cevionavi-*`/`X-Ceviocenter-*`/`X-Cevioshop-*`/`X-Ceviopro-*`/`X-Ceviomart-*`/`X-Cevioplus-*`/`X-Ceviosmart-*`/`X-Ceviofamily-*`/`X-Voiceroidnavi-*`/`X-Voiceroidcenter-*`/`X-Voiceroidshop-*`/`X-Voiceroidpro-*`/`X-Voiceroidmart-*`/`X-Voiceroidplus-*`/`X-Voiceroidsmart-*`/`X-Voiceroidfamily-*`/`X-Utaunavi-*`/`X-Utaucenter-*`/`X-Utaushop-*`/`X-Utaupro-*`/`X-Utaumart-*`/`X-Utauplus-*`/`X-Utausmart-*`/`X-Utaufamily-*`/`X-Voisonanavi-*`/`X-Voisonacenter-*`/`X-Voisonashop-*`/`X-Voisonapro-*`/`X-Voisonamart-*`/`X-Voisonaplus-*`/`X-Voisonasmart-*`/`X-Voisonafamily-*`/`X-Voidolnavi-*`/`X-Voidolcenter-*`/`X-Voidolshop-*`/`X-Voidolpro-*`/`X-Voidolmart-*`/`X-Voidolplus-*` 等 は声機の通知記録 — 送信側が書くことは自称。歌声ライブラリ販売・ライセンス更新の偽装は音声合成詐欺の典型手口。(楽器機は D610)
- **修正**: `Envelope` に `vocaloid_marks` + `has_vocaloid_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 声印の自署を問え。

### Security — D769: `X-Monitor-*`/`X-Macromill-*`/`X-Intage-*` 等の覆面調査・アンケート印自称が未検査

- **問題**: `X-Monitor-*`/`X-Macromill-*`/`X-Intage-*`/`X-Researchpanel-*`/`X-Myvoice-*`/`X-Asmarq-*`/`X-Questant-*`/`X-Crossmarketing-*`/`X-Dstyle-*`/`X-Monitornavi-*`/`X-Monitorcenter-*`/`X-Monitorshop-*`/`X-Monitorpro-*`/`X-Monitormart-*`/`X-Monitorplus-*`/`X-Monitorsmart-*`/`X-Monitorfamily-*`/`X-Macromillnavi-*`/`X-Macromillcenter-*`/`X-Macromillshop-*`/`X-Macromillpro-*`/`X-Macromillmart-*`/`X-Macromillplus-*`/`X-Macromillsmart-*`/`X-Macromillfamily-*`/`X-Intagenavi-*`/`X-Intagecenter-*`/`X-Intageshop-*`/`X-Intagepro-*`/`X-Intagemart-*`/`X-Intageplus-*`/`X-Intagesmart-*`/`X-Intagefamily-*`/`X-Researchpanelnavi-*`/`X-Researchpanelcenter-*`/`X-Researchpanelshop-*`/`X-Researchpanelpro-*`/`X-Researchpanelmart-*`/`X-Researchpanelplus-*`/`X-Researchpanelsmart-*`/`X-Researchpanelfamily-*`/`X-Myvoicenavi-*`/`X-Myvoicecenter-*`/`X-Myvoiceshop-*`/`X-Myvoicepro-*`/`X-Myvoicemart-*`/`X-Myvoiceplus-*`/`X-Myvoicesmart-*`/`X-Myvoicefamily-*`/`X-Asmarqnavi-*`/`X-Asmarqcenter-*`/`X-Asmarqshop-*`/`X-Asmarqpro-*`/`X-Asmarqmart-*`/`X-Asmarqplus-*`/`X-Asmarqsmart-*`/`X-Asmarqfamily-*`/`X-Questantnavi-*`/`X-Questantcenter-*`/`X-Questantshop-*`/`X-Questantpro-*`/`X-Questantmart-*` 等 は調機の通知記録 — 送信側が書くことは自称。高額謝礼・登録料請求の偽装は調査モニター詐欺の典型手口。(ポイ活機は D593)
- **修正**: `Envelope` に `survey_marks` + `has_survey_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 調印の自署を問え。

### Security — D764: `X-Smarthome-*`/`X-Tuya-*`/`X-Smartthings-*` 等のスマートホーム・IoT家電印自称が未検査

- **問題**: `X-Smarthome-*`/`X-Tuya-*`/`X-Smartthings-*`/`X-Hue-*`/`X-Lifx-*`/`X-Wyze-*`/`X-Eufy-*`/`X-Aqara-*`/`X-Switchbot-*`/`X-Natureremo-*`/`X-Smarthomenavi-*`/`X-Smarthomecenter-*`/`X-Smarthomeshop-*`/`X-Smarthomepro-*`/`X-Smarthomemart-*`/`X-Smarthomeplus-*`/`X-Smarthomesmart-*`/`X-Smarthomefamily-*`/`X-Tuyanavi-*`/`X-Tuyacenter-*`/`X-Tuyashop-*`/`X-Tuyapro-*`/`X-Tuyamart-*`/`X-Tuyaplus-*`/`X-Tuyasmart-*`/`X-Tuyafamily-*`/`X-Smartthingsnavi-*`/`X-Smartthingscenter-*`/`X-Smartthingsshop-*`/`X-Smartthingspro-*`/`X-Smartthingsmart-*`/`X-Smartthingsplus-*`/`X-Smartthingssmart-*`/`X-Smartthingsfamily-*`/`X-Huenavi-*`/`X-Huecenter-*`/`X-Hueshop-*`/`X-Huepro-*`/`X-Huemart-*`/`X-Hueplus-*`/`X-Huesmart-*`/`X-Huefamily-*`/`X-Lifxnavi-*`/`X-Lifxcenter-*`/`X-Lifxshop-*`/`X-Lifxpro-*`/`X-Lifxmart-*`/`X-Lifxplus-*`/`X-Lifxsmart-*`/`X-Lifxfamily-*`/`X-Wyzenavi-*`/`X-Wyzecenter-*`/`X-Wyzeshop-*`/`X-Wyzepro-*`/`X-Wyzemart-*`/`X-Wyzeplus-*`/`X-Wyzesmart-*`/`X-Wyzefamily-*`/`X-Eufynavi-*`/`X-Eufycenter-*`/`X-Eufyshop-*`/`X-Eufypro-*` 等 は智機の通知記録 — 送信側が書くことは自称。デバイス割引・セットアップ料・クラウド課金の偽装はスマートホーム詐欺の典型手口。(家電機は D496、IoT機は D498)
- **修正**: `Envelope` に `smarthome_marks` + `has_smarthome_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 智印の自署を問え。

### Security — D765: `X-Orchestra-*`/`X-Suisougaku-*`/`X-Brassband-*` 等の吹奏楽・オーケストラ印自称が未検査

- **問題**: `X-Orchestra-*`/`X-Suisougaku-*`/`X-Brassband-*`/`X-Philharmonic-*`/`X-Symphony-*`/`X-Winds-*`/`X-Concertband-*`/`X-Marching-*`/`X-Orchestranavi-*`/`X-Orchestracenter-*`/`X-Orchestrashop-*`/`X-Orchestrapro-*`/`X-Orchestramart-*`/`X-Orchestraplus-*`/`X-Orchestrasmart-*`/`X-Orchestrafamily-*`/`X-Suisougakunavi-*`/`X-Suisougakucenter-*`/`X-Suisougakushop-*`/`X-Suisougakupro-*`/`X-Suisougakumart-*`/`X-Suisougakuplus-*`/`X-Suisougakusmart-*`/`X-Suisougakufamily-*`/`X-Brassbandnavi-*`/`X-Brassbandcenter-*`/`X-Brassbandshop-*`/`X-Brassbandpro-*`/`X-Brassbandmart-*`/`X-Brassbandplus-*`/`X-Brassbandsmart-*`/`X-Brassbandfamily-*`/`X-Philharmonicnavi-*`/`X-Philharmoniccenter-*`/`X-Philharmonicshop-*`/`X-Philharmonicpro-*`/`X-Philharmonicmart-*`/`X-Philharmonicplus-*`/`X-Philharmonicsmart-*`/`X-Philharmonicfamily-*`/`X-Symphonynavi-*`/`X-Symphonycenter-*`/`X-Symphonyshop-*`/`X-Symphonypro-*`/`X-Symphonymart-*`/`X-Symphonyplus-*`/`X-Symphonysmart-*`/`X-Symphonyfamily-*`/`X-Windsnavi-*`/`X-Windscenter-*`/`X-Windsshop-*`/`X-Windspro-*`/`X-Windsmart-*`/`X-Windsplus-*`/`X-Windssmart-*`/`X-Windsfamily-*`/`X-Concertbandnavi-*`/`X-Concertbandcenter-*`/`X-Concertbandshop-*`/`X-Concertbandpro-*`/`X-Concertbandmart-*`/`X-Concertbandplus-*` 等 は吹機の通知記録 — 送信側が書くことは自称。楽団員募金・公演チケット・楽譜料の偽装は吹奏楽詐欺の典型手口。(楽器機は D610、劇場機は D639)
- **修正**: `Envelope` に `orchestra_marks` + `has_orchestra_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 吹印の自署を問え。

### Security — D766: `X-Rccar-*`/`X-Rcplane-*`/`X-Rcdrone-*` 等のラジコン・RC印自称が未検査

- **問題**: `X-Rccar-*`/`X-Rcplane-*`/`X-Rcdrone-*`/`X-Tamiyarc-*`/`X-Kyosho-*`/`X-Yokomo-*`/`X-Traxxas-*`/`X-Arrma-*`/`X-Losi-*`/`X-Sanwa-*`/`X-Rccarnavi-*`/`X-Rccarcenter-*`/`X-Rccarshop-*`/`X-Rccarpro-*`/`X-Rccarmart-*`/`X-Rccarplus-*`/`X-Rccarsmart-*`/`X-Rccarfamily-*`/`X-Rcplanenavi-*`/`X-Rcplanecenter-*`/`X-Rcplaneshop-*`/`X-Rcplanepro-*`/`X-Rcplanemart-*`/`X-Rcplaneplus-*`/`X-Rcplanesmart-*`/`X-Rcplanefamily-*`/`X-Rcdronenavi-*`/`X-Rcdronecenter-*`/`X-Rcdroneshop-*`/`X-Rcdronepro-*`/`X-Rcdronemart-*`/`X-Rcdroneplus-*`/`X-Rcdronesmart-*`/`X-Rcdronefamily-*`/`X-Tamiyarcnavi-*`/`X-Tamiyarccenter-*`/`X-Tamiyarcshop-*`/`X-Tamiyarcpro-*`/`X-Tamiyarcmart-*`/`X-Tamiyarcplus-*`/`X-Tamiyarcsmart-*`/`X-Tamiyarcfamily-*`/`X-Kyoshonavi-*`/`X-Kyoshocenter-*`/`X-Kyoshoshop-*`/`X-Kyoshopro-*`/`X-Kyoshomart-*`/`X-Kyoshoplus-*`/`X-Kyoshosmart-*`/`X-Kyoshofamily-*`/`X-Yokomonavi-*`/`X-Yokomocenter-*`/`X-Yokomoshop-*`/`X-Yokomopro-*`/`X-Yokomomart-*`/`X-Yokomoplus-*`/`X-Yokomosmart-*`/`X-Yokomofamily-*`/`X-Traxxasnavi-*`/`X-Traxxascenter-*`/`X-Traxxasshop-*`/`X-Traxxaspro-*` 等 は操機の通知記録 — 送信側が書くことは自称。限定キット・中古パーツ・プロポ割引の偽装はラジコン詐欺の典型手口。(ドローン機は D748、模型機は D728)
- **修正**: `Envelope` に `radiocon_marks` + `has_radiocon_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 操印の自署を問え。

### Security — D761: `X-Yachinhosho-*`/`X-Rentguarantee-*`/`X-Hoshocompany-*` 等の家賃保証・賃貸保証印自称が未検査

- **問題**: `X-Yachinhosho-*`/`X-Rentguarantee-*`/`X-Hoshocompany-*`/`X-Casa-*`/`X-Jleave-*`/`X-Garanty-*`/`X-Epis-*`/`X-Roomca-*`/`X-Zenkyoren-*`/`X-Yachinhoshonavi-*`/`X-Yachinhoshocenter-*`/`X-Yachinhoshoshop-*`/`X-Yachinhoshopro-*`/`X-Yachinhoshomart-*`/`X-Yachinhoshoplus-*`/`X-Yachinhoshosmart-*`/`X-Yachinhoshofamily-*`/`X-Rentguaranteenavi-*`/`X-Rentguaranteecenter-*`/`X-Rentguaranteeshop-*`/`X-Rentguaranteepro-*`/`X-Rentguaranteemart-*`/`X-Rentguaranteeplus-*`/`X-Rentguaranteesmart-*`/`X-Rentguaranteefamily-*`/`X-Hoshocompanynavi-*`/`X-Hoshocompanycenter-*`/`X-Hoshocompanyshop-*`/`X-Hoshocompanypro-*`/`X-Hoshocompanymart-*`/`X-Hoshocompanyplus-*`/`X-Hoshocompanysmart-*`/`X-Hoshocompanyfamily-*`/`X-Casanavi-*`/`X-Casacenter-*`/`X-Casashop-*`/`X-Casapro-*`/`X-Casamart-*`/`X-Casaplus-*`/`X-Casasmart-*`/`X-Casafamily-*`/`X-Jleavenavi-*`/`X-Jleavecenter-*`/`X-Jleaveshop-*`/`X-Jleavepro-*`/`X-Jleavemart-*`/`X-Jleaveplus-*`/`X-Jleavesmart-*`/`X-Jleavefamily-*`/`X-Garantynavi-*`/`X-Garantycenter-*`/`X-Garantyshop-*`/`X-Garantypro-*`/`X-Garantymart-*`/`X-Garantyplus-*`/`X-Garantysmart-*`/`X-Garantyfamily-*`/`X-Episnavi-*`/`X-Episcenter-*`/`X-Episshop-*`/`X-Epispro-*`/`X-Epismart-*` 等 は賃機の通知記録 — 送信側が書くことは自称。保証料・更新料・督促手数料の偽装は家賃保証詐欺の典型手口。(不動産機は D480)
- **修正**: `Envelope` に `rentguarantee_marks` + `has_rentguarantee_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 賃印の自署を問え。

### Security — D762: `X-Lasik-*`/`X-Icl-*`/`X-Orthok-*` 等の眼科手術・視力矯正印自称が未検査

- **問題**: `X-Lasik-*`/`X-Icl-*`/`X-Orthok-*`/`X-Relex-*`/`X-Presbyond-*`/`X-Lasikclinic-*`/`X-Intralasik-*`/`X-Lasiknavi-*`/`X-Lasikcenter-*`/`X-Lasikshop-*`/`X-Lasikpro-*`/`X-Lasikmart-*`/`X-Lasikplus-*`/`X-Lasiksmart-*`/`X-Lasikfamily-*`/`X-Iclnavi-*`/`X-Iclcenter-*`/`X-Iclshop-*`/`X-Iclpro-*`/`X-Iclmart-*`/`X-Iclplus-*`/`X-Iclsmart-*`/`X-Iclfamily-*`/`X-Orthoknavi-*`/`X-Orthokcenter-*`/`X-Orthokshop-*`/`X-Orthokpro-*`/`X-Orthokmart-*`/`X-Orthokplus-*`/`X-Orthoksmart-*`/`X-Orthokfamily-*`/`X-Relexnavi-*`/`X-Relexcenter-*`/`X-Relexshop-*`/`X-Relexpro-*`/`X-Relexmart-*`/`X-Relexplus-*`/`X-Relexsmart-*`/`X-Relexfamily-*`/`X-Presbyondnavi-*`/`X-Presbyondcenter-*`/`X-Presbyondshop-*`/`X-Presbyondpro-*`/`X-Presbyondmart-*`/`X-Presbyondplus-*`/`X-Presbyondsmart-*`/`X-Presbyondfamily-*`/`X-Lasikclinicnavi-*`/`X-Lasikcliniccenter-*`/`X-Lasikclinicshop-*`/`X-Lasikclinicpro-*`/`X-Lasikclinicmart-*`/`X-Lasikclinicplus-*`/`X-Lasikclinicsmart-*`/`X-Lasikclinicfamily-*`/`X-Intralasiknavi-*`/`X-Intralasikcenter-*`/`X-Intralasikshop-*`/`X-Intralasikpro-*`/`X-Intralasikmart-*`/`X-Intralasikplus-*`/`X-Intralasiksmart-*` 等 は視機の通知記録 — 送信側が書くことは自称。激安手術・検査予約・適応判定の偽装は視力矯正詐欺の典型手口。(眼鏡機は D565)
- **修正**: `Envelope` に `lasik_marks` + `has_lasik_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 視印の自署を問え。

### Security — D763: `X-Tattoo-*`/`X-Irezumi-*`/`X-Piercing-*` 等のタトゥー・ボディアート印自称が未検査

- **問題**: `X-Tattoo-*`/`X-Irezumi-*`/`X-Piercing-*`/`X-Bodyart-*`/`X-Tattooshop-*`/`X-Bodypierce-*`/`X-Tattoostudio-*`/`X-Tattooland-*`/`X-Tattoonavi-*`/`X-Tattoocenter-*`/`X-Tattooshop-*`/`X-Tattoopro-*`/`X-Tattoomart-*`/`X-Tattooplus-*`/`X-Tattoosmart-*`/`X-Tattoofamily-*`/`X-Irezuminavi-*`/`X-Irezumicenter-*`/`X-Irezumishop-*`/`X-Irezumipro-*`/`X-Irezumimart-*`/`X-Irezumiplus-*`/`X-Irezumismart-*`/`X-Irezumifamily-*`/`X-Piercingnavi-*`/`X-Piercingcenter-*`/`X-Piercingshop-*`/`X-Piercingpro-*`/`X-Piercingmart-*`/`X-Piercingplus-*`/`X-Piercingsmart-*`/`X-Piercingfamily-*`/`X-Bodyartnavi-*`/`X-Bodyartcenter-*`/`X-Bodyartshop-*`/`X-Bodyartpro-*`/`X-Bodyartmart-*`/`X-Bodyartplus-*`/`X-Bodyartsmart-*`/`X-Bodyartfamily-*`/`X-Tattooshopnavi-*`/`X-Tattooshopcenter-*`/`X-Tattooshopshop-*`/`X-Tattooshoppro-*`/`X-Tattooshopmart-*`/`X-Tattooshopplus-*`/`X-Tattooshopsmart-*`/`X-Tattooshopfamily-*`/`X-Bodypiercenavi-*`/`X-Bodypiercecenter-*`/`X-Bodypierceshop-*`/`X-Bodypiercepro-*`/`X-Bodypiercemart-*`/`X-Bodypierceplus-*`/`X-Bodypiercesmart-*`/`X-Bodypiercefamily-*`/`X-Tattoostudionavi-*`/`X-Tattoostudiocenter-*`/`X-Tattoostudioshop-*`/`X-Tattoostudiopro-*`/`X-Tattoostudiomart-*`/`X-Tattoostudioplus-*` 等 は彫機の通知記録 — 送信側が書くことは自称。施術予約金・除去費用・デザイン料の偽装はタトゥー詐欺の典型手口。(美機は既存、ボディ機は既存)
- **修正**: `Envelope` に `tattoo_marks` + `has_tattoo_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 彫印の自署を問え。

### Security — D758: `X-Lovehotel-*`/`X-Coupleshotel-*`/`X-Resthotel-*` 等のラブホテル・休憩ホテル印自称が未検査

- **問題**: `X-Lovehotel-*`/`X-Coupleshotel-*`/`X-Resthotel-*`/`X-Balian-*`/`X-Sala-*`/`X-Grandbali-*`/`X-Hoteljumu-*`/`X-Hotelfine-*`/`X-Lovehotelnavi-*`/`X-Lovehotelcenter-*`/`X-Lovehotelshop-*`/`X-Lovehotelpro-*`/`X-Lovehotelmart-*`/`X-Lovehotelplus-*`/`X-Lovehotelsmart-*`/`X-Lovehotelfamily-*`/`X-Coupleshotelnavi-*`/`X-Coupleshotelcenter-*`/`X-Coupleshotelshop-*`/`X-Coupleshotelpro-*`/`X-Coupleshotelmart-*`/`X-Coupleshotelplus-*`/`X-Coupleshotelsmart-*`/`X-Coupleshotelfamily-*`/`X-Resthotelnavi-*`/`X-Resthotelcenter-*`/`X-Resthotelshop-*`/`X-Resthotelpro-*`/`X-Resthotelmart-*`/`X-Resthotelplus-*`/`X-Resthotelsmart-*`/`X-Resthotelfamily-*`/`X-Baliannavi-*`/`X-Baliancenter-*`/`X-Balianshop-*`/`X-Balianpro-*`/`X-Balianmart-*`/`X-Balianplus-*`/`X-Baliansmart-*`/`X-Balianfamily-*`/`X-Salanavi-*`/`X-Salacenter-*`/`X-Salashop-*`/`X-Salapro-*`/`X-Salamart-*`/`X-Salaplus-*`/`X-Salasmart-*`/`X-Salafamily-*`/`X-Grandbalinavi-*`/`X-Grandbalicenter-*`/`X-Grandbalishop-*`/`X-Grandbalipro-*`/`X-Grandbalimart-*`/`X-Grandbaliplus-*`/`X-Grandbalismart-*`/`X-Grandbalifamily-*`/`X-Hoteljumunavi-*`/`X-Hoteljumucenter-*`/`X-Hoteljumushop-*`/`X-Hoteljumupro-*`/`X-Hoteljumumart-*`/`X-Hoteljumuplus-*` 等 は恋機の通知記録 — 送信側が書くことは自称。休憩料金・延長料金・会員特典の偽装はラブホテル詐欺の典型手口。(ホテル機は D535)
- **修正**: `Envelope` に `lovehotel_marks` + `has_lovehotel_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 恋印の自署を問え。

### Security — D759: `X-Kosokubus-*`/`X-Yakoubus-*`/`X-Highwaybus-*` 等の高速バス・夜行バス印自称が未検査

- **問題**: `X-Kosokubus-*`/`X-Yakoubus-*`/`X-Highwaybus-*`/`X-Nightbus-*`/`X-Willerbus-*`/`X-Jamjam-*`/`X-Vipliner-*`/`X-Orionbus-*`/`X-Atliner-*`/`X-Kosokubusnavi-*`/`X-Kosokubuscenter-*`/`X-Kosokubusshop-*`/`X-Kosokubuspro-*`/`X-Kosokubusmart-*`/`X-Kosokubusplus-*`/`X-Kosokubussmart-*`/`X-Kosokubusfamily-*`/`X-Yakoubusnavi-*`/`X-Yakoubuscenter-*`/`X-Yakoubusshop-*`/`X-Yakoubuspro-*`/`X-Yakoubusmart-*`/`X-Yakoubusplus-*`/`X-Yakoubussmart-*`/`X-Yakoubusfamily-*`/`X-Highwaybusnavi-*`/`X-Highwaybuscenter-*`/`X-Highwaybusshop-*`/`X-Highwaybuspro-*`/`X-Highwaybusmart-*`/`X-Highwaybusplus-*`/`X-Highwaybussmart-*`/`X-Highwaybusfamily-*`/`X-Nightbusnavi-*`/`X-Nightbuscenter-*`/`X-Nightbusshop-*`/`X-Nightbuspro-*`/`X-Nightbusmart-*`/`X-Nightbusplus-*`/`X-Nightbussmart-*`/`X-Nightbusfamily-*`/`X-Willerbusnavi-*`/`X-Willerbuscenter-*`/`X-Willerbusshop-*`/`X-Willerbuspro-*`/`X-Willerbusmart-*`/`X-Willerbusplus-*`/`X-Willerbussmart-*`/`X-Willerbusfamily-*`/`X-Jamjamnavi-*`/`X-Jamjamcenter-*`/`X-Jamjamshop-*`/`X-Jamjampro-*`/`X-Jamjammart-*`/`X-Jamjamplus-*`/`X-Jamjamsmart-*`/`X-Jamjamfamily-*`/`X-Viplinernavi-*`/`X-Viplinercenter-*`/`X-Viplinershop-*`/`X-Viplinerpro-*`/`X-Viplinermart-*` 等 は迅機の通知記録 — 送信側が書くことは自称。予約確認・乗車変更・キャンセル返金の偽装は高速バス詐欺の典型手口。(バス機は D656、LCC機は D747)
- **修正**: `Envelope` に `kosokubus_marks` + `has_kosokubus_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 迅印の自署を問え。

### Security — D760: `X-Sleepclinic-*`/`X-Cpap-*`/`X-Sleepapnea-*` 等の睡眠・いびき治療印自称が未検査

- **問題**: `X-Sleepclinic-*`/`X-Cpap-*`/`X-Sleepapnea-*`/`X-Snoring-*`/`X-Sleeptech-*`/`X-Zquiet-*`/`X-Snorerx-*`/`X-Vitalsleep-*`/`X-Zyppah-*`/`X-Somnomed-*`/`X-Sleepclinicnavi-*`/`X-Sleepcliniccenter-*`/`X-Sleepclinicshop-*`/`X-Sleepclinicpro-*`/`X-Sleepclinicmart-*`/`X-Sleepclinicplus-*`/`X-Sleepclinicsmart-*`/`X-Sleepclinicfamily-*`/`X-Cpapnavi-*`/`X-Cpapcenter-*`/`X-Cpapshop-*`/`X-Cpappro-*`/`X-Cpapmart-*`/`X-Cpapplus-*`/`X-Cpapsmart-*`/`X-Cpapfamily-*`/`X-Sleepapneanavi-*`/`X-Sleepapneacenter-*`/`X-Sleepapneashop-*`/`X-Sleepapneapro-*`/`X-Sleepapneamart-*`/`X-Sleepapneaplus-*`/`X-Sleepapneasmart-*`/`X-Sleepapneafamily-*`/`X-Snoringnavi-*`/`X-Snoringcenter-*`/`X-Snoringshop-*`/`X-Snoringpro-*`/`X-Snoringmart-*`/`X-Snoringplus-*`/`X-Snoringsmart-*`/`X-Snoringfamily-*`/`X-Sleeptechnavi-*`/`X-Sleeptechcenter-*`/`X-Sleeptechshop-*`/`X-Sleeptechpro-*`/`X-Sleeptechmart-*`/`X-Sleeptechplus-*`/`X-Sleeptechsmart-*`/`X-Sleeptechfamily-*`/`X-Zquietnavi-*`/`X-Zquietcenter-*`/`X-Zquietshop-*`/`X-Zquietpro-*`/`X-Zquietmart-*`/`X-Zquietplus-*`/`X-Zquietsmart-*`/`X-Zquietfamily-*`/`X-Snorerxnavi-*`/`X-Snorerxcenter-*`/`X-Snorerxshop-*`/`X-Snorerxpro-*` 等 は眠機の通知記録 — 送信側が書くことは自称。装置代金・検査予約・レンタル料金の偽装は睡眠治療詐欺の典型手口。(診療機は D575、寝具機は D632)
- **修正**: `Envelope` に `sleepclinic_marks` + `has_sleepclinic_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 眠印の自署を問え。

### Security — D755: `X-Fertility-*`/`X-Ivf-*`/`X-Infertility-*` 等の不妊治療・妊活印自称が未検査

- **問題**: `X-Fertility-*`/`X-Ivf-*`/`X-Infertility-*`/`X-Pgt-*`/`X-Eggfreeze-*`/`X-Ivfclinic-*`/`X-Hanabusa-*`/`X-Oakkai-*`/`X-Ninkatsu-*`/`X-Fertilitynavi-*`/`X-Fertilitycenter-*`/`X-Fertilityshop-*`/`X-Fertilitypro-*`/`X-Fertilitymart-*`/`X-Fertilityplus-*`/`X-Fertilitysmart-*`/`X-Fertilityfamily-*`/`X-Ivfnavi-*`/`X-Ivfcenter-*`/`X-Ivfshop-*`/`X-Ivfpro-*`/`X-Ivfmart-*`/`X-Ivfplus-*`/`X-Ivfsmart-*`/`X-Ivffamily-*`/`X-Infertilitynavi-*`/`X-Infertilitycenter-*`/`X-Infertilityshop-*`/`X-Infertilitypro-*`/`X-Infertilitymart-*`/`X-Infertilityplus-*`/`X-Infertilitysmart-*`/`X-Infertilityfamily-*`/`X-Pgtnavi-*`/`X-Pgtcenter-*`/`X-Pgtshop-*`/`X-Pgtpro-*`/`X-Pgtmart-*`/`X-Pgtplus-*`/`X-Pgtsmart-*`/`X-Pgtfamily-*`/`X-Eggfreezenavi-*`/`X-Eggfreezecenter-*`/`X-Eggfreezeshop-*`/`X-Eggfreezepro-*`/`X-Eggfreezemart-*`/`X-Eggfreezeplus-*`/`X-Eggfreezesmart-*`/`X-Eggfreezefamily-*`/`X-Ivfclinicnavi-*`/`X-Ivfcliniccenter-*`/`X-Ivfclinicshop-*`/`X-Ivfclinicpro-*`/`X-Ivfclinicmart-*`/`X-Ivfclinicplus-*`/`X-Ivfclinicsmart-*`/`X-Ivfclinicfamily-*`/`X-Hanabusanavi-*`/`X-Hanabusacenter-*`/`X-Hanabusashop-*`/`X-Hanabusapro-*`/`X-Hanabusamart-*` 等 は妊機の通知記録 — 送信側が書くことは自称。高額治療費・保険適用外請求・妊娠報告の偽装は不妊治療詐欺の典型手口。(診療機は D575、ベビー機は D582)
- **修正**: `Envelope` に `fertility_marks` + `has_fertility_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 妊印の自署を問え。

### Security — D756: `X-Mahjong-*`/`X-Janisou-*`/`X-Jantama-*` 等の麻雀・雀荘印自称が未検査

- **問題**: `X-Mahjong-*`/`X-Janisou-*`/`X-Jantama-*`/`X-Mahjongsoul-*`/`X-Tenhou-*`/`X-Jantaku-*`/`X-Riichi-*`/`X-Mahjongnavi-*`/`X-Mahjongcenter-*`/`X-Mahjongshop-*`/`X-Mahjongpro-*`/`X-Mahjongmart-*`/`X-Mahjongplus-*`/`X-Mahjongsmart-*`/`X-Mahjongfamily-*`/`X-Janisounavi-*`/`X-Janisoucenter-*`/`X-Janisoushop-*`/`X-Janisoupro-*`/`X-Janisoumart-*`/`X-Janisouplus-*`/`X-Janisousmart-*`/`X-Janisoufamily-*`/`X-Jantamanavi-*`/`X-Jantamacenter-*`/`X-Jantamashop-*`/`X-Jantamapro-*`/`X-Jantamamart-*`/`X-Jantamaplus-*`/`X-Jantamasmart-*`/`X-Jantamafamily-*`/`X-Mahjongsoulnavi-*`/`X-Mahjongsoulcenter-*`/`X-Mahjongsoulshop-*`/`X-Mahjongsoulpro-*`/`X-Mahjongsoulmart-*`/`X-Mahjongsoulplus-*`/`X-Mahjongsoulsmart-*`/`X-Mahjongsoulfamily-*`/`X-Tenhounavi-*`/`X-Tenhoucenter-*`/`X-Tenhoushop-*`/`X-Tenhoupro-*`/`X-Tenhoumart-*`/`X-Tenhouplus-*`/`X-Tenhousmart-*`/`X-Tenhoufamily-*`/`X-Jantakunavi-*`/`X-Jantakucenter-*`/`X-Jantakushop-*`/`X-Jantakupro-*`/`X-Jantakumart-*`/`X-Jantakuplus-*`/`X-Jantakusmart-*`/`X-Jantakufamily-*`/`X-Riichinavi-*`/`X-Riichicenter-*`/`X-Riichishop-*`/`X-Riichipro-*`/`X-Riichimart-*`/`X-Riichiplus-*`/`X-Riichismart-*` 等 は雀機の通知記録 — 送信側が書くことは自称。参加費・研究会費・高レート卓案内の偽装は麻雀詐欺の典型手口。(賭博機は D547、牌機は D754)
- **修正**: `Envelope` に `mahjong_marks` + `has_mahjong_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 雀印の自署を問え。

### Security — D757: `X-Hikkoshi-*`/`X-Moving-*`/`X-Artmoving-*` 等の引越・引越見積印自称が未検査

- **問題**: `X-Hikkoshi-*`/`X-Moving-*`/`X-Artmoving-*`/`X-Heartmoving-*`/`X-Akabou-*`/`X-Movingcenter-*`/`X-Kurogane-*`/`X-Panda-Express-*`/`X-Hikkoshinavi-*`/`X-Hikkoshicenter-*`/`X-Hikkoshishop-*`/`X-Hikkoshipro-*`/`X-Hikkoshimart-*`/`X-Hikkoshiplus-*`/`X-Hikkoshismart-*`/`X-Hikkoshifamily-*`/`X-Movingnavi-*`/`X-Movingcenter-*`/`X-Movingshop-*`/`X-Movingpro-*`/`X-Movingmart-*`/`X-Movingplus-*`/`X-Movingsmart-*`/`X-Movingfamily-*`/`X-Artmovingnavi-*`/`X-Artmovingcenter-*`/`X-Artmovingshop-*`/`X-Artmovingpro-*`/`X-Artmovingmart-*`/`X-Artmovingplus-*`/`X-Artmovingsmart-*`/`X-Artmovingfamily-*`/`X-Heartmovingnavi-*`/`X-Heartmovingcenter-*`/`X-Heartmovingshop-*`/`X-Heartmovingpro-*`/`X-Heartmovingmart-*`/`X-Heartmovingplus-*`/`X-Heartmovingsmart-*`/`X-Heartmovingfamily-*`/`X-Akabounavi-*`/`X-Akaboucenter-*`/`X-Akaboushop-*`/`X-Akaboupro-*`/`X-Akaboumart-*`/`X-Akabouplus-*`/`X-Akabousmart-*`/`X-Akaboufamily-*`/`X-Movingcenternavi-*`/`X-Movingcentercenter-*`/`X-Movingcentershop-*`/`X-Movingcenterpro-*`/`X-Movingcentermart-*`/`X-Movingcenterplus-*`/`X-Movingcentersmart-*`/`X-Movingcenterfamily-*`/`X-Kuroganenavi-*`/`X-Kuroganecenter-*`/`X-Kuroganeshop-*`/`X-Kuroganepro-*`/`X-Kuroganemart-*`/`X-Kuroganeplus-*` 等 は引機の通知記録 — 送信側が書くことは自称。見積提示・キャンセル料・荷物預かり金の偽装は引越詐欺の典型手口。(倉庫機は D646)
- **修正**: `Envelope` に `hikkoshi_marks` + `has_hikkoshi_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 引印の自署を問え。

### Security — D752: `X-Keiba-*`/`X-Nar-*`/`X-Netkeiba-*` 等の競馬・公営競技印自称が未検査

- **問題**: `X-Keiba-*`/`X-Nar-*`/`X-Netkeiba-*`/`X-Ipat-*`/`X-Spat4-*`/`X-Racecourse-*`/`X-Win5-*`/`X-Kyotei-*`/`X-Keibanavi-*`/`X-Keibacenter-*`/`X-Keibashop-*`/`X-Keibapro-*`/`X-Keibamart-*`/`X-Keibaplus-*`/`X-Keibasmart-*`/`X-Keibafamily-*`/`X-Narnavi-*`/`X-Narcenter-*`/`X-Narshop-*`/`X-Narpro-*`/`X-Narmart-*`/`X-Narplus-*`/`X-Narsmart-*`/`X-Narfamily-*`/`X-Netkeibanavi-*`/`X-Netkeibacenter-*`/`X-Netkeibashop-*`/`X-Netkeibapro-*`/`X-Netkeibamart-*`/`X-Netkeibaplus-*`/`X-Netkeibasmart-*`/`X-Netkeibafamily-*`/`X-Ipatnavi-*`/`X-Ipatcenter-*`/`X-Ipatshop-*`/`X-Ipatpro-*`/`X-Ipatmart-*`/`X-Ipatplus-*`/`X-Ipatsmart-*`/`X-Ipatfamily-*`/`X-Spat4navi-*`/`X-Spat4center-*`/`X-Spat4shop-*`/`X-Spat4pro-*`/`X-Spat4mart-*`/`X-Spat4plus-*`/`X-Spat4smart-*`/`X-Spat4family-*`/`X-Racecoursenavi-*`/`X-Racecoursecenter-*`/`X-Racecourseshop-*`/`X-Racecoursepro-*`/`X-Racecoursemart-*`/`X-Racecourseplus-*`/`X-Racecoursesmart-*`/`X-Racecoursefamily-*`/`X-Win5navi-*`/`X-Win5center-*`/`X-Win5shop-*`/`X-Win5pro-*`/`X-Win5mart-*`/`X-Win5plus-*` 等 は駒機の通知記録 — 送信側が書くことは自称。馬券購入・予想情報料・的中配当の偽装は競馬詐欺の典型手口。(賭博機は D547)
- **修正**: `Envelope` に `keiba_marks` + `has_keiba_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 駒印の自署を問え。

### Security — D753: `X-Kabutomushi-*`/`X-Kuwagata-*`/`X-Insect-*` 等の昆虫・爬虫類・熱帯魚印自称が未検査

- **問題**: `X-Kabutomushi-*`/`X-Kuwagata-*`/`X-Insect-*`/`X-Reptile-*`/`X-Tarantula-*`/`X-Gecko-*`/`X-Ballpython-*`/`X-Tropicalfish-*`/`X-Aquariumfish-*`/`X-Beardeddragon-*`/`X-Kabutomushinavi-*`/`X-Kabutomushicenter-*`/`X-Kabutomushishop-*`/`X-Kabutomushipro-*`/`X-Kabutomushimart-*`/`X-Kabutomushiplus-*`/`X-Kabutomushismart-*`/`X-Kabutomushifamily-*`/`X-Kuwagatanavi-*`/`X-Kuwagatacenter-*`/`X-Kuwagatashop-*`/`X-Kuwagatapro-*`/`X-Kuwagatamart-*`/`X-Kuwagataplus-*`/`X-Kuwagatasmart-*`/`X-Kuwagatafamily-*`/`X-Insectnavi-*`/`X-Insectcenter-*`/`X-Insectshop-*`/`X-Insectpro-*`/`X-Insectmart-*`/`X-Insectplus-*`/`X-Insectsmart-*`/`X-Insectfamily-*`/`X-Reptilenavi-*`/`X-Reptilecenter-*`/`X-Reptileshop-*`/`X-Reptilepro-*`/`X-Reptilemart-*`/`X-Reptileplus-*`/`X-Reptilesmart-*`/`X-Reptilefamily-*`/`X-Tarantulanavi-*`/`X-Tarantulacenter-*`/`X-Tarantulashop-*`/`X-Tarantulapro-*`/`X-Tarantulamart-*`/`X-Tarantulaplus-*`/`X-Tarantulasmart-*`/`X-Tarantulafamily-*`/`X-Geckonavi-*`/`X-Geckocenter-*`/`X-Geckoshop-*`/`X-Geckopro-*`/`X-Geckomart-*`/`X-Geckoplus-*`/`X-Geckosmart-*`/`X-Geckofamily-*`/`X-Ballpythonnavi-*`/`X-Ballpythoncenter-*`/`X-Ballpythonshop-*`/`X-Ballpythonpro-*` 等 は虫機の通知記録 — 送信側が書くことは自称。高価個体通販・入札・繁殖案内の偽装は昆虫詐欺の典型手口。(ペット機は D561・D532、動物園水族館機は D563)
- **修正**: `Envelope` に `insect_marks` + `has_insect_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 虫印の自署を問え。

### Security — D754: `X-Poker-*`/`X-Wsop-*`/`X-Ggpoker-*` 等のポーカー印自称が未検査

- **問題**: `X-Poker-*`/`X-Wsop-*`/`X-Ggpoker-*`/`X-Partypoker-*`/`X-Natural8-*`/`X-Jopt-*`/`X-Wpt-*`/`X-Pppoker-*`/`X-Clubgg-*`/`X-Upoker-*`/`X-Kkpoker-*`/`X-Livepoker-*`/`X-Pokernavi-*`/`X-Pokercenter-*`/`X-Pokershop-*`/`X-Pokerpro-*`/`X-Pokermart-*`/`X-Pokerplus-*`/`X-Pokersmart-*`/`X-Pokerfamily-*`/`X-Wsopnavi-*`/`X-Wsopcenter-*`/`X-Wsopshop-*`/`X-Wsoppro-*`/`X-Wsopmart-*`/`X-Wsopplus-*`/`X-Wsopsmart-*`/`X-Wsopfamily-*`/`X-Ggpokernavi-*`/`X-Ggpokercenter-*`/`X-Ggpokershop-*`/`X-Ggpokerpro-*`/`X-Ggpokermart-*`/`X-Ggpokerplus-*`/`X-Ggpokersmart-*`/`X-Ggpokerfamily-*`/`X-Partypokernavi-*`/`X-Partypokercenter-*`/`X-Partypokershop-*`/`X-Partypokerpro-*`/`X-Partypokermart-*`/`X-Partypokerplus-*`/`X-Partypokersmart-*`/`X-Partypokerfamily-*`/`X-Natural8navi-*`/`X-Natural8center-*`/`X-Natural8shop-*`/`X-Natural8pro-*`/`X-Natural8mart-*`/`X-Natural8plus-*`/`X-Natural8smart-*`/`X-Natural8family-*`/`X-Joptnavi-*`/`X-Joptcenter-*`/`X-Joptshop-*`/`X-Joptpro-*`/`X-Joptmart-*`/`X-Joptplus-*`/`X-Joptsmart-*`/`X-Joptfamily-*`/`X-Wptnavi-*`/`X-Wptcenter-*` 等 は牌機の通知記録 — 送信側が書くことは自称。参加費・出金・バンクロール増量の偽装はポーカー詐欺の典型手口。(賭博機は D547、カジノ機は既存)
- **修正**: `Envelope` に `poker_marks` + `has_poker_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 牌印の自署を問え。

### Security — D749: `X-Wintersport-*`/`X-Skating-*`/`X-Curling-*` 等のウインタースポーツ印自称が未検査

- **問題**: `X-Wintersport-*`/`X-Skating-*`/`X-Curling-*`/`X-Biathlon-*`/`X-Bobsleigh-*`/`X-Skijump-*`/`X-Speedskate-*`/`X-Figureskate-*`/`X-Hockey-*`/`X-Wintersportnavi-*`/`X-Wintersportcenter-*`/`X-Wintersportshop-*`/`X-Wintersportpro-*`/`X-Wintersportmart-*`/`X-Wintersportplus-*`/`X-Wintersportsmart-*`/`X-Wintersportfamily-*`/`X-Skatingnavi-*`/`X-Skatingcenter-*`/`X-Skatingshop-*`/`X-Skatingpro-*`/`X-Skatingmart-*`/`X-Skatingplus-*`/`X-Skatingsmart-*`/`X-Skatingfamily-*`/`X-Curlingnavi-*`/`X-Curlingcenter-*`/`X-Curlingshop-*`/`X-Curlingpro-*`/`X-Curlingmart-*`/`X-Curlingplus-*`/`X-Curlingsmart-*`/`X-Curlingfamily-*`/`X-Biathlonnavi-*`/`X-Biathloncenter-*`/`X-Biathlonshop-*`/`X-Biathlonpro-*`/`X-Biathlonmart-*`/`X-Biathlonplus-*`/`X-Biathlonsmart-*`/`X-Biathlonfamily-*`/`X-Bobsleighnavi-*`/`X-Bobsleighcenter-*`/`X-Bobsleighshop-*`/`X-Bobsleighpro-*`/`X-Bobsleighmart-*`/`X-Bobsleighplus-*`/`X-Bobsleighsmart-*`/`X-Bobsleighfamily-*`/`X-Skijumpnavi-*`/`X-Skijumpcenter-*`/`X-Skijumpshop-*`/`X-Skijumppro-*`/`X-Skijumpmart-*`/`X-Skijumpplus-*`/`X-Skijumpsmart-*`/`X-Skijumpfamily-*`/`X-Speedskatenavi-*`/`X-Speedskatecenter-*`/`X-Speedskateshop-*`/`X-Speedskatepro-*`/`X-Speedskatemart-*` 等 は冬機の通知記録 — 送信側が書くことは自称。スケート教室・大会出場費・用具購入の偽装はウインタースポーツ詐欺の典型手口。(スキー機は D658、五輪機は D746)
- **修正**: `Envelope` に `wintersport_marks` + `has_wintersport_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 冬印の自署を問え。

### Security — D750: `X-Hunting-*`/`X-Rifle-*`/`X-Shotgun-*` 等の猟銃・射撃・ハンティング印自称が未検査

- **問題**: `X-Hunting-*`/`X-Rifle-*`/`X-Shotgun-*`/`X-Ammo-*`/`X-Remington-*`/`X-Winchester-*`/`X-Beretta-*`/`X-Browning-*`/`X-Mossberg-*`/`X-Ruger-*`/`X-Glock-*`/`X-Smithwesson-*`/`X-Huntingnavi-*`/`X-Huntingcenter-*`/`X-Huntingshop-*`/`X-Huntingpro-*`/`X-Huntingmart-*`/`X-Huntingplus-*`/`X-Huntingsmart-*`/`X-Huntingfamily-*`/`X-Riflenavi-*`/`X-Riflecenter-*`/`X-Rifleshop-*`/`X-Riflepro-*`/`X-Riflemart-*`/`X-Rifleplus-*`/`X-Riflesmart-*`/`X-Riflefamily-*`/`X-Shotgunnavi-*`/`X-Shotguncenter-*`/`X-Shotgunshop-*`/`X-Shotgunpro-*`/`X-Shotgunmart-*`/`X-Shotgunplus-*`/`X-Shotgunsmart-*`/`X-Shotgunfamily-*`/`X-Ammonavi-*`/`X-Ammocenter-*`/`X-Ammoshop-*`/`X-Ammopro-*`/`X-Ammomart-*`/`X-Ammoplus-*`/`X-Ammosmart-*`/`X-Ammofamily-*`/`X-Remingtonnavi-*`/`X-Remingtoncenter-*`/`X-Remingtonshop-*`/`X-Remingtonpro-*`/`X-Remingtonmart-*`/`X-Remingtonplus-*`/`X-Remingtonsmart-*`/`X-Remingtonfamily-*`/`X-Winchesternavi-*`/`X-Winchestercenter-*`/`X-Winchestershop-*`/`X-Winchesterpro-*`/`X-Winchestermart-*`/`X-Winchesterplus-*`/`X-Winchestersmart-*`/`X-Winchesterfamily-*`/`X-Berettanavi-*`/`X-Berettacenter-*` 等 は猟機の通知記録 — 送信側が書くことは自称。猟銃免許・弾薬購入・猟区案内の偽装はハンティング詐欺の典型手口。(サバゲー機は D707)
- **修正**: `Envelope` に `hunting_marks` + `has_hunting_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 猟印の自署を問え。

### Security — D751: `X-Weightlifting-*`/`X-Powerlifting-*`/`X-Strongman-*` 等の重量挙・パワーリフティング印自称が未検査

- **問題**: `X-Weightlifting-*`/`X-Powerlifting-*`/`X-Strongman-*`/`X-Crossfit-*`/`X-Ipf-*`/`X-Usapl-*`/`X-Wpc-*`/`X-Gpc-*`/`X-Benchpress-*`/`X-Deadlift-*`/`X-Weightliftingnavi-*`/`X-Weightliftingcenter-*`/`X-Weightliftingshop-*`/`X-Weightliftingpro-*`/`X-Weightliftingmart-*`/`X-Weightliftingplus-*`/`X-Weightliftingsmart-*`/`X-Weightliftingfamily-*`/`X-Powerliftingnavi-*`/`X-Powerliftingcenter-*`/`X-Powerliftingshop-*`/`X-Powerliftingpro-*`/`X-Powerliftingmart-*`/`X-Powerliftingplus-*`/`X-Powerliftingsmart-*`/`X-Powerliftingfamily-*`/`X-Strongmannavi-*`/`X-Strongmancenter-*`/`X-Strongmanshop-*`/`X-Strongmanpro-*`/`X-Strongmanmart-*`/`X-Strongmanplus-*`/`X-Strongmansmart-*`/`X-Strongmanfamily-*`/`X-Crossfitnavi-*`/`X-Crossfitcenter-*`/`X-Crossfitshop-*`/`X-Crossfitpro-*`/`X-Crossfitmart-*`/`X-Crossfitplus-*`/`X-Crossfitsmart-*`/`X-Crossfitfamily-*`/`X-Ipfnavi-*`/`X-Ipfcenter-*`/`X-Ipfshop-*`/`X-Ipfpro-*`/`X-Ipfmart-*`/`X-Ipfplus-*`/`X-Ipfsmart-*`/`X-Ipffamily-*`/`X-Usaplnavi-*`/`X-Usaplcenter-*`/`X-Usaplshop-*`/`X-Usaplpro-*`/`X-Usaplmart-*`/`X-Usaplplus-*`/`X-Usaplsmart-*`/`X-Usaplfamily-*`/`X-Wpcnavi-*`/`X-Wpccenter-*`/`X-Wpcshop-*`/`X-Wpcpro-*` 等 は挙機の通知記録 — 送信側が書くことは自称。大会出場費・ギア購入・記録認定の偽装はパワーリフティング詐欺の典型手口。(ジム機は D530、格闘技機は D699)
- **修正**: `Envelope` に `powerlifting_marks` + `has_powerlifting_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 挙印の自署を問え。

### Security — D746: `X-Olympic-*`/`X-Paralympic-*`/`X-Ioc-*` 等のオリンピック・国際スポーツ大会印自称が未検査

- **問題**: `X-Olympic-*`/`X-Paralympic-*`/`X-Ioc-*`/`X-Tokyo2020-*`/`X-Paris2024-*`/`X-La2028-*`/`X-Olympics-*`/`X-Joc-*`/`X-Ipc-*`/`X-Fifa-*`/`X-Uefa-*`/`X-Worldcup-*`/`X-Olympicnavi-*`/`X-Olympiccenter-*`/`X-Olympicshop-*`/`X-Olympicpro-*`/`X-Olympicmart-*`/`X-Olympicplus-*`/`X-Olympicsmart-*`/`X-Olympicfamily-*`/`X-Paralympicnavi-*`/`X-Paralympiccenter-*`/`X-Paralympicshop-*`/`X-Paralympicpro-*`/`X-Paralympicmart-*`/`X-Paralympicplus-*`/`X-Paralympicsmart-*`/`X-Paralympicfamily-*`/`X-Iocnavi-*`/`X-Ioccenter-*`/`X-Iocshop-*`/`X-Iocpro-*`/`X-Iocmart-*`/`X-Iocplus-*`/`X-Iocsmart-*`/`X-Iocfamily-*`/`X-Tokyo2020navi-*`/`X-Tokyo2020center-*`/`X-Tokyo2020shop-*`/`X-Tokyo2020pro-*`/`X-Tokyo2020mart-*`/`X-Tokyo2020plus-*`/`X-Tokyo2020smart-*`/`X-Tokyo2020family-*`/`X-Paris2024navi-*`/`X-Paris2024center-*`/`X-Paris2024shop-*`/`X-Paris2024pro-*`/`X-Paris2024mart-*`/`X-Paris2024plus-*`/`X-Paris2024smart-*`/`X-Paris2024family-*`/`X-La2028navi-*`/`X-La2028center-*`/`X-La2028shop-*`/`X-La2028pro-*`/`X-La2028mart-*`/`X-La2028plus-*`/`X-La2028smart-*`/`X-La2028family-*`/`X-Olympicsnavi-*`/`X-Olympicscenter-*` 等 は五機の通知記録 — 送信側が書くことは自称。聖火リレー・記念品・観戦チケット抽選の偽装は国際大会詐欺の典型手口。(プロチーム機は D564、マラソン機は D725)
- **修正**: `Envelope` に `olympic_marks` + `has_olympic_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 五印の自署を問え。

### Security — D747: `X-Lcc-*`/`X-Airdo-*`/`X-Solaseed-*` 等のLCC・格安航空印自称が未検査

- **問題**: `X-Lcc-*`/`X-Airdo-*`/`X-Solaseed-*`/`X-Starflyer-*`/`X-Zipair-*`/`X-Springjapan-*`/`X-Fda-*`/`X-Airasia-*`/`X-Scoot-*`/`X-Tigerair-*`/`X-Cebu-*`/`X-Vietjet-*`/`X-Lccnavi-*`/`X-Lcccenter-*`/`X-Lccshop-*`/`X-Lccpro-*`/`X-Lccmart-*`/`X-Lccplus-*`/`X-Lccsmart-*`/`X-Lccfamily-*`/`X-Airdonavi-*`/`X-Airdocenter-*`/`X-Airdoshop-*`/`X-Airdopro-*`/`X-Airdomart-*`/`X-Airdoplus-*`/`X-Airdosmart-*`/`X-Airdofamily-*`/`X-Solaseednavi-*`/`X-Solaseedcenter-*`/`X-Solaseedshop-*`/`X-Solaseedpro-*`/`X-Solaseedmart-*`/`X-Solaseedplus-*`/`X-Solaseedsmart-*`/`X-Solaseedfamily-*`/`X-Starflyernavi-*`/`X-Starflyercenter-*`/`X-Starflyershop-*`/`X-Starflyerpro-*`/`X-Starflyermart-*`/`X-Starflyerplus-*`/`X-Starflyersmart-*`/`X-Starflyerfamily-*`/`X-Zipairnavi-*`/`X-Zipaircenter-*`/`X-Zipairshop-*`/`X-Zipairpro-*`/`X-Zipairmart-*`/`X-Zipairplus-*`/`X-Zipairsmart-*`/`X-Zipairfamily-*`/`X-Springjapannavi-*`/`X-Springjapancenter-*`/`X-Springjapanshop-*`/`X-Springjapanpro-*`/`X-Springjapanmart-*`/`X-Springjapanplus-*`/`X-Springjapansmart-*`/`X-Springjapanfamily-*`/`X-Fdanavi-*`/`X-Fdacenter-*` 等 は翼機の通知記録 — 送信側が書くことは自称。セール運賃・欠航補償・マイル失効の偽装は格安航空詐欺の典型手口。(航空機は D513、MVNO機は D716)
- **修正**: `Envelope` に `lcc_marks` + `has_lcc_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 翼印の自署を問え。

### Security — D748: `X-Dji-*`/`X-Uav-*`/`X-Fpv-*` 等のドローン・FPV印自称が未検査

- **問題**: `X-Dji-*`/`X-Uav-*`/`X-Fpv-*`/`X-Quadcopter-*`/`X-Multicopter-*`/`X-Autel-*`/`X-Skydio-*`/`X-Betafpv-*`/`X-Emax-*`/`X-Hglrc-*`/`X-Geprc-*`/`X-Walkera-*`/`X-Hubsan-*`/`X-Potensic-*`/`X-Djinavi-*`/`X-Djicenter-*`/`X-Djishop-*`/`X-Djipro-*`/`X-Djimart-*`/`X-Djiplus-*`/`X-Djismart-*`/`X-Djifamily-*`/`X-Uavnavi-*`/`X-Uavcenter-*`/`X-Uavshop-*`/`X-Uavpro-*`/`X-Uavmart-*`/`X-Uavplus-*`/`X-Uavsmart-*`/`X-Uavfamily-*`/`X-Fpvnavi-*`/`X-Fpvcenter-*`/`X-Fpvshop-*`/`X-Fpvpro-*`/`X-Fpvmart-*`/`X-Fpvplus-*`/`X-Fpvsmart-*`/`X-Fpvfamily-*`/`X-Quadcopternavi-*`/`X-Quadcoptercenter-*`/`X-Quadcoptershop-*`/`X-Quadcopterpro-*`/`X-Quadcoptermart-*`/`X-Quadcopterplus-*`/`X-Quadcoptersmart-*`/`X-Quadcopterfamily-*`/`X-Multicopternavi-*`/`X-Multicoptercenter-*`/`X-Multicoptershop-*`/`X-Multicopterpro-*`/`X-Multicoptermart-*`/`X-Multicopterplus-*`/`X-Multicoptersmart-*`/`X-Multicopterfamily-*`/`X-Autelnavi-*`/`X-Autelcenter-*`/`X-Autelshop-*`/`X-Autelpro-*`/`X-Autelmart-*`/`X-Autelplus-*`/`X-Autelsmart-*`/`X-Autelfamily-*` 等 は翔機の通知記録 — 送信側が書くことは自称。免許講習・購入代金・修理見積の偽装はドローン詐欺の典型手口。(カメラ機は既存、ラジコン機は D616)
- **修正**: `Envelope` に `drone_marks` + `has_drone_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 翔印の自署を問え。

### Security — D743: `X-Gasstation-*`/`X-Carwash-*`/`X-Apollostation-*` 等のガソリンスタンド・洗車・コーティング印自称が未検査

- **問題**: `X-Gasstation-*`/`X-Carwash-*`/`X-Apollostation-*`/`X-Detailing-*`/`X-Coating-*`/`X-Selfcarwash-*`/`X-Washstation-*`/`X-Cleancar-*`/`X-Gasstationnavi-*`/`X-Gasstationcenter-*`/`X-Gasstationshop-*`/`X-Gasstationpro-*`/`X-Gasstationmart-*`/`X-Gasstationplus-*`/`X-Gasstationsmart-*`/`X-Gasstationfamily-*`/`X-Carwashnavi-*`/`X-Carwashcenter-*`/`X-Carwashshop-*`/`X-Carwashpro-*`/`X-Carwashmart-*`/`X-Carwashplus-*`/`X-Carwashsmart-*`/`X-Carwashfamily-*`/`X-Apollostationnavi-*`/`X-Apollostationcenter-*`/`X-Apollostationshop-*`/`X-Apollostationpro-*`/`X-Apollostationmart-*`/`X-Apollostationplus-*`/`X-Apollostationsmart-*`/`X-Apollostationfamily-*`/`X-Detailingnavi-*`/`X-Detailingcenter-*`/`X-Detailingshop-*`/`X-Detailingpro-*`/`X-Detailingmart-*`/`X-Detailingplus-*`/`X-Detailingsmart-*`/`X-Detailingfamily-*`/`X-Coatingnavi-*`/`X-Coatingcenter-*`/`X-Coatingshop-*`/`X-Coatingpro-*`/`X-Coatingmart-*`/`X-Coatingplus-*`/`X-Coatingsmart-*`/`X-Coatingfamily-*`/`X-Selfcarwashnavi-*`/`X-Selfcarwashcenter-*`/`X-Selfcarwashshop-*`/`X-Selfcarwashpro-*`/`X-Selfcarwashmart-*`/`X-Selfcarwashplus-*`/`X-Selfcarwashsmart-*`/`X-Selfcarwashfamily-*`/`X-Washstationnavi-*`/`X-Washstationcenter-*`/`X-Washstationshop-*`/`X-Washstationpro-*`/`X-Washstationmart-*`/`X-Washstationplus-*` 等 は泡機の通知記録 — 送信側が書くことは自称。給油割引・高額コーティング・プリペイド洗車の偽装は洗車詐欺の典型手口。(車買取機は D572、自動車機は D521)
- **修正**: `Envelope` に `carwash_marks` + `has_carwash_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 泡印の自署を問え。

### Security — D744: `X-Datsumo-*`/`X-Hairremoval-*`/`X-Epilation-*` 等の脱毛・メンズ脱毛印自称が未検査

- **問題**: `X-Datsumo-*`/`X-Hairremoval-*`/`X-Epilation-*`/`X-Waxing-*`/`X-Ginzacallerie-*`/`X-Stlacchie-*`/`X-Regina-*`/`X-Mensclear-*`/`X-Depilation-*`/`X-Datsumonavi-*`/`X-Datsumocenter-*`/`X-Datsumoshop-*`/`X-Datsumopro-*`/`X-Datsumomart-*`/`X-Datsumoplus-*`/`X-Datsumosmart-*`/`X-Datsumofamily-*`/`X-Hairremovalnavi-*`/`X-Hairremovalcenter-*`/`X-Hairremovalshop-*`/`X-Hairremovalpro-*`/`X-Hairremovalmart-*`/`X-Hairremovalplus-*`/`X-Hairremovalsmart-*`/`X-Hairremovalfamily-*`/`X-Epilationnavi-*`/`X-Epilationcenter-*`/`X-Epilationshop-*`/`X-Epilationpro-*`/`X-Epilationmart-*`/`X-Epilationplus-*`/`X-Epilationsmart-*`/`X-Epilationfamily-*`/`X-Waxingnavi-*`/`X-Waxingcenter-*`/`X-Waxingshop-*`/`X-Waxingpro-*`/`X-Waxingmart-*`/`X-Waxingplus-*`/`X-Waxingsmart-*`/`X-Waxingfamily-*`/`X-Ginzacallerienavi-*`/`X-Ginzacalleriecenter-*`/`X-Ginzacallerieshop-*`/`X-Ginzacalleriepro-*`/`X-Ginzacalleriemart-*`/`X-Ginzacallerieplus-*`/`X-Ginzacalleriesmart-*`/`X-Ginzacalleriefamily-*`/`X-Stlacchienavi-*`/`X-Stlacchiecenter-*`/`X-Stlacchieshop-*`/`X-Stlacchiepro-*`/`X-Stlacchiemart-*`/`X-Stlacchieplus-*`/`X-Stlacchiesmart-*`/`X-Stlacchiefamily-*`/`X-Reginanavi-*`/`X-Reginacenter-*`/`X-Reginashop-*`/`X-Reginapro-*`/`X-Reginamart-*` 等 は脱機の通知記録 — 送信側が書くことは自称。高額回数券・中途解約・キャンセル料の偽装は脱毛サロン詐欺の典型手口。(エステ機は D608、メンズエステ機は D696)
- **修正**: `Envelope` に `datsumo_marks` + `has_datsumo_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 脱印の自署を問え。

### Security — D745: `X-Kidzania-*`/`X-Kandu-*`/`X-Jobexperience-*` 等の職業体験・キッザニア印自称が未検査

- **問題**: `X-Kidzania-*`/`X-Kandu-*`/`X-Jobexperience-*`/`X-Careerpark-*`/`X-Kidswork-*`/`X-Pretendcity-*`/`X-Kidscareer-*`/`X-Workexperience-*`/`X-Kidzanianavi-*`/`X-Kidzaniacenter-*`/`X-Kidzaniashop-*`/`X-Kidzaniapro-*`/`X-Kidzaniamart-*`/`X-Kidzaniaplus-*`/`X-Kidzaniasmart-*`/`X-Kidzaniafamily-*`/`X-Kandunavi-*`/`X-Kanducenter-*`/`X-Kandushop-*`/`X-Kandupro-*`/`X-Kandumart-*`/`X-Kanduplus-*`/`X-Kandusmart-*`/`X-Kandufamily-*`/`X-Jobexperiencenavi-*`/`X-Jobexperiencecenter-*`/`X-Jobexperienceshop-*`/`X-Jobexperiencepro-*`/`X-Jobexperiencemart-*`/`X-Jobexperienceplus-*`/`X-Jobexperiencesmart-*`/`X-Jobexperiencefamily-*`/`X-Careerparknavi-*`/`X-Careerparkcenter-*`/`X-Careerparkshop-*`/`X-Careerparkpro-*`/`X-Careerparkmart-*`/`X-Careerparkplus-*`/`X-Careerparksmart-*`/`X-Careerparkfamily-*`/`X-Kidsworknavi-*`/`X-Kidsworkcenter-*`/`X-Kidsworkshop-*`/`X-Kidsworkpro-*`/`X-Kidsworkmart-*`/`X-Kidsworkplus-*`/`X-Kidsworksmart-*`/`X-Kidsworkfamily-*`/`X-Pretendcitynavi-*`/`X-Pretendcitycenter-*`/`X-Pretendcityshop-*`/`X-Pretendcitypro-*`/`X-Pretendcitymart-*`/`X-Pretendcityplus-*`/`X-Pretendcitysmart-*`/`X-Pretendcityfamily-*`/`X-Kidscareernavi-*`/`X-Kidscareercenter-*`/`X-Kidscareershop-*`/`X-Kidscareerpro-*`/`X-Kidscareermart-*`/`X-Kidscareerplus-*` 等 は体機の通知記録 — 送信側が書くことは自称。チケット・年間パス・優先入場権の偽装は職業体験詐欺の典型手口。(娯楽機は D536、動物園水族館機は D563)
- **修正**: `Envelope` に `kidzania_marks` + `has_kidzania_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 体印の自署を問え。

### Security — D740: `X-Senior-*`/`X-Seniorliving-*`/`X-Retirementhome-*` 等のシニア・高齢者向けサービス印自称が未検査

- **問題**: `X-Senior-*`/`X-Seniorliving-*`/`X-Retirementhome-*`/`X-Ccrc-*`/`X-Silver-*`/`X-Elderly-*`/`X-Petanque-*`/`X-Gateball-*`/`X-Groundgolf-*`/`X-Nordicwalking-*`/`X-Seniorsports-*`/`X-Seniornavi-*`/`X-Seniorcenter-*`/`X-Seniorshop-*`/`X-Seniorpro-*`/`X-Seniormart-*`/`X-Seniorplus-*`/`X-Seniorsmart-*`/`X-Seniorfamily-*`/`X-Seniorlivingnavi-*`/`X-Seniorlivingcenter-*`/`X-Seniorlivingshop-*`/`X-Seniorlivingpro-*`/`X-Seniorlivingmart-*`/`X-Seniorlivingplus-*`/`X-Seniorlivingsmart-*`/`X-Seniorlivingfamily-*`/`X-Retirementhomenavi-*`/`X-Retirementhomecenter-*`/`X-Retirementhomeshop-*`/`X-Retirementhomepro-*`/`X-Retirementhomemart-*`/`X-Retirementhomeplus-*`/`X-Retirementhomesmart-*`/`X-Retirementhomefamily-*`/`X-Ccrcnavi-*`/`X-Ccrccenter-*`/`X-Ccrcshop-*`/`X-Ccrcpro-*`/`X-Ccrcmart-*`/`X-Ccrcplus-*`/`X-Ccrcsmart-*`/`X-Ccrcfamily-*`/`X-Silvernavi-*`/`X-Silvercenter-*`/`X-Silvershop-*`/`X-Silverpro-*`/`X-Silvermart-*`/`X-Silverplus-*`/`X-Silversmart-*`/`X-Silverfamily-*`/`X-Elderlynavi-*`/`X-Elderlycenter-*`/`X-Elderlyshop-*`/`X-Elderlypro-*`/`X-Elderlymart-*`/`X-Elderlyplus-*`/`X-Elderlysmart-*`/`X-Elderlyfamily-*`/`X-Petanquenavi-*`/`X-Petanquecenter-*`/`X-Petanqueshop-*` 等 は寿機の通知記録 — 送信側が書くことは自称。入居一時金・デポジット・生涯スポーツ会費の偽装はシニア向け詐欺の典型手口。(介護機は D591、福祉用具機は D726)
- **修正**: `Envelope` に `senior_marks` + `has_senior_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 寿印の自署を問え。

### Security — D741: `X-Aerobics-*`/`X-Cheerleading-*`/`X-Dancesport-*` 等のダンス・バレエ印自称が未検査

- **問題**: `X-Aerobics-*`/`X-Cheerleading-*`/`X-Dancesport-*`/`X-Ballroom-*`/`X-Zumba-*`/`X-Polefitness-*`/`X-Barre-*`/`X-Ballet-*`/`X-Jazzdance-*`/`X-Bellydance-*`/`X-Flamenco-*`/`X-Tapdance-*`/`X-Dancestudio-*`/`X-Aerobicsnavi-*`/`X-Aerobicscenter-*`/`X-Aerobicsshop-*`/`X-Aerobicspro-*`/`X-Aerobicsmart-*`/`X-Aerobicsplus-*`/`X-Aerobicssmart-*`/`X-Aerobicsfamily-*`/`X-Cheerleadingnavi-*`/`X-Cheerleadingcenter-*`/`X-Cheerleadingshop-*`/`X-Cheerleadingpro-*`/`X-Cheerleadingmart-*`/`X-Cheerleadingplus-*`/`X-Cheerleadingsmart-*`/`X-Cheerleadingfamily-*`/`X-Dancesportnavi-*`/`X-Dancesportcenter-*`/`X-Dancesportshop-*`/`X-Dancesportpro-*`/`X-Dancesportmart-*`/`X-Dancesportplus-*`/`X-Dancesportsmart-*`/`X-Dancesportfamily-*`/`X-Ballroomnavi-*`/`X-Ballroomcenter-*`/`X-Ballroomshop-*`/`X-Ballroompro-*`/`X-Ballroommart-*`/`X-Ballroomplus-*`/`X-Ballroomsmart-*`/`X-Ballroomfamily-*`/`X-Zumbanavi-*`/`X-Zumbacenter-*`/`X-Zumbashop-*`/`X-Zumbapro-*`/`X-Zumbamart-*`/`X-Zumbaplus-*`/`X-Zumbasmart-*`/`X-Zumbafamily-*`/`X-Polefitnessnavi-*`/`X-Polefitnesscenter-*`/`X-Polefitnessshop-*`/`X-Polefitnesspro-*`/`X-Polefitnessmart-*`/`X-Polefitnessplus-*`/`X-Polefitnesssmart-*`/`X-Polefitnessfamily-*`/`X-Barrenavi-*` 等 は舞機の通知記録 — 送信側が書くことは自称。発表会費・レッスン料・衣装代の偽装はダンス教室詐欺の典型手口。(ヨガ機は D602、楽器機は D610)
- **修正**: `Envelope` に `dancestudio_marks` + `has_dancestudio_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 舞印の自署を問え。

### Security — D742: `X-Antiaging-*`/`X-Longevity-*`/`X-Healthspan-*` 等のアンチエイジング・ウェルネス印自称が未検査

- **問題**: `X-Antiaging-*`/`X-Longevity-*`/`X-Healthspan-*`/`X-Wellness-*`/`X-Bioidentical-*`/`X-Hormone-*`/`X-Peptide-*`/`X-Nad-*`/`X-Ivdrip-*`/`X-Medspa-*`/`X-Regenerative-*`/`X-Stemcell-*`/`X-Antiagingnavi-*`/`X-Antiagingcenter-*`/`X-Antiagingshop-*`/`X-Antiagingpro-*`/`X-Antiagingmart-*`/`X-Antiagingplus-*`/`X-Antiagingsmart-*`/`X-Antiagingfamily-*`/`X-Longevitynavi-*`/`X-Longevitycenter-*`/`X-Longevityshop-*`/`X-Longevitypro-*`/`X-Longevitymart-*`/`X-Longevityplus-*`/`X-Longevitysmart-*`/`X-Longevityfamily-*`/`X-Healthspannavi-*`/`X-Healthspancenter-*`/`X-Healthspanshop-*`/`X-Healthspanpro-*`/`X-Healthspanmart-*`/`X-Healthspanplus-*`/`X-Healthspansmart-*`/`X-Healthspanfamily-*`/`X-Wellnessnavi-*`/`X-Wellnesscenter-*`/`X-Wellnessshop-*`/`X-Wellnesspro-*`/`X-Wellnessmart-*`/`X-Wellnessplus-*`/`X-Wellnesssmart-*`/`X-Wellnessfamily-*`/`X-Bioidenticalnavi-*`/`X-Bioidenticalcenter-*`/`X-Bioidenticalshop-*`/`X-Bioidenticalpro-*`/`X-Bioidenticalmart-*`/`X-Bioidenticalplus-*`/`X-Bioidenticalsmart-*`/`X-Bioidenticalfamily-*`/`X-Hormonenavi-*`/`X-Hormonecenter-*`/`X-Hormoneshop-*`/`X-Hormonepro-*`/`X-Hormonemart-*`/`X-Hormoneplus-*`/`X-Hormonesmart-*`/`X-Hormonefamily-*`/`X-Peptidenavi-*`/`X-Peptidecenter-*` 等 は若機の通知記録 — 送信側が書くことは自称。高額点滴・若返り治療・未承認再生医療の偽装はアンチエイジング詐欺の典型手口。(エステ機は D608、代替療法機は D733)
- **修正**: `Envelope` に `antiaging_marks` + `has_antiaging_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 若印の自署を問え。

### Security — D737: `X-Sociallending-*`/`X-Crowdlending-*`/`X-P2plending-*` 等のソーシャルレンディング・先物取引印自称が未検査

- **問題**: `X-Sociallending-*`/`X-Crowdlending-*`/`X-P2plending-*`/`X-Commodity-*`/`X-Futures-*`/`X-Options-*`/`X-Cfd-*`/`X-Margin-*`/`X-Bullion-*`/`X-Binary-*`/`X-Sociallendingnavi-*`/`X-Sociallendingcenter-*`/`X-Sociallendingshop-*`/`X-Sociallendingpro-*`/`X-Sociallendingmart-*`/`X-Sociallendingplus-*`/`X-Sociallendingsmart-*`/`X-Sociallendingfamily-*`/`X-Crowdlendingnavi-*`/`X-Crowdlendingcenter-*`/`X-Crowdlendingshop-*`/`X-Crowdlendingpro-*`/`X-Crowdlendingmart-*`/`X-Crowdlendingplus-*`/`X-Crowdlendingsmart-*`/`X-Crowdlendingfamily-*`/`X-P2plendingnavi-*`/`X-P2plendingcenter-*`/`X-P2plendingshop-*`/`X-P2plendingpro-*`/`X-P2plendingmart-*`/`X-P2plendingplus-*`/`X-P2plendingsmart-*`/`X-P2plendingfamily-*`/`X-Commoditynavi-*`/`X-Commoditycenter-*`/`X-Commodityshop-*`/`X-Commoditypro-*`/`X-Commoditymart-*`/`X-Commodityplus-*`/`X-Commoditysmart-*`/`X-Commodityfamily-*`/`X-Futuresnavi-*`/`X-Futurescenter-*`/`X-Futuresshop-*`/`X-Futurespro-*`/`X-Futuresmart-*`/`X-Futuresplus-*`/`X-Futuressmart-*`/`X-Futuresfamily-*`/`X-Optionsnavi-*`/`X-Optionscenter-*`/`X-Optionsshop-*`/`X-Optionspro-*`/`X-Optionsmart-*`/`X-Optionsplus-*`/`X-Optionssmart-*`/`X-Optionsfamily-*`/`X-Cfdnavi-*`/`X-Cfdcenter-*`/`X-Cfdshop-*`/`X-Cfdpro-*` 等 は融機の通知記録 — 送信側が書くことは自称。元本保証・高利回り・追証請求の偽装は先物取引詐欺の典型手口。(証券機は D680、消費者金融機は D581)
- **修正**: `Envelope` に `sociallending_marks` + `has_sociallending_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 融印の自署を問え。

### Security — D738: `X-Danjiki-*`/`X-Touji-*`/`X-Fasting-*` 等のファスティング・断食・湯治印自称が未検査

- **問題**: `X-Danjiki-*`/`X-Touji-*`/`X-Fasting-*`/`X-Detox-*`/`X-Juicefast-*`/`X-Waterfast-*`/`X-Intermittent-*`/`X-Cleansing-*`/`X-Juicecleanse-*`/`X-Macrobiotic-*`/`X-Danjikinavi-*`/`X-Danjikicenter-*`/`X-Danjikishop-*`/`X-Danjikipro-*`/`X-Danjikimart-*`/`X-Danjikiplus-*`/`X-Danjikismart-*`/`X-Danjikifamily-*`/`X-Toujinavi-*`/`X-Toujicenter-*`/`X-Toujishop-*`/`X-Toujipro-*`/`X-Toujimart-*`/`X-Toujiplus-*`/`X-Toujismart-*`/`X-Toujifamily-*`/`X-Fastingnavi-*`/`X-Fastingcenter-*`/`X-Fastingshop-*`/`X-Fastingpro-*`/`X-Fastingmart-*`/`X-Fastingplus-*`/`X-Fastingsmart-*`/`X-Fastingfamily-*`/`X-Detoxnavi-*`/`X-Detoxcenter-*`/`X-Detoxshop-*`/`X-Detoxpro-*`/`X-Detoxmart-*`/`X-Detoxplus-*`/`X-Detoxsmart-*`/`X-Detoxfamily-*`/`X-Juicefastnavi-*`/`X-Juicefastcenter-*`/`X-Juicefastshop-*`/`X-Juicefastpro-*`/`X-Juicefastmart-*`/`X-Juicefastplus-*`/`X-Juicefastsmart-*`/`X-Juicefastfamily-*`/`X-Waterfastnavi-*`/`X-Waterfastcenter-*`/`X-Waterfastshop-*`/`X-Waterfastpro-*`/`X-Waterfastmart-*`/`X-Waterfastplus-*`/`X-Waterfastsmart-*`/`X-Waterfastfamily-*`/`X-Intermittentnavi-*`/`X-Intermittentcenter-*`/`X-Intermittentshop-*`/`X-Intermittentpro-*` 等 は断機の通知記録 — 送信側が書くことは自称。高額断食道場・リトリート・効果保証ジュースの偽装はファスティング詐欺の典型手口。(健康食品機は D720、代替療法機は D733)
- **修正**: `Envelope` に `fasting_marks` + `has_fasting_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 断印の自署を問え。

### Security — D739: `X-Cricket-*`/`X-Ipl-*`/`X-Bbl-*` 等の海外スポーツリーグ印自称が未検査

- **問題**: `X-Cricket-*`/`X-Ipl-*`/`X-Bbl-*`/`X-Psl-*`/`X-Cpl-*`/`X-Nfl-*`/`X-Xleague-*`/`X-Cfl-*`/`X-Afl-*`/`X-T20-*`/`X-Superbowl-*`/`X-Stanleycup-*`/`X-Cricketnavi-*`/`X-Cricketcenter-*`/`X-Cricketshop-*`/`X-Cricketpro-*`/`X-Cricketmart-*`/`X-Cricketplus-*`/`X-Cricketsmart-*`/`X-Cricketfamily-*`/`X-Iplnavi-*`/`X-Iplcenter-*`/`X-Iplshop-*`/`X-Iplpro-*`/`X-Iplmart-*`/`X-Iplplus-*`/`X-Iplsmart-*`/`X-Iplfamily-*`/`X-Bblnavi-*`/`X-Bblcenter-*`/`X-Bblshop-*`/`X-Bblpro-*`/`X-Bblmart-*`/`X-Bblplus-*`/`X-Bblsmart-*`/`X-Bblfamily-*`/`X-Pslnavi-*`/`X-Pslcenter-*`/`X-Pslshop-*`/`X-Pslpro-*`/`X-Pslmart-*`/`X-Pslplus-*`/`X-Pslsmart-*`/`X-Pslfamily-*`/`X-Cplnavi-*`/`X-Cplcenter-*`/`X-Cplshop-*`/`X-Cplpro-*`/`X-Cplmart-*`/`X-Cplplus-*`/`X-Cplsmart-*`/`X-Cplfamily-*`/`X-Nflnavi-*`/`X-Nflcenter-*`/`X-Nflshop-*`/`X-Nflpro-*`/`X-Nflmart-*`/`X-Nflplus-*`/`X-Nflsmart-*`/`X-Nflfamily-*`/`X-Xleaguenavi-*`/`X-Xleaguecenter-*` 等 は競機の通知記録 — 送信側が書くことは自称。海外リーグ中継視聴・グッズ・試合チケットの偽装はスポーツ観戦詐欺の典型手口。(プロチーム機は D564、ラグビー機は D713)
- **修正**: `Envelope` に `cricket_marks` + `has_cricket_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 競印の自署を問え。

### Security — D734: `X-Photostudio-*`/`X-Shashinkan-*`/`X-Idphoto-*` 等の写真館・証明写真印自称が未検査

- **問題**: `X-Photostudio-*`/`X-Shashinkan-*`/`X-Idphoto-*`/`X-Passportphoto-*`/`X-Sealphoto-*`/`X-Boxphoto-*`/`X-Shichigosan-*`/`X-Graduation-*`/`X-Yearbook-*`/`X-Commencement-*`/`X-Photostudionavi-*`/`X-Photostudiocenter-*`/`X-Photostudioshop-*`/`X-Photostudiopro-*`/`X-Photostudiomart-*`/`X-Photostudioplus-*`/`X-Photostudiosmart-*`/`X-Photostudiofamily-*`/`X-Shashinkannavi-*`/`X-Shashinkancenter-*`/`X-Shashinkanshop-*`/`X-Shashinkanpro-*`/`X-Shashinkanmart-*`/`X-Shashinkanplus-*`/`X-Shashinkansmart-*`/`X-Shashinkanfamily-*`/`X-Idphotonavi-*`/`X-Idphotocenter-*`/`X-Idphotoshop-*`/`X-Idphotopro-*`/`X-Idphotomart-*`/`X-Idphotoplus-*`/`X-Idphotosmart-*`/`X-Idphotofamily-*`/`X-Passportphotonavi-*`/`X-Passportphotocenter-*`/`X-Passportphotoshop-*`/`X-Passportphotopro-*`/`X-Passportphotomart-*`/`X-Passportphotoplus-*`/`X-Passportphotosmart-*`/`X-Passportphotofamily-*`/`X-Sealphotonavi-*`/`X-Sealphotocenter-*`/`X-Sealphotoshop-*`/`X-Sealphotopro-*`/`X-Sealphotomart-*`/`X-Sealphotoplus-*`/`X-Sealphotosmart-*`/`X-Sealphotofamily-*`/`X-Boxphotonavi-*`/`X-Boxphotocenter-*`/`X-Boxphotoshop-*`/`X-Boxphotopro-*`/`X-Boxphotomart-*`/`X-Boxphotoplus-*`/`X-Boxphotosmart-*`/`X-Boxphotofamily-*`/`X-Shichigosannavi-*`/`X-Shichigosancenter-*`/`X-Shichigosanshop-*`/`X-Shichigosanpro-*` 等 は写機の通知記録 — 送信側が書くことは自称。撮影予約・追加料金・データ納品の偽装は写真館詐欺の典型手口。(写真プリント機は D604)
- **修正**: `Envelope` に `photostudio_marks` + `has_photostudio_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 写印の自署を問え。

### Security — D735: `X-Chiiki-*`/`X-Jimoto-*`/`X-Machiokoshi-*` 等の地域コミュニティ・商店街印自称が未検査

- **問題**: `X-Chiiki-*`/`X-Jimoto-*`/`X-Machiokoshi-*`/`X-Freepaper-*`/`X-Minikomi-*`/`X-Chonaikai-*`/`X-Jichikai-*`/`X-Shotengai-*`/`X-Townmagazine-*`/`X-Chiikinavi-*`/`X-Chiikicenter-*`/`X-Chiikishop-*`/`X-Chiikipro-*`/`X-Chiikimart-*`/`X-Chiikiplus-*`/`X-Chiikismart-*`/`X-Chiikifamily-*`/`X-Jimotonavi-*`/`X-Jimotocenter-*`/`X-Jimotoshop-*`/`X-Jimotopro-*`/`X-Jimotomart-*`/`X-Jimotoplus-*`/`X-Jimotosmart-*`/`X-Jimotofamily-*`/`X-Machiokoshinavi-*`/`X-Machiokoshicenter-*`/`X-Machiokoshishop-*`/`X-Machiokoshipro-*`/`X-Machiokoshimart-*`/`X-Machiokoshiplus-*`/`X-Machiokoshismart-*`/`X-Machiokoshifamily-*`/`X-Freepapernavi-*`/`X-Freepapercenter-*`/`X-Freepapershop-*`/`X-Freepaperpro-*`/`X-Freepapermart-*`/`X-Freepaperplus-*`/`X-Freepapersmart-*`/`X-Freepaperfamily-*`/`X-Minikominavi-*`/`X-Minikomicenter-*`/`X-Minikomishop-*`/`X-Minikomipro-*`/`X-Minikomimart-*`/`X-Minikomiplus-*`/`X-Minikomismart-*`/`X-Minikomifamily-*`/`X-Chonaikainavi-*`/`X-Chonaikaicenter-*`/`X-Chonaikaishop-*`/`X-Chonaikaipro-*`/`X-Chonaikaimart-*`/`X-Chonaikaiplus-*`/`X-Chonaikaismart-*`/`X-Chonaikaifamily-*`/`X-Jichikainavi-*`/`X-Jichikaicenter-*`/`X-Jichikaishop-*`/`X-Jichikaipro-*`/`X-Jichikaimart-*` 等 は街機の通知記録 — 送信側が書くことは自称。町内会費・広告掲載・祭り協賛金の偽装は地域コミュニティ詐欺の典型手口。(祭り機は D709)
- **修正**: `Envelope` に `chiiki_marks` + `has_chiiki_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 街印の自署を問え。

### Security — D736: `X-Geocache-*`/`X-Stamprally-*`/`X-Orienteering-*` 等のジオキャッシング・宝探し印自称が未検査

- **問題**: `X-Geocache-*`/`X-Stamprally-*`/`X-Orienteering-*`/`X-Rogaining-*`/`X-Locationgame-*`/`X-Checkpoint-*`/`X-Discgolf-*`/`X-Scavenger-*`/`X-Geohunt-*`/`X-Geocachenavi-*`/`X-Geocachecenter-*`/`X-Geocacheshop-*`/`X-Geocachepro-*`/`X-Geocachemart-*`/`X-Geocacheplus-*`/`X-Geocachesmart-*`/`X-Geocachefamily-*`/`X-Stamprallynavi-*`/`X-Stamprallycenter-*`/`X-Stamprallyshop-*`/`X-Stamprallypro-*`/`X-Stamprallymart-*`/`X-Stamprallyplus-*`/`X-Stamprallysmart-*`/`X-Stamprallyfamily-*`/`X-Orienteeringnavi-*`/`X-Orienteeringcenter-*`/`X-Orienteeringshop-*`/`X-Orienteeringpro-*`/`X-Orienteeringmart-*`/`X-Orienteeringplus-*`/`X-Orienteeringsmart-*`/`X-Orienteeringfamily-*`/`X-Rogainingnavi-*`/`X-Rogainingcenter-*`/`X-Rogainingshop-*`/`X-Rogainingpro-*`/`X-Rogainingmart-*`/`X-Rogainingplus-*`/`X-Rogainingsmart-*`/`X-Rogainingfamily-*`/`X-Locationgamenavi-*`/`X-Locationgamecenter-*`/`X-Locationgameshop-*`/`X-Locationgamepro-*`/`X-Locationgamemart-*`/`X-Locationgameplus-*`/`X-Locationgamesmart-*`/`X-Locationgamefamily-*`/`X-Checkpointnavi-*`/`X-Checkpointcenter-*`/`X-Checkpointshop-*`/`X-Checkpointpro-*`/`X-Checkpointmart-*`/`X-Checkpointplus-*`/`X-Checkpointsmart-*`/`X-Checkpointfamily-*`/`X-Discgolfnavi-*`/`X-Discgolfcenter-*`/`X-Discgolfshop-*`/`X-Discgolfpro-*`/`X-Discgolfmart-*` 等 は隠機の通知記録 — 送信側が書くことは自称。イベント参加費・景品引換・コース開放料の偽装は宝探し詐欺の典型手口。(謎解き機は D712)
- **修正**: `Envelope` に `geocache_marks` + `has_geocache_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 隠印の自署を問え。

### Security — D731: `X-Kitchencar-*`/`X-Foodtruck-*`/`X-Catering-*` 等のキッチンカー・移動販売印自称が未検査

- **問題**: `X-Kitchencar-*`/`X-Foodtruck-*`/`X-Catering-*`/`X-Michinoeki-*`/`X-Lunchcar-*`/`X-Wagon-*`/`X-Mobileshop-*`/`X-Takeout-*`/`X-Bento-*`/`X-Stall-*`/`X-Popupshop-*`/`X-Farmstand-*`/`X-Kitchencarnavi-*`/`X-Kitchencarcenter-*`/`X-Kitchencarshop-*`/`X-Kitchencarpro-*`/`X-Kitchencarmart-*`/`X-Kitchencarplus-*`/`X-Kitchencarsmart-*`/`X-Kitchencarfamily-*`/`X-Foodtrucknavi-*`/`X-Foodtruckcenter-*`/`X-Foodtruckshop-*`/`X-Foodtruckpro-*`/`X-Foodtruckmart-*`/`X-Foodtruckplus-*`/`X-Foodtrucksmart-*`/`X-Foodtruckfamily-*`/`X-Cateringnavi-*`/`X-Cateringcenter-*`/`X-Cateringshop-*`/`X-Cateringpro-*`/`X-Cateringmart-*`/`X-Cateringplus-*`/`X-Cateringsmart-*`/`X-Cateringfamily-*`/`X-Michinoekinavi-*`/`X-Michinoekicenter-*`/`X-Michinoekishop-*`/`X-Michinoekipro-*`/`X-Michinoekimart-*`/`X-Michinoekiplus-*`/`X-Michinoekismart-*`/`X-Michinoekifamily-*`/`X-Lunchcarnavi-*`/`X-Lunchcarcenter-*`/`X-Lunchcarshop-*`/`X-Lunchcarpro-*`/`X-Lunchcarmart-*`/`X-Lunchcarplus-*`/`X-Lunchcarsmart-*`/`X-Lunchcarfamily-*`/`X-Wagonnavi-*`/`X-Wagoncenter-*`/`X-Wagonshop-*`/`X-Wagonpro-*`/`X-Wagonmart-*`/`X-Wagonplus-*`/`X-Wagonsmart-*`/`X-Wagonfamily-*`/`X-Mobileshopnavi-*`/`X-Mobileshopcenter-*` 等 は移機の通知記録 — 送信側が書くことは自称。出店料・場所代・材料費前払いの偽装は移動販売詐欺の典型手口。(飲食機は D528)
- **修正**: `Envelope` に `foodtruck_marks` + `has_foodtruck_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 移印の自署を問え。

### Security — D732: `X-Bonsai-*`/`X-Orchid-*`/`X-Succulent-*` 等の盆栽・観葉植物印自称が未検査

- **問題**: `X-Bonsai-*`/`X-Orchid-*`/`X-Succulent-*`/`X-Tanniku-*`/`X-Sansevieria-*`/`X-Foliage-*`/`X-Kokedama-*`/`X-Terrarium-*`/`X-Cactus-*`/`X-Agave-*`/`X-Carnivorous-*`/`X-Airplant-*`/`X-Bonsainavi-*`/`X-Bonsaicenter-*`/`X-Bonsaishop-*`/`X-Bonsaipro-*`/`X-Bonsaimart-*`/`X-Bonsaiplus-*`/`X-Bonsaismart-*`/`X-Bonsaifamily-*`/`X-Orchidnavi-*`/`X-Orchidcenter-*`/`X-Orchidshop-*`/`X-Orchidpro-*`/`X-Orchidmart-*`/`X-Orchidplus-*`/`X-Orchidsmart-*`/`X-Orchidfamily-*`/`X-Succulentnavi-*`/`X-Succulentcenter-*`/`X-Succulentshop-*`/`X-Succulentpro-*`/`X-Succulentmart-*`/`X-Succulentplus-*`/`X-Succulentsmart-*`/`X-Succulentfamily-*`/`X-Tannikunavi-*`/`X-Tannikucenter-*`/`X-Tannikushop-*`/`X-Tannikupro-*`/`X-Tannikumart-*`/`X-Tannikuplus-*`/`X-Tannikusmart-*`/`X-Tannikufamily-*`/`X-Sansevierianavi-*`/`X-Sansevieriacenter-*`/`X-Sansevieriashop-*`/`X-Sansevieriapro-*`/`X-Sansevieriamart-*`/`X-Sansevieriaplus-*`/`X-Sansevieriasmart-*`/`X-Sansevieriafamily-*`/`X-Foliagenavi-*`/`X-Foliagecenter-*`/`X-Foliageshop-*`/`X-Foliagepro-*`/`X-Foliagemart-*`/`X-Foliageplus-*`/`X-Foliagesmart-*`/`X-Foliagefamily-*`/`X-Kokedamanavi-*`/`X-Kokedamacenter-*` 等 は栽機の通知記録 — 送信側が書くことは自称。希少株競売・鉢植え枯れ保証・肥料定期便の偽装は植物詐欺の典型手口。(花機は D583、農園機は D719)
- **修正**: `Envelope` に `bonsai_marks` + `has_bonsai_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 栽印の自署を問え。

### Security — D733: `X-Naturopathy-*`/`X-Homeopathy-*`/`X-Remedy-*` 等の代替療法・自然療法印自称が未検査

- **問題**: `X-Naturopathy-*`/`X-Homeopathy-*`/`X-Remedy-*`/`X-Ayurveda-*`/`X-Aromatherapy-*`/`X-Reflexology-*`/`X-Tcm-*`/`X-Herbal-*`/`X-Bach-*`/`X-Cryotherapy-*`/`X-Hydrotherapy-*`/`X-Chiropractic-*`/`X-Naturopathynavi-*`/`X-Naturopathycenter-*`/`X-Naturopathyshop-*`/`X-Naturopathypro-*`/`X-Naturopathymart-*`/`X-Naturopathyplus-*`/`X-Naturopathysmart-*`/`X-Naturopathyfamily-*`/`X-Homeopathynavi-*`/`X-Homeopathycenter-*`/`X-Homeopathyshop-*`/`X-Homeopathypro-*`/`X-Homeopathymart-*`/`X-Homeopathyplus-*`/`X-Homeopathysmart-*`/`X-Homeopathyfamily-*`/`X-Remedynavi-*`/`X-Remedycenter-*`/`X-Remedyshop-*`/`X-Remedypro-*`/`X-Remedymart-*`/`X-Remedyplus-*`/`X-Remedysmart-*`/`X-Remedyfamily-*`/`X-Ayurvedanavi-*`/`X-Ayurvedacenter-*`/`X-Ayurvedashop-*`/`X-Ayurvedapro-*`/`X-Ayurvedamart-*`/`X-Ayurvedaplus-*`/`X-Ayurvedasmart-*`/`X-Ayurvedafamily-*`/`X-Aromatherapynavi-*`/`X-Aromatherapycenter-*`/`X-Aromatherapyshop-*`/`X-Aromatherapypro-*`/`X-Aromatherapymart-*`/`X-Aromatherapyplus-*`/`X-Aromatherapysmart-*`/`X-Aromatherapyfamily-*`/`X-Reflexologynavi-*`/`X-Reflexologycenter-*`/`X-Reflexologyshop-*`/`X-Reflexologypro-*`/`X-Reflexologymart-*`/`X-Reflexologyplus-*`/`X-Reflexologysmart-*`/`X-Reflexologyfamily-*`/`X-Tcmnavi-*`/`X-Tcmcenter-*` 等 は然機の通知記録 — 送信側が書くことは自称。効果保証・高額療程・危険な治療中止勧告の偽装は代替療法詐欺の典型手口。(鍼灸機は D703、リラク機は D594)
- **修正**: `Envelope` に `naturopathy_marks` + `has_naturopathy_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 然印の自署を問え。

### Security — D728: `X-Tomytec-*`/`X-Greenmax-*`/`X-Modeltrain-*` 等の鉄道模型・ドール印自称が未検査

- **問題**: `X-Tomytec-*`/`X-Greenmax-*`/`X-Modeltrain-*`/`X-Kato-*`/`X-Tomix-*`/`X-Microace-*`/`X-Doll-*`/`X-Bjd-*`/`X-Pullip-*`/`X-Azone-*`/`X-Obitsu-*`/`X-Momoko-*`/`X-Mini4wd-*`/`X-Dollhouse-*`/`X-Miniature-*`/`X-Tomytecnavi-*`/`X-Tomyteccenter-*`/`X-Tomytecshop-*`/`X-Tomytecpro-*`/`X-Tomytecmart-*`/`X-Tomytecplus-*`/`X-Tomytecsmart-*`/`X-Tomytecfamily-*`/`X-Greenmaxnavi-*`/`X-Greenmaxcenter-*`/`X-Greenmaxshop-*`/`X-Greenmaxpro-*`/`X-Greenmaxmart-*`/`X-Greenmaxplus-*`/`X-Greenmaxsmart-*`/`X-Greenmaxfamily-*`/`X-Modeltrainnavi-*`/`X-Modeltraincenter-*`/`X-Modeltrainshop-*`/`X-Modeltrainpro-*`/`X-Modeltrainmart-*`/`X-Modeltrainplus-*`/`X-Modeltrainsmart-*`/`X-Modeltrainfamily-*`/`X-Katonavi-*`/`X-Katocenter-*`/`X-Katoshop-*`/`X-Katopro-*`/`X-Katomart-*`/`X-Katoplus-*`/`X-Katosmart-*`/`X-Katofamily-*`/`X-Tomixnavi-*`/`X-Tomixcenter-*`/`X-Tomixshop-*`/`X-Tomixpro-*`/`X-Tomixmart-*`/`X-Tomixplus-*`/`X-Tomixsmart-*`/`X-Tomixfamily-*`/`X-Microacenavi-*`/`X-Microacecenter-*`/`X-Microaceshop-*`/`X-Microacepro-*`/`X-Microacemart-*`/`X-Microaceplus-*`/`X-Microacesmart-*` 等 は形機の通知記録 — 送信側が書くことは自称。限定品抽選・予約開始・コレクション査定の偽装は鉄道模型詐欺の典型手口。(玩具機は D558、ホビーショップ機は D559)
- **修正**: `Envelope` に `modeltrain_marks` + `has_modeltrain_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 形印の自署を問え。

### Security — D729: `X-Protein-*`/`X-Myprotein-*`/`X-Valx-*` 等のプロテイン・筋トレサプリ印自称が未検査

- **問題**: `X-Protein-*`/`X-Myprotein-*`/`X-Valx-*`/`X-Belegend-*`/`X-Xtend-*`/`X-Dns-*`/`X-Zavas-*`/`X-Ultora-*`/`X-Eaa-*`/`X-Bcaa-*`/`X-Creatine-*`/`X-Whey-*`/`X-Hmb-*`/`X-Glutamine-*`/`X-Citrulline-*`/`X-Proteinnavi-*`/`X-Proteincenter-*`/`X-Proteinshop-*`/`X-Proteinpro-*`/`X-Proteinmart-*`/`X-Proteinplus-*`/`X-Proteinsmart-*`/`X-Proteinfamily-*`/`X-Myproteinnavi-*`/`X-Myproteincenter-*`/`X-Myproteinshop-*`/`X-Myproteinpro-*`/`X-Myproteinmart-*`/`X-Myproteinplus-*`/`X-Myproteinsmart-*`/`X-Myproteinfamily-*`/`X-Valxnavi-*`/`X-Valxcenter-*`/`X-Valxshop-*`/`X-Valxpro-*`/`X-Valxmart-*`/`X-Valxplus-*`/`X-Valxsmart-*`/`X-Valxfamily-*`/`X-Belegendnavi-*`/`X-Belegendcenter-*`/`X-Belegendshop-*`/`X-Belegendpro-*`/`X-Belegendmart-*`/`X-Belegendplus-*`/`X-Belegendsmart-*`/`X-Belegendfamily-*`/`X-Xtendnavi-*`/`X-Xtendcenter-*`/`X-Xtendshop-*`/`X-Xtendpro-*`/`X-Xtendmart-*`/`X-Xtendplus-*`/`X-Xtendsmart-*`/`X-Xtendfamily-*`/`X-Dnsnavi-*`/`X-Dnscenter-*`/`X-Dnsshop-*`/`X-Dnspro-*`/`X-Dnsmart-*`/`X-Dnsplus-*`/`X-Dnssmart-*` 等 は筋機の通知記録 — 送信側が書くことは自称。定期購入・解約手数料・増量キャンペーンの偽装はプロテイン詐欺の典型手口。(サプリ機は D587、ジム機は D530)
- **修正**: `Envelope` に `protein_marks` + `has_protein_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 筋印の自署を問え。

### Security — D730: `X-Creema-*`/`X-Minne-*`/`X-Handmade-*` 等のハンドメイド作家・クラフトマーケット印自称が未検査

- **問題**: `X-Creema-*`/`X-Minne-*`/`X-Handmade-*`/`X-Iichi-*`/`X-Tetote-*`/`X-Craftie-*`/`X-Commau-*`/`X-Pinkoi-*`/`X-Artfire-*`/`X-Folksy-*`/`X-Dawanda-*`/`X-Bigcartel-*`/`X-Creemanavi-*`/`X-Creemacenter-*`/`X-Creemashop-*`/`X-Creemapro-*`/`X-Creemamart-*`/`X-Creemaplus-*`/`X-Creemasmart-*`/`X-Creemafamily-*`/`X-Minnenavi-*`/`X-Minnecenter-*`/`X-Minneshop-*`/`X-Minnepro-*`/`X-Minnemart-*`/`X-Minneplus-*`/`X-Minnesmart-*`/`X-Minnefamily-*`/`X-Handmadenavi-*`/`X-Handmadecenter-*`/`X-Handmadeshop-*`/`X-Handmadepro-*`/`X-Handmademart-*`/`X-Handmadeplus-*`/`X-Handmadesmart-*`/`X-Handmadefamily-*`/`X-Iichinavi-*`/`X-Iichicenter-*`/`X-Iichishop-*`/`X-Iichipro-*`/`X-Iichimart-*`/`X-Iichiplus-*`/`X-Iichismart-*`/`X-Iichifamily-*`/`X-Tetotenavi-*`/`X-Tetotecenter-*`/`X-Tetoteshop-*`/`X-Tetotepro-*`/`X-Tetotemart-*`/`X-Tetoteplus-*`/`X-Tetotesmart-*`/`X-Tetotefamily-*`/`X-Craftienavi-*`/`X-Craftiecenter-*`/`X-Craftieshop-*`/`X-Craftiepro-*`/`X-Craftiemart-*`/`X-Craftieplus-*`/`X-Craftiesmart-*`/`X-Craftiefamily-*`/`X-Commaunavi-*`/`X-Commaucenter-*` 等 は作機の通知記録 — 送信側が書くことは自称。作家登録・販売手数料・出展料の偽装はハンドメイド詐欺の典型手口。(EC機は D467・D494)
- **修正**: `Envelope` に `handmade_marks` + `has_handmade_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 作印の自署を問え。

### Security — D725: `X-Marathon-*`/`X-Tokyomarathon-*`/`X-Honolulumarathon-*` 等のマラソン・駅伝・ランニング印自称が未検査

- **問題**: `X-Marathon-*`/`X-Tokyomarathon-*`/`X-Honolulumarathon-*`/`X-Bostonmarathon-*`/`X-Berlinmarathon-*`/`X-Londonmarathon-*`/`X-Chicagomarathon-*`/`X-Nycmarathon-*`/`X-Ekiden-*`/`X-Hakone-*`/`X-Running-*`/`X-Jog-*`/`X-Ultramarathon-*`/`X-Relay-*`/`X-Race-*`/`X-Marathonnavi-*`/`X-Marathoncenter-*`/`X-Marathonshop-*`/`X-Marathonpro-*`/`X-Marathonmart-*`/`X-Marathonplus-*`/`X-Marathonsmart-*`/`X-Marathonfamily-*`/`X-Tokyomarathonnavi-*`/`X-Tokyomarathoncenter-*`/`X-Tokyomarathonshop-*`/`X-Tokyomarathonpro-*`/`X-Tokyomarathonmart-*`/`X-Tokyomarathonplus-*`/`X-Tokyomarathonsmart-*`/`X-Tokyomarathonfamily-*`/`X-Honolulumarathonnavi-*`/`X-Honolulumarathoncenter-*`/`X-Honolulumarathonshop-*`/`X-Honolulumarathonpro-*`/`X-Honolulumarathonmart-*`/`X-Honolulumarathonplus-*`/`X-Honolulumarathonsmart-*`/`X-Honolulumarathonfamily-*`/`X-Bostonmarathonnavi-*`/`X-Bostonmarathoncenter-*`/`X-Bostonmarathonshop-*`/`X-Bostonmarathonpro-*`/`X-Bostonmarathonmart-*`/`X-Bostonmarathonplus-*`/`X-Bostonmarathonsmart-*`/`X-Bostonmarathonfamily-*`/`X-Berlinmarathonnavi-*`/`X-Berlinmarathoncenter-*`/`X-Berlinmarathonshop-*`/`X-Berlinmarathonpro-*`/`X-Berlinmarathonmart-*`/`X-Berlinmarathonplus-*`/`X-Berlinmarathonsmart-*`/`X-Berlinmarathonfamily-*`/`X-Londonmarathonnavi-*`/`X-Londonmarathoncenter-*`/`X-Londonmarathonshop-*`/`X-Londonmarathonpro-*`/`X-Londonmarathonmart-*`/`X-Londonmarathonplus-*`/`X-Londonmarathonsmart-*` 等 は奔機の通知記録 — 送信側が書くことは自称。参加費・エントリー・完走メダル発送の偽装はマラソン詐欺の典型手口。(プロチーム機は D564、スポーツ教室機は D682)
- **修正**: `Envelope` に `marathon_marks` + `has_marathon_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 奔印の自署を問え。

### Security — D726: `X-Fukushiyogu-*`/`X-Kaigoyohin-*`/`X-Wheelchair-*` 等の福祉用具・介護用品印自称が未検査

- **問題**: `X-Fukushiyogu-*`/`X-Kaigoyohin-*`/`X-Wheelchair-*`/`X-Hosogu-*`/`X-Gishisogu-*`/`X-Barrierfree-*`/`X-Grouphome-*`/`X-Portabletoilet-*`/`X-Handrail-*`/`X-Wheelchairlift-*`/`X-Rehabgoods-*`/`X-Caregoods-*`/`X-Fukushiyogunavi-*`/`X-Fukushiyogucenter-*`/`X-Fukushiyogushop-*`/`X-Fukushiyogupro-*`/`X-Fukushiyogumart-*`/`X-Fukushiyoguplus-*`/`X-Fukushiyogusmart-*`/`X-Fukushiyogufamily-*`/`X-Kaigoyohinnavi-*`/`X-Kaigoyohincenter-*`/`X-Kaigoyohinshop-*`/`X-Kaigoyohinpro-*`/`X-Kaigoyohinmart-*`/`X-Kaigoyohinplus-*`/`X-Kaigoyohinsmart-*`/`X-Kaigoyohinfamily-*`/`X-Wheelchairnavi-*`/`X-Wheelchaircenter-*`/`X-Wheelchairshop-*`/`X-Wheelchairpro-*`/`X-Wheelchairmart-*`/`X-Wheelchairplus-*`/`X-Wheelchairsmart-*`/`X-Wheelchairfamily-*`/`X-Hosogunavi-*`/`X-Hosogucenter-*`/`X-Hosogushop-*`/`X-Hosogupro-*`/`X-Hosogumart-*`/`X-Hosoguplus-*`/`X-Hosogusmart-*`/`X-Hosogufamily-*`/`X-Gishisogunavi-*`/`X-Gishisogucenter-*`/`X-Gishisogushop-*`/`X-Gishisogupro-*`/`X-Gishisogumart-*`/`X-Gishisoguplus-*`/`X-Gishisogusmart-*`/`X-Gishisogufamily-*`/`X-Barrierfreenavi-*`/`X-Barrierfreecenter-*`/`X-Barrierfreeshop-*`/`X-Barrierfreepro-*`/`X-Barrierfreemart-*`/`X-Barrierfreeplus-*`/`X-Barrierfreesmart-*`/`X-Barrierfreefamily-*`/`X-Grouphomenavi-*`/`X-Grouphomecenter-*` 等 は椅機の通知記録 — 送信側が書くことは自称。レンタル料金・給付申請・宅配修理の偽装は福祉用具詐欺の典型手口。(介護機は D591、福祉機は D650)
- **修正**: `Envelope` に `fukushiyogu_marks` + `has_fukushiyogu_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 椅印の自署を問え。

### Security — D727: `X-Adventure-*`/`X-Rafting-*`/`X-Canyoning-*` 等のアウトドア・アドベンチャー印自称が未検査

- **問題**: `X-Adventure-*`/`X-Rafting-*`/`X-Canyoning-*`/`X-Canoe-*`/`X-Zipline-*`/`X-Paraglider-*`/`X-Skydiving-*`/`X-Hotair-*`/`X-Balloon-*`/`X-Atv-*`/`X-Buggy-*`/`X-Mtb-*`/`X-Caving-*`/`X-Motocross-*`/`X-Adventurenavi-*`/`X-Adventurecenter-*`/`X-Adventureshop-*`/`X-Adventurepro-*`/`X-Adventuremart-*`/`X-Adventureplus-*`/`X-Adventuresmart-*`/`X-Adventurefamily-*`/`X-Raftingnavi-*`/`X-Raftingcenter-*`/`X-Raftingshop-*`/`X-Raftingpro-*`/`X-Raftingmart-*`/`X-Raftingplus-*`/`X-Raftingsmart-*`/`X-Raftingfamily-*`/`X-Canyoningnavi-*`/`X-Canyoningcenter-*`/`X-Canyoningshop-*`/`X-Canyoningpro-*`/`X-Canyoningmart-*`/`X-Canyoningplus-*`/`X-Canyoningsmart-*`/`X-Canyoningfamily-*`/`X-Canoenavi-*`/`X-Canoecenter-*`/`X-Canoeshop-*`/`X-Canoepro-*`/`X-Canoemart-*`/`X-Canoeplus-*`/`X-Canoesmart-*`/`X-Canoefamily-*`/`X-Ziplinenavi-*`/`X-Ziplinecenter-*`/`X-Ziplineshop-*`/`X-Ziplinepro-*`/`X-Ziplinemart-*`/`X-Ziplineplus-*`/`X-Ziplinesmart-*`/`X-Ziplinefamily-*`/`X-Paraglidernavi-*`/`X-Paraglidercenter-*`/`X-Paraglidershop-*`/`X-Paragliderpro-*`/`X-Paraglidermart-*`/`X-Paragliderplus-*`/`X-Paraglidersmart-*`/`X-Paragliderfamily-*` 等 は険機の通知記録 — 送信側が書くことは自称。ツアー予約・体験料金・装備レンタルの偽装はアウトドア詐欺の典型手口。(キャンプ機は D616、山岳機は D715)
- **修正**: `Envelope` に `adventure_marks` + `has_adventure_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 険印の自署を問え。

### Security — D722: `X-Fujirock-*`/`X-Summersonic-*`/`X-Rockin-*` 等の音楽フェス印自称が未検査

- **問題**: `X-Fujirock-*`/`X-Summersonic-*`/`X-Rockin-*`/`X-Risingsun-*`/`X-Sstv-*`/`X-Sweetloveshower-*`/`X-Viva-*`/`X-Metrock-*`/`X-Rushball-*`/`X-Apbank-*`/`X-Itadaki-*`/`X-Wildbunch-*`/`X-Umf-*`/`X-Edc-*`/`X-Tomorrowland-*`/`X-Coachella-*`/`X-Glastonbury-*`/`X-Lollapalooza-*`/`X-Fujirocknavi-*`/`X-Fujirockcenter-*`/`X-Fujirockshop-*`/`X-Fujirockpro-*`/`X-Fujirockmart-*`/`X-Fujirockplus-*`/`X-Fujirocksmart-*`/`X-Fujirockfamily-*`/`X-Summersonicnavi-*`/`X-Summersoniccenter-*`/`X-Summersonicshop-*`/`X-Summersonicpro-*`/`X-Summersonicmart-*`/`X-Summersonicplus-*`/`X-Summersonicsmart-*`/`X-Summersonicfamily-*`/`X-Rockinnavi-*`/`X-Rockincenter-*`/`X-Rockinshop-*`/`X-Rockinpro-*`/`X-Rockinmart-*`/`X-Rockinplus-*`/`X-Rockinsmart-*`/`X-Rockinfamily-*`/`X-Risingsunnavi-*`/`X-Risingsuncenter-*`/`X-Risingsunshop-*`/`X-Risingsunpro-*`/`X-Risingsunmart-*`/`X-Risingsunplus-*`/`X-Risingsunsmart-*`/`X-Risingsunfamily-*`/`X-Sstvnavi-*`/`X-Sstvcenter-*`/`X-Sstvshop-*`/`X-Sstvpro-*`/`X-Sstvmart-*`/`X-Sstvplus-*`/`X-Sstvsmart-*`/`X-Sstvfamily-*`/`X-Sweetloveshowernavi-*`/`X-Sweetloveshowercenter-*`/`X-Sweetloveshowershop-*`/`X-Sweetloveshowerpro-*` 等 は演機の通知記録 — 送信側が書くことは自称。チケット転売・リストバンド・VIPパスの偽装はフェス詐欺の典型手口。(祭り機は D709、ライブハウス機は D672)
- **修正**: `Envelope` に `fujirock_marks` + `has_fujirock_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 演印の自署を問え。

### Security — D723: `X-Callcenter-*`/`X-Telemarketing-*`/`X-Bell24-*` 等のコールセンター・電話代行印自称が未検査

- **問題**: `X-Callcenter-*`/`X-Telemarketing-*`/`X-Bell24-*`/`X-Transcosmos-*`/`X-Teleperformance-*`/`X-Taskus-*`/`X-Alorica-*`/`X-Convergys-*`/`X-Sitel-*`/`X-Sykes-*`/`X-Icmi-*`/`X-Iquest-*`/`X-Denwa-*`/`X-Reservationcenter-*`/`X-Callcenternavi-*`/`X-Callcentercenter-*`/`X-Callcentershop-*`/`X-Callcenterpro-*`/`X-Callcentermart-*`/`X-Callcenterplus-*`/`X-Callcentersmart-*`/`X-Callcenterfamily-*`/`X-Telemarketingnavi-*`/`X-Telemarketingcenter-*`/`X-Telemarketingshop-*`/`X-Telemarketingpro-*`/`X-Telemarketingmart-*`/`X-Telemarketingplus-*`/`X-Telemarketingsmart-*`/`X-Telemarketingfamily-*`/`X-Bell24navi-*`/`X-Bell24center-*`/`X-Bell24shop-*`/`X-Bell24pro-*`/`X-Bell24mart-*`/`X-Bell24plus-*`/`X-Bell24smart-*`/`X-Bell24family-*`/`X-Transcosmosnavi-*`/`X-Transcosmoscenter-*`/`X-Transcosmosshop-*`/`X-Transcosmospro-*`/`X-Transcosmosmart-*`/`X-Transcosmosplus-*`/`X-Transcosmossmart-*`/`X-Transcosmosfamily-*`/`X-Teleperformancenavi-*`/`X-Teleperformancecenter-*`/`X-Teleperformanceshop-*`/`X-Teleperformancepro-*`/`X-Teleperformancemart-*`/`X-Teleperformanceplus-*`/`X-Teleperformancesmart-*`/`X-Teleperformancefamily-*`/`X-Taskusnavi-*`/`X-Taskuscenter-*`/`X-Taskusshop-*`/`X-Taskuspro-*`/`X-Taskusmart-*`/`X-Taskusplus-*`/`X-Taskussmart-*`/`X-Taskusfamily-*` 等 は電機の通知記録 — 送信側が書くことは自称。電話勧誘・架電代行・サポート料金請求の偽装はコールセンター詐欺の典型手口。(通信API機は D476、BPOは未整備)
- **修正**: `Envelope` に `callcenter_marks` + `has_callcenter_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 電印の自署を問え。

### Security — D724: `X-Kashikaigi-*`/`X-Virtualoffice-*`/`X-Servicedoffice-*` 等の貸し会議室・レンタルスペース印自称が未検査

- **問題**: `X-Kashikaigi-*`/`X-Virtualoffice-*`/`X-Servicedoffice-*`/`X-Rentalspace-*`/`X-Crosscoop-*`/`X-Fabbit-*`/`X-Tiw-*`/`X-Conference-*`/`X-Meetingroom-*`/`X-Eventspace-*`/`X-Rentalhall-*`/`X-Kashikaiginavi-*`/`X-Kashikaigicenter-*`/`X-Kashikaigishop-*`/`X-Kashikaigipro-*`/`X-Kashikaigimart-*`/`X-Kashikaigiplus-*`/`X-Kashikaigismart-*`/`X-Kashikaigifamily-*`/`X-Virtualofficenavi-*`/`X-Virtualofficecenter-*`/`X-Virtualofficeshop-*`/`X-Virtualofficepro-*`/`X-Virtualofficemart-*`/`X-Virtualofficeplus-*`/`X-Virtualofficesmart-*`/`X-Virtualofficefamily-*`/`X-Servicedofficenavi-*`/`X-Servicedofficecenter-*`/`X-Servicedofficeshop-*`/`X-Servicedofficepro-*`/`X-Servicedofficemart-*`/`X-Servicedofficeplus-*`/`X-Servicedofficesmart-*`/`X-Servicedofficefamily-*`/`X-Rentalspacenavi-*`/`X-Rentalspacecenter-*`/`X-Rentalspaceshop-*`/`X-Rentalspacepro-*`/`X-Rentalspacemart-*`/`X-Rentalspaceplus-*`/`X-Rentalspacesmart-*`/`X-Rentalspacefamily-*`/`X-Crosscoopnavi-*`/`X-Crosscoopcenter-*`/`X-Crosscoopshop-*`/`X-Crosscooppro-*`/`X-Crosscoopmart-*`/`X-Crosscoopplus-*`/`X-Crosscoopsmart-*`/`X-Crosscoopfamily-*`/`X-Fabbitnavi-*`/`X-Fabbitcenter-*`/`X-Fabbitshop-*`/`X-Fabbitpro-*`/`X-Fabbitmart-*`/`X-Fabbitplus-*`/`X-Fabbitsmart-*`/`X-Fabbitfamily-*`/`X-Tiwnavi-*`/`X-Tiwcenter-*`/`X-Tiwshop-*` 等 は室機の通知記録 — 送信側が書くことは自称。利用料金・入会費・鍵デポジットの偽装はレンタルスペース詐欺の典型手口。(コワーキング機は D597、シェアハウス機は D679)
- **修正**: `Envelope` に `rentalspace_marks` + `has_rentalspace_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 室印の自署を問え。

### Security — D719: `X-Shiminnouen-*`/`X-Nouen-*`/`X-Farm-*` 等の市民農園・家庭菜園印自称が未検査

- **問題**: `X-Shiminnouen-*`/`X-Nouen-*`/`X-Farm-*`/`X-Sharehatake-*`/`X-Myfarm-*`/`X-Kateisaien-*`/`X-Plantfactory-*`/`X-Hatake-*`/`X-Hata-*`/`X-Garden-*`/`X-Allotment-*`/`X-Communitygarden-*`/`X-Shiminnouennavi-*`/`X-Shiminnouencenter-*`/`X-Shiminnouenshop-*`/`X-Shiminnouenpro-*`/`X-Shiminnouenmart-*`/`X-Shiminnouenplus-*`/`X-Shiminnouensmart-*`/`X-Shiminnouenfamily-*`/`X-Nouennavi-*`/`X-Nouencenter-*`/`X-Nouenshop-*`/`X-Nouenpro-*`/`X-Nouenmart-*`/`X-Nouenplus-*`/`X-Nouensmart-*`/`X-Nouenfamily-*`/`X-Farmnavi-*`/`X-Farmcenter-*`/`X-Farmshop-*`/`X-Farmpro-*`/`X-Farmmart-*`/`X-Farmplus-*`/`X-Farmsmart-*`/`X-Farmfamily-*`/`X-Sharehatakenavi-*`/`X-Sharehatakecenter-*`/`X-Sharehatakeshop-*`/`X-Sharehatakepro-*`/`X-Sharehatakemart-*`/`X-Sharehatakeplus-*`/`X-Sharehatakesmart-*`/`X-Sharehatakefamily-*`/`X-Myfarmnavi-*`/`X-Myfarmcenter-*`/`X-Myfarmshop-*`/`X-Myfarmpro-*`/`X-Myfarmmart-*`/`X-Myfarmplus-*`/`X-Myfarmsmart-*`/`X-Myfarmfamily-*`/`X-Kateisaiennavi-*`/`X-Kateisaiencenter-*`/`X-Kateisaienshop-*`/`X-Kateisaienpro-*`/`X-Kateisaienmart-*`/`X-Kateisaienplus-*`/`X-Kateisaiensmart-*`/`X-Kateisaienfamily-*`/`X-Plantfactorynavi-*`/`X-Plantfactorycenter-*` 等 は畑機の通知記録 — 送信側が書くことは自称。区画年間利用料・種苗購入・収穫体験の偽装は農園詐欺の典型手口。(造園機は D619、農業資材機は D634)
- **修正**: `Envelope` に `nouen_marks` + `has_nouen_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 畑印の自署を問え。

### Security — D720: `X-Tokuho-*`/`X-Foshu-*`/`X-Kinousei-*` 等のトクホ・機能性食品・健康食品印自称が未検査

- **問題**: `X-Tokuho-*`/`X-Foshu-*`/`X-Kinousei-*`/`X-Eiyou-*`/`X-Kouso-*`/`X-Enzyme-*`/`X-Collagen-*`/`X-Placenta-*`/`X-Ceramide-*`/`X-Isoflavone-*`/`X-Nyusankin-*`/`X-Bifidus-*`/`X-Glucosamine-*`/`X-Chondroitin-*`/`X-Coq10-*`/`X-Astaxanthin-*`/`X-Dha-*`/`X-Epa-*`/`X-Fucoidan-*`/`X-Agaricus-*`/`X-Propolis-*`/`X-Royaljelly-*`/`X-Noni-*`/`X-Aojiru-*`/`X-Maca-*`/`X-Turmeric-*`/`X-Ukon-*`/`X-Tokuhonavi-*`/`X-Tokuhocenter-*`/`X-Tokuhoshop-*`/`X-Tokuhopro-*`/`X-Tokuhomart-*`/`X-Tokuhoplus-*`/`X-Tokuhosmart-*`/`X-Tokuhofamily-*`/`X-Foshunavi-*`/`X-Foshucenter-*`/`X-Foshushop-*`/`X-Foshupro-*`/`X-Foshumart-*`/`X-Foshuplus-*`/`X-Foshusmart-*`/`X-Foshufamily-*`/`X-Kinouseinavi-*`/`X-Kinouseicenter-*`/`X-Kinouseishop-*`/`X-Kinouseipro-*`/`X-Kinouseimart-*`/`X-Kinouseiplus-*`/`X-Kinouseismart-*`/`X-Kinouseifamily-*`/`X-Eiyounavi-*`/`X-Eiyoucenter-*`/`X-Eiyoushop-*`/`X-Eiyoupro-*`/`X-Eiyoumart-*`/`X-Eiyouplus-*`/`X-Eiyousmart-*`/`X-Eiyoufamily-*`/`X-Kousonavi-*`/`X-Kousocenter-*`/`X-Kousoshop-*` 等 は療機の通知記録 — 送信側が書くことは自称。効能誇大・定期購入トラブル・モニター勧誘の偽装は健康食品詐欺の典型手口。(サプリ機は D587、ドラッグストア機は D527)
- **修正**: `Envelope` に `tokuho_marks` + `has_tokuho_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 療印の自署を問え。

### Security — D721: `X-Planetarium-*`/`X-Astronomy-*`/`X-Observatory-*` 等の天文・プラネタリウム印自称が未検査

- **問題**: `X-Planetarium-*`/`X-Astronomy-*`/`X-Observatory-*`/`X-Telescope-*`/`X-Tenmon-*`/`X-Hoshizora-*`/`X-Celestron-*`/`X-Vixen-*`/`X-Meade-*`/`X-Astro-*`/`X-Hoshi-*`/`X-Zodiac-*`/`X-Meteor-*`/`X-Planetariumnavi-*`/`X-Planetariumcenter-*`/`X-Planetariumshop-*`/`X-Planetariumpro-*`/`X-Planetariummart-*`/`X-Planetariumplus-*`/`X-Planetariumsmart-*`/`X-Planetariumfamily-*`/`X-Astronomynavi-*`/`X-Astronomycenter-*`/`X-Astronomyshop-*`/`X-Astronomypro-*`/`X-Astronomymart-*`/`X-Astronomyplus-*`/`X-Astronomysmart-*`/`X-Astronomyfamily-*`/`X-Observatorynavi-*`/`X-Observatorycenter-*`/`X-Observatoryshop-*`/`X-Observatorypro-*`/`X-Observatorymart-*`/`X-Observatoryplus-*`/`X-Observatorysmart-*`/`X-Observatoryfamily-*`/`X-Telescopenavi-*`/`X-Telescopecenter-*`/`X-Telescopeshop-*`/`X-Telescopepro-*`/`X-Telescopemart-*`/`X-Telescopeplus-*`/`X-Telescopesmart-*`/`X-Telescopefamily-*`/`X-Tenmonnavi-*`/`X-Tenmoncenter-*`/`X-Tenmonshop-*`/`X-Tenmonpro-*`/`X-Tenmonmart-*`/`X-Tenmonplus-*`/`X-Tenmonsmart-*`/`X-Tenmonfamily-*`/`X-Hoshizoranavi-*`/`X-Hoshizoracenter-*`/`X-Hoshizorashop-*`/`X-Hoshizorapro-*`/`X-Hoshizoramart-*`/`X-Hoshizoraplus-*`/`X-Hoshizorasmart-*`/`X-Hoshizorafamily-*`/`X-Celestronnavi-*` 等 は星機の通知記録 — 送信側が書くことは自称。観望会チケット・機材予約・星空ツアーの偽装は天文詐欺の典型手口。(気象機は D566、美術館機は D638)
- **修正**: `Envelope` に `planetarium_marks` + `has_planetarium_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 星印の自署を問え。

### Security — D716: `X-Mvno-*`/`X-Mineo-*`/`X-Uqmobile-*` 等の格安SIM・MVNO印自称が未検査

- **問題**: `X-Mvno-*`/`X-Mineo-*`/`X-Uqmobile-*`/`X-Ymobile-*`/`X-Linemo-*`/`X-Povo-*`/`X-Ahamo-*`/`X-Ocnmobile-*`/`X-Nifmo-*`/`X-Freetel-*`/`X-Dtone-*`/`X-Roketmobile-*`/`X-Libmo-*`/`X-Jcommobile-*`/`X-Hismobile-*`/`X-Xmobile-*`/`X-Younet-*`/`X-Aeonmobile-*`/`X-Uq-*`/`X-Mvnonavi-*`/`X-Mvnocenter-*`/`X-Mvnoshop-*`/`X-Mvnopro-*`/`X-Mvnomart-*`/`X-Mvnoplus-*`/`X-Mvnosmart-*`/`X-Mvnofamily-*`/`X-Mineonavi-*`/`X-Mineocenter-*`/`X-Mineoshop-*`/`X-Mineopro-*`/`X-Mineomart-*`/`X-Mineoplus-*`/`X-Mineosmart-*`/`X-Mineofamily-*`/`X-Uqmobilenavi-*`/`X-Uqmobilecenter-*`/`X-Uqmobileshop-*`/`X-Uqmobilepro-*`/`X-Uqmobilemart-*`/`X-Uqmobileplus-*`/`X-Uqmobilesmart-*`/`X-Uqmobilefamily-*`/`X-Ymobilenavi-*`/`X-Ymobilecenter-*`/`X-Ymobileshop-*`/`X-Ymobilepro-*`/`X-Ymobilemart-*`/`X-Ymobileplus-*`/`X-Ymobilesmart-*`/`X-Ymobilefamily-*`/`X-Linemonavi-*`/`X-Linemocenter-*`/`X-Linemoshop-*`/`X-Linemopro-*`/`X-Linemomart-*`/`X-Linemoplus-*`/`X-Linemosmart-*`/`X-Linemofamily-*`/`X-Povonavi-*`/`X-Povocenter-*`/`X-Povoshop-*` 等 は格機の通知記録 — 送信側が書くことは自称。MNP転出・料金未納・キャンペーン適用の偽装は格安SIM詐欺の典型手口。(キャリア機は D511、eSIM機は D569)
- **修正**: `Envelope` に `mvno_marks` + `has_mvno_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 格印の自署を問え。

### Security — D717: `X-Craftbeer-*`/`X-Brewery-*`/`X-Winery-*` 等のクラフトビール・酒蔵・ワイナリー印自称が未検査

- **問題**: `X-Craftbeer-*`/`X-Brewery-*`/`X-Winery-*`/`X-Sakebrewery-*`/`X-Sakagura-*`/`X-Kuramoto-*`/`X-Jizake-*`/`X-Shochu-*`/`X-Awamori-*`/`X-Wine-*`/`X-Gin-*`/`X-Craftgin-*`/`X-Mead-*`/`X-Cider-*`/`X-Distillery-*`/`X-Craftbeernavi-*`/`X-Craftbeercenter-*`/`X-Craftbeershop-*`/`X-Craftbeerpro-*`/`X-Craftbeermart-*`/`X-Craftbeerplus-*`/`X-Craftbeersmart-*`/`X-Craftbeerfamily-*`/`X-Brewerynavi-*`/`X-Brewerycenter-*`/`X-Breweryshop-*`/`X-Brewerypro-*`/`X-Brewerymart-*`/`X-Breweryplus-*`/`X-Brewerysmart-*`/`X-Breweryfamily-*`/`X-Winerynavi-*`/`X-Winerycenter-*`/`X-Wineryshop-*`/`X-Winerypro-*`/`X-Winerymart-*`/`X-Wineryplus-*`/`X-Winerysmart-*`/`X-Wineryfamily-*`/`X-Sakebrewerynavi-*`/`X-Sakebrewerycenter-*`/`X-Sakebreweryshop-*`/`X-Sakebrewerypro-*`/`X-Sakebrewerymart-*`/`X-Sakebreweryplus-*`/`X-Sakebrewerysmart-*`/`X-Sakebreweryfamily-*`/`X-Sakaguranavi-*`/`X-Sakaguracenter-*`/`X-Sakagurashop-*`/`X-Sakagurapro-*`/`X-Sakaguramart-*`/`X-Sakaguraplus-*`/`X-Sakagurasmart-*`/`X-Sakagurafamily-*`/`X-Kuramotonavi-*`/`X-Kuramotocenter-*`/`X-Kuramotoshop-*`/`X-Kuramotopro-*`/`X-Kuramotomart-*`/`X-Kuramotoplus-*`/`X-Kuramotosmart-*` 等 は醸機の通知記録 — 送信側が書くことは自称。限定醸造・蔵開き・定期便の偽装は地酒詐欺の典型手口。(サントリー等大メーカーは D551、居酒屋機は D666)
- **修正**: `Envelope` に `craftbeer_marks` + `has_craftbeer_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 醸印の自署を問え。

### Security — D718: `X-Expo-*`/`X-Exhibition-*`/`X-Messe-*` 等の展示会・見本市・学会印自称が未検査

- **問題**: `X-Expo-*`/`X-Exhibition-*`/`X-Messe-*`/`X-Tradeshow-*`/`X-Booth-*`/`X-Gakkai-*`/`X-Convention-*`/`X-Fair-*`/`X-Exhibit-*`/`X-Sxsw-*`/`X-Ces-*`/`X-Tgs-*`/`X-Comicmarket-*`/`X-Fairs-*`/`X-Exponavi-*`/`X-Expocenter-*`/`X-Exposhop-*`/`X-Expopro-*`/`X-Expomart-*`/`X-Expoplus-*`/`X-Exposmart-*`/`X-Expofamily-*`/`X-Exhibitionnavi-*`/`X-Exhibitioncenter-*`/`X-Exhibitionshop-*`/`X-Exhibitionpro-*`/`X-Exhibitionmart-*`/`X-Exhibitionplus-*`/`X-Exhibitionsmart-*`/`X-Exhibitionfamily-*`/`X-Messenavi-*`/`X-Messecenter-*`/`X-Messeshop-*`/`X-Messepro-*`/`X-Messemart-*`/`X-Messeplus-*`/`X-Messesmart-*`/`X-Messefamily-*`/`X-Tradeshownavi-*`/`X-Tradeshowcenter-*`/`X-Tradeshowshop-*`/`X-Tradeshowpro-*`/`X-Tradeshowmart-*`/`X-Tradeshowplus-*`/`X-Tradeshowsmart-*`/`X-Tradeshowfamily-*`/`X-Boothnavi-*`/`X-Boothcenter-*`/`X-Boothshop-*`/`X-Boothpro-*`/`X-Boothmart-*`/`X-Boothplus-*`/`X-Boothsmart-*`/`X-Boothfamily-*`/`X-Gakkainavi-*`/`X-Gakkaicenter-*`/`X-Gakkaishop-*`/`X-Gakkaipro-*`/`X-Gakkaimart-*`/`X-Gakkaiplus-*`/`X-Gakkaismart-*`/`X-Gakkaifamily-*` 等 は展機の通知記録 — 送信側が書くことは自称。出展料・ブース費・参加登録費の偽装は展示会詐欺の典型手口。(同人即売会は D559、セミナー機は D687)
- **修正**: `Envelope` に `expo_marks` + `has_expo_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 展印の自署を問え。

### Security — D713: `X-Rugby-*`/`X-Jrfu-*`/`X-Top14-*` 等のラグビー印自称が未検査

- **問題**: `X-Rugby-*`/`X-Jrfu-*`/`X-Top14-*`/`X-Premrugby-*`/`X-Urc-*`/`X-Sixnations-*`/`X-Allblacks-*`/`X-Springboks-*`/`X-Wallabies-*`/`X-Sungoliath-*`/`X-Wildknights-*`/`X-Harlequins-*`/`X-Crusaders-*`/`X-Chiefs-*`/`X-Rugbyworld-*`/`X-Rugbynavi-*`/`X-Rugbycenter-*`/`X-Rugbyshop-*`/`X-Rugbypro-*`/`X-Rugbymart-*`/`X-Rugbyplus-*`/`X-Rugbysmart-*`/`X-Rugbyfamily-*`/`X-Jrfunavi-*`/`X-Jrfucenter-*`/`X-Jrfushop-*`/`X-Jrfupro-*`/`X-Jrfumart-*`/`X-Jrfuplus-*`/`X-Jrfusmart-*`/`X-Jrfufamily-*`/`X-Top14navi-*`/`X-Top14center-*`/`X-Top14shop-*`/`X-Top14pro-*`/`X-Top14mart-*`/`X-Top14plus-*`/`X-Top14smart-*`/`X-Top14family-*`/`X-Premrugbynavi-*`/`X-Premrugbycenter-*`/`X-Premrugbyshop-*`/`X-Premrugbypro-*`/`X-Premrugbymart-*`/`X-Premrugbyplus-*`/`X-Premrugbysmart-*`/`X-Premrugbyfamily-*`/`X-Urcnavi-*`/`X-Urccenter-*`/`X-Urcshop-*`/`X-Urcpro-*`/`X-Urcmart-*`/`X-Urcplus-*`/`X-Urcsmart-*`/`X-Urcfamily-*`/`X-Sixnationsnavi-*`/`X-Sixnationscenter-*`/`X-Sixnationsshop-*`/`X-Sixnationspro-*`/`X-Sixnationsmart-*`/`X-Sixnationsplus-*`/`X-Sixnationssmart-*` 等 は蹴機の通知記録 — 送信側が書くことは自称。試合チケット・グッズ当選・ファンクラブ会費の偽装はラグビー詐欺の典型手口。(プロチーム機は D564、高校ラグビーは花園)
- **修正**: `Envelope` に `rugby_marks` + `has_rugby_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 蹴印の自署を問え。

### Security — D714: `X-Motorsport-*`/`X-Motogp-*`/`X-Nascar-*` 等のモータースポーツ印自称が未検査

- **問題**: `X-Motorsport-*`/`X-Motogp-*`/`X-Nascar-*`/`X-Supergt-*`/`X-Formula1-*`/`X-Wrc-*`/`X-Imsa-*`/`X-Wec-*`/`X-Lemans-*`/`X-Dakar-*`/`X-Kart-*`/`X-Indycar-*`/`X-Superformula-*`/`X-Btcc-*`/`X-Fim-*`/`X-Motorsportnavi-*`/`X-Motorsportcenter-*`/`X-Motorsportshop-*`/`X-Motorsportpro-*`/`X-Motorsportmart-*`/`X-Motorsportplus-*`/`X-Motorsportsmart-*`/`X-Motorsportfamily-*`/`X-Motogpnavi-*`/`X-Motogpcenter-*`/`X-Motogpshop-*`/`X-Motogppro-*`/`X-Motogpmart-*`/`X-Motogpplus-*`/`X-Motogpsmart-*`/`X-Motogpfamily-*`/`X-Nascarnavi-*`/`X-Nascarcenter-*`/`X-Nascarshop-*`/`X-Nascarpro-*`/`X-Nascarmart-*`/`X-Nascarplus-*`/`X-Nascarsmart-*`/`X-Nascarfamily-*`/`X-Supergtnavi-*`/`X-Supergtcenter-*`/`X-Supergtshop-*`/`X-Supergtpro-*`/`X-Supergtmart-*`/`X-Supergtplus-*`/`X-Supergtsmart-*`/`X-Supergtfamily-*`/`X-Formula1navi-*`/`X-Formula1center-*`/`X-Formula1shop-*`/`X-Formula1pro-*`/`X-Formula1mart-*`/`X-Formula1plus-*`/`X-Formula1smart-*`/`X-Formula1family-*`/`X-Wrcnavi-*`/`X-Wrccenter-*`/`X-Wrcshop-*`/`X-Wrcpro-*`/`X-Wrcmart-*`/`X-Wrcplus-*`/`X-Wrcsmart-*` 等 は走機の通知記録 — 送信側が書くことは自称。観戦チケット・パドックパス・グッズ抽選の偽装はモータースポーツ詐欺の典型手口。(競輪・オートレースは D547)
- **修正**: `Envelope` に `motorsport_marks` + `has_motorsport_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 走印の自署を問え。

### Security — D715: `X-Trekking-*`/`X-Hiking-*`/`X-Mountaineering-*` 等の山岳・トレッキング印自称が未検査

- **問題**: `X-Trekking-*`/`X-Hiking-*`/`X-Mountaineering-*`/`X-Tozan-*`/`X-Sangaku-*`/`X-Yama-*`/`X-Expedition-*`/`X-Crampon-*`/`X-Mountain-*`/`X-Sawanobori-*`/`X-Keiryu-*`/`X-Snowshoe-*`/`X-Trekkingnavi-*`/`X-Trekkingcenter-*`/`X-Trekkingshop-*`/`X-Trekkingpro-*`/`X-Trekkingmart-*`/`X-Trekkingplus-*`/`X-Trekkingsmart-*`/`X-Trekkingfamily-*`/`X-Hikingnavi-*`/`X-Hikingcenter-*`/`X-Hikingshop-*`/`X-Hikingpro-*`/`X-Hikingmart-*`/`X-Hikingplus-*`/`X-Hikingsmart-*`/`X-Hikingfamily-*`/`X-Mountaineeringnavi-*`/`X-Mountaineeringcenter-*`/`X-Mountaineeringshop-*`/`X-Mountaineeringpro-*`/`X-Mountaineeringmart-*`/`X-Mountaineeringplus-*`/`X-Mountaineeringsmart-*`/`X-Mountaineeringfamily-*`/`X-Tozannavi-*`/`X-Tozancenter-*`/`X-Tozanshop-*`/`X-Tozanpro-*`/`X-Tozanmart-*`/`X-Tozanplus-*`/`X-Tozansmart-*`/`X-Tozanfamily-*`/`X-Sangakunavi-*`/`X-Sangakucenter-*`/`X-Sangakushop-*`/`X-Sangakupro-*`/`X-Sangakumart-*`/`X-Sangakuplus-*`/`X-Sangakusmart-*`/`X-Sangakufamily-*`/`X-Yamanavi-*`/`X-Yamacenter-*`/`X-Yamashop-*`/`X-Yamapro-*`/`X-Yamamart-*`/`X-Yamaplus-*`/`X-Yamasmart-*`/`X-Yamafamily-*`/`X-Expeditionnavi-*`/`X-Expeditioncenter-*` 等 は山機の通知記録 — 送信側が書くことは自称。登山ツアー・山岳保険・遭難救助費用の偽装は山岳詐欺の典型手口。(モンベル・山アプリは既存、スキー機は D658)
- **修正**: `Envelope` に `trekking_marks` + `has_trekking_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 山印の自署を問え。

### Security — D710: `X-Nekocafe-*`/`X-Dogcafe-*`/`X-Owlcafe-*` 等の猫カフェ・動物カフェ印自称が未検査

- **問題**: `X-Nekocafe-*`/`X-Dogcafe-*`/`X-Owlcafe-*`/`X-Catcafe-*`/`X-Mameshiba-*`/`X-Hedgehogcafe-*`/`X-Harinezumi-*`/`X-Kotsumate-*`/`X-Birdscafe-*`/`X-Owlvillage-*`/`X-Capycafe-*`/`X-Kotori-*`/`X-Nekocafenavi-*`/`X-Nekocafecenter-*`/`X-Nekocafeshop-*`/`X-Nekocafepro-*`/`X-Nekocafemart-*`/`X-Nekocafeplus-*`/`X-Nekocafesmart-*`/`X-Nekocafefamily-*`/`X-Dogcafenavi-*`/`X-Dogcafecenter-*`/`X-Dogcafeshop-*`/`X-Dogcafepro-*`/`X-Dogcafemart-*`/`X-Dogcafeplus-*`/`X-Dogcafesmart-*`/`X-Dogcafefamily-*`/`X-Owlcafenavi-*`/`X-Owlcafecenter-*`/`X-Owlcafeshop-*`/`X-Owlcafepro-*`/`X-Owlcafemart-*`/`X-Owlcafeplus-*`/`X-Owlcafesmart-*`/`X-Owlcafefamily-*`/`X-Catcafenavi-*`/`X-Catcafecenter-*`/`X-Catcafeshop-*`/`X-Catcafepro-*`/`X-Catcafemart-*`/`X-Catcafeplus-*`/`X-Catcafesmart-*`/`X-Catcafefamily-*`/`X-Mameshibanavi-*`/`X-Mameshibacenter-*`/`X-Mameshibashop-*`/`X-Mameshibapro-*`/`X-Mameshibamart-*`/`X-Mameshibaplus-*`/`X-Mameshibasmart-*`/`X-Mameshibafamily-*`/`X-Hedgehogcafenavi-*`/`X-Hedgehogcafecenter-*`/`X-Hedgehogcafeshop-*`/`X-Hedgehogcafepro-*`/`X-Hedgehogcafemart-*`/`X-Hedgehogcafeplus-*`/`X-Hedgehogcafesmart-*`/`X-Hedgehogcafefamily-*`/`X-Harinezuminavi-*`/`X-Harinezumicenter-*` 等 は猫機の通知記録 — 送信側が書くことは自称。入場料・ふれあい料金・ドリンク注文の偽装は動物カフェ詐欺の典型手口。(ペットショップ機は D662、ペット保険機は D561)
- **修正**: `Envelope` に `nekocafe_marks` + `has_nekocafe_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 猫印の自署を問え。

### Security — D711: `X-Shichiya-*`/`X-Pawn-*`/`X-Pawnshop-*` 等の質屋・古物商・蚤の市印自称が未検査

- **問題**: `X-Shichiya-*`/`X-Pawn-*`/`X-Pawnshop-*`/`X-Kobutsu-*`/`X-Fleamarket-*`/`X-Nominoichi-*`/`X-Secondhand-*`/`X-Reuse-*`/`X-Recycle-*`/`X-Furugi-*`/`X-Vintage-*`/`X-Kotto-*`/`X-Flea-*`/`X-Swapmeet-*`/`X-Antiquemarket-*`/`X-Shichiyanavi-*`/`X-Shichiyacenter-*`/`X-Shichiyashop-*`/`X-Shichiyapro-*`/`X-Shichiyamart-*`/`X-Shichiyaplus-*`/`X-Shichiyasmart-*`/`X-Shichiyafamily-*`/`X-Pawnnavi-*`/`X-Pawncenter-*`/`X-Pawnshop-*`/`X-Pawnpro-*`/`X-Pawnmart-*`/`X-Pawnplus-*`/`X-Pawnsmart-*`/`X-Pawnfamily-*`/`X-Pawnshopnavi-*`/`X-Pawnshopcenter-*`/`X-Pawnshopshop-*`/`X-Pawnshoppro-*`/`X-Pawnshopmart-*`/`X-Pawnshopplus-*`/`X-Pawnshopsmart-*`/`X-Pawnshopfamily-*`/`X-Kobutsunavi-*`/`X-Kobutsucenter-*`/`X-Kobutsushop-*`/`X-Kobutsupro-*`/`X-Kobutsumart-*`/`X-Kobutsuplus-*`/`X-Kobutsusmart-*`/`X-Kobutsufamily-*`/`X-Fleamarketnavi-*`/`X-Fleamarketcenter-*`/`X-Fleamarketshop-*`/`X-Fleamarketpro-*`/`X-Fleamarketmart-*`/`X-Fleamarketplus-*`/`X-Fleamarketsmart-*`/`X-Fleamarketfamily-*`/`X-Nominoichinavi-*`/`X-Nominoichicenter-*`/`X-Nominoichishop-*`/`X-Nominoichipro-*`/`X-Nominoichimart-*`/`X-Nominoichiplus-*`/`X-Nominoichismart-*` 等 は質機の通知記録 — 送信側が書くことは自称。買取査定・質預かり・古物許可証の偽装は質屋詐欺の典型手口。(中古買取機は D576、骨董機は D623)
- **修正**: `Envelope` に `shichiya_marks` + `has_shichiya_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 質印の自署を問え。

### Security — D712: `X-Escape-*`/`X-Escaperoom-*`/`X-Nazotoki-*` 等の脱出ゲーム・謎解き・ボードゲーム印自称が未検査

- **問題**: `X-Escape-*`/`X-Escaperoom-*`/`X-Nazotoki-*`/`X-Nazo-*`/`X-Realdasshutsu-*`/`X-Jinro-*`/`X-Werewolf-*`/`X-Boardgame-*`/`X-Dicecafe-*`/`X-Mystery-*`/`X-Puzzle-*`/`X-Treasurehunt-*`/`X-Riddle-*`/`X-Scav-*`/`X-Spygame-*`/`X-Escapenavi-*`/`X-Escapecenter-*`/`X-Escapeshop-*`/`X-Escapepro-*`/`X-Escapemart-*`/`X-Escapeplus-*`/`X-Escapesmart-*`/`X-Escapefamily-*`/`X-Escaperoomnavi-*`/`X-Escaperoomcenter-*`/`X-Escaperoomshop-*`/`X-Escaperoompro-*`/`X-Escaperoommart-*`/`X-Escaperoomplus-*`/`X-Escaperoomsmart-*`/`X-Escaperoomfamily-*`/`X-Nazotokinavi-*`/`X-Nazotokicenter-*`/`X-Nazotokishop-*`/`X-Nazotokipro-*`/`X-Nazotokimart-*`/`X-Nazotokiplus-*`/`X-Nazotokismart-*`/`X-Nazotokifamily-*`/`X-Nazonavi-*`/`X-Nazocenter-*`/`X-Nazoshop-*`/`X-Nazopro-*`/`X-Nazomart-*`/`X-Nazoplus-*`/`X-Nazosmart-*`/`X-Nazofamily-*`/`X-Realdasshutsunavi-*`/`X-Realdasshutsucenter-*`/`X-Realdasshutsushop-*`/`X-Realdasshutsupro-*`/`X-Realdasshutsumart-*`/`X-Realdasshutsuplus-*`/`X-Realdasshutsusmart-*`/`X-Realdasshutsufamily-*`/`X-Jinronavi-*`/`X-Jinrocenter-*`/`X-Jinroshop-*`/`X-Jinropro-*`/`X-Jinromart-*`/`X-Jinroplus-*`/`X-Jinrosmart-*` 等 は謎機の通知記録 — 送信側が書くことは自称。チケット・イベント参加費・グッズ予約の偽装は謎解き詐欺の典型手口。(TCG機は D559、ライブハウス機は D672)
- **修正**: `Envelope` に `nazotoki_marks` + `has_nazotoki_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 謎印の自署を問え。

### Security — D707: `X-Sabage-*`/`X-Airgun-*`/`X-Paintball-*` 等のサバゲー・エアガン印自称が未検査

- **問題**: `X-Sabage-*`/`X-Airgun-*`/`X-Paintball-*`/`X-Airsoft-*`/`X-Tokyomarui-*`/`X-Survival-*`/`X-Sabbage-*`/`X-Field-*`/`X-Camo-*`/`X-Tacticool-*`/`X-Ghillie-*`/`X-Aresguns-*`/`X-Vfc-*`/`X-Sabagenavi-*`/`X-Sabagecenter-*`/`X-Sabageshop-*`/`X-Sabagepro-*`/`X-Sabagemart-*`/`X-Sabageplus-*`/`X-Sabagesmart-*`/`X-Sabagefamily-*`/`X-Airgunnavi-*`/`X-Airguncenter-*`/`X-Airgunshop-*`/`X-Airgunpro-*`/`X-Airgunmart-*`/`X-Airgunplus-*`/`X-Airgunsmart-*`/`X-Airgunfamily-*`/`X-Paintballnavi-*`/`X-Paintballcenter-*`/`X-Paintballshop-*`/`X-Paintballpro-*`/`X-Paintballmart-*`/`X-Paintballplus-*`/`X-Paintballsmart-*`/`X-Paintballfamily-*`/`X-Airsoftnavi-*`/`X-Airsoftcenter-*`/`X-Airsoftshop-*`/`X-Airsoftpro-*`/`X-Airsoftmart-*`/`X-Airsoftplus-*`/`X-Airsoftsmart-*`/`X-Airsoftfamily-*`/`X-Tokyomaruinavi-*`/`X-Tokyomaruicenter-*`/`X-Tokyomaruishop-*`/`X-Tokyomaruipro-*`/`X-Tokyomaruimart-*`/`X-Tokyomaruiplus-*`/`X-Tokyomaruismart-*`/`X-Tokyomaruifamily-*`/`X-Survivalnavi-*`/`X-Survivalcenter-*`/`X-Survivalshop-*`/`X-Survivalpro-*`/`X-Survivalmart-*`/`X-Survivalplus-*`/`X-Survivalsmart-*`/`X-Survivalfamily-*`/`X-Sabbagenavi-*` 等 は撃機の通知記録 — 送信側が書くことは自称。フィールド予約・エアガン販売・カスタム品注文の偽装はサバゲー詐欺の典型手口。(玩具機は D558、狩猟機は未整備)
- **修正**: `Envelope` に `sabage_marks` + `has_sabage_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 撃印の自署を問え。

### Security — D708: `X-Reiki-*`/`X-Qigong-*`/`X-Meditation-*` 等の瞑想・スピリチュアル・レイキ印自称が未検査

- **問題**: `X-Reiki-*`/`X-Qigong-*`/`X-Meditation-*`/`X-Meiso-*`/`X-Hikiyose-*`/`X-Kaiun-*`/`X-Fengshui-*`/`X-Kiko-*`/`X-Hypno-*`/`X-Mindfulness-*`/`X-Zen-*`/`X-Vipassana-*`/`X-Chakra-*`/`X-Reikinavi-*`/`X-Reikicenter-*`/`X-Reikishop-*`/`X-Reikipro-*`/`X-Reikimart-*`/`X-Reikiplus-*`/`X-Reikismart-*`/`X-Reikifamily-*`/`X-Qigongnavi-*`/`X-Qigongcenter-*`/`X-Qigongshop-*`/`X-Qigongpro-*`/`X-Qigongmart-*`/`X-Qigongplus-*`/`X-Qigongsmart-*`/`X-Qigongfamily-*`/`X-Meditationnavi-*`/`X-Meditationcenter-*`/`X-Meditationshop-*`/`X-Meditationpro-*`/`X-Meditationmart-*`/`X-Meditationplus-*`/`X-Meditationsmart-*`/`X-Meditationfamily-*`/`X-Meisonavi-*`/`X-Meisocenter-*`/`X-Meisoshop-*`/`X-Meisopro-*`/`X-Meisomart-*`/`X-Meisoplus-*`/`X-Meisosmart-*`/`X-Meisofamily-*`/`X-Hikiyosenavi-*`/`X-Hikiyosecenter-*`/`X-Hikiyoseshop-*`/`X-Hikiyosepro-*`/`X-Hikiyosemart-*`/`X-Hikiyoseplus-*`/`X-Hikiyosesmart-*`/`X-Hikiyosefamily-*`/`X-Kaiunnavi-*`/`X-Kaiuncenter-*`/`X-Kaiunshop-*`/`X-Kaiunpro-*`/`X-Kaiunmart-*`/`X-Kaiunplus-*`/`X-Kaiunsmart-*`/`X-Kaiunfamily-*`/`X-Fengshuinavi-*` 等 は霊機の通知記録 — 送信側が書くことは自称。霊感商法・高額セミナー・開運グッズの勧誘はスピリチュアル詐欺の典型手口。(占い機は D574、Calm/Headspace は別族)
- **修正**: `Envelope` に `spiritual_marks` + `has_spiritual_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 霊印の自署を問え。

### Security — D709: `X-Matsuri-*`/`X-Hanabi-*`/`X-Bonodori-*` 等の祭り・花火大会・縁日印自称が未検査

- **問題**: `X-Matsuri-*`/`X-Hanabi-*`/`X-Bonodori-*`/`X-Ennichi-*`/`X-Yomise-*`/`X-Shutten-*`/`X-Yatai-*`/`X-Omatsuri-*`/`X-Mikoshi-*`/`X-Nebuta-*`/`X-Awaodori-*`/`X-Yosakoi-*`/`X-Kanda-*`/`X-Gion-*`/`X-Tenjin-*`/`X-Festival-*`/`X-Matsurinavi-*`/`X-Matsuricenter-*`/`X-Matsurishop-*`/`X-Matsuripro-*`/`X-Matsurimart-*`/`X-Matsuriplus-*`/`X-Matsurismart-*`/`X-Matsurifamily-*`/`X-Hanabinavi-*`/`X-Hanabicenter-*`/`X-Hanabishop-*`/`X-Hanabipro-*`/`X-Hanabimart-*`/`X-Hanabiplus-*`/`X-Hanabismart-*`/`X-Hanabifamily-*`/`X-Bonodorinavi-*`/`X-Bonodoricenter-*`/`X-Bonodorishop-*`/`X-Bonodoripro-*`/`X-Bonodorimart-*`/`X-Bonodoriplus-*`/`X-Bonodorismart-*`/`X-Bonodorifamily-*`/`X-Ennichinavi-*`/`X-Ennichicenter-*`/`X-Ennichishop-*`/`X-Ennichipro-*`/`X-Ennichimart-*`/`X-Ennichiplus-*`/`X-Ennichismart-*`/`X-Ennichifamily-*`/`X-Yomisenavi-*`/`X-Yomisecenter-*`/`X-Yomiseshop-*`/`X-Yomisepro-*`/`X-Yomisemart-*`/`X-Yomiseplus-*`/`X-Yomisesmart-*`/`X-Yomisefamily-*`/`X-Shuttennavi-*`/`X-Shuttencenter-*`/`X-Shuttenshop-*`/`X-Shuttenpro-*`/`X-Shuttenmart-*`/`X-Shuttenplus-*` 等 は祭機の通知記録 — 送信側が書くことは自称。出店料・協賛金・観覧席チケットの偽装は祭り詐欺の典型手口。(ライブハウス機は D672、娯楽機は D536)
- **修正**: `Envelope` に `matsuri_marks` + `has_matsuri_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 祭印の自署を問え。

### Security — D704: `X-Jouba-*`/`X-Riding-*`/`X-Equestrian-*` 等の乗馬・馬術印自称が未検査

- **問題**: `X-Jouba-*`/`X-Riding-*`/`X-Equestrian-*`/`X-Horse-*`/`X-Horseriding-*`/`X-Uma-*`/`X-Bajou-*`/`X-Pony-*`/`X-Stable-*`/`X-Kiba-*`/`X-Dressage-*`/`X-Horseshow-*`/`X-Equine-*`/`X-Joubanavi-*`/`X-Joubacenter-*`/`X-Joubashop-*`/`X-Joubapro-*`/`X-Joubamart-*`/`X-Joubaplus-*`/`X-Joubasmart-*`/`X-Joubafamily-*`/`X-Ridingnavi-*`/`X-Ridingcenter-*`/`X-Ridingshop-*`/`X-Ridingpro-*`/`X-Ridingmart-*`/`X-Ridingplus-*`/`X-Ridingsmart-*`/`X-Ridingfamily-*`/`X-Equestriannavi-*`/`X-Equestriancenter-*`/`X-Equestrianshop-*`/`X-Equestrianpro-*`/`X-Equestrianmart-*`/`X-Equestrianplus-*`/`X-Equestriansmart-*`/`X-Equestrianfamily-*`/`X-Horsenavi-*`/`X-Horsecenter-*`/`X-Horseshop-*`/`X-Horsepro-*`/`X-Horsemart-*`/`X-Horseplus-*`/`X-Horsesmart-*`/`X-Horsefamily-*`/`X-Horseridingnavi-*`/`X-Horseridingcenter-*`/`X-Horseridingshop-*`/`X-Horseridingpro-*`/`X-Horseridingmart-*`/`X-Horseridingplus-*`/`X-Horseridingsmart-*`/`X-Horseridingfamily-*`/`X-Umanavi-*`/`X-Umacenter-*`/`X-Umashop-*`/`X-Umapro-*`/`X-Umamart-*`/`X-Umaplus-*`/`X-Umasmart-*`/`X-Umafamily-*`/`X-Bajounavi-*` 等 は馬機の通知記録 — 送信側が書くことは自称。乗馬クラブ会員権・レッスン料・馬保険の偽装は乗馬詐欺の典型手口。(JRA機は D547、牧場機は D563)
- **修正**: `Envelope` に `jouba_marks` + `has_jouba_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 馬印の自署を問え。

### Security — D705: `X-Aikido-*`/`X-Kyudo-*`/`X-Iaido-*` 等の武道・弓道・フェンシング印自称が未検査

- **問題**: `X-Aikido-*`/`X-Kyudo-*`/`X-Iaido-*`/`X-Kobudo-*`/`X-Kenjutsu-*`/`X-Budokan-*`/`X-Shorinji-*`/`X-Taekwondo-*`/`X-Jiujitsu-*`/`X-Bjj-*`/`X-Archery-*`/`X-Fencing-*`/`X-Shooting-*`/`X-Aikidonavi-*`/`X-Aikidocenter-*`/`X-Aikidoshop-*`/`X-Aikidopro-*`/`X-Aikidomart-*`/`X-Aikidoplus-*`/`X-Aikidosmart-*`/`X-Aikidofamily-*`/`X-Kyudonavi-*`/`X-Kyudocenter-*`/`X-Kyudoshop-*`/`X-Kyudopro-*`/`X-Kyudomart-*`/`X-Kyudoplus-*`/`X-Kyudosmart-*`/`X-Kyudofamily-*`/`X-Iaidonavi-*`/`X-Iaidocenter-*`/`X-Iaidoshop-*`/`X-Iaidopro-*`/`X-Iaidomart-*`/`X-Iaidoplus-*`/`X-Iaidosmart-*`/`X-Iaidofamily-*`/`X-Kobudonavi-*`/`X-Kobudocenter-*`/`X-Kobudoshop-*`/`X-Kobudopro-*`/`X-Kobudomart-*`/`X-Kobudoplus-*`/`X-Kobudosmart-*`/`X-Kobudofamily-*`/`X-Kenjutsunavi-*`/`X-Kenjutsucenter-*`/`X-Kenjutsushop-*`/`X-Kenjutsupro-*`/`X-Kenjutsumart-*`/`X-Kenjutsuplus-*`/`X-Kenjutsusmart-*`/`X-Kenjutsufamily-*`/`X-Budokannavi-*`/`X-Budokancenter-*`/`X-Budokanshop-*`/`X-Budokanpro-*`/`X-Budokanmart-*`/`X-Budokanplus-*`/`X-Budokansmart-*`/`X-Budokanfamily-*`/`X-Shorinjinavi-*` 等 は武機の通知記録 — 送信側が書くことは自称。道場月謝・段位審査・防具販売の偽装は武道詐欺の典型手口。(空手・柔道・剣道は泳機に含む、格闘技機は D699)
- **修正**: `Envelope` に `budo_marks` + `has_budo_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 武印の自署を問え。

### Security — D706: `X-Radio-*`/`X-Jwave-*`/`X-Tokyofm-*` 等のラジオ・コミュニティFM印自称が未検査

- **問題**: `X-Radio-*`/`X-Jwave-*`/`X-Tokyofm-*`/`X-Bayfm-*`/`X-Nack5-*`/`X-Fmyokohama-*`/`X-Zipfm-*`/`X-Lovefm-*`/`X-Fm802-*`/`X-Northwave-*`/`X-Aircfm-*`/`X-Datefm-*`/`X-Tbsradio-*`/`X-Bunkahoso-*`/`X-Mbsradio-*`/`X-Abcradio-*`/`X-Rkb-*`/`X-Communityfm-*`/`X-Interfm-*`/`X-Radiko-*`/`X-Radiru-*`/`X-Radionavi-*`/`X-Radiocenter-*`/`X-Radioshop-*`/`X-Radiopro-*`/`X-Radiomart-*`/`X-Radioplus-*`/`X-Radiosmart-*`/`X-Radiofamily-*`/`X-Jwavenavi-*`/`X-Jwavecenter-*`/`X-Jwaveshop-*`/`X-Jwavepro-*`/`X-Jwavemart-*`/`X-Jwaveplus-*`/`X-Jwavesmart-*`/`X-Jwavefamily-*`/`X-Tokyofmnavi-*`/`X-Tokyofmcenter-*`/`X-Tokyofmshop-*`/`X-Tokyofmpro-*`/`X-Tokyofmmart-*`/`X-Tokyofmplus-*`/`X-Tokyofmsmart-*`/`X-Tokyofmfamily-*`/`X-Bayfmnavi-*`/`X-Bayfmcenter-*`/`X-Bayfmshop-*`/`X-Bayfmpro-*`/`X-Bayfmmart-*`/`X-Bayfmplus-*`/`X-Bayfmsmart-*`/`X-Bayfmfamily-*`/`X-Nack5navi-*`/`X-Nack5center-*`/`X-Nack5shop-*`/`X-Nack5pro-*`/`X-Nack5mart-*`/`X-Nack5plus-*`/`X-Nack5smart-*`/`X-Nack5family-*`/`X-Fmyokohamanavi-*` 等 は波機の通知記録 — 送信側が書くことは自称。リスナープレゼント・番組協賛・投稿採用通知の偽装はラジオ詐欺の典型手口。(放送局機は D549、配信機は D516)
- **修正**: `Envelope` に `radio_marks` + `has_radio_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 波印の自署を問え。

### Security — D701: `X-Minpaku-*`/`X-Vacationrental-*`/`X-Villa-*` 等の民泊・旅館・グランピング印自称が未検査

- **問題**: `X-Minpaku-*`/`X-Vacationrental-*`/`X-Villa-*`/`X-Cottage-*`/`X-Glamping-*`/`X-Ryokan-*`/`X-Minshuku-*`/`X-Auberge-*`/`X-Besso-*`/`X-Hatago-*`/`X-Kominka-*`/`X-Machiya-*`/`X-Kokuminshukusha-*`/`X-Minpakunavi-*`/`X-Minpakucenter-*`/`X-Minpakushop-*`/`X-Minpakupro-*`/`X-Minpakumart-*`/`X-Minpakuplus-*`/`X-Minpakusmart-*`/`X-Minpakufamily-*`/`X-Vacationrentalnavi-*`/`X-Vacationrentalcenter-*`/`X-Vacationrentalshop-*`/`X-Vacationrentalpro-*`/`X-Vacationrentalmart-*`/`X-Vacationrentalplus-*`/`X-Vacationrentalsmart-*`/`X-Vacationrentalfamily-*`/`X-Villanavi-*`/`X-Villacenter-*`/`X-Villashop-*`/`X-Villapro-*`/`X-Villamart-*`/`X-Villaplus-*`/`X-Villasmart-*`/`X-Villafamily-*`/`X-Cottagenavi-*`/`X-Cottagecenter-*`/`X-Cottageshop-*`/`X-Cottagepro-*`/`X-Cottagemart-*`/`X-Cottageplus-*`/`X-Cottagesmart-*`/`X-Cottagefamily-*`/`X-Glampingnavi-*`/`X-Glampingcenter-*`/`X-Glampingshop-*`/`X-Glampingpro-*`/`X-Glampingmart-*`/`X-Glampingplus-*`/`X-Glampingsmart-*`/`X-Glampingfamily-*`/`X-Ryokannavi-*`/`X-Ryokancenter-*`/`X-Ryokanshop-*`/`X-Ryokanpro-*`/`X-Ryokanmart-*`/`X-Ryokanplus-*`/`X-Ryokansmart-*`/`X-Ryokanfamily-*`/`X-Minshukunavi-*` 等 は民機の通知記録 — 送信側が書くことは自称。民泊料金・清掃費・違法民泊取り締まりの偽装は民泊詐欺の典型手口。(ホテル機は D535、旅行代理店機は D573)
- **修正**: `Envelope` に `minpaku_marks` + `has_minpaku_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 民印の自署を問え。

### Security — D702: `X-Maidcafe-*`/`X-Concafe-*`/`X-Cosplay-*` 等のメイドカフェ・コンカフェ・コスプレ印自称が未検査

- **問題**: `X-Maidcafe-*`/`X-Concafe-*`/`X-Cosplay-*`/`X-Maid-*`/`X-Maidreamin-*`/`X-Athomecafe-*`/`X-Butler-*`/`X-Shitsuji-*`/`X-Akiba-*`/`X-Cos-*`/`X-Kosupure-*`/`X-Coscafe-*`/`X-Maidcafenavi-*`/`X-Maidcafecenter-*`/`X-Maidcafeshop-*`/`X-Maidcafepro-*`/`X-Maidcafemart-*`/`X-Maidcafeplus-*`/`X-Maidcafesmart-*`/`X-Maidcafefamily-*`/`X-Concafenavi-*`/`X-Concafecenter-*`/`X-Concafeshop-*`/`X-Concafepro-*`/`X-Concafemart-*`/`X-Concafeplus-*`/`X-Concafesmart-*`/`X-Concafefamily-*`/`X-Cosplaynavi-*`/`X-Cosplaycenter-*`/`X-Cosplayshop-*`/`X-Cosplaypro-*`/`X-Cosplaymart-*`/`X-Cosplayplus-*`/`X-Cosplaysmart-*`/`X-Cosplayfamily-*`/`X-Maidnavi-*`/`X-Maidcenter-*`/`X-Maidshop-*`/`X-Maidpro-*`/`X-Maidmart-*`/`X-Maidplus-*`/`X-Maidsmart-*`/`X-Maidfamily-*`/`X-Maidreaminnavi-*`/`X-Maidreamincenter-*`/`X-Maidreaminshop-*`/`X-Maidreaminpro-*`/`X-Maidreaminmart-*`/`X-Maidreaminplus-*`/`X-Maidreaminsmart-*`/`X-Maidreaminfamily-*`/`X-Athomecafenavi-*`/`X-Athomecafecenter-*`/`X-Athomecafeshop-*`/`X-Athomecafepro-*`/`X-Athomecafemart-*`/`X-Athomecafeplus-*`/`X-Athomecafesmart-*`/`X-Athomecafefamily-*`/`X-Butlernavi-*`/`X-Butlercenter-*` 等 は喫機の通知記録 — 送信側が書くことは自称。チャージ料・撮影料・ぼったくり請求の偽装はコンカフェ詐欺の典型手口。(ネットカフェ機は D698、漫画喫茶は同族)
- **修正**: `Envelope` に `maidcafe_marks` + `has_maidcafe_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 喫印の自署を問え。

### Security — D703: `X-Shinkyuu-*`/`X-Harikyuu-*`/`X-Kyuu-*` 等の鍼灸・漢方・東洋医学印自称が未検査

- **問題**: `X-Shinkyuu-*`/`X-Harikyuu-*`/`X-Kyuu-*`/`X-Toyou-*`/`X-Touyaku-*`/`X-Kampou-*`/`X-Kampo-*`/`X-Kanpo-*`/`X-Acupuncture-*`/`X-Moxibustion-*`/`X-Acu-*`/`X-Okyu-*`/`X-Yakuzen-*`/`X-Shinkyuunavi-*`/`X-Shinkyuucenter-*`/`X-Shinkyuushop-*`/`X-Shinkyuupro-*`/`X-Shinkyuumart-*`/`X-Shinkyuuplus-*`/`X-Shinkyuusmart-*`/`X-Shinkyuufamily-*`/`X-Harikyuunavi-*`/`X-Harikyuucenter-*`/`X-Harikyuushop-*`/`X-Harikyuupro-*`/`X-Harikyuumart-*`/`X-Harikyuuplus-*`/`X-Harikyuusmart-*`/`X-Harikyuufamily-*`/`X-Kyuunavi-*`/`X-Kyuucenter-*`/`X-Kyuushop-*`/`X-Kyuupro-*`/`X-Kyuumart-*`/`X-Kyuuplus-*`/`X-Kyuusmart-*`/`X-Kyuufamily-*`/`X-Toyounavi-*`/`X-Toyoucenter-*`/`X-Toyoushop-*`/`X-Toyoupro-*`/`X-Toyoumart-*`/`X-Toyouplus-*`/`X-Toyousmart-*`/`X-Toyoufamily-*`/`X-Touyakunavi-*`/`X-Touyakucenter-*`/`X-Touyakushop-*`/`X-Touyakupro-*`/`X-Touyakumart-*`/`X-Touyakuplus-*`/`X-Touyakusmart-*`/`X-Touyakufamily-*`/`X-Kampounavi-*`/`X-Kampoucenter-*`/`X-Kampoushop-*`/`X-Kampoupro-*`/`X-Kampoumart-*`/`X-Kampouplus-*`/`X-Kampousmart-*`/`X-Kampoufamily-*`/`X-Kamponavi-*` 等 は鍼機の通知記録 — 送信側が書くことは自称。漢方薬の高額購入・治療費請求・免許偽装は東洋医学詐欺の典型手口。(接骨院機は D629、エステ機は D608)
- **修正**: `Envelope` に `shinkyuu_marks` + `has_shinkyuu_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 鍼印の自署を問え。

### Security — D698: `X-Netcafe-*`/`X-Mangakissa-*`/`X-Kissa-*` 等のネットカフェ・漫画喫茶印自称が未検査

- **問題**: `X-Netcafe-*`/`X-Mangakissa-*`/`X-Kissa-*`/`X-Jiyu-*`/`X-Bagus-*`/`X-Manboo-*`/`X-Geragera-*`/`X-Customa-*`/`X-Cybercafe-*`/`X-Mangacafe-*`/`X-Comicbuster-*`/`X-Popai-*`/`X-Netcafenavi-*`/`X-Netcafecenter-*`/`X-Netcafeshop-*`/`X-Netcafepro-*`/`X-Netcafemart-*`/`X-Netcafeplus-*`/`X-Netcafesmart-*`/`X-Netcafefamily-*`/`X-Mangakissanavi-*`/`X-Mangakissacenter-*`/`X-Mangakissashop-*`/`X-Mangakissapro-*`/`X-Mangakissamart-*`/`X-Mangakissaplus-*`/`X-Mangakissasmart-*`/`X-Mangakissafamily-*`/`X-Kissanavi-*`/`X-Kissacenter-*`/`X-Kissashop-*`/`X-Kissapro-*`/`X-Kissamart-*`/`X-Kissaplus-*`/`X-Kissasmart-*`/`X-Kissafamily-*`/`X-Jiyunavi-*`/`X-Jiyucenter-*`/`X-Jiyushop-*`/`X-Jiyupro-*`/`X-Jiyumart-*`/`X-Jiyuplus-*`/`X-Jiyusmart-*`/`X-Jiyufamily-*`/`X-Bagusnavi-*`/`X-Baguscenter-*`/`X-Bagusshop-*`/`X-Baguspro-*`/`X-Bagusmart-*`/`X-Bagusplus-*`/`X-Bagussmart-*`/`X-Bagusfamily-*`/`X-Manboonavi-*`/`X-Manboocenter-*`/`X-Manbooshop-*`/`X-Manboopro-*`/`X-Manboomart-*`/`X-Manbooplus-*`/`X-Manboosmart-*`/`X-Manboofamily-*`/`X-Gerageranavi-*`/`X-Gerageracenter-*` 等 は漫機の通知記録 — 送信側が書くことは自称。会員証・料金請求・宿泊パックの偽装はネットカフェ詐欺の典型手口。(快活・メディアカフェ・スペースクリエイトは既存、漫画機は D557)
- **修正**: `Envelope` に `netcafe_marks` + `has_netcafe_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 漫印の自署を問え。

### Security — D699: `X-Boxing-*`/`X-Mma-*`/`X-Ufc-*` 等の格闘技・プロレス・相撲印自称が未検査

- **問題**: `X-Boxing-*`/`X-Mma-*`/`X-Ufc-*`/`X-Rizin-*`/`X-K1-*`/`X-Bellator-*`/`X-Onefc-*`/`X-Puroresu-*`/`X-Njpw-*`/`X-Wwe-*`/`X-Ajpw-*`/`X-Sumo-*`/`X-Ozumo-*`/`X-Kakutougi-*`/`X-Shooto-*`/`X-Pancrase-*`/`X-Deep-*`/`X-Krush-*`/`X-Glory-*`/`X-Boxingnavi-*`/`X-Boxingcenter-*`/`X-Boxingshop-*`/`X-Boxingpro-*`/`X-Boxingmart-*`/`X-Boxingplus-*`/`X-Boxingsmart-*`/`X-Boxingfamily-*`/`X-Mmanavi-*`/`X-Mmacenter-*`/`X-Mmashop-*`/`X-Mmapro-*`/`X-Mmamart-*`/`X-Mmaplus-*`/`X-Mmasmart-*`/`X-Mmafamily-*`/`X-Ufcnavi-*`/`X-Ufccenter-*`/`X-Ufcshop-*`/`X-Ufcpro-*`/`X-Ufcmart-*`/`X-Ufcplus-*`/`X-Ufcsmart-*`/`X-Ufcfamily-*`/`X-Rizinnavi-*`/`X-Rizincenter-*`/`X-Rizinshop-*`/`X-Rizinpro-*`/`X-Rizinmart-*`/`X-Rizinplus-*`/`X-Rizinsmart-*`/`X-Rizinfamily-*`/`X-K1navi-*`/`X-K1center-*`/`X-K1shop-*`/`X-K1pro-*`/`X-K1mart-*`/`X-K1plus-*`/`X-K1smart-*`/`X-K1family-*`/`X-Bellatornavi-*`/`X-Bellatorcenter-*`/`X-Bellatorshop-*` 等 は闘機の通知記録 — 送信側が書くことは自称。観戦チケット・PPV購入・グッズ販売の偽装は格闘技詐欺の典型手口。(プロチーム機は D564、娯楽機は D536)
- **修正**: `Envelope` に `fight_marks` + `has_fight_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 闘印の自署を問え。

### Security — D700: `X-Bouldering-*`/`X-Climbing-*`/`X-Skate-*` 等のクライミング・フットサル・室内スポーツ印自称が未検査

- **問題**: `X-Bouldering-*`/`X-Climbing-*`/`X-Skate-*`/`X-Skateboard-*`/`X-Iceskate-*`/`X-Rink-*`/`X-Badminton-*`/`X-Takkyu-*`/`X-Tabletennis-*`/`X-Pingpong-*`/`X-Squash-*`/`X-Trampoline-*`/`X-Athletic-*`/`X-Parkour-*`/`X-Futsal-*`/`X-Footsal-*`/`X-Boulderingnavi-*`/`X-Boulderingcenter-*`/`X-Boulderingshop-*`/`X-Boulderingpro-*`/`X-Boulderingmart-*`/`X-Boulderingplus-*`/`X-Boulderingsmart-*`/`X-Boulderingfamily-*`/`X-Climbingnavi-*`/`X-Climbingcenter-*`/`X-Climbingshop-*`/`X-Climbingpro-*`/`X-Climbingmart-*`/`X-Climbingplus-*`/`X-Climbingsmart-*`/`X-Climbingfamily-*`/`X-Skatenavi-*`/`X-Skatecenter-*`/`X-Skateshop-*`/`X-Skatepro-*`/`X-Skatemart-*`/`X-Skateplus-*`/`X-Skatesmart-*`/`X-Skatefamily-*`/`X-Skateboardnavi-*`/`X-Skateboardcenter-*`/`X-Skateboardshop-*`/`X-Skateboardpro-*`/`X-Skateboardmart-*`/`X-Skateboardplus-*`/`X-Skateboardsmart-*`/`X-Skateboardfamily-*`/`X-Iceskatenavi-*`/`X-Iceskatecenter-*`/`X-Iceskateshop-*`/`X-Iceskatepro-*`/`X-Iceskatemart-*`/`X-Iceskateplus-*`/`X-Iceskatesmart-*`/`X-Iceskatefamily-*`/`X-Rinknavi-*`/`X-Rinkcenter-*`/`X-Rinkshop-*`/`X-Rinkpro-*`/`X-Rinkmart-*`/`X-Rinkplus-*` 等 は登機の通知記録 — 送信側が書くことは自称。月会費・利用料請求・スクール入会の偽装は室内スポーツ詐欺の典型手口。(スポーツ教室機は D682、フィットネス機は D530)
- **修正**: `Envelope` に `climbing_marks` + `has_climbing_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 登印の自署を問え。

### Security — D695: `X-Diving-*`/`X-Dive-*`/`X-Surf-*` 等のダイビング・マリンスポーツ印自称が未検査

- **問題**: `X-Diving-*`/`X-Dive-*`/`X-Surf-*`/`X-Surfing-*`/`X-Marine-*`/`X-Marinesport-*`/`X-Sup-*`/`X-Wakeboard-*`/`X-Jetski-*`/`X-Snorkeling-*`/`X-Seasport-*`/`X-Beach-*`/`X-Ocean-*`/`X-Padi-*`/`X-Ssi-*`/`X-Naui-*`/`X-Bsac-*`/`X-Cmas-*`/`X-Divingnavi-*`/`X-Divingcenter-*`/`X-Divingshop-*`/`X-Divingpro-*`/`X-Divingmart-*`/`X-Divingplus-*`/`X-Divingsmart-*`/`X-Divingfamily-*`/`X-Divenavi-*`/`X-Divecenter-*`/`X-Diveshop-*`/`X-Divepro-*`/`X-Divemart-*`/`X-Diveplus-*`/`X-Divesmart-*`/`X-Divefamily-*`/`X-Surfnavi-*`/`X-Surfcenter-*`/`X-Surfshop-*`/`X-Surfpro-*`/`X-Surfmart-*`/`X-Surfplus-*`/`X-Surfsmart-*`/`X-Surffamily-*`/`X-Surfingnavi-*`/`X-Surfingcenter-*`/`X-Surfingshop-*`/`X-Surfingpro-*`/`X-Surfingmart-*`/`X-Surfingplus-*`/`X-Surfingsmart-*`/`X-Surfingfamily-*`/`X-Marinenavi-*`/`X-Marinecenter-*`/`X-Marineshop-*`/`X-Marinepro-*`/`X-Marinemart-*`/`X-Marineplus-*`/`X-Marinesmart-*`/`X-Marinefamily-*`/`X-Marinesportnavi-*`/`X-Marinesportcenter-*`/`X-Marinesportshop-*`/`X-Marinesportpro-*` 等 は潜機の通知記録 — 送信側が書くことは自称。ライセンス講習・ツアー予約・器材販売の偽装はマリンスポーツ詐欺の典型手口。(スキー機は D658、スポーツ教室機は D682)
- **修正**: `Envelope` に `diving_marks` + `has_diving_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 潜印の自署を問え。

### Security — D696: `X-Menseste-*`/`X-Menzueste-*`/`X-Refre-*` 等のメンズエステ・リフレ・JKビジネス印自称が未検査

- **問題**: `X-Menseste-*`/`X-Menzueste-*`/`X-Refre-*`/`X-Jk-*`/`X-Jkrefre-*`/`X-Jkbusiness-*`/`X-Massage-*`/`X-Mensmassage-*`/`X-Aroma-*`/`X-Aromamass-*`/`X-Oilmassage-*`/`X-Kaishun-*`/`X-Seikan-*`/`X-Mensestenavi-*`/`X-Mensestecenter-*`/`X-Mensesteshop-*`/`X-Mensestepro-*`/`X-Mensestemart-*`/`X-Mensesteplus-*`/`X-Mensestesmart-*`/`X-Mensestefamily-*`/`X-Menzuestenavi-*`/`X-Menzuestecenter-*`/`X-Menzuesteshop-*`/`X-Menzuestepro-*`/`X-Menzuestemart-*`/`X-Menzuesteplus-*`/`X-Menzuestesmart-*`/`X-Menzuestefamily-*`/`X-Refrenavi-*`/`X-Refrecenter-*`/`X-Refreshop-*`/`X-Refrepro-*`/`X-Refremart-*`/`X-Refreplus-*`/`X-Refresmart-*`/`X-Refrefamily-*`/`X-Jknavi-*`/`X-Jkcenter-*`/`X-Jkshop-*`/`X-Jkpro-*`/`X-Jkmart-*`/`X-Jkplus-*`/`X-Jksmart-*`/`X-Jkfamily-*`/`X-Jkrefrenavi-*`/`X-Jkrefrecenter-*`/`X-Jkrefreshop-*`/`X-Jkrefrepro-*`/`X-Jkrefremart-*`/`X-Jkrefreplus-*`/`X-Jkrefresmart-*`/`X-Jkrefrefamily-*`/`X-Jkbusinessnavi-*`/`X-Jkbusinesscenter-*`/`X-Jkbusinessshop-*`/`X-Jkbusinesspro-*`/`X-Jkbusinessmart-*`/`X-Jkbusinessplus-*`/`X-Jkbusinesssmart-*`/`X-Jkbusinessfamily-*`/`X-Massagenavi-*` 等 は摩機の通知記録 — 送信側が書くことは自称。料金前払い・写真指名・オプション請求の偽装はメンエス詐欺の典型手口。(エステ機は D608、リラク機は D594)
- **修正**: `Envelope` に `menseste_marks` + `has_menseste_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 摩印の自署を問え。

### Security — D697: `X-Dutyfree-*`/`X-Menzei-*`/`X-Laox-*` 等の免税店・旅行土産印自称が未検査

- **問題**: `X-Dutyfree-*`/`X-Menzei-*`/`X-Laox-*`/`X-Dfs-*`/`X-Shilla-*`/`X-Kingpower-*`/`X-Omiyage-*`/`X-Miyage-*`/`X-Souvenir-*`/`X-Taxfree-*`/`X-Travelretail-*`/`X-Dufry-*`/`X-Lagardere-*`/`X-Heinemann-*`/`X-Everrich-*`/`X-Anaduty-*`/`X-Jalduty-*`/`X-Worldduty-*`/`X-Gebr-*`/`X-Dutyfreenavi-*`/`X-Dutyfreecenter-*`/`X-Dutyfreeshop-*`/`X-Dutyfreepro-*`/`X-Dutyfreemart-*`/`X-Dutyfreeplus-*`/`X-Dutyfreesmart-*`/`X-Dutyfreefamily-*`/`X-Menzeinavi-*`/`X-Menzeicenter-*`/`X-Menzeishop-*`/`X-Menzeipro-*`/`X-Menzeimart-*`/`X-Menzeiplus-*`/`X-Menzeismart-*`/`X-Menzeifamily-*`/`X-Laoxnavi-*`/`X-Laoxcenter-*`/`X-Laoxshop-*`/`X-Laoxpro-*`/`X-Laoxmart-*`/`X-Laoxplus-*`/`X-Laoxsmart-*`/`X-Laoxfamily-*`/`X-Dfsnavi-*`/`X-Dfscenter-*`/`X-Dfsshop-*`/`X-Dfspro-*`/`X-Dfsmart-*`/`X-Dfsplus-*`/`X-Dfssmart-*`/`X-Dfsfamily-*`/`X-Shillanavi-*`/`X-Shillacenter-*`/`X-Shillashop-*`/`X-Shillapro-*`/`X-Shillamart-*`/`X-Shillaplus-*`/`X-Shillasmart-*`/`X-Shillafamily-*`/`X-Kingpowernavi-*`/`X-Kingpowercenter-*`/`X-Kingpowershop-*` 等 は免機の通知記録 — 送信側が書くことは自称。免税手続・商品引換・関税還付の偽装は免税店詐欺の典型手口。(空港・航空機は D513、ホテル機は D535)
- **修正**: `Envelope` に `dutyfree_marks` + `has_dutyfree_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 免印の自署を問え。

### Security — D692: `X-Vtuber-*`/`X-Vliver-*`/`X-Liver-*` 等のVTuber・ライバー印自称が未検査

- **問題**: `X-Vtuber-*`/`X-Vliver-*`/`X-Liver-*`/`X-Nijisanji-*`/`X-Nijien-*`/`X-Hololive-*`/`X-Holoen-*`/`X-Holoid-*`/`X-Holostars-*`/`X-Vspo-*`/`X-Voms-*`/`X-Anycolor-*`/`X-Cover-*`/`X-Nanashinku-*`/`X-Vshojo-*`/`X-Phaseconnect-*`/`X-Prism-*`/`X-Kawaii-*`/`X-Bravegroup-*`/`X-Regloss-*`/`X-Obsydia-*`/`X-Luxiem-*`/`X-Noctyx-*`/`X-Iluna-*`/`X-Xsoleil-*`/`X-Krisis-*`/`X-Lazulight-*`/`X-Vtubernavi-*`/`X-Vtubercenter-*`/`X-Vtubershop-*`/`X-Vtuberpro-*`/`X-Vtubermart-*`/`X-Vtuberplus-*`/`X-Vtubersmart-*`/`X-Vtuberfamily-*`/`X-Vlivernavi-*`/`X-Vlivercenter-*`/`X-Vlivershop-*`/`X-Vliverpro-*`/`X-Vlivermart-*`/`X-Vliverplus-*`/`X-Vliversmart-*`/`X-Vliverfamily-*`/`X-Livernavi-*`/`X-Livercenter-*`/`X-Livershop-*`/`X-Liverpro-*`/`X-Livermart-*`/`X-Liverplus-*`/`X-Liversmart-*`/`X-Liverfamily-*`/`X-Nijisanjinavi-*`/`X-Nijisanjicenter-*`/`X-Nijisanjishop-*`/`X-Nijisanjipro-*`/`X-Nijisanjimart-*`/`X-Nijisanjiplus-*`/`X-Nijisanjismart-*`/`X-Nijisanjifamily-*`/`X-Nijiennavi-*`/`X-Nijiencenter-*`/`X-Nijienshop-*` 等 は播機の通知記録 — 送信側が書くことは自称。スパチャ返金・限定グッズ・イベント当選の偽装はVTuber詐欺の典型手口。(アイドル機は D640、ゲーム機は D473)
- **修正**: `Envelope` に `vtuber_marks` + `has_vtuber_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 播印の自署を問え。

### Security — D693: `X-Host-*`/`X-Hostclub-*`/`X-Kyaba-*` 等のナイトライフ・パパ活印自称が未検査

- **問題**: `X-Host-*`/`X-Hostclub-*`/`X-Kyaba-*`/`X-Girlsbar-*`/`X-Cabaret-*`/`X-Lounge-*`/`X-Soapland-*`/`X-Fuuzoku-*`/`X-Night-*`/`X-Nightlife-*`/`X-Papakatsu-*`/`X-Sugar-*`/`X-Sugardaddy-*`/`X-Seeking-*`/`X-Paddy-*`/`X-Lovean-*`/`X-Hostnavi-*`/`X-Hostcenter-*`/`X-Hostshop-*`/`X-Hostpro-*`/`X-Hostmart-*`/`X-Hostplus-*`/`X-Hostsmart-*`/`X-Hostfamily-*`/`X-Hostclubnavi-*`/`X-Hostclubcenter-*`/`X-Hostclubshop-*`/`X-Hostclubpro-*`/`X-Hostclubmart-*`/`X-Hostclubplus-*`/`X-Hostclubsmart-*`/`X-Hostclubfamily-*`/`X-Kyabanavi-*`/`X-Kyabacenter-*`/`X-Kyabashop-*`/`X-Kyabapro-*`/`X-Kyabamart-*`/`X-Kyabaplus-*`/`X-Kyabasmart-*`/`X-Kyabafamily-*`/`X-Girlsbarnavi-*`/`X-Girlsbarcenter-*`/`X-Girlsbarshop-*`/`X-Girlsbarpro-*`/`X-Girlsbarmart-*`/`X-Girlsbarplus-*`/`X-Girlsbarsmart-*`/`X-Girlsbarfamily-*`/`X-Cabaretnavi-*`/`X-Cabaretcenter-*`/`X-Cabaretshop-*`/`X-Cabaretpro-*`/`X-Cabaretmart-*`/`X-Cabaretplus-*`/`X-Cabaretsmart-*`/`X-Cabaretfamily-*`/`X-Loungenavi-*`/`X-Loungecenter-*`/`X-Loungeshop-*`/`X-Loungepro-*`/`X-Loungemart-*`/`X-Loungeplus-*` 等 は夜機の通知記録 — 送信側が書くことは自称。料金未払い・罰金請求・デート援助の偽装は夜職・パパ活詐欺の典型手口。(出会い機は D524、結婚機は D562)
- **修正**: `Envelope` に `nightlife_marks` + `has_nightlife_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 夜印の自署を問え。

### Security — D694: `X-Tokushu-*`/`X-Tokushuseisou-*`/`X-Gomiyashiki-*` 等の特殊清掃・遺品整理・除霊印自称が未検査

- **問題**: `X-Tokushu-*`/`X-Tokushuseisou-*`/`X-Gomiyashiki-*`/`X-Ihinseiri-*`/`X-Kodokushi-*`/`X-Seisou-*`/`X-Seisougyo-*`/`X-Souji-*`/`X-Yuibutsu-*`/`X-Kataduke-*`/`X-Jorei-*`/`X-Reikan-*`/`X-Kokkuri-*`/`X-Spiritual-*`/`X-Oharai-*`/`X-Omikuji-*`/`X-Tokushunavi-*`/`X-Tokushucenter-*`/`X-Tokushushop-*`/`X-Tokushupro-*`/`X-Tokushumart-*`/`X-Tokushuplus-*`/`X-Tokushusmart-*`/`X-Tokushufamily-*`/`X-Tokushuseisounavi-*`/`X-Tokushuseisoucenter-*`/`X-Tokushuseisoushop-*`/`X-Tokushuseisoupro-*`/`X-Tokushuseisoumart-*`/`X-Tokushuseisouplus-*`/`X-Tokushuseisousmart-*`/`X-Tokushuseisoufamily-*`/`X-Gomiyashikinavi-*`/`X-Gomiyashikicenter-*`/`X-Gomiyashikishop-*`/`X-Gomiyashikipro-*`/`X-Gomiyashikimart-*`/`X-Gomiyashikiplus-*`/`X-Gomiyashikismart-*`/`X-Gomiyashikifamily-*`/`X-Ihinseirinavi-*`/`X-Ihinseiricenter-*`/`X-Ihinseirishop-*`/`X-Ihinseiripro-*`/`X-Ihinseirimart-*`/`X-Ihinseiriplus-*`/`X-Ihinseirismart-*`/`X-Ihinseirifamily-*`/`X-Kodokushinavi-*`/`X-Kodokushicenter-*`/`X-Kodokushishop-*`/`X-Kodokushipro-*`/`X-Kodokushimart-*`/`X-Kodokushiplus-*`/`X-Kodokushismart-*`/`X-Kodokushifamily-*`/`X-Seisounavi-*`/`X-Seisoucenter-*`/`X-Seisoushop-*`/`X-Seisoupro-*`/`X-Seisoumart-*`/`X-Seisouplus-*` 等 は清機の通知記録 — 送信側が書くことは自称。清掃費用前払い・除霊料金・遺品整理見積の偽装は特殊清掃・霊感商法詐欺の典型手口。(不用品機は D631、葬儀機は D580)
- **修正**: `Envelope` に `tokushu_marks` + `has_tokushu_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 清印の自署を問え。

### Security — D689: `X-Etc-*`/`X-Nexco-*`/`X-Nexcoeast-*` 等のETC・高速道路印自称が未検査

- **問題**: `X-Etc-*`/`X-Nexco-*`/`X-Nexcoeast-*`/`X-Nexcocentral-*`/`X-Nexcowest-*`/`X-Shutoko-*`/`X-Expway-*`/`X-Highway-*`/`X-Etccard-*`/`X-Toll-*`/`X-Wangan-*`/`X-Sanyo-*`/`X-Tohoku-*`/`X-Kyushu-*`/`X-Honjushiko-*`/`X-Douro-*`/`X-Kousoku-*`/`X-Kousokudouro-*`/`X-Ryokin-*`/`X-Smartic-*`/`X-Etcnavi-*`/`X-Etccenter-*`/`X-Etcshop-*`/`X-Etcpro-*`/`X-Etcmart-*`/`X-Etcplus-*`/`X-Etcsmart-*`/`X-Etcfamily-*`/`X-Nexconavi-*`/`X-Nexcocenter-*`/`X-Nexcoshop-*`/`X-Nexcopro-*`/`X-Nexcomart-*`/`X-Nexcoplus-*`/`X-Nexcosmart-*`/`X-Nexcofamily-*`/`X-Nexcoeastnavi-*`/`X-Nexcoeastcenter-*`/`X-Nexcoeastshop-*`/`X-Nexcoeastpro-*`/`X-Nexcoeastmart-*`/`X-Nexcoeastplus-*`/`X-Nexcoeastsmart-*`/`X-Nexcoeastfamily-*`/`X-Nexcocentralnavi-*`/`X-Nexcocentralcenter-*`/`X-Nexcocentralshop-*`/`X-Nexcocentralpro-*`/`X-Nexcocentralmart-*`/`X-Nexcocentralplus-*`/`X-Nexcocentralsmart-*`/`X-Nexcocentralfamily-*`/`X-Nexcowestnavi-*`/`X-Nexcowestcenter-*`/`X-Nexcowestshop-*`/`X-Nexcowestpro-*`/`X-Nexcowestmart-*`/`X-Nexcowestplus-*`/`X-Nexcowestsmart-*`/`X-Nexcowestfamily-*`/`X-Shutokonavi-*`/`X-Shutokocenter-*` 等 は路機の通知記録 — 送信側が書くことは自称。ETC利用照会・通行料金請求・カード停止の偽装はETC詐欺の典型手口。(鉄道機は D522、バス・タクシー機は D656)
- **修正**: `Envelope` に `etc_marks` + `has_etc_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 路印の自署を問え。

### Security — D690: `X-Wakaresase-*`/`X-Fukuen-*`/`X-Fukuenya-*` 等の復縁・別れさせ屋・国際結婚印自称が未検査

- **問題**: `X-Wakaresase-*`/`X-Fukuen-*`/`X-Fukuenya-*`/`X-Kokusaikekkon-*`/`X-Intlmarriage-*`/`X-Filipina-*`/`X-Romance-*`/`X-Matchmaker-*`/`X-Kokusaikonkatsu-*`/`X-Reunion-*`/`X-Loveback-*`/`X-Mailbride-*`/`X-Bride-*`/`X-Wakaresasenavi-*`/`X-Wakaresasecenter-*`/`X-Wakaresaseshop-*`/`X-Wakaresasepro-*`/`X-Wakaresasemart-*`/`X-Wakaresaseplus-*`/`X-Wakaresasesmart-*`/`X-Wakaresasefamily-*`/`X-Fukuennavi-*`/`X-Fukuencenter-*`/`X-Fukuenshop-*`/`X-Fukuenpro-*`/`X-Fukuenmart-*`/`X-Fukuenplus-*`/`X-Fukuensmart-*`/`X-Fukuenfamily-*`/`X-Fukuenyanavi-*`/`X-Fukuenyacenter-*`/`X-Fukuenyashop-*`/`X-Fukuenyapro-*`/`X-Fukuenyamart-*`/`X-Fukuenyaplus-*`/`X-Fukuenyasmart-*`/`X-Fukuenyafamily-*`/`X-Kokusaikekkonnavi-*`/`X-Kokusaikekkoncenter-*`/`X-Kokusaikekkonshop-*`/`X-Kokusaikekkonpro-*`/`X-Kokusaikekkonmart-*`/`X-Kokusaikekkonplus-*`/`X-Kokusaikekkonsmart-*`/`X-Kokusaikekkonfamily-*`/`X-Intlmarriagenavi-*`/`X-Intlmarriagecenter-*`/`X-Intlmarriageshop-*`/`X-Intlmarriagepro-*`/`X-Intlmarriagemart-*`/`X-Intlmarriageplus-*`/`X-Intlmarriagesmart-*`/`X-Intlmarriagefamily-*`/`X-Filipinanavi-*`/`X-Filipinacenter-*`/`X-Filipinashop-*`/`X-Filipinapro-*`/`X-Filipinamart-*`/`X-Filipinaplus-*`/`X-Filipinasmart-*`/`X-Filipinafamily-*`/`X-Romancenavi-*` 等 は縁機の通知記録 — 送信側が書くことは自称。工作成功報酬・着手金・成婚料の偽装は復縁工作・国際結婚詐欺の典型手口。(探偵機は D681、結婚機は D562、出会い機は D524)
- **修正**: `Envelope` に `wakaresase_marks` + `has_wakaresase_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 縁印の自署を問え。

### Security — D691: `X-Hellowork-*`/`X-Shokugyoukunren-*`/`X-Kunren-*` 等のハローワーク・職業訓練印自称が未検査

- **問題**: `X-Hellowork-*`/`X-Shokugyoukunren-*`/`X-Kunren-*`/`X-Shokuan-*`/`X-Jobcard-*`/`X-Worknavi-*`/`X-Koyo-*`/`X-Shokureba-*`/`X-Polytech-*`/`X-Jinzai-*`/`X-Shuushoku-*`/`X-Tenshoku-*`/`X-Ginou-*`/`X-Jukuren-*`/`X-Syokuren-*`/`X-Helloworknavi-*`/`X-Helloworkcenter-*`/`X-Helloworkshop-*`/`X-Helloworkpro-*`/`X-Helloworkmart-*`/`X-Helloworkplus-*`/`X-Helloworksmart-*`/`X-Helloworkfamily-*`/`X-Shokugyoukunrennavi-*`/`X-Shokugyoukunrencenter-*`/`X-Shokugyoukunrenshop-*`/`X-Shokugyoukunrenpro-*`/`X-Shokugyoukunrenmart-*`/`X-Shokugyoukunrenplus-*`/`X-Shokugyoukunrensmart-*`/`X-Shokugyoukunrenfamily-*`/`X-Kunrennavi-*`/`X-Kunrencenter-*`/`X-Kunrenshop-*`/`X-Kunrenpro-*`/`X-Kunrenmart-*`/`X-Kunrenplus-*`/`X-Kunrensmart-*`/`X-Kunrenfamily-*`/`X-Shokuannavi-*`/`X-Shokuancenter-*`/`X-Shokuanshop-*`/`X-Shokuanpro-*`/`X-Shokuanmart-*`/`X-Shokuanplus-*`/`X-Shokuansmart-*`/`X-Shokuanfamily-*`/`X-Jobcardnavi-*`/`X-Jobcardcenter-*`/`X-Jobcardshop-*`/`X-Jobcardpro-*`/`X-Jobcardmart-*`/`X-Jobcardplus-*`/`X-Jobcardsmart-*`/`X-Jobcardfamily-*`/`X-Worknavinavi-*`/`X-Worknavicenter-*`/`X-Worknavishop-*`/`X-Worknavipro-*`/`X-Worknavimart-*`/`X-Worknaviplus-*`/`X-Worknavismart-*` 等 は職機の通知記録 — 送信側が書くことは自称。失業給付・受講料返還・求人情報の偽装は職業詐欺の典型手口。(求職人材機は D482、補助金機は D683)
- **修正**: `Envelope` に `hellowork_marks` + `has_hellowork_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 職印の自署を問え。

### Security — D686: `X-Jasso-*`/`X-Shogakukin-*`/`X-Kyouikuloan-*` 等の奨学金・教育ローン印自称が未検査

- **問題**: `X-Jasso-*`/`X-Shogakukin-*`/`X-Kyouikuloan-*`/`X-Eduloan-*`/`X-Studentloan-*`/`X-Sallie-*`/`X-Salliemae-*`/`X-Navient-*`/`X-Ashinaga-*`/`X-Kyouikukin-*`/`X-Shugakuenjo-*`/`X-Gakusei-*`/`X-Earnest-*`/`X-Scholarship-*`/`X-Scholar-*`/`X-Jassonavi-*`/`X-Jassocenter-*`/`X-Jassoshop-*`/`X-Jassopro-*`/`X-Jassomart-*`/`X-Jassoplus-*`/`X-Jassosmart-*`/`X-Jassofamily-*`/`X-Shogakukinnavi-*`/`X-Shogakukincenter-*`/`X-Shogakukinshop-*`/`X-Shogakukinpro-*`/`X-Shogakukinmart-*`/`X-Shogakukinplus-*`/`X-Shogakukinsmart-*`/`X-Shogakukinfamily-*`/`X-Kyouikuloannavi-*`/`X-Kyouikuloancenter-*`/`X-Kyouikuloanshop-*`/`X-Kyouikuloanpro-*`/`X-Kyouikuloanmart-*`/`X-Kyouikuloanplus-*`/`X-Kyouikuloansmart-*`/`X-Kyouikuloanfamily-*`/`X-Eduloannavi-*`/`X-Eduloancenter-*`/`X-Eduloanshop-*`/`X-Eduloanpro-*`/`X-Eduloanmart-*`/`X-Eduloanplus-*`/`X-Eduloansmart-*`/`X-Eduloanfamily-*`/`X-Studentloannavi-*`/`X-Studentloancenter-*`/`X-Studentloanshop-*`/`X-Studentloanpro-*`/`X-Studentloanmart-*`/`X-Studentloanplus-*`/`X-Studentloansmart-*`/`X-Studentloanfamily-*`/`X-Sallienavi-*`/`X-Salliecenter-*`/`X-Sallieshop-*`/`X-Salliepro-*`/`X-Salliemart-*`/`X-Sallieplus-*`/`X-Salliesmart-*` 等 は奨機の通知記録 — 送信側が書くことは自称。奨学金給付・返還免除・口座登録確認の偽装は学生向け詐欺の典型手口。(教育機は D477、消費者金融機は D581)
- **修正**: `Envelope` に `shogaku_marks` + `has_shogaku_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 奨印の自署を問え。

### Security — D687: `X-Fukugyou-*`/`X-Zaitaku-*`/`X-Naishoku-*` 等の副業・在宅ワーク・情報商材印自称が未検査

- **問題**: `X-Fukugyou-*`/`X-Zaitaku-*`/`X-Naishoku-*`/`X-Sidejob-*`/`X-Sidebiz-*`/`X-Wah-*`/`X-Johoshozai-*`/`X-Shozai-*`/`X-Netbusiness-*`/`X-Sidehustle-*`/`X-Affiliate-*`/`X-Afiri-*`/`X-Kanemochi-*`/`X-Netjob-*`/`X-Johosho-*`/`X-Infobusiness-*`/`X-Fukugyounavi-*`/`X-Fukugyoucenter-*`/`X-Fukugyoushop-*`/`X-Fukugyoupro-*`/`X-Fukugyoumart-*`/`X-Fukugyouplus-*`/`X-Fukugyousmart-*`/`X-Fukugyoufamily-*`/`X-Zaitakunavi-*`/`X-Zaitakucenter-*`/`X-Zaitakushop-*`/`X-Zaitakupro-*`/`X-Zaitakumart-*`/`X-Zaitakuplus-*`/`X-Zaitakusmart-*`/`X-Zaitakufamily-*`/`X-Naishokunavi-*`/`X-Naishokucenter-*`/`X-Naishokushop-*`/`X-Naishokupro-*`/`X-Naishokumart-*`/`X-Naishokuplus-*`/`X-Naishokusmart-*`/`X-Naishokufamily-*`/`X-Sidejobnavi-*`/`X-Sidejobcenter-*`/`X-Sidejobshop-*`/`X-Sidejobpro-*`/`X-Sidejobmart-*`/`X-Sidejobplus-*`/`X-Sidejobsmart-*`/`X-Sidejobfamily-*`/`X-Sidebiznavi-*`/`X-Sidebizcenter-*`/`X-Sidebizshop-*`/`X-Sidebizpro-*`/`X-Sidebizmart-*`/`X-Sidebizplus-*`/`X-Sidebizsmart-*`/`X-Sidebizfamily-*`/`X-Wahnavi-*`/`X-Wahcenter-*`/`X-Wahshop-*`/`X-Wahpro-*`/`X-Wahmart-*`/`X-Wahplus-*` 等 は副機の通知記録 — 送信側が書くことは自称。在宅高収入・副業紹介・商材購入勧誘の偽装は副業詐欺の典型手口。(求職機は D482、広告機は D553)
- **修正**: `Envelope` に `fukugyou_marks` + `has_fukugyou_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 副印の自署を問え。

### Security — D688: `X-Mlm-*`/`X-Networkbusiness-*`/`X-Networkbiz-*` 等のMLM・ネットワークビジネス印自称が未検査

- **問題**: `X-Mlm-*`/`X-Networkbusiness-*`/`X-Networkbiz-*`/`X-Multilevel-*`/`X-Downline-*`/`X-Pyramid-*`/`X-Referral-*`/`X-Forever-*`/`X-Neways-*`/`X-Doterra-*`/`X-Acn-*`/`X-Jeunesse-*`/`X-Monat-*`/`X-Youngliving-*`/`X-Arbonne-*`/`X-Shaklee-*`/`X-Isagenix-*`/`X-Kyani-*`/`X-Organogold-*`/`X-Zurvita-*`/`X-Mlmnavi-*`/`X-Mlmcenter-*`/`X-Mlmshop-*`/`X-Mlmpro-*`/`X-Mlmmart-*`/`X-Mlmplus-*`/`X-Mlmsmart-*`/`X-Mlmfamily-*`/`X-Networkbusinessnavi-*`/`X-Networkbusinesscenter-*`/`X-Networkbusinessshop-*`/`X-Networkbusinesspro-*`/`X-Networkbusinessmart-*`/`X-Networkbusinessplus-*`/`X-Networkbusinesssmart-*`/`X-Networkbusinessfamily-*`/`X-Networkbiznavi-*`/`X-Networkbizcenter-*`/`X-Networkbizshop-*`/`X-Networkbizpro-*`/`X-Networkbizmart-*`/`X-Networkbizplus-*`/`X-Networkbizsmart-*`/`X-Networkbizfamily-*`/`X-Multilevelnavi-*`/`X-Multilevelcenter-*`/`X-Multilevelshop-*`/`X-Multilevelpro-*`/`X-Multilevelmart-*`/`X-Multilevelplus-*`/`X-Multilevelsmart-*`/`X-Multilevelfamily-*`/`X-Downlinenavi-*`/`X-Downlinecenter-*`/`X-Downlineshop-*`/`X-Downlinepro-*`/`X-Downlinemart-*`/`X-Downlineplus-*`/`X-Downlinesmart-*`/`X-Downlinefamily-*`/`X-Pyramidnavi-*`/`X-Pyramidcenter-*` 等 は連機の通知記録 — 送信側が書くことは自称。勧誘・会員登録・ボーナス振込の偽装はマルチ商法詐欺の典型手口。(Amway/NuSkin/Herbalife/MaryKay/USANA は既存)
- **修正**: `Envelope` に `mlm_marks` + `has_mlm_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 連印の自署を問え。

### Security — D683: `X-Jgrants-*`/`X-Hojokin-*`/`X-Joseikin-*` 等の補助金・助成金・給付金印自称が未検査

- **問題**: `X-Jgrants-*`/`X-Hojokin-*`/`X-Joseikin-*`/`X-Kyufukin-*`/`X-Monodukuri-*`/`X-Jizukuka-*`/`X-Jizokuka-*`/`X-Itdonyu-*`/`X-Saikouchiku-*`/`X-Jigyokeishou-*`/`X-Shienkin-*`/`X-Enjo-*`/`X-Hojo-*`/`X-Koyochosei-*`/`X-Subsidy-*`/`X-Grant-*`/`X-Benefit-*`/`X-Kyufu-*`/`X-Josei-*`/`X-Seido-*`/`X-Bosyu-*`/`X-Jgrantsnavi-*`/`X-Jgrantscenter-*`/`X-Jgrantsshop-*`/`X-Jgrantspro-*`/`X-Jgrantsmart-*`/`X-Jgrantsplus-*`/`X-Jgrantssmart-*`/`X-Jgrantsfamily-*`/`X-Hojokinnavi-*`/`X-Hojokincenter-*`/`X-Hojokinshop-*`/`X-Hojokinpro-*`/`X-Hojokinmart-*`/`X-Hojokinplus-*`/`X-Hojokinsmart-*`/`X-Hojokinfamily-*`/`X-Joseikinnavi-*`/`X-Joseikincenter-*`/`X-Joseikinshop-*`/`X-Joseikinpro-*`/`X-Joseikinmart-*`/`X-Joseikinplus-*`/`X-Joseikinsmart-*`/`X-Joseikinfamily-*`/`X-Kyufukinnavi-*`/`X-Kyufukincenter-*`/`X-Kyufukinshop-*`/`X-Kyufukinpro-*`/`X-Kyufukinmart-*`/`X-Kyufukinplus-*`/`X-Kyufukinsmart-*`/`X-Kyufukinfamily-*`/`X-Monodukurinavi-*`/`X-Monodukuricenter-*`/`X-Monodukurishop-*`/`X-Monodukuripro-*`/`X-Monodukurimart-*`/`X-Monodukuriplus-*`/`X-Monodukurismart-*`/`X-Monodukurifamily-*`/`X-Jizukukanavi-*` 等 は補機の通知記録 — 送信側が書くことは自称。持続化給付金・事業再構築補助金を騙る申請代行・手数料前払いは給付金詐欺の典型手口。(政府機は D518、税務機は D598)
- **修正**: `Envelope` に `hojokin_marks` + `has_hojokin_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 補印の自署を問え。

### Security — D684: `X-Hikaku-*`/`X-Hikakun-*`/`X-Hikakuya-*` 等の一括見積・比較印自称が未検査

- **問題**: `X-Hikaku-*`/`X-Hikakun-*`/`X-Hikakuya-*`/`X-Mitsumori-*`/`X-Ikkatsu-*`/`X-Ikkyakumitsumori-*`/`X-Kakakucom-*`/`X-Hikakucom-*`/`X-Kakakuhyou-*`/`X-Quote-*`/`X-Quotes-*`/`X-Estimate-*`/`X-Estimates-*`/`X-Compare-*`/`X-Comparison-*`/`X-Price-*`/`X-Prices-*`/`X-Hyouka-*`/`X-Kurumitsu-*`/`X-Hikakunavi-*`/`X-Hikakucenter-*`/`X-Hikakushop-*`/`X-Hikakupro-*`/`X-Hikakumart-*`/`X-Hikakuplus-*`/`X-Hikakusmart-*`/`X-Hikakufamily-*`/`X-Hikakunnavi-*`/`X-Hikakuncenter-*`/`X-Hikakunshop-*`/`X-Hikakunpro-*`/`X-Hikakunmart-*`/`X-Hikakunplus-*`/`X-Hikakunsmart-*`/`X-Hikakunfamily-*`/`X-Hikakuyanavi-*`/`X-Hikakuyacenter-*`/`X-Hikakuyashop-*`/`X-Hikakuyapro-*`/`X-Hikakuyamart-*`/`X-Hikakuyaplus-*`/`X-Hikakuyasmart-*`/`X-Hikakuyafamily-*`/`X-Mitsumorinavi-*`/`X-Mitsumoricenter-*`/`X-Mitsumorishop-*`/`X-Mitsumoripro-*`/`X-Mitsumorimart-*`/`X-Mitsumoriplus-*`/`X-Mitsumorismart-*`/`X-Mitsumorifamily-*`/`X-Ikkatsunavi-*`/`X-Ikkatsucenter-*`/`X-Ikkatsushop-*`/`X-Ikkatsupro-*`/`X-Ikkatsumart-*`/`X-Ikkatsuplus-*`/`X-Ikkatsusmart-*`/`X-Ikkatsufamily-*`/`X-Ikkyakumitsumorinavi-*`/`X-Ikkyakumitsumoricenter-*`/`X-Ikkyakumitsumorishop-*` 等 は比機の通知記録 — 送信側が書くことは自称。一括見積完了・最安値提示・見積もり比較の偽装は個人情報収集詐欺の典型手口。(価格コム本体・LIFULL・ズバットは既存)
- **修正**: `Envelope` に `hikaku_marks` + `has_hikaku_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 比印の自署を問え。

### Security — D685: `X-Nenkin-*`/`X-Nenkinnet-*`/`X-Pension-*` 等の年金・社会保険印自称が未検査

- **問題**: `X-Nenkin-*`/`X-Nenkinnet-*`/`X-Pension-*`/`X-Kenpo-*`/`X-Kokuho-*`/`X-Kosei-*`/`X-Koseinenkin-*`/`X-Shaho-*`/`X-Shakaihoken-*`/`X-Kyousai-*`/`X-Jps-*`/`X-Kaigohoken-*`/`X-Roudouhoken-*`/`X-Koyohoken-*`/`X-Nenkinnavi-*`/`X-Nenkincenter-*`/`X-Nenkinshop-*`/`X-Nenkinpro-*`/`X-Nenkinmart-*`/`X-Nenkinplus-*`/`X-Nenkinsmart-*`/`X-Nenkinfamily-*`/`X-Nenkinnetnavi-*`/`X-Nenkinnetcenter-*`/`X-Nenkinnetshop-*`/`X-Nenkinnetpro-*`/`X-Nenkinnetmart-*`/`X-Nenkinnetplus-*`/`X-Nenkinnetsmart-*`/`X-Nenkinnetfamily-*`/`X-Pensionnavi-*`/`X-Pensioncenter-*`/`X-Pensionshop-*`/`X-Pensionpro-*`/`X-Pensionmart-*`/`X-Pensionplus-*`/`X-Pensionsmart-*`/`X-Pensionfamily-*`/`X-Kenponavi-*`/`X-Kenpocenter-*`/`X-Kenposhop-*`/`X-Kenpopro-*`/`X-Kenpomart-*`/`X-Kenpoplus-*`/`X-Kenposmart-*`/`X-Kenpofamily-*`/`X-Kokuhonavi-*`/`X-Kokuhocenter-*`/`X-Kokuhoshop-*`/`X-Kokuhopro-*`/`X-Kokuhomart-*`/`X-Kokuhoplus-*`/`X-Kokuhosmart-*`/`X-Kokuhofamily-*`/`X-Koseinavi-*`/`X-Koseicenter-*`/`X-Koseishop-*`/`X-Koseipro-*`/`X-Koseimart-*`/`X-Koseiplus-*`/`X-Koseismart-*`/`X-Koseifamily-*` 等 は年機の通知記録 — 送信側が書くことは自称。未納督促・還付通知・年金記録確認の偽装は年金詐欺の典型手口。(政府機は D518、保険機は D519)
- **修正**: `Envelope` に `nenkin_marks` + `has_nenkin_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 年印の自署を問え。

### Security — D680: `X-Sbisec-*`/`X-Rakutensec-*`/`X-Monex-*` 等の証券・投資信託印自称が未検査

- **問題**: `X-Sbisec-*`/`X-Rakutensec-*`/`X-Monex-*`/`X-Matsui-*`/`X-Kabu-*`/`X-Aukabu-*`/`X-Smbcnikko-*`/`X-Nikko-*`/`X-Daiwasec-*`/`X-Nomura-*`/`X-Mizuhosc-*`/`X-Okasan-*`/`X-Iwasec-*`/`X-Naito-*`/`X-Shoken-*`/`X-Sec-*`/`X-Securities-*`/`X-Invest-*`/`X-Toushi-*`/`X-Toushin-*`/`X-Shintaku-*`/`X-Fund-*`/`X-Asset-*`/`X-Wealth-*`/`X-Neomoba-*`/`X-Linesec-*`/`X-Jpx-*`/`X-Sbisecnavi-*`/`X-Sbiseccenter-*`/`X-Sbisecshop-*`/`X-Sbisecpro-*`/`X-Sbisecmart-*`/`X-Sbisecplus-*`/`X-Sbisecsmart-*`/`X-Sbisecfamily-*`/`X-Rakutensecnavi-*`/`X-Rakutenseccenter-*`/`X-Rakutensecshop-*`/`X-Rakutensecpro-*`/`X-Rakutensecmart-*`/`X-Rakutensecplus-*`/`X-Rakutensecsmart-*`/`X-Rakutensecfamily-*`/`X-Monexnavi-*`/`X-Monexcenter-*`/`X-Monexshop-*`/`X-Monexpro-*`/`X-Monexmart-*`/`X-Monexplus-*`/`X-Monexsmart-*`/`X-Monexfamily-*`/`X-Matsuinavi-*`/`X-Matsuicenter-*`/`X-Matsuishop-*`/`X-Matsuipro-*`/`X-Matsuimart-*`/`X-Matsuiplus-*`/`X-Matsuismart-*`/`X-Matsuifamily-*`/`X-Kabunavi-*`/`X-Kabucenter-*`/`X-Kabushop-*` 等 は証機の通知記録 — 送信側が書くことは自称。偽証券会社・偽投資サイトへの誘導・口座開設確認の偽装は投資詐欺の典型手口。(銀行機は D514/D554、消費者金融機は D581)
- **修正**: `Envelope` に `shoken_marks` + `has_shoken_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 証印の自署を問え。

### Security — D681: `X-Tantei-*`/`X-Tanteisha-*`/`X-Koushinjo-*` 等の探偵・興信所・信用調査印自称が未検査

- **問題**: `X-Tantei-*`/`X-Tanteisha-*`/`X-Koushinjo-*`/`X-Chousajo-*`/`X-Chousa-*`/`X-Shinyochosa-*`/`X-Shinyo-*`/`X-Teikoku-*`/`X-Teikokudata-*`/`X-Tdb-*`/`X-Tsr-*`/`X-Nichishin-*`/`X-Haraichi-*`/`X-Galu-*`/`X-Mrtan-*`/`X-Haltan-*`/`X-Ism-*`/`X-Uwaki-*`/`X-Torishirabe-*`/`X-Mikudari-*`/`X-Tanteinavi-*`/`X-Tanteicenter-*`/`X-Tanteishop-*`/`X-Tanteipro-*`/`X-Tanteimart-*`/`X-Tanteiplus-*`/`X-Tanteismart-*`/`X-Tanteifamily-*`/`X-Tanteishanavi-*`/`X-Tanteishacenter-*`/`X-Tanteishashop-*`/`X-Tanteishapro-*`/`X-Tanteishamart-*`/`X-Tanteishaplus-*`/`X-Tanteishasmart-*`/`X-Tanteishafamily-*`/`X-Koushinjonavi-*`/`X-Koushinjocenter-*`/`X-Koushinjoshop-*`/`X-Koushinjopro-*`/`X-Koushinjomart-*`/`X-Koushinjoplus-*`/`X-Koushinjosmart-*`/`X-Koushinjofamily-*`/`X-Chousajonavi-*`/`X-Chousajocenter-*`/`X-Chousajoshop-*`/`X-Chousajopro-*`/`X-Chousajomart-*`/`X-Chousajoplus-*`/`X-Chousajosmart-*`/`X-Chousajofamily-*`/`X-Chousanavi-*`/`X-Chousacenter-*`/`X-Chousashop-*`/`X-Chousapro-*`/`X-Chousamart-*`/`X-Chousaplus-*`/`X-Chousasmart-*`/`X-Chousafamily-*`/`X-Shinyochosanavi-*`/`X-Shinyochosacenter-*` 等 は探機の通知記録 — 送信側が書くことは自称。調査結果送付・着手金前払い・身辺調査の偽装は探偵詐欺の典型手口。(法務機は D523、士業団体機は D642)
- **修正**: `Envelope` に `tantei_marks` + `has_tantei_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 探印の自署を問え。

### Security — D682: `X-Swimming-*`/`X-Swim-*`/`X-Suiei-*` 等のスイミング・スポーツ教室印自称が未検査

- **問題**: `X-Swimming-*`/`X-Swim-*`/`X-Suiei-*`/`X-Pool-*`/`X-Jss-*`/`X-Itoman-*`/`X-Swimclub-*`/`X-Swimmy-*`/`X-Tennis-*`/`X-Soccer-*`/`X-Baseball-*`/`X-Basketball-*`/`X-Volleyball-*`/`X-Budo-*`/`X-Karate-*`/`X-Judo-*`/`X-Kendo-*`/`X-Gymnastics-*`/`X-Taiso-*`/`X-Undou-*`/`X-Sportsclub-*`/`X-Sportsschool-*`/`X-Kidsport-*`/`X-Swimmingnavi-*`/`X-Swimmingcenter-*`/`X-Swimmingshop-*`/`X-Swimmingpro-*`/`X-Swimmingmart-*`/`X-Swimmingplus-*`/`X-Swimmingsmart-*`/`X-Swimmingfamily-*`/`X-Swimnavi-*`/`X-Swimcenter-*`/`X-Swimshop-*`/`X-Swimpro-*`/`X-Swimmart-*`/`X-Swimplus-*`/`X-Swimsmart-*`/`X-Swimfamily-*`/`X-Suieinavi-*`/`X-Suieicenter-*`/`X-Suieishop-*`/`X-Suieipro-*`/`X-Suieimart-*`/`X-Suieiplus-*`/`X-Suieismart-*`/`X-Suieifamily-*`/`X-Poolnavi-*`/`X-Poolcenter-*`/`X-Poolshop-*`/`X-Poolpro-*`/`X-Poolmart-*`/`X-Poolplus-*`/`X-Poolsmart-*`/`X-Poolfamily-*`/`X-Jssnavi-*`/`X-Jsscenter-*`/`X-Jssshop-*`/`X-Jsspro-*`/`X-Jssmart-*`/`X-Jssplus-*`/`X-Jsssmart-*` 等 は泳機の通知記録 — 送信側が書くことは自称。入会案内・月謝請求・体験レッスン当選の偽装は教室詐欺の典型手口。(フィットネス機は D530、学習塾機は D605)
- **修正**: `Envelope` に `suiei_marks` + `has_suiei_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 泳印の自署を問え。

### Security — D677: `X-Coinlaundry-*`/`X-Coinlaundrynavi-*`/`X-Coinlaundrycenter-*` 等のコインランドリー・洗濯印自称が未検査

- **問題**: `X-Coinlaundry-*`/`X-Coinlaundrynavi-*`/`X-Coinlaundrycenter-*`/`X-Coinlaundryshop-*`/`X-Coinlaundrypro-*`/`X-Laundry-*`/`X-Laundrynavi-*`/`X-Laundrycenter-*`/`X-Laundryshop-*`/`X-Laundrypro-*`/`X-Sentaku-*`/`X-Sentakunavi-*`/`X-Sentakucenter-*`/`X-Sentakushop-*`/`X-Sentakupro-*`/`X-Washing-*`/`X-Washingnavi-*`/`X-Washingcenter-*`/`X-Washingshop-*`/`X-Washingpro-*`/`X-Landrie-*`/`X-Landrienavi-*`/`X-Landriecenter-*`/`X-Landrieshop-*`/`X-Landriepro-*`/`X-Hakuchou-*`/`X-Hakuchounavi-*`/`X-Hakuchoucenter-*`/`X-Hakuchoushop-*`/`X-Hakuchoupro-*`/`X-Fuwafuwa-*`/`X-Fuwafuwanavi-*`/`X-Laundrymart-*`/`X-Laundryplus-*`/`X-Laundrysmart-*`/`X-Laundryfamily-*`/`X-Coinmart-*`/`X-Coinplus-*`/`X-Coinsmart-*`/`X-Coinfamily-*`/`X-Arainavi-*`/`X-Araicenter-*`/`X-Araishop-*`/`X-Araipro-*`/`X-Sentakuya-*`/`X-Sentakuyanavi-*`/`X-Sentakuyacenter-*`/`X-Sentakuyashop-*`/`X-Sentakuyapro-*`/`X-Washnavi-*`/`X-Washcenter-*`/`X-Washshop-*`/`X-Washpro-*`/`X-Cleanlaundry-*`/`X-Cleanlaundrynavi-*`/`X-Cleanlaundrycenter-*`/`X-Cleanlaundryshop-*`/`X-Cleanlaundrypro-*`/`X-Laundromat-*`/`X-Laundromatnavi-*`/`X-Laundromatcenter-*`/`X-Laundromatshop-*`/`X-Laundromatpro-*`/`X-Draimart-*`/`X-Draiplus-*`/`X-Draismart-*`/`X-Draifamily-*` 等 は洗機の通知記録 — 送信側が書くことは自称。コインランドリー会員・洗濯代行・クリーニング料金の偽装は生活詐欺の典型手口。(クリーニング機は D601、洗い本体は既存)
- **修正**: `Envelope` に `laundry_marks` + `has_laundry_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 洗印の自署を問え。

### Security — D678: `X-Gamecenter-*`/`X-Gamecenternavi-*`/`X-Gamecentercenter-*` 等のゲームセンター・eスポーツ印自称が未検査

- **問題**: `X-Gamecenter-*`/`X-Gamecenternavi-*`/`X-Gamecentercenter-*`/`X-Gamecentershop-*`/`X-Gamecenterpro-*`/`X-Geesen-*`/`X-Geesennavi-*`/`X-Geesencenter-*`/`X-Geesenshop-*`/`X-Geesenpro-*`/`X-Gameworks-*`/`X-Gameworksnavi-*`/`X-Gameworkscenter-*`/`X-Gameworksshop-*`/`X-Gameworkspro-*`/`X-Esports-*`/`X-Esportsnavi-*`/`X-Esportscenter-*`/`X-Esportsshop-*`/`X-Esportspro-*`/`X-Purikura-*`/`X-Purikuranavi-*`/`X-Purikuracenter-*`/`X-Purikurashop-*`/`X-Purikurapro-*`/`X-Ufocatcher-*`/`X-Ufonavi-*`/`X-Ufocenter-*`/`X-Ufoshop-*`/`X-Ufopro-*`/`X-Crane-*`/`X-Cranenavi-*`/`X-Cranecenter-*`/`X-Craneshop-*`/`X-Cranepro-*`/`X-Medal-*`/`X-Medalnavi-*`/`X-Medalcenter-*`/`X-Medalshop-*`/`X-Medalpro-*`/`X-Taitostation-*`/`X-Taitostationnavi-*`/`X-Taitostationcenter-*`/`X-Namco-*`/`X-Namconavi-*`/`X-Namcocenter-*`/`X-Namcoshop-*`/`X-Namcopro-*`/`X-Adores-*`/`X-Adoresnavi-*`/`X-Adorescenter-*`/`X-Adoresshop-*`/`X-Adorespro-*`/`X-Gamecentermart-*`/`X-Gamecenterplus-*`/`X-Gamecentersmart-*`/`X-Gamecenterfamily-*`/`X-Geesenmart-*`/`X-Geesenplus-*`/`X-Geesensmart-*`/`X-Geesenfamily-*`/`X-Esportsmart-*`/`X-Esportsplus-*`/`X-Esportssmart-*`/`X-Esportsfamily-*`/`X-Kiyosumi-*`/`X-Kiyosuminavi-*`/`X-Kiyosumicenter-*`/`X-Kiyosumishop-*`/`X-Kiyosumipro-*`/`X-Arcade-*`/`X-Arcadenavi-*`/`X-Arcadecenter-*`/`X-Arcadeshop-*`/`X-Arcadepro-*`/`X-Gameparlor-*`/`X-Gameparlornavi-*`/`X-Gameparlorcenter-*`/`X-Gameparlorshop-*`/`X-Gameparlorpro-*` 等 は遊機の通知記録 — 送信側が書くことは自称。大会・景品・会員カード・プリクライベントの偽装は娯楽詐欺の典型手口。(娯楽機は D536、e スポーツ本体は既存)
- **修正**: `Envelope` に `gamecenter_marks` + `has_gamecenter_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 遊印の自署を問え。

### Security — D679: `X-Sharehouse-*`/`X-Sharenavi-*`/`X-Sharehousecenter-*` 等のシェアハウス・ゲストハウス印自称が未検査

- **問題**: `X-Sharehouse-*`/`X-Sharenavi-*`/`X-Sharehousecenter-*`/`X-Shareshop-*`/`X-Sharehousepro-*`/`X-Guesthouse-*`/`X-Guesthousenavi-*`/`X-Guesthousecenter-*`/`X-Guesthouseshop-*`/`X-Guesthousepro-*`/`X-Socialapartment-*`/`X-Socialapartmentnavi-*`/`X-Socialapartmentcenter-*`/`X-Oakhouse-*`/`X-Oakhousenavi-*`/`X-Oakhousecenter-*`/`X-Oakhouseshop-*`/`X-Oakhousepro-*`/`X-Hituji-*`/`X-Hitujinavi-*`/`X-Hitujicenter-*`/`X-Hitujishop-*`/`X-Hitujipro-*`/`X-Kyoudou-*`/`X-Kyoudounavi-*`/`X-Kyoudoucenter-*`/`X-Kyoudoushop-*`/`X-Kyoudoupro-*`/`X-Borderless-*`/`X-Borderlessnavi-*`/`X-Borderlesscenter-*`/`X-Borderlessshop-*`/`X-Borderlesspro-*`/`X-Sharemart-*`/`X-Shareplus-*`/`X-Sharesmart-*`/`X-Sharefamily-*`/`X-Monthlynavi-*`/`X-Monthlycenter-*`/`X-Monthlyshop-*`/`X-Monthlypro-*`/`X-Weekly-*`/`X-Weeklynavi-*`/`X-Weeklycenter-*`/`X-Weeklyshop-*`/`X-Weeklypro-*`/`X-Monthlymansion-*`/`X-Monthlymansionnavi-*`/`X-Monthlymansioncenter-*`/`X-Monthlymansionshop-*`/`X-Monthlymansionpro-*`/`X-Sharehousemart-*`/`X-Sharehouseplus-*`/`X-Sharehousesmart-*`/`X-Sharehousefamily-*`/`X-Guestmart-*`/`X-Guestplus-*`/`X-Guestsmart-*`/`X-Guestfamily-*`/`X-Roomshare-*`/`X-Roomsharenavi-*`/`X-Roomsharecenter-*`/`X-Roomshareshop-*`/`X-Roomsharepro-*`/`X-Kyousei-*`/`X-Kyouseitaku-*`/`X-Kyouseitakunavi-*`/`X-Kyouseitakucenter-*`/`X-Kyouseitakushop-*`/`X-Kyouseitakupro-*`/`X-Sharekan-*`/`X-Sharekannavi-*`/`X-Sharekancenter-*`/`X-Sharekanshop-*`/`X-Sharekanpro-*` 等 は舎機の通知記録 — 送信側が書くことは自称。入居審査・家賃請求・退去清算の偽装は不動産詐欺の典型手口。(不動産機は D481、団地管理機は D674)
- **修正**: `Envelope` に `sharehouse_marks` + `has_sharehouse_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 舎印の自署を問え。

### Security — D674: `X-Danchi-*`/`X-Danchinavi-*`/`X-Danchicenter-*` 等の団地・マンション管理組合印自称が未検査

- **問題**: `X-Danchi-*`/`X-Danchinavi-*`/`X-Danchicenter-*`/`X-Danchishop-*`/`X-Danchipro-*`/`X-Mansionkanri-*`/`X-Mansionkanrinavi-*`/`X-Mansionkanricenter-*`/`X-Mansionkanrishop-*`/`X-Mansionkanripro-*`/`X-Kumiainavi-*`/`X-Kumiaicenter-*`/`X-Kumiaishop-*`/`X-Kumiaipro-*`/`X-Kanrikan-*`/`X-Kanrikannavi-*`/`X-Kanrikancenter-*`/`X-Kanrikanshop-*`/`X-Kanrikanpro-*`/`X-Urrental-*`/`X-Urnavi-*`/`X-Urcenter-*`/`X-Urshop-*`/`X-Urpro-*`/`X-Kanrinet-*`/`X-Kanrinetnavi-*`/`X-Kanrinetcenter-*`/`X-Kanrinetshop-*`/`X-Kanrinetpro-*`/`X-Jkyo-*`/`X-Jkyonavi-*`/`X-Jkyocenter-*`/`X-Jkyoshop-*`/`X-Jkyopro-*`/`X-Mansion-*`/`X-Mansionnavi-*`/`X-Mansioncenter-*`/`X-Mansionshop-*`/`X-Mansionpro-*`/`X-Residence-*`/`X-Residencenavi-*`/`X-Residencecenter-*`/`X-Residenceshop-*`/`X-Residencepro-*`/`X-Danchimart-*`/`X-Danchiplus-*`/`X-Danchismart-*`/`X-Danchifamily-*`/`X-Mansionmart-*`/`X-Mansionplus-*`/`X-Mansionsmart-*`/`X-Mansionfamily-*`/`X-Kanrimart-*`/`X-Kanriplus-*`/`X-Kanrismart-*`/`X-Kanrifamily-*`/`X-Jyutaku-*`/`X-Jyutakunavi-*`/`X-Jyutakucenter-*`/`X-Jyutakushop-*`/`X-Jyutakupro-*`/`X-Syuzen-*`/`X-Syuzennavi-*`/`X-Syuzencenter-*`/`X-Syuzenshop-*`/`X-Syuzenpro-*`/`X-Daikann-*`/`X-Daikannavi-*`/`X-Daikanncenter-*`/`X-Daikannshop-*`/`X-Daikannpro-*` 等 は団機の通知記録 — 送信側が書くことは自称。管理費・修繕積立金・総会案内の偽装は不動産詐欺の典型手口。(不動産機は D481、組合本体は既存)
- **修正**: `Envelope` に `danchi_marks` + `has_danchi_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 団印の自署を問え。

### Security — D675: `X-Houseclean-*`/`X-Housecleannavi-*`/`X-Housecleancenter-*` 等のハウスクリーニング・お掃除印自称が未検査

- **問題**: `X-Houseclean-*`/`X-Housecleannavi-*`/`X-Housecleancenter-*`/`X-Housecleanshop-*`/`X-Housecleanpro-*`/`X-Osouji-*`/`X-Osoujinavi-*`/`X-Osoujicenter-*`/`X-Osoujishop-*`/`X-Osoujipro-*`/`X-Cleanning-*`/`X-Cleanningnavi-*`/`X-Cleanningcenter-*`/`X-Cleaningshop-*`/`X-Airconclean-*`/`X-Airconcleannavi-*`/`X-Airconcleancenter-*`/`X-Airconcleanshop-*`/`X-Airconcleanpro-*`/`X-Kirei-*`/`X-Kireinavi-*`/`X-Kireicenter-*`/`X-Kireishop-*`/`X-Kireipro-*`/`X-Onamae-*`/`X-Onamaenavi-*`/`X-Onamaecenter-*`/`X-Onamaeshop-*`/`X-Onamaepro-*`/`X-Cleanmart-*`/`X-Cleanplus-*`/`X-Cleansmart-*`/`X-Cleanfamily-*`/`X-Osoujimart-*`/`X-Osoujiplus-*`/`X-Osoujismart-*`/`X-Osoujifamily-*`/`X-Cleannavi-*`/`X-Cleancenter-*`/`X-Cleanshop-*`/`X-Cleanrescue-*`/`X-Clean24-*`/`X-Cleandoctor-*`/`X-Soujiki-*`/`X-Soujikinavi-*`/`X-Soujikicenter-*`/`X-Soujikishop-*`/`X-Soujikipro-*`/`X-Oatsu-*`/`X-Oatsunavi-*`/`X-Oatsucenter-*`/`X-Oatsushop-*`/`X-Oatsupro-*`/`X-Rinsu-*`/`X-Rinsunavi-*`/`X-Rinsucenter-*`/`X-Rinsushop-*`/`X-Rinsupro-*`/`X-Econs-*`/`X-Econsnavi-*`/`X-Econscenter-*`/`X-Econsshop-*`/`X-Econspro-*`/`X-Kanzukai-*`/`X-Kanzukainavi-*`/`X-Kanzukaicenter-*`/`X-Kanzukaishop-*`/`X-Kanzukaipro-*` 等 は掃機の通知記録 — 送信側が書くことは自称。エアコン洗浄・水回り・カビ取り見積の偽装は訪問販売詐欺の典型手口。(家事代行機は D584、エアコン機は D652)
- **修正**: `Envelope` に `houseclean_marks` + `has_houseclean_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 掃印の自署を問え。

### Security — D676: `X-Petfuneral-*`/`X-Petfuneralnavi-*`/`X-Petfuneralcenter-*` 等のペット葬儀・ペット霊園印自称が未検査

- **問題**: `X-Petfuneral-*`/`X-Petfuneralnavi-*`/`X-Petfuneralcenter-*`/`X-Petfuneralshop-*`/`X-Petfuneralpro-*`/`X-Petsougi-*`/`X-Petsouginavi-*`/`X-Petsougicenter-*`/`X-Petsougishop-*`/`X-Petsougipro-*`/`X-Petreien-*`/`X-Petreiennavi-*`/`X-Petreiencenter-*`/`X-Petreienshop-*`/`X-Petreienpro-*`/`X-Petmemorial-*`/`X-Petmemorialnavi-*`/`X-Petmemorialcenter-*`/`X-Petmemorialshop-*`/`X-Petmemorialpro-*`/`X-Kuyou-*`/`X-Kuyounavi-*`/`X-Kuyoucenter-*`/`X-Kuyoushop-*`/`X-Kuyoupro-*`/`X-Petgarden-*`/`X-Petgardennavi-*`/`X-Petgardencenter-*`/`X-Petgardenshop-*`/`X-Petgardenpro-*`/`X-Aisou-*`/`X-Aisounavi-*`/`X-Aisoucenter-*`/`X-Aisoushop-*`/`X-Aisoupro-*`/`X-Petheaven-*`/`X-Petheavennavi-*`/`X-Petheavencenter-*`/`X-Petheavenshop-*`/`X-Petheavenpro-*`/`X-Rainbridge-*`/`X-Rainbowbridge-*`/`X-Rainbowbridgenavi-*`/`X-Rainbowbridgecenter-*`/`X-Rainbowbridgeshop-*`/`X-Rainbowbridgepro-*`/`X-Funeralmart-*`/`X-Funeralplus-*`/`X-Funeralsmart-*`/`X-Funeralfamily-*`/`X-Sougimart-*`/`X-Sougiplus-*`/`X-Sougismart-*`/`X-Sougifamily-*`/`X-Memorialmart-*`/`X-Memorialplus-*`/`X-Memorialsmart-*`/`X-Memorialfamily-*`/`X-Enmusubi-*`/`X-Enmusubinavi-*`/`X-Enmusubicenter-*`/`X-Enmusubishop-*`/`X-Enmusubipro-*`/`X-Tokubetsu-*`/`X-Tokubetsunavi-*`/`X-Tokubetsucenter-*`/`X-Tokubetsushop-*`/`X-Tokubetsupro-*`/`X-Otera-*`/`X-Oteranavi-*`/`X-Oteracenter-*`/`X-Oterashop-*`/`X-Oterapro-*` 等 は弔機の通知記録 — 送信側が書くことは自称。ペット火葬・供養料・霊園区画の偽装は葬儀詐欺の典型手口。(葬儀機は D580、ペットショップ機は D662)
- **修正**: `Envelope` に `petfuneral_marks` + `has_petfuneral_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 弔印の自署を問え。

### Security — D671: `X-Kinken-*`/`X-Kinkennavi-*`/`X-Kinkencenter-*` 等の金券・チケットショップ印自称が未検査

- **問題**: `X-Kinken-*`/`X-Kinkennavi-*`/`X-Kinkencenter-*`/`X-Kinkenshop-*`/`X-Kinkenpro-*`/`X-Ticketshop-*`/`X-Ticketshopnavi-*`/`X-Ticketshopcenter-*`/`X-Ticketshopshop-*`/`X-Ticketshoppro-*`/`X-Kittenavi-*`/`X-Kittecenter-*`/`X-Kitteshop-*`/`X-Kittepro-*`/`X-Shouken-*`/`X-Shoukennavi-*`/`X-Shoukencenter-*`/`X-Shoukenshop-*`/`X-Shoukenpro-*`/`X-Voucher-*`/`X-Vouchernavi-*`/`X-Vouchercenter-*`/`X-Vouchershop-*`/`X-Voucherpro-*`/`X-Giftcard-*`/`X-Giftcardnavi-*`/`X-Giftcardcenter-*`/`X-Giftcardshop-*`/`X-Giftcardpro-*`/`X-Daikenshops-*`/`X-Daikenshop-*`/`X-Naviken-*`/`X-Navikennavi-*`/`X-Navikencenter-*`/`X-Navikenshop-*`/`X-Navikenpro-*`/`X-Joshaken-*`/`X-Joshakennavi-*`/`X-Joshakencenter-*`/`X-Joshakenshop-*`/`X-Joshakenpro-*`/`X-Ticketmart-*`/`X-Ticketplus-*`/`X-Ticketsmart-*`/`X-Ticketfamily-*`/`X-Kinkenmart-*`/`X-Kinkenplus-*`/`X-Kinkensmart-*`/`X-Kinkenfamily-*`/`X-Tekkenshop-*`/`X-Tekkennavi-*`/`X-Tekkencenter-*`/`X-Tekkenpro-*`/`X-Kennavi-*`/`X-Kencenter-*`/`X-Kenshop-*`/`X-Kenpro-*`/`X-Ticketnavi-*`/`X-Ticketcenter-*`/`X-Ticketpro-*`/`X-Ticketdoctor-*`/`X-Ticketrescue-*`/`X-Ticket24-*` 等 は紙機の通知記録 — 送信側が書くことは自称。金券買取・チケット換金・ギフト券送付の偽装は金券詐欺の典型手口。(切手・大広は既存、チケット機は D534)
- **修正**: `Envelope` に `ticketshop_marks` + `has_ticketshop_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 紙印の自署を問え。

### Security — D672: `X-Livehouse-*`/`X-Livehousenavi-*`/`X-Livehousecenter-*` 等のライブハウス・クラブ印自称が未検査

- **問題**: `X-Livehouse-*`/`X-Livehousenavi-*`/`X-Livehousecenter-*`/`X-Livehouseshop-*`/`X-Livehousepro-*`/`X-Live-*`/`X-Livenavi-*`/`X-Livecenter-*`/`X-Liveshop-*`/`X-Livepro-*`/`X-Zepp-*`/`X-Zeppnavi-*`/`X-Zeppcenter-*`/`X-Zeppshop-*`/`X-Zepppro-*`/`X-Club-*`/`X-Clubnavi-*`/`X-Clubcenter-*`/`X-Clubshop-*`/`X-Clubpro-*`/`X-Ondoku-*`/`X-Ondokunavi-*`/`X-Ondokucenter-*`/`X-Ondokushop-*`/`X-Ondokupro-*`/`X-Livehousemart-*`/`X-Livehouseplus-*`/`X-Livehousesmart-*`/`X-Livehousefamily-*`/`X-Livemart-*`/`X-Liveplus-*`/`X-Livesmart-*`/`X-Livefamily-*`/`X-Clubmart-*`/`X-Clubplus-*`/`X-Clubsmart-*`/`X-Clubfamily-*`/`X-Daikounavi-*`/`X-Daikoucenter-*`/`X-Daikoushop-*`/`X-Daikoupro-*`/`X-Livehall-*`/`X-Livehallnavi-*`/`X-Livehallcenter-*`/`X-Livehallshop-*`/`X-Livehallpro-*`/`X-Musicbox-*`/`X-Musicboxnavi-*`/`X-Musicboxcenter-*`/`X-Musicboxshop-*`/`X-Musicboxpro-*`/`X-Onband-*`/`X-Onbandnavi-*`/`X-Onbandcenter-*`/`X-Onbandshop-*`/`X-Onbandpro-*`/`X-Staging-*`/`X-Stagingnavi-*`/`X-Stagingcenter-*`/`X-Stagingshop-*`/`X-Stagingpro-*`/`X-Rockhouse-*`/`X-Rockhousenavi-*`/`X-Rockhousecenter-*`/`X-Rockhouseshop-*`/`X-Rockhousepro-*` 等 は奏機の通知記録 — 送信側が書くことは自称。ライブ予約・チケット先行・物販の偽装は興行詐欺の典型手口。(娯楽機は D536、劇場機は D639)
- **修正**: `Envelope` に `livehouse_marks` + `has_livehouse_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 奏印の自署を問え。

### Security — D673: `X-Barber-*`/`X-Barbernavi-*`/`X-Barbercenter-*` 等の床屋・理容・QB印自称が未検査

- **問題**: `X-Barber-*`/`X-Barbernavi-*`/`X-Barbercenter-*`/`X-Barbershop-*`/`X-Barberpro-*`/`X-Riyou-*`/`X-Riyounavi-*`/`X-Riyoucenter-*`/`X-Riyoushop-*`/`X-Riyoupro-*`/`X-Tokoya-*`/`X-Tokoyanavi-*`/`X-Tokoyacenter-*`/`X-Tokoyashop-*`/`X-Tokoyapro-*`/`X-Qbhouse-*`/`X-Qb-*`/`X-Qbnavi-*`/`X-Qbcenter-*`/`X-Qbshop-*`/`X-Qbpro-*`/`X-Plaisir-*`/`X-Plaisirnavi-*`/`X-Plaisircenter-*`/`X-Plaisirshop-*`/`X-Plaisirpro-*`/`X-Sanpatsu-*`/`X-Sanpatsunavi-*`/`X-Sanpatsucenter-*`/`X-Sanpatsushop-*`/`X-Sanpatsupro-*`/`X-Haircut-*`/`X-Haircutnavi-*`/`X-Haircutcenter-*`/`X-Haircutshop-*`/`X-Haircutpro-*`/`X-Barbermart-*`/`X-Barberplus-*`/`X-Barbersmart-*`/`X-Barberfamily-*`/`X-Mens-*`/`X-Mensnavi-*`/`X-Menscenter-*`/`X-Mensshop-*`/`X-Menspro-*`/`X-Salondenavi-*`/`X-Salondencenter-*`/`X-Salondenshop-*`/`X-Salondenpro-*`/`X-Barberia-*`/`X-Barberianavi-*`/`X-Barberiacenter-*`/`X-Barberiashop-*`/`X-Barberiapro-*`/`X-Riyouin-*`/`X-Riyouinnavi-*`/`X-Riyouincenter-*`/`X-Riyouinshop-*`/`X-Riyouinpro-*`/`X-Kamikire-*`/`X-Kamikirenavi-*`/`X-Kamikirecenter-*`/`X-Kamikireshop-*`/`X-Kamikirepro-*`/`X-Danseigan-*`/`X-Danseigannavi-*`/`X-Danseigancenter-*`/`X-Danseiganshop-*`/`X-Danseiganpro-*` 等 は髭機の通知記録 — 送信側が書くことは自称。散髪予約・理容会員・カット料金の偽装は美容詐欺の典型手口。(美容院機は D665)
- **修正**: `Envelope` に `barber_marks` + `has_barber_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 髭印の自署を問え。

### Security — D668: `X-Pachinkonavi-*`/`X-Pachinkocenter-*`/`X-Pachinkoshop-*` 等のパチンコ・パチスロ・ホール印自称が未検査

- **問題**: `X-Pachinkonavi-*`/`X-Pachinkocenter-*`/`X-Pachinkoshop-*`/`X-Pachinkopro-*`/`X-Pachisuro-*`/`X-Pachisuronavi-*`/`X-Pachisurocenter-*`/`X-Pachisuroshop-*`/`X-Pachisuropro-*`/`X-Hall-*`/`X-Hallnavi-*`/`X-Hallcenter-*`/`X-Hallshop-*`/`X-Hallpro-*`/`X-Parlor-*`/`X-Parlornavi-*`/`X-Parlorcenter-*`/`X-Parlorshop-*`/`X-Parlorpro-*`/`X-Slot-*`/`X-Slotnavi-*`/`X-Slotcenter-*`/`X-Slotshop-*`/`X-Slotpro-*`/`X-Maruhan-*`/`X-Dainavi-*`/`X-Dainam-*`/`X-Pworld-*`/`X-Pworldnavi-*`/`X-Pworldcenter-*`/`X-Pworldshop-*`/`X-Pworldpro-*`/`X-Gurume-*`/`X-Gurumekougyou-*`/`X-Undoukai-*`/`X-Kyoutei-*`/`X-Kyoteinavi-*`/`X-Kyoteicenter-*`/`X-Kappa-*`/`X-Kappanavi-*`/`X-Kappacenter-*`/`X-Kappashop-*`/`X-Kappapro-*`/`X-Pachimart-*`/`X-Pachiplus-*`/`X-Pachismart-*`/`X-Pachifamily-*`/`X-Slotmart-*`/`X-Slotplus-*`/`X-Slotsmart-*`/`X-Slotfamily-*`/`X-Nijyuu-*`/`X-Nijyuunavi-*`/`X-Nijyuucenter-*`/`X-Nijyuushop-*`/`X-Nijyuupro-*`/`X-Tamaya-*`/`X-Tamayanavi-*`/`X-Tamayacenter-*`/`X-Tamayashop-*`/`X-Tamayapro-*`/`X-Tamatsukuri-*`/`X-Tamanavi-*`/`X-Tamacenter-*`/`X-Tamashop-*`/`X-Tamapro-*`/`X-Hallmart-*`/`X-Hallplus-*`/`X-Hallsmart-*`/`X-Hallfamily-*` 等 は玉機の通知記録 — 送信側が書くことは自称。会員カード・イベント・景品交換の偽装はギャンブル詐欺の典型手口。(賭博機は D547、`X-Pachinko-*`/Dynam は既存)
- **修正**: `Envelope` に `pachinko_marks` + `has_pachinko_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 玉印の自署を問え。

### Security — D669: `X-Gyokyou-*`/`X-Gyokyounavi-*`/`X-Gyokyoucenter-*` 等の漁協・水産・魚市場印自称が未検査

- **問題**: `X-Gyokyou-*`/`X-Gyokyounavi-*`/`X-Gyokyoucenter-*`/`X-Gyokyoushop-*`/`X-Gyokyoupro-*`/`X-Suisan-*`/`X-Suisannavi-*`/`X-Suisancenter-*`/`X-Suisanshop-*`/`X-Suisanpro-*`/`X-Uoichiba-*`/`X-Uoichibanavi-*`/`X-Uoichibacenter-*`/`X-Uoichibashop-*`/`X-Uoichibapro-*`/`X-Fishmarket-*`/`X-Fishmarketnavi-*`/`X-Fishmarketcenter-*`/`X-Fishmarketshop-*`/`X-Fishmarketpro-*`/`X-Kaisen-*`/`X-Kaisennavi-*`/`X-Kaisencenter-*`/`X-Kaisenshop-*`/`X-Kaisenpro-*`/`X-Maguro-*`/`X-Maguronavi-*`/`X-Magurocenter-*`/`X-Maguroshop-*`/`X-Maguropro-*`/`X-Kani-*`/`X-Kaninavi-*`/`X-Kanicenter-*`/`X-Kanishop-*`/`X-Kanipro-*`/`X-Seafoods-*`/`X-Seafoodsnavi-*`/`X-Seafoodscenter-*`/`X-Seafoodsshop-*`/`X-Seafoodspro-*`/`X-Gyoson-*`/`X-Gyosonnavi-*`/`X-Gyosoncenter-*`/`X-Gyosonshop-*`/`X-Gyosonpro-*`/`X-Kichibapro-*`/`X-Gyokyomart-*`/`X-Gyokyoplus-*`/`X-Gyokyosmart-*`/`X-Gyokyofamily-*`/`X-Suisanmart-*`/`X-Suisanplus-*`/`X-Suisansmart-*`/`X-Suisanfamily-*`/`X-Minato-*`/`X-Minatonavi-*`/`X-Minatocenter-*`/`X-Minatoshop-*`/`X-Minatopro-*`/`X-Fushimi-*`/`X-Fushiminavi-*`/`X-Fushimicenter-*`/`X-Fushimishop-*`/`X-Fushimipro-*`/`X-Uotoshi-*`/`X-Uotoshinavi-*`/`X-Uotoshicenter-*`/`X-Uotoshishop-*`/`X-Uotoshipro-*` 等 は漁機の通知記録 — 送信側が書くことは自称。漁協組合・水産直送・魚市場競りの偽装は産地直送詐欺の典型手口。(釣具機は D600、食品機は D551)
- **修正**: `Envelope` に `fishery_marks` + `has_fishery_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 漁印の自署を問え。

### Security — D670: `X-Eiga-*`/`X-Eiganavi-*`/`X-Eigacenter-*` 等の映画館・シネコン印自称が未検査

- **問題**: `X-Eiga-*`/`X-Eiganavi-*`/`X-Eigacenter-*`/`X-Eigashop-*`/`X-Eigapro-*`/`X-Cinema-*`/`X-Cinemanavi-*`/`X-Cinemacenter-*`/`X-Cinemashop-*`/`X-Cinemapro-*`/`X-Cinecon-*`/`X-Cineconnavi-*`/`X-Cineconcenter-*`/`X-Cineconshop-*`/`X-Cineconpro-*`/`X-Tohonavi-*`/`X-Tohocenter-*`/`X-Tohoshop-*`/`X-Tohopro-*`/`X-Movixnavi-*`/`X-Movixcenter-*`/`X-Movixshop-*`/`X-Movixpro-*`/`X-Piccadilly-*`/`X-Piccadillynavi-*`/`X-Piccadillycenter-*`/`X-Piccadillyshop-*`/`X-Piccadillypro-*`/`X-Unitedcinema-*`/`X-Cinemart-*`/`X-Cinemaplus-*`/`X-Cinemasmart-*`/`X-Cinemafamily-*`/`X-Screening-*`/`X-Screeningnavi-*`/`X-Screeningcenter-*`/`X-Screeningshop-*`/`X-Screeningpro-*`/`X-Minitheater-*`/`X-Eizou-*`/`X-Eizounavi-*`/`X-Eizoucenter-*`/`X-Eizoushop-*`/`X-Eizoupro-*`/`X-Eigakan-*`/`X-Eigakannavi-*`/`X-Eigakancenter-*`/`X-Eigakanshop-*`/`X-Eigakanpro-*`/`X-Screent-*`/`X-Screentnavi-*`/`X-Screentcenter-*`/`X-Screentshop-*`/`X-Screentpro-*`/`X-Ioncinema-*`/`X-Ioncinemanavi-*`/`X-Ioncinemacenter-*`/`X-Ioncinemashop-*`/`X-Ioncinemapro-*`/`X-Cinemanew-*`/`X-Cinemanewnavi-*`/`X-Cinemanewcenter-*`/`X-Cinemanewshop-*`/`X-Cinemanewpro-*`/`X-Matinee-*`/`X-Matineenavi-*`/`X-Matineecenter-*`/`X-Matineeshop-*`/`X-Matineepro-*` 等 は映機の通知記録 — 送信側が書くことは自称。チケット予約・舞台挨拶・会員割引の偽装は興行詐欺の典型手口。(劇場機は D639、東宝/MOVIX/イオンシネマ本体印は既存)
- **修正**: `Envelope` に `cinema_marks` + `has_cinema_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 映印の自署を問え。

### Security — D665: `X-Nail-*`/`X-Nailnavi-*`/`X-Nailcenter-*` 等のネイル・まつげ・美容院印自称が未検査

- **問題**: `X-Nail-*`/`X-Nailnavi-*`/`X-Nailcenter-*`/`X-Nailshop-*`/`X-Nailpro-*`/`X-Matsuge-*`/`X-Matsugenavi-*`/`X-Matsugecenter-*`/`X-Matsugeshop-*`/`X-Matsugepro-*`/`X-Matsueku-*`/`X-Matsuekunavi-*`/`X-Matsuekucenter-*`/`X-Matsuekushop-*`/`X-Matsuekupro-*`/`X-Gelnail-*`/`X-Gelnailnavi-*`/`X-Gelnailcenter-*`/`X-Gelnailshop-*`/`X-Gelnailpro-*`/`X-Biyouin-*`/`X-Biyouinnavi-*`/`X-Biyouincenter-*`/`X-Biyouinshop-*`/`X-Biyouinpro-*`/`X-Hair-*`/`X-Hairnavi-*`/`X-Haircenter-*`/`X-Hairshop-*`/`X-Hairpro-*`/`X-Salon-*`/`X-Salonnavi-*`/`X-Saloncenter-*`/`X-Salonshop-*`/`X-Salonpro-*`/`X-Nailmart-*`/`X-Nailplus-*`/`X-Nailsmart-*`/`X-Nailfamily-*`/`X-Matsugemart-*`/`X-Matsugeplus-*`/`X-Matsugesmart-*`/`X-Matsugefamily-*`/`X-Eyebrow-*`/`X-Eyebrownavi-*`/`X-Eyebrowcenter-*`/`X-Eyebrowshop-*`/`X-Eyebrowpro-*`/`X-Lash-*`/`X-Lashnavi-*`/`X-Lashcenter-*`/`X-Lashshop-*`/`X-Lashpro-*`/`X-Beautyroom-*`/`X-Beautyroomnavi-*`/`X-Beautyroomcenter-*`/`X-Beautyroomshop-*`/`X-Beautyroompro-*` 等 は爪機の通知記録 — 送信側が書くことは自称。ネイル予約・まつエク施術・美容院会員の偽装は美容詐欺の典型手口。(エステ機は D608、化粧品機は D531)
- **修正**: `Envelope` に `nail_marks` + `has_nail_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 爪印の自署を問え。

### Security — D666: `X-Izakaya-*`/`X-Izakayanavi-*`/`X-Izakayacenter-*` 等の居酒屋・バー・焼鳥印自称が未検査

- **問題**: `X-Izakaya-*`/`X-Izakayanavi-*`/`X-Izakayacenter-*`/`X-Izakayashop-*`/`X-Izakayapro-*`/`X-Barnavi-*`/`X-Barcenter-*`/`X-Barshop-*`/`X-Barpro-*`/`X-Yakitori-*`/`X-Yakitorinavi-*`/`X-Yakitoricenter-*`/`X-Yakitorishop-*`/`X-Yakitoripro-*`/`X-Tavern-*`/`X-Tavernnavi-*`/`X-Taverncenter-*`/`X-Tavernshop-*`/`X-Tavernpro-*`/`X-Pubnavi-*`/`X-Pubcenter-*`/`X-Pubshop-*`/`X-Pubpro-*`/`X-Roba-*`/`X-Robatanavi-*`/`X-Robatacenter-*`/`X-Robatashop-*`/`X-Robatapro-*`/`X-Dining-*`/`X-Diningnavi-*`/`X-Diningcenter-*`/`X-Diningshop-*`/`X-Diningpro-*`/`X-Izakayamart-*`/`X-Izakayaplus-*`/`X-Izakayasmart-*`/`X-Izakayafamily-*`/`X-Yakitorimart-*`/`X-Yakitoriplus-*`/`X-Yakitorismart-*`/`X-Yakitorifamily-*`/`X-Nomiya-*`/`X-Nomiyanavi-*`/`X-Nomiyacenter-*`/`X-Nomiyashop-*`/`X-Nomiyapro-*`/`X-Sakaba-*`/`X-Sakabanavi-*`/`X-Sakabacenter-*`/`X-Sakabashop-*`/`X-Sakabapro-*`/`X-Kyabakura-*`/`X-Kyabakuranavi-*`/`X-Kyabakuracenter-*`/`X-Kyabakurashop-*`/`X-Kyabakurapro-*`/`X-Snack-*`/`X-Snacknavi-*`/`X-Snackcenter-*`/`X-Snackshop-*`/`X-Snackpro-*` 等 は酌機の通知記録 — 送信側が書くことは自称。居酒屋予約・飲み放題・会員特典の偽装は飲食詐欺の典型手口。(飲食機は D528)
- **修正**: `Envelope` に `izakaya_marks` + `has_izakaya_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 酌印の自署を問え。

### Security — D667: `X-Jaf-*`/`X-Jafnavi-*`/`X-Jafcenter-*` 等のロードサービス・レッカー印自称が未検査

- **問題**: `X-Jaf-*`/`X-Jafnavi-*`/`X-Jafcenter-*`/`X-Jafshop-*`/`X-Jafpro-*`/`X-Roadservice-*`/`X-Roadservicenavi-*`/`X-Roadservicecenter-*`/`X-Roadserviceshop-*`/`X-Roadservicepro-*`/`X-Roadside-*`/`X-Roadsidenavi-*`/`X-Roadsidecenter-*`/`X-Roadsideshop-*`/`X-Roadsidepro-*`/`X-Rekkya-*`/`X-Rekkyanavi-*`/`X-Rekkyacenter-*`/`X-Rekkyashop-*`/`X-Rekkyapro-*`/`X-Wrecker-*`/`X-Wreckernavi-*`/`X-Wreckercenter-*`/`X-Wreckershop-*`/`X-Wreckerpro-*`/`X-Towing-*`/`X-Towingnavi-*`/`X-Towingcenter-*`/`X-Towingshop-*`/`X-Towingpro-*`/`X-Batterycharge-*`/`X-Danpan-*`/`X-Danpannavi-*`/`X-Danpancenter-*`/`X-Danpanshop-*`/`X-Danpanpro-*`/`X-Mobilebattery-*`/`X-Emergencyroad-*`/`X-Rescuecar-*`/`X-Roadmart-*`/`X-Roadplus-*`/`X-Roadsmart-*`/`X-Roadfamily-*`/`X-Rekkymart-*`/`X-Rekkyplus-*`/`X-Rekkysmart-*`/`X-Rekkyfamily-*`/`X-Pank-*`/`X-Panknavi-*`/`X-Pankcenter-*`/`X-Pankshop-*`/`X-Pankpro-*`/`X-Tirei-*`/`X-Tireinavi-*`/`X-Tireicenter-*`/`X-Tireishop-*`/`X-Tireipro-*`/`X-Gasorinnavi-*`/`X-Gasorincenter-*`/`X-Gasorinshop-*`/`X-Gasorinpro-*`/`X-Jafmart-*`/`X-Jafplus-*`/`X-Jafsmart-*`/`X-Jaffamily-*` 等 は牽機の通知記録 — 送信側が書くことは自称。JAF会員・レッカー費用・緊急出動料金の偽装は自動車詐欺の典型手口。(自動車機は D521、車検機は D664)
- **修正**: `Envelope` に `roadside_marks` + `has_roadside_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 牽印の自署を問え。

### Security — D662: `X-Petshop-*`/`X-Petshopnavi-*`/`X-Petshopcenter-*` 等のペットショップ・トリミング印自称が未検査

- **問題**: `X-Petshop-*`/`X-Petshopnavi-*`/`X-Petshopcenter-*`/`X-Petshopshop-*`/`X-Petshoppro-*`/`X-Trimming-*`/`X-Trimmingnavi-*`/`X-Trimmingcenter-*`/`X-Trimmingshop-*`/`X-Trimmingpro-*`/`X-Pethotel-*`/`X-Pethotelnavi-*`/`X-Pethotelcenter-*`/`X-Pethotelshop-*`/`X-Pethotelpro-*`/`X-Breeder-*`/`X-Breedernavi-*`/`X-Breedercenter-*`/`X-Breedershop-*`/`X-Breederpro-*`/`X-Onechan-*`/`X-Onechannavi-*`/`X-Onechancenter-*`/`X-Onechanshop-*`/`X-Onechanpro-*`/`X-Wanchan-*`/`X-Wanchannavi-*`/`X-Wanchancenter-*`/`X-Wanchanshop-*`/`X-Wanchanpro-*`/`X-Nyanchan-*`/`X-Nyanchannavi-*`/`X-Nyanchancenter-*`/`X-Nyanchanshop-*`/`X-Nyanchanpro-*`/`X-Petnavi-*`/`X-Petcenter-*`/`X-Petpro-*`/`X-Petrescue-*`/`X-Pet24-*`/`X-Petmart-*`/`X-Petplus-*`/`X-Wanmarch-*`/`X-Nyanmaru-*`/`X-Petclinicnavi-*`/`X-Petcliniccenter-*`/`X-Petclinicshop-*`/`X-Petclinicpro-*`/`X-Petshopmart-*`/`X-Petshopplus-*`/`X-Petshopsmart-*`/`X-Petshopfamily-*`/`X-Trimmingmart-*`/`X-Trimmingplus-*`/`X-Trimmingsmart-*`/`X-Trimmingfamily-*`/`X-Wannavi-*`/`X-Wancenter-*`/`X-Wanshop-*`/`X-Wanpro-*`/`X-Nyannavi-*`/`X-Nyancenter-*`/`X-Nyanshop-*`/`X-Nyanpro-*` 等 は毛機の通知記録 — 送信側が書くことは自称。子犬販売・トリミング予約・ペットホテル料金の偽装はペット詐欺の典型手口。(ペット保険機は D561、動物病院機は D630)
- **修正**: `Envelope` に `petshop_marks` + `has_petshop_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 毛印の自署を問え。

### Security — D663: `X-Dental-*`/`X-Dentalnavi-*`/`X-Dentalcenter-*` 等の歯科・矯正歯科印自称が未検査

- **問題**: `X-Dental-*`/`X-Dentalnavi-*`/`X-Dentalcenter-*`/`X-Dentalshop-*`/`X-Dentalpro-*`/`X-Dentaldoctor-*`/`X-Dentalrescue-*`/`X-Dental24-*`/`X-Shika-*`/`X-Shikanavi-*`/`X-Shikacenter-*`/`X-Shikashop-*`/`X-Shikapro-*`/`X-Shikadoctor-*`/`X-Shikarescue-*`/`X-Shika24-*`/`X-Kyousei-*`/`X-Kyouseinavi-*`/`X-Kyouseicenter-*`/`X-Kyouseishop-*`/`X-Kyouseipro-*`/`X-Whitening-*`/`X-Whiteningnavi-*`/`X-Whiteningcenter-*`/`X-Whiteningshop-*`/`X-Whiteningpro-*`/`X-Implant-*`/`X-Implantnavi-*`/`X-Implantcenter-*`/`X-Implantshop-*`/`X-Implantpro-*`/`X-Haisha-*`/`X-Haishanavi-*`/`X-Haishacenter-*`/`X-Haishashop-*`/`X-Haishapro-*`/`X-Dentist-*`/`X-Dentistnavi-*`/`X-Dentistcenter-*`/`X-Dentistshop-*`/`X-Dentistpro-*`/`X-Dentmart-*`/`X-Dentplus-*`/`X-Dentsmart-*`/`X-Dentfamily-*`/`X-Dentalmart-*`/`X-Dentalplus-*`/`X-Dentalsmart-*`/`X-Dentalfamily-*`/`X-Hamigaki-*`/`X-Hamigakinavi-*`/`X-Hamigakicenter-*`/`X-Hamigakishop-*`/`X-Hamigakipro-*`/`X-Koukuu-*`/`X-Koukuunavi-*`/`X-Koukuucenter-*`/`X-Koukuushop-*`/`X-Koukuupro-*`/`X-Koushinetsu-*`/`X-Koushinetsunavi-*`/`X-Koushinetsucenter-*`/`X-Koushinetsushop-*`/`X-Koushinetsupro-*` 等 は歯機の通知記録 — 送信側が書くことは自称。歯科予約・矯正見積・インプラント費用の偽装は医療詐欺の典型手口。(医療機は D461)
- **修正**: `Envelope` に `dental_marks` + `has_dental_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 歯印の自署を問え。

### Security — D664: `X-Shaken-*`/`X-Shakennavi-*`/`X-Shakencenter-*` 等の車検・板金・タイヤ印自称が未検査

- **問題**: `X-Shaken-*`/`X-Shakennavi-*`/`X-Shakencenter-*`/`X-Shakenshop-*`/`X-Shakenpro-*`/`X-Carinspection-*`/`X-Bankin-*`/`X-Bankinnavi-*`/`X-Bankincenter-*`/`X-Bankinshop-*`/`X-Bankinpro-*`/`X-Tire-*`/`X-Tirenavi-*`/`X-Tirecenter-*`/`X-Tireshop-*`/`X-Tirepro-*`/`X-Oil-*`/`X-Oilnavi-*`/`X-Oilcenter-*`/`X-Oilshop-*`/`X-Oilpro-*`/`X-Carcheck-*`/`X-Carchecknavi-*`/`X-Carcheckcenter-*`/`X-Carcheckshop-*`/`X-Carcheckpro-*`/`X-Kakena-*`/`X-Kakenanavi-*`/`X-Kakenacenter-*`/`X-Kakenashop-*`/`X-Kakenapro-*`/`X-Shakek-*`/`X-Shakenger-*`/`X-Tiremart-*`/`X-Tireplus-*`/`X-Tiresmart-*`/`X-Tirefamily-*`/`X-Bankinmart-*`/`X-Bankinplus-*`/`X-Bankinsmart-*`/`X-Bankinfamily-*`/`X-Carfix-*`/`X-Carfixnavi-*`/`X-Carfixcenter-*`/`X-Carfixshop-*`/`X-Carfixpro-*`/`X-Itabankin-*`/`X-Itabankinnavi-*`/`X-Itabankincenter-*`/`X-Itabankinshop-*`/`X-Itabankinpro-*`/`X-Bikeshaken-*`/`X-Bikeshakennavi-*`/`X-Bikeshakencenter-*`/`X-Bikeshakenshop-*`/`X-Bikeshakenpro-*`/`X-Hokena-*`/`X-Hokenanavi-*`/`X-Hokenacenter-*`/`X-Hokenashop-*`/`X-Hokenapro-*` 等 は車機の通知記録 — 送信側が書くことは自称。車検見積・板金修理・タイヤ交換料金の偽装は自動車詐欺の典型手口。(自動車機は D521、車買取機は D572)
- **修正**: `Envelope` に `shaken_marks` + `has_shaken_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 車印の自署を問え。

### Security — D659: `X-Sauna-*`/`X-Onyoku-*`/`X-Onyokunavi-*` 等のサウナ・温浴・スパ印自称が未検査

- **問題**: `X-Sauna-*`/`X-Onyoku-*`/`X-Onyokunavi-*`/`X-Onyokucenter-*`/`X-Onyokushop-*`/`X-Onyokupro-*`/`X-Onyokudoctor-*`/`X-Onyokurescue-*`/`X-Onyoku24-*`/`X-Supa-*`/`X-Supanavi-*`/`X-Supacenter-*`/`X-Supashop-*`/`X-Supapro-*`/`X-Supadoctor-*`/`X-Suparescue-*`/`X-Supa24-*`/`X-Totonoi-*`/`X-Totonoinavi-*`/`X-Totonoicenter-*`/`X-Totonoishop-*`/`X-Totonoipro-*`/`X-Totorou-*`/`X-Totorounavi-*`/`X-Totoroucenter-*`/`X-Totoroushop-*`/`X-Totoroupro-*`/`X-Kenkouland-*`/`X-Kenkounavi-*`/`X-Kenkoucenter-*`/`X-Kenkoushop-*`/`X-Kenkoupro-*`/`X-Spalaqua-*`/`X-Raqu-*`/`X-Panpus-*`/`X-Yunessun-*`/`X-Saunamart-*`/`X-Saunaplus-*`/`X-Saunasmart-*`/`X-Saunafamily-*`/`X-Onyokumart-*`/`X-Onyokuplus-*`/`X-Onyokusmart-*`/`X-Onyokufamily-*`/`X-Supamart-*`/`X-Supaplus-*`/`X-Supasmart-*`/`X-Supafamily-*`/`X-Totonoimart-*`/`X-Totonoiplus-*`/`X-Totonoismart-*`/`X-Totonoifamily-*`/`X-Kannamanavi-*`/`X-Kannamacenter-*`/`X-Kannamashop-*`/`X-Kannamapro-*`/`X-Kannamadoctor-*`/`X-Kannamarescue-*`/`X-Kannama24-*`/`X-Rasshuanavi-*`/`X-Rasshuacenter-*`/`X-Rasshuashop-*`/`X-Rasshuapro-*`/`X-Rasshuadoctor-*`/`X-Rasshuarescue-*`/`X-Rasshua24-*`/`X-Rakuspanavi-*`/`X-Rakuspackenter-*`/`X-Rakuspashop-*`/`X-Rakuspaopro-*`/`X-Rakuspadoctor-*`/`X-Rakusparescue-*`/`X-Rakuspa24-*` 等 は浴機の通知記録 — 送信側が書くことは自称。サウナ会員・温浴回数券・スパ宿泊・整いイベントの偽装は温浴詐欺の典型手口。(温泉銭湯機は D637)
- **修正**: `Envelope` に `sauna_marks` + `has_sauna_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 浴印の自署を問え。

### Security — D660: `X-Karaoke-*`/`X-Karaokenavi-*`/`X-Karaokecenter-*` 等のカラオケ・ネットカフェ印自称が未検査

- **問題**: `X-Karaoke-*`/`X-Karaokenavi-*`/`X-Karaokecenter-*`/`X-Karaokeshop-*`/`X-Karaokepro-*`/`X-Karaokedoctor-*`/`X-Karaokerescue-*`/`X-Karaoke24-*`/`X-Manekineko-*`/`X-Koodajuu-*`/`X-Nekafee-*`/`X-Nekafeenavi-*`/`X-Nekafeecenter-*`/`X-Nekafeeshop-*`/`X-Nekafeepro-*`/`X-Nekafeedoctor-*`/`X-Nekafeerescue-*`/`X-Nekafee24-*`/`X-Kaikatsu-*`/`X-Jiyuukukan-*`/`X-Jiyuu-*`/`X-Jiyuunavi-*`/`X-Jiyuucenter-*`/`X-Jiyuushop-*`/`X-Jiyuupro-*`/`X-Jiyuudoctor-*`/`X-Jiyuurescue-*`/`X-Jiyuu24-*`/`X-Internetcafe-*`/`X-Mediacafe-*`/`X-Spacecreate-*`/`X-Bagusu-*`/`X-Hexaforo-*`/`X-Karaoke7-*`/`X-Karaokekan-*`/`X-Karaokehonpo-*`/`X-Utahiroba-*`/`X-Singing-*`/`X-Singingnavi-*`/`X-Singingcenter-*`/`X-Singingshop-*`/`X-Singingpro-*`/`X-Karaokemart-*`/`X-Karaokeplus-*`/`X-Karaokesmart-*`/`X-Karaokefamily-*`/`X-Nekafeemart-*`/`X-Nekafeeplus-*`/`X-Nekafeesmart-*`/`X-Nekafeefamily-*`/`X-Utasenavi-*`/`X-Utasecenter-*`/`X-Utaseshop-*`/`X-Utasepro-*`/`X-Utasedoctor-*`/`X-Utaserescue-*`/`X-Utase24-*`/`X-Manganavi-*`/`X-Mangacenter-*`/`X-Mangashop-*`/`X-Mangapro-*`/`X-Mangadoctor-*`/`X-Mangarescue-*`/`X-Manga24-*`/`X-Comickunavi-*`/`X-Comickucenter-*`/`X-Comickushop-*`/`X-Comickupro-*`/`X-Comickudoctor-*`/`X-Comickurescue-*`/`X-Comicku24-*` 等 は歌機の通知記録 — 送信側が書くことは自称。カラオケ会員・ネカフェ料金・採点イベント・歌い放題の偽装は娯楽詐欺の典型手口。(娯楽機は D536、漫画機は D557)
- **修正**: `Envelope` に `karaoke_marks` + `has_karaoke_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 歌印の自署を問え。

### Security — D661: `X-Bowling-*`/`X-Bowlingnavi-*`/`X-Bowlingcenter-*` 等のボウリング・ダーツ・ビリヤード印自称が未検査

- **問題**: `X-Bowling-*`/`X-Bowlingnavi-*`/`X-Bowlingcenter-*`/`X-Bowlingshop-*`/`X-Bowlingpro-*`/`X-Bowlingdoctor-*`/`X-Bowlingrescue-*`/`X-Bowling24-*`/`X-Roundone-*`/`X-Darts-*`/`X-Dartsnavi-*`/`X-Dartscenter-*`/`X-Dartsshop-*`/`X-Dartspro-*`/`X-Dartsdoctor-*`/`X-Dartsrescue-*`/`X-Darts24-*`/`X-Dartslive-*`/`X-Phoenixdarts-*`/`X-Phoenix-*`/`X-Biliyard-*`/`X-Billiard-*`/`X-Billiardnavi-*`/`X-Billiardcenter-*`/`X-Billiardshop-*`/`X-Billiardpro-*`/`X-Batting-*`/`X-Battingcenter-*`/`X-Battingnavi-*`/`X-Youkyuu-*`/`X-Youkyuunavi-*`/`X-Youkyuucenter-*`/`X-Youkyuushop-*`/`X-Youkyuupro-*`/`X-Amipara-*`/`X-Amiparanavi-*`/`X-Amiparacenter-*`/`X-Amiparashop-*`/`X-Amiparapro-*`/`X-Bowlingmart-*`/`X-Bowlingplus-*`/`X-Bowlingsmart-*`/`X-Bowlingfamily-*`/`X-Dartsmart-*`/`X-Dartsplus-*`/`X-Dartssmart-*`/`X-Dartsfamily-*`/`X-Sukouanavi-*`/`X-Sukouacenter-*`/`X-Sukouashop-*`/`X-Sukouapro-*`/`X-Sukouadoctor-*`/`X-Sukouarescue-*`/`X-Sukoua24-*`/`X-Nagekominnavi-*`/`X-Nagekomincenter-*`/`X-Nagekominshop-*`/`X-Nagekominpro-*`/`X-Nagekomindoctor-*`/`X-Nagekominrescue-*`/`X-Nagekomin24-*`/`X-Raundowannavi-*`/`X-Raundowancenter-*`/`X-Raundowanshop-*`/`X-Raundowanpro-*`/`X-Raundowandoctor-*`/`X-Raundowanrescue-*`/`X-Raundowan24-*` 等 は投機の通知記録 — 送信側が書くことは自称。ボウリング大会・ダーツ機器・ビリヤード台・ゲーム料金の偽装は娯楽詐欺の典型手口。(娯楽機は D536)
- **修正**: `Envelope` に `bowling_marks` + `has_bowling_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 投印の自署を問え。

### Security — D656: `X-Taxi-*`/`X-Taxinavi-*`/`X-Taxicenter-*` 等のバス・タクシー・ハイヤー印自称が未検査

- **問題**: `X-Taxi-*`/`X-Taxinavi-*`/`X-Taxicenter-*`/`X-Taxishop-*`/`X-Taxipro-*`/`X-Taxidoctor-*`/`X-Taxirescue-*`/`X-Taxi24-*`/`X-Haiya-*`/`X-Haiyanavi-*`/`X-Haiyacenter-*`/`X-Haiyashop-*`/`X-Haiyapro-*`/`X-Haiyadoctor-*`/`X-Haiyarescue-*`/`X-Haiya24-*`/`X-Kousokubasu-*`/`X-Kousokubasunavi-*`/`X-Kousokubasucenter-*`/`X-Kousokubasushop-*`/`X-Kousokubasupro-*`/`X-Kankoubasu-*`/`X-Kankoubasunavi-*`/`X-Kankoubasucenter-*`/`X-Kankoubasushop-*`/`X-Kankoubasupro-*`/`X-Rosenbasu-*`/`X-Rosenbasunavi-*`/`X-Rosenbasucenter-*`/`X-Rosenbasushop-*`/`X-Rosenbasupro-*`/`X-Japantaxi-*`/`X-Tohaiya-*`/`X-Tohaiyanavi-*`/`X-Tohaiyacenter-*`/`X-Tohaiyashop-*`/`X-Tohaiyapro-*`/`X-Meitetsutaxi-*`/`X-Nihonkotsu-*`/`X-Checkercab-*`/`X-Iketaxi-*`/`X-Daiichikoutsuu-*`/`X-Koubanbus-*`/`X-Koubannavi-*`/`X-Koubancenter-*`/`X-Koubanshop-*`/`X-Koubanpro-*`/`X-Taximart-*`/`X-Taxiplus-*`/`X-Taxismart-*`/`X-Taxifamily-*`/`X-Haiyamart-*`/`X-Haiyaplus-*`/`X-Haiyasmart-*`/`X-Haiyafamily-*`/`X-Noritunavi-*`/`X-Noritcenter-*`/`X-Noritshop-*`/`X-Noritpro-*`/`X-Notime-*`/`X-Hayarinavi-*`/`X-Hayaricenter-*`/`X-Hayarishop-*`/`X-Hayaripro-*`/`X-Yosoukinavi-*`/`X-Yosoukicenter-*`/`X-Yosoukishop-*`/`X-Yosoukipro-*`/`X-Yosoukidoctor-*`/`X-Yosoukirescue-*`/`X-Yosouki24-*` 等 は乗機の通知記録 — 送信側が書くことは自称。運賃決済・乗車予約・定期券・チャーター料金の偽装は交通詐欺の典型手口。(鉄道機は D522、配車アプリ機は D468)
- **修正**: `Envelope` に `bus_marks` + `has_bus_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 乗印の自署を問え。

### Security — D657: `X-Mado-*`/`X-Madonavi-*`/`X-Madocenter-*` 等の窓・サッシ・ガラス印自称が未検査

- **問題**: `X-Mado-*`/`X-Madonavi-*`/`X-Madocenter-*`/`X-Madoshop-*`/`X-Madopro-*`/`X-Madodoctor-*`/`X-Madorescue-*`/`X-Mado24-*`/`X-Sashim-*`/`X-Sashinavi-*`/`X-Sashicenter-*`/`X-Sashishop-*`/`X-Sashipro-*`/`X-Sashidoctor-*`/`X-Sashirescue-*`/`X-Sashi24-*`/`X-Glassnavi-*`/`X-Glasscenter-*`/`X-Glassshop-*`/`X-Glasspro-*`/`X-Glassdoctor-*`/`X-Glassrescue-*`/`X-Glass24-*`/`X-Doornavi-*`/`X-Doorcenter-*`/`X-Doorshop-*`/`X-Doorpro-*`/`X-Doordoctor-*`/`X-Doorrescue-*`/`X-Door24-*`/`X-Amido-*`/`X-Amidonavi-*`/`X-Amidocenter-*`/`X-Amidoshop-*`/`X-Amidopro-*`/`X-Amidodoctor-*`/`X-Amidorescue-*`/`X-Amido24-*`/`X-Garasu-*`/`X-Garasunavi-*`/`X-Garasucenter-*`/`X-Garasushop-*`/`X-Garasupro-*`/`X-Garasudoctor-*`/`X-Garasurescue-*`/`X-Garasu24-*`/`X-Itado-*`/`X-Itadonavi-*`/`X-Itadocenter-*`/`X-Itadoshop-*`/`X-Itadopro-*`/`X-Madomart-*`/`X-Madoplus-*`/`X-Madosmart-*`/`X-Madofamily-*`/`X-Sashimart-*`/`X-Sashiplus-*`/`X-Sashismart-*`/`X-Sashifamily-*`/`X-Shamen-*`/`X-Shamennavi-*`/`X-Shamencenter-*`/`X-Shamenshop-*`/`X-Shamenpro-*`/`X-Shamendoctor-*`/`X-Shamenrescue-*`/`X-Shamen24-*`/`X-Toorinavi-*`/`X-Tooricenter-*`/`X-Toorishop-*`/`X-Tooripro-*`/`X-Tooridoctor-*`/`X-Toorirescue-*`/`X-Toori24-*`/`X-Kaikonavikaiko-*`/`X-Kaikonavi-*`/`X-Kaikocenter-*`/`X-Kaikoshop-*`/`X-Kaikopro-*` 等 は窓機の通知記録 — 送信側が書くことは自称。窓ガラス修理・サッシ交換・網戸張替・断熱工事の偽装はリフォーム詐欺の典型手口。(住宅機は D579、外壁機は D651)
- **修正**: `Envelope` に `window_marks` + `has_window_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 窓印の自署を問え。

### Security — D658: `X-Sukii-*`/`X-Sukiinavi-*`/`X-Sukiicenter-*` 等のスキー・ゲレンデ・スノボ印自称が未検査

- **問題**: `X-Sukii-*`/`X-Sukiinavi-*`/`X-Sukiicenter-*`/`X-Sukiishop-*`/`X-Sukiipro-*`/`X-Sukiidoctor-*`/`X-Sukiirescue-*`/`X-Sukii24-*`/`X-Gerende-*`/`X-Gerendenavi-*`/`X-Gerendecenter-*`/`X-Gerendeshop-*`/`X-Gerendepro-*`/`X-Gerendedoctor-*`/`X-Gerenderescue-*`/`X-Gerende24-*`/`X-Sunobo-*`/`X-Sunobonavi-*`/`X-Sunobocenter-*`/`X-Sunoboshop-*`/`X-Sunobopro-*`/`X-Sunobodoctor-*`/`X-Sunoborescue-*`/`X-Sunobo24-*`/`X-Rifutonavi-*`/`X-Rifutocenter-*`/`X-Rifutoshop-*`/`X-Rifutopro-*`/`X-Rifutodoctor-*`/`X-Rifutorescue-*`/`X-Rifuto24-*`/`X-Ski-*`/`X-Skinavi-*`/`X-Skicenter-*`/`X-Skishop-*`/`X-Skipro-*`/`X-Skidoctor-*`/`X-Skirescue-*`/`X-Ski24-*`/`X-Snowboard-*`/`X-Snowmountain-*`/`X-Hakuba-*`/`X-Niseko-*`/`X-Nozawa-*`/`X-Zao-*`/`X-Naeba-*`/`X-Shiga-*`/`X-Myoko-*`/`X-Gala-*`/`X-Rusutsu-*`/`X-Furano-*`/`X-Appi-*`/`X-Happo-*`/`X-Skijo-*`/`X-Skijonavi-*`/`X-Skijocenter-*`/`X-Skijoshop-*`/`X-Skijopro-*`/`X-Skijodoctor-*`/`X-Skijorescue-*`/`X-Skijo24-*`/`X-Sukiimart-*`/`X-Sukiiplus-*`/`X-Sukiismart-*`/`X-Sukiifamily-*`/`X-Gerendemart-*`/`X-Gerendeplus-*`/`X-Gerendesmart-*`/`X-Gerendefamily-*`/`X-Yukiyamanavi-*`/`X-Yukiyamacenter-*`/`X-Yukiyamashop-*`/`X-Yukiyamapro-*`/`X-Yukiyamadoctor-*`/`X-Yukiyamarescue-*`/`X-Yukiyama24-*`/`X-Bakukantori-*`/`X-Bakukantorinavi-*`/`X-Bakukantoricenter-*`/`X-Bakukantorishop-*`/`X-Bakukantoripro-*` 等 は滑機の通知記録 — 送信側が書くことは自称。リフト券・シーズン券・ゲレンデ宿泊・スクール予約の偽装はレジャー詐欺の典型手口。(娯楽機は D536、ホテル機は D535)
- **修正**: `Envelope` に `ski_marks` + `has_ski_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 滑印の自署を問え。

### Security — D653: `X-Kyutou-*`/`X-Kyutounavi-*`/`X-Kyutoucenter-*` 等の給湯・ボイラー・キッチン設備印自称が未検査

- **問題**: `X-Kyutou-*`/`X-Kyutounavi-*`/`X-Kyutoucenter-*`/`X-Kyutoushop-*`/`X-Kyutoupro-*`/`X-Kyutoudoctor-*`/`X-Kyutourescue-*`/`X-Kyutou24-*`/`X-Boiler-*`/`X-Boilernavi-*`/`X-Boilercenter-*`/`X-Boilershop-*`/`X-Boilerpro-*`/`X-Boilerdoctor-*`/`X-Boilerrescue-*`/`X-Boiler24-*`/`X-Noritsu-*`/`X-Rinnai-*`/`X-Kitchennavi-*`/`X-Kitchencenter-*`/`X-Kitchenshop-*`/`X-Kitchenpro-*`/`X-Kitchendoctor-*`/`X-Kitchenrescue-*`/`X-Kitchen24-*`/`X-Renji-*`/`X-Renjinavi-*`/`X-Renjicenter-*`/`X-Renjishop-*`/`X-Renjipro-*`/`X-Basu-*`/`X-Basunavi-*`/`X-Basucenter-*`/`X-Basushop-*`/`X-Basupro-*`/`X-Kyutoumart-*`/`X-Kyutouplus-*`/`X-Kyutousmart-*`/`X-Kyutoufamily-*`/`X-Boilermart-*`/`X-Boilerplus-*`/`X-Boilersmart-*`/`X-Boilerfamily-*`/`X-Yuwakashi-*`/`X-Yuwakashinavi-*`/`X-Yuwakashicenter-*`/`X-Yuwakashishop-*`/`X-Yuwakashipro-*`/`X-Yuwakadoctor-*`/`X-Yuwakarescue-*`/`X-Yuwaka24-*`/`X-Yuwakanavi-*`/`X-Yuwakacenter-*`/`X-Yuwakashop-*`/`X-Yuwakapro-*`/`X-Ofuronavim-*`/`X-Ofurodoctor-*`/`X-Ofurorescue-*`/`X-Ofuro24-*`/`X-Gasunavi-*`/`X-Gasucenter-*`/`X-Gasushop-*`/`X-Gasupro-*`/`X-Gasudoctor-*`/`X-Gasurescue-*`/`X-Gasu24-*`/`X-Econavi-*`/`X-Ecocenter-*`/`X-Ecoshop-*`/`X-Ecopro-*`/`X-Ecocute-*`/`X-Echone-*` 等 は釜機の通知記録 — 送信側が書くことは自称。給湯器故障・ボイラー点検・ガス料金・キッチンリフォームの偽装は設備詐欺の典型手口。(公益機は D520、エアコン機は D652)
- **修正**: `Envelope` に `boiler_marks` + `has_boiler_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 釜印の自署を問え。

### Security — D654: `X-Hoshizaki-*`/`X-Fukushimakougyou-*`/`X-Tanikou-*` 等の厨房・食品工場設備印自称が未検査

- **問題**: `X-Hoshizaki-*`/`X-Fukushimakougyou-*`/`X-Tanikou-*`/`X-Maruzenmaruzen-*`/`X-Chubounavi-*`/`X-Chuboucenter-*`/`X-Chuboushop-*`/`X-Chuboupro-*`/`X-Chuboudoctor-*`/`X-Chubourescue-*`/`X-Chubou24-*`/`X-Shokukoujou-*`/`X-Shokukoujounavi-*`/`X-Shokukoujoucenter-*`/`X-Shokukoujoushop-*`/`X-Shokukoujoupro-*`/`X-Shokukoujoudoctor-*`/`X-Shokukoujourescue-*`/`X-Shokukoujou24-*`/`X-Sangyoureitou-*`/`X-Reitounavi-*`/`X-Reitoucenter-*`/`X-Reitoushop-*`/`X-Reitoupro-*`/`X-Reitoudoctor-*`/`X-Reitourescue-*`/`X-Reitou24-*`/`X-Gyokin-*`/`X-Gyoukinnavi-*`/`X-Gyoukincenter-*`/`X-Gyoukinshop-*`/`X-Gyoukinpro-*`/`X-Kitchenmart-*`/`X-Kitchenplus-*`/`X-Kitchensmart-*`/`X-Kitchenfamily-*`/`X-Chuboumart-*`/`X-Chubouplus-*`/`X-Chubousmart-*`/`X-Chuboufamily-*`/`X-Chuubounavi-*`/`X-Chuuboucenter-*`/`X-Chuuboushop-*`/`X-Chuuboupro-*`/`X-Chuuboudoctor-*`/`X-Chuubourescue-*`/`X-Chuubou24-*`/`X-Gyoshanavi-*`/`X-Gyoshacenter-*`/`X-Gyoshashop-*`/`X-Gyoshapro-*`/`X-Gyoshadoctor-*`/`X-Gyosharescue-*`/`X-Gyosha24-*`/`X-Reizoukoreizouko-*`/`X-Reizoukonavi-*`/`X-Reizoukocenter-*`/`X-Reizoukoshop-*`/`X-Reizoukopro-*`/`X-Koorinokoori-*`/`X-Koorinavi-*`/`X-Kooricenter-*`/`X-Koorishop-*`/`X-Kooripro-*`/`X-Suishounavi-*`/`X-Suishoucenter-*`/`X-Suishoushop-*`/`X-Suishoupro-*`/`X-Suidounavi-*`/`X-Suidoucenter-*`/`X-Suidoushop-*`/`X-Suidoupro-*` 等 は厨機の通知記録 — 送信側が書くことは自称。厨房機器・冷凍設備・食品工場ライン・衛生点検の偽装は業務設備詐欺の典型手口。(飲食機は D528、食品機は D551)
- **修正**: `Envelope` に `kitchen_marks` + `has_kitchen_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 厨印の自署を問え。

### Security — D655: `X-Hanko-*`/`X-Hankonavi-*`/`X-Hankocenter-*` 等の印鑑・ハンコ・名札印自称が未検査

- **問題**: `X-Hanko-*`/`X-Hankonavi-*`/`X-Hankocenter-*`/`X-Hankoshop-*`/`X-Hankopro-*`/`X-Hankodoctor-*`/`X-Hankorescue-*`/`X-Hanko24-*`/`X-Inkan-*`/`X-Inkannavi-*`/`X-Inkancenter-*`/`X-Inkanshop-*`/`X-Inkanpro-*`/`X-Inkandoctor-*`/`X-Inkanrescue-*`/`X-Inkan24-*`/`X-Gomuin-*`/`X-Gomuinnavi-*`/`X-Gomuincenter-*`/`X-Gomuinshop-*`/`X-Gomuinpro-*`/`X-Jitsuin-*`/`X-Jitsuinnavi-*`/`X-Jitsuincenter-*`/`X-Jitsuinshop-*`/`X-Jitsuinpro-*`/`X-Ginkoin-*`/`X-Ginkoinnavi-*`/`X-Ginkoincenter-*`/`X-Ginkoinshop-*`/`X-Ginkoinpro-*`/`X-Mitomein-*`/`X-Mitomeinnavi-*`/`X-Mitomeincenter-*`/`X-Mitomeinshop-*`/`X-Mitomeinpro-*`/`X-Nafuda-*`/`X-Nafudanavi-*`/`X-Nafudacenter-*`/`X-Nafudashop-*`/`X-Nafudapro-*`/`X-Nafudadoctor-*`/`X-Nafudarescue-*`/`X-Nafuda24-*`/`X-Neimpureito-*`/`X-Neimpureitonavi-*`/`X-Neimpureitocenter-*`/`X-Neimpureitoshop-*`/`X-Neimpureitopro-*`/`X-Hankomart-*`/`X-Hankoplus-*`/`X-Hankosmart-*`/`X-Hankofamily-*`/`X-Inkanmart-*`/`X-Inkanplus-*`/`X-Inkansmart-*`/`X-Inkanfamily-*`/`X-Inshou-*`/`X-Inshounavi-*`/`X-Inshoucenter-*`/`X-Inshoushop-*`/`X-Inshoupro-*`/`X-Inshoudoctor-*`/`X-Inshourescue-*`/`X-Inshou24-*`/`X-Hankoctr-*`/`X-Domein-*`/`X-Domeinnavi-*`/`X-Domeincenter-*`/`X-Domeinshop-*`/`X-Domeinpro-*`/`X-Meisaimama-*`/`X-Meisainavi-*`/`X-Meisaicenter-*`/`X-Meisaishop-*`/`X-Meisaipro-*` 等 は印機の通知記録 — 送信側が書くことは自称。実印作成・印鑑登録・会社印注文・名札発注の偽装は印章詐欺の典型手口。(印刷機は D590、文房具機は D606)
- **修正**: `Envelope` に `hanko_marks` + `has_hanko_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 印印の自署を問え。

### Security — D650: `X-Fukushinavi-*`/`X-Fukushicenter-*`/`X-Fukushishop-*` 等の福祉・児童相談所・生活保護印自称が未検査

- **問題**: `X-Fukushinavi-*`/`X-Fukushicenter-*`/`X-Fukushishop-*`/`X-Fukushipro-*`/`X-Fukushidoctor-*`/`X-Fukushirescue-*`/`X-Fukushi24-*`/`X-Jidosoushodan-*`/`X-Jikosou-*`/`X-Jikosounavi-*`/`X-Jikosoucenter-*`/`X-Jikosoushop-*`/`X-Jikosoupro-*`/`X-Shakaifukushi-*`/`X-Syakai-*`/`X-Shakainavi-*`/`X-Shakaicenter-*`/`X-Shakaishop-*`/`X-Shakaipro-*`/`X-Shakaidoctor-*`/`X-Shakairescue-*`/`X-Shakai24-*`/`X-Seikatsuhogo-*`/`X-Seikatsuhogonavi-*`/`X-Seikatsuhogocenter-*`/`X-Seikatsuhogoshop-*`/`X-Seikatsuhogopro-*`/`X-Seikatsuhogodoctor-*`/`X-Seikatsuhogorescue-*`/`X-Seikatsuhogo24-*`/`X-Caseworker-*`/`X-Kyougikai-*`/`X-Kyougikainavi-*`/`X-Kyougikaicenter-*`/`X-Kyougikaishop-*`/`X-Kyougikaipro-*`/`X-Hojin-*`/`X-Hojinnavi-*`/`X-Hojincenter-*`/`X-Hojinshop-*`/`X-Hojinpro-*`/`X-Koreikai-*`/`X-Koreikainavi-*`/`X-Koreikaicenter-*`/`X-Koreikaishop-*`/`X-Koreikaipro-*`/`X-Kodomo-*`/`X-Kodomonavi-*`/`X-Kodomocenter-*`/`X-Kodomoshop-*`/`X-Kodomopro-*`/`X-Kodomodoctor-*`/`X-Kodomorescue-*`/`X-Kodomo24-*`/`X-Kazokunavi-*`/`X-Kazokucenter-*`/`X-Kazokushop-*`/`X-Kazokupro-*`/`X-Kazokudoctor-*`/`X-Kazokurescue-*`/`X-Kazoku24-*`/`X-Fukushimart-*`/`X-Fukushiplus-*`/`X-Fukushismart-*`/`X-Fukushifamily-*`/`X-Kodomomart-*`/`X-Kodomoplus-*`/`X-Kodomosmart-*`/`X-Kodomofamily-*`/`X-Kyousannavi-*`/`X-Kyousancenter-*`/`X-Kyousanshop-*`/`X-Kyousanpro-*`/`X-Enjoinavi-*`/`X-Enjocenter-*`/`X-Enjoshop-*`/`X-Enjopro-*` 等 は福機の通知記録 — 送信側が書くことは自称。生活保護受給・児童手当・福祉サービス・ケースワーカー訪問の偽装は福祉詐欺の典型手口。(政府機は D518)
- **修正**: `Envelope` に `welfare_marks` + `has_welfare_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 福印の自署を問え。

### Security — D651: `X-Gaihekunavi-*`/`X-Gaihekucenter-*`/`X-Gaihekushop-*` 等の外壁塗装・屋根修理印自称が未検査

- **問題**: `X-Gaihekunavi-*`/`X-Gaihekucenter-*`/`X-Gaihekushop-*`/`X-Gaihekupro-*`/`X-Gaihekudoctor-*`/`X-Gaihekurescue-*`/`X-Gaiheku24-*`/`X-Yanenavi-*`/`X-Yanecenter-*`/`X-Yaneshop-*`/`X-Yanepro-*`/`X-Yanedoctor-*`/`X-Yanerescue-*`/`X-Yane24-*`/`X-Amamori-*`/`X-Amamorinavi-*`/`X-Amamoricenter-*`/`X-Amamorishop-*`/`X-Amamoripro-*`/`X-Amamoridoctor-*`/`X-Amamorescue-*`/`X-Amamori24-*`/`X-Tosou-*`/`X-Tosounavi-*`/`X-Tosoucenter-*`/`X-Tosoushop-*`/`X-Tosoupro-*`/`X-Tosoudoctor-*`/`X-Tosourescue-*`/`X-Tosou24-*`/`X-Shiringu-*`/`X-Sealing-*`/`X-Waterproof-*`/`X-Roofing-*`/`X-Roofnavi-*`/`X-Roofcenter-*`/`X-Roofshop-*`/`X-Roofpro-*`/`X-Gaihekumart-*`/`X-Gaihekuplus-*`/`X-Gaihekusmart-*`/`X-Gaihekufamily-*`/`X-Yanemart-*`/`X-Yaneplus-*`/`X-Yanesmart-*`/`X-Yanefamily-*`/`X-Sotobonavi-*`/`X-Sotobocenter-*`/`X-Sotoboshop-*`/`X-Sotobopro-*`/`X-Sotobodoctor-*`/`X-Sotoborescue-*`/`X-Sotobo24-*`/`X-Houbainavi-*`/`X-Houbaicenter-*`/`X-Houbaishop-*`/`X-Houbaipro-*`/`X-Houbaidoctor-*`/`X-Houbairescue-*`/`X-Houbai24-*`/`X-Houbaisan-*`/`X-Houbaisannavi-*`/`X-Houbaisancenter-*`/`X-Houbaisanshop-*`/`X-Houbaisanpro-*`/`X-Okujounavi-*`/`X-Okujoucenter-*`/`X-Okujoushop-*`/`X-Okujoupro-*`/`X-Kouennavi-*`/`X-Kouencenter-*`/`X-Kouenshop-*`/`X-Kouenpro-*` 等 は塗機の通知記録 — 送信側が書くことは自称。外壁塗装・屋根修理・雨漏り点検の訪問販売偽装はリフォーム詐欺の典型手口。(住宅機は D579、建設機は D644)
- **修正**: `Envelope` に `roofing_marks` + `has_roofing_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 塗印の自署を問え。

### Security — D652: `X-Aircon-*`/`X-Airconnavi-*`/`X-Airconcenter-*` 等のエアコン・冷暖房工事印自称が未検査

- **問題**: `X-Aircon-*`/`X-Airconnavi-*`/`X-Airconcenter-*`/`X-Airconshop-*`/`X-Airconpro-*`/`X-Aircondoctor-*`/`X-Airconrescue-*`/`X-Aircon24-*`/`X-Hvac-*`/`X-Hvacnavi-*`/`X-Hvaccenter-*`/`X-Hvacshop-*`/`X-Hvacpro-*`/`X-Hvacdoctor-*`/`X-Hvacrescue-*`/`X-Hvac24-*`/`X-Reidanbou-*`/`X-Reidbounavi-*`/`X-Reidobucenter-*`/`X-Reidobushop-*`/`X-Reidobupro-*`/`X-Kankisen-*`/`X-Kankisennavi-*`/`X-Kankisencenter-*`/`X-Kankisenshop-*`/`X-Kankisenpro-*`/`X-Eakon-*`/`X-Eakonnavi-*`/`X-Eakoncenter-*`/`X-Eakonshop-*`/`X-Eakonpro-*`/`X-Eakondoctor-*`/`X-Eakonrescue-*`/`X-Eakon24-*`/`X-Daikinservers-*`/`X-Mitsubishidenki-*`/`X-Fujitsuozone-*`/`X-Panair-*`/`X-Hitachiair-*`/`X-Airconmart-*`/`X-Airconplus-*`/`X-Airconsmart-*`/`X-Airconfamily-*`/`X-Eakonmart-*`/`X-Eakonplus-*`/`X-Eakonsmart-*`/`X-Eakonfamily-*`/`X-Kukinavi-*`/`X-Kukicenter-*`/`X-Kukishop-*`/`X-Kukipro-*`/`X-Reibo-*`/`X-Chobo-*`/`X-Danbo-*`/`X-Danbounavi-*`/`X-Danboucenter-*`/`X-Danboushop-*`/`X-Danboupro-*`/`X-Danboudoctor-*`/`X-Danbourescue-*`/`X-Danbou24-*`/`X-Reibounavi-*`/`X-Reiboucenter-*`/`X-Reiboushop-*`/`X-Reiboupro-*`/`X-Reiboudoctor-*`/`X-Reibourescue-*`/`X-Reibou24-*`/`X-Jyoka-*`/`X-Jyokanavi-*`/`X-Jyokacenter-*`/`X-Jyokashop-*`/`X-Jyokapro-*`/`X-Jyokadoctor-*`/`X-Jyokarescue-*`/`X-Jyoka24-*` 等 は空機の通知記録 — 送信側が書くことは自称。エアコン工事・クリーニング・フィルター交換・点検通知の偽装は設備詐欺の典型手口。(家電機は D496、修理機は D626)
- **修正**: `Envelope` に `hvac_marks` + `has_hvac_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 空印の自署を問え。

### Security — D647: `X-Daigakunavi-*`/`X-Daigakucenter-*`/`X-Daigakushop-*` 等の大学・専門学校・受験印自称が未検査

- **問題**: `X-Daigakunavi-*`/`X-Daigakucenter-*`/`X-Daigakushop-*`/`X-Daigakupro-*`/`X-Daigakudoctor-*`/`X-Daigakurescue-*`/`X-Daigaku24-*`/`X-Daigaku-*`/`X-Senmongakkounavi-*`/`X-Senmongakkoucenter-*`/`X-Senmongakkoushop-*`/`X-Senmongakkoupro-*`/`X-Yobikounavi-*`/`X-Yobikoucenter-*`/`X-Yobikoushop-*`/`X-Yobikoupro-*`/`X-Benessek-*`/`X-Juuken-*`/`X-Juukennavi-*`/`X-Juukencenter-*`/`X-Juukenshop-*`/`X-Juukenpro-*`/`X-Juukendoctor-*`/`X-Juukenrescue-*`/`X-Juuken24-*`/`X-College-*`/`X-Collegenavi-*`/`X-Collegecenter-*`/`X-Collegeshop-*`/`X-Collegepro-*`/`X-Collegedoctor-*`/`X-Collegerescue-*`/`X-College24-*`/`X-University-*`/`X-Universitynavi-*`/`X-Universitycenter-*`/`X-Universityshop-*`/`X-Universitypro-*`/`X-Daigakumart-*`/`X-Daigakuplus-*`/`X-Daigakusmart-*`/`X-Daigakufamily-*`/`X-Juukenmart-*`/`X-Juukenplus-*`/`X-Juukensmart-*`/`X-Juukenfamily-*`/`X-Nyuushinavi-*`/`X-Nyuushicenter-*`/`X-Nyuushishop-*`/`X-Nyuushipro-*`/`X-Nyuushidoctor-*`/`X-Nyuushirescue-*`/`X-Nyuushi24-*`/`X-Zenkokumononavi-*`/`X-Zenkokumonocenter-*`/`X-Zenkokumonoshop-*`/`X-Zenkokumonopro-*`/`X-Hyousennavi-*`/`X-Hyousencenter-*`/`X-Hyousenshop-*`/`X-Hyousenpro-*`/`X-Hensachinavi-*`/`X-Hensachicenter-*`/`X-Hensachishop-*`/`X-Hensachipro-*`/`X-Suishojsyo-*`/`X-Oshirase-*`/`X-Kyoushikinnavi-*`/`X-Kyoushikincenter-*`/`X-Kyoushikinshop-*`/`X-Kyoushikinpro-*` 等 は受機の通知記録 — 送信側が書くことは自称。合格発表・入試案内・学費請求・奨学金通知の偽装は受験詐欺の典型手口。(学習塾機は D605)
- **修正**: `Envelope` に `college_marks` + `has_college_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 受印の自署を問え。

### Security — D648: `X-Bousannavi-*`/`X-Bousancenter-*`/`X-Bousanshop-*` 等の防犯カメラ・監視印自称が未検査

- **問題**: `X-Bousannavi-*`/`X-Bousancenter-*`/`X-Bousanshop-*`/`X-Bousanpro-*`/`X-Bousandoctor-*`/`X-Bousanrescue-*`/`X-Bousan24-*`/`X-Kanshikamera-*`/`X-Kanshinavi-*`/`X-Kanshicenter-*`/`X-Kanshishop-*`/`X-Kanshipro-*`/`X-Kanshidoctor-*`/`X-Kanshirescue-*`/`X-Kanshi24-*`/`X-Securitycamera-*`/`X-Cameranavi-*`/`X-Cameracenter-*`/`X-Camerashop-*`/`X-Camerapro-*`/`X-Cameradoctor-*`/`X-Camerarescue-*`/`X-Camera24-*`/`X-Monitornavi-*`/`X-Monitorcenter-*`/`X-Monitorshop-*`/`X-Monitorpro-*`/`X-Monitordoctor-*`/`X-Monitorrescue-*`/`X-Monitor24-*`/`X-Cctv-*`/`X-Cctvnavi-*`/`X-Cctvcenter-*`/`X-Cctvshop-*`/`X-Cctvpro-*`/`X-Cctvmart-*`/`X-Cctvplus-*`/`X-Cctvsmart-*`/`X-Cctvfamily-*`/`X-Hikvision-*`/`X-Dahua-*`/`X-Axis-*`/`X-Avigilon-*`/`X-Bosch-*`/`X-Pelco-*`/`X-Vivotek-*`/`X-Hanwha-*`/`X-Uniview-*`/`X-Tiandy-*`/`X-Ikegami-*`/`X-Sunell-*`/`X-Verint-*`/`X-Miharu-*`/`X-Cameramart-*`/`X-Cameraplus-*`/`X-Camerasmart-*`/`X-Camerafamily-*`/`X-Kanshimart-*`/`X-Kanshiplus-*`/`X-Kanshismart-*`/`X-Kanshifamily-*`/`X-Denbannavi-*`/`X-Denbancenter-*`/`X-Denbanshop-*`/`X-Denbanpro-*`/`X-Pasonavi-*`/`X-Pasocenter-*`/`X-Pasoshop-*`/`X-Pasopro-*` 等 は録機の通知記録 — 送信側が書くことは自称。カメラ設置・防犯診断・録画アクセス通知の偽装は防犯詐欺の典型手口。(警備機は D548)
- **修正**: `Envelope` に `securitycam_marks` + `has_securitycam_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 録印の自署を問え。

### Security — D649: `X-Ferry-*`/`X-Ferries-*`/`X-Ferrynavi-*` 等のフェリー・クルーズ・船舶印自称が未検査

- **問題**: `X-Ferry-*`/`X-Ferries-*`/`X-Ferrynavi-*`/`X-Ferrycenter-*`/`X-Ferryshop-*`/`X-Ferrypro-*`/`X-Ferrydoctor-*`/`X-Ferryrescue-*`/`X-Ferry24-*`/`X-Cruise-*`/`X-Cruisenavi-*`/`X-Cruisecenter-*`/`X-Cruiseshop-*`/`X-Cruisepro-*`/`X-Cruisedoctor-*`/`X-Cruiserescue-*`/`X-Cruise24-*`/`X-Norimononavi-*`/`X-Norimonocenter-*`/`X-Norimonoshop-*`/`X-Norimonopro-*`/`X-Senpaku-*`/`X-Senpakunavi-*`/`X-Senpakucenter-*`/`X-Senpakushop-*`/`X-Senpakupro-*`/`X-Kaiji-*`/`X-Kaijinnavi-*`/`X-Kaijincenter-*`/`X-Kaijinshop-*`/`X-Kaijinpro-*`/`X-Kaijindoctor-*`/`X-Kaijinrescue-*`/`X-Kaijin24-*`/`X-Shinmoji-*`/`X-Shinmojinavi-*`/`X-Shinmojicenter-*`/`X-Shinmojishop-*`/`X-Shinmojipro-*`/`X-Hankyuferry-*`/`X-Hankyuferrynavi-*`/`X-Hankyuferrycenter-*`/`X-Hankyuferryshop-*`/`X-Hankyuferrypro-*`/`X-Oceantrans-*`/`X-Oceantransnavi-*`/`X-Oceantranscenter-*`/`X-Oceantransshop-*`/`X-Oceantranspro-*`/`X-Dreamferry-*`/`X-Dreamferrynavi-*`/`X-Dreamferrycenter-*`/`X-Dreamferryshop-*`/`X-Dreamferrypro-*`/`X-Ferrymart-*`/`X-Ferryplus-*`/`X-Ferrysmart-*`/`X-Ferryfamily-*`/`X-Cruisemart-*`/`X-Cruiseplus-*`/`X-Cruisesmart-*`/`X-Cruisefamily-*`/`X-Funabinavi-*`/`X-Funabicenter-*`/`X-Funabishop-*`/`X-Funabipro-*`/`X-Funabadoctor-*`/`X-Funabarescue-*`/`X-Funaba24-*`/`X-Sunflowernavi-*`/`X-Sunflowercenter-*`/`X-Sunflowershop-*`/`X-Sunflowerpro-*`/`X-Oceankourossonavi-*`/`X-Oceankourossocenter-*`/`X-Oceankourossoshop-*`/`X-Oceankourossopro-*` 等 は船機の通知記録 — 送信側が書くことは自称。乗船予約・運航中止・船内販売・ツアー催行の偽装は船舶詐欺の典型手口。(貨物機は D545、旅行機は D573)
- **修正**: `Envelope` に `ferry_marks` + `has_ferry_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 船印の自署を問え。

### Security — D644: `X-Kashima-*`/`X-Obayashi-*`/`X-Shimizu-*` 等の建設・ゼネコン・工事印自称が未検査

- **問題**: `X-Kashima-*`/`X-Obayashi-*`/`X-Shimizu-*`/`X-Takenaka-*`/`X-Zenekon-*`/`X-Zenekonnavi-*`/`X-Zenekoncenter-*`/`X-Zenekonshop-*`/`X-Zenekonpro-*`/`X-Zenekondoctor-*`/`X-Zenekonrescue-*`/`X-Zenekon24-*`/`X-Kensetsunavi-*`/`X-Kensetsucenter-*`/`X-Kensetsushop-*`/`X-Kensetsupro-*`/`X-Kensetsudoctor-*`/`X-Kensetsurescue-*`/`X-Kensetsu24-*`/`X-Dobokunavi-*`/`X-Dobokucenter-*`/`X-Dobokushop-*`/`X-Dobokupro-*`/`X-Dobokudoctor-*`/`X-Dobokurescue-*`/`X-Doboku24-*`/`X-Konkuriitonavi-*`/`X-Konkuriitocenter-*`/`X-Konkuriitoshop-*`/`X-Konkuriitopro-*`/`X-Genbanavi-*`/`X-Genbacenter-*`/`X-Genbashop-*`/`X-Genbapro-*`/`X-Genbadoctor-*`/`X-Genbarescue-*`/`X-Genba24-*`/`X-Shokuninnavi-*`/`X-Shokunincenter-*`/`X-Shokuninshop-*`/`X-Shokuninpro-*`/`X-Shokunindoctor-*`/`X-Shokuninrescue-*`/`X-Shokunin24-*`/`X-Naisounavi-*`/`X-Naisoucenter-*`/`X-Naisoushop-*`/`X-Naisoupro-*`/`X-Naisoudoctor-*`/`X-Naisourescue-*`/`X-Naisou24-*`/`X-Tobanavi-*`/`X-Tobacenter-*`/`X-Tobashop-*`/`X-Tobapro-*`/`X-Koujinavi-*`/`X-Koujicenter-*`/`X-Koujishop-*`/`X-Koujipro-*`/`X-Zenekonmart-*`/`X-Zenekonplus-*`/`X-Zenekonsmart-*`/`X-Zenekonfamily-*`/`X-Kensetsumart-*`/`X-Kensetsuplus-*`/`X-Kensetsusmart-*`/`X-Kensetsufamily-*`/`X-Goukakunavi-*`/`X-Goukakucenter-*`/`X-Goukakushop-*`/`X-Goukakupro-*`/`X-Anzeninavi-*`/`X-Anzencenter-*`/`X-Anzenshop-*`/`X-Anzenpro-*` 等 は建機の通知記録 — 送信側が書くことは自称。建設業届出・工事請負・現場安全・職人派遣の偽装は建設業詐欺の典型手口。(住宅機は D579、産業機は D538)
- **修正**: `Envelope` に `construction_marks` + `has_construction_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 建印の自署を問え。

### Security — D645: `X-Nipponrental-*`/`X-Nikken-*`/`X-Rentalnavi-*` 等のレンタル・リース印自称が未検査

- **問題**: `X-Nipponrental-*`/`X-Nikken-*`/`X-Rentalnavi-*`/`X-Rentalcenter-*`/`X-Rentalshop-*`/`X-Rentalpro-*`/`X-Rentaldoctor-*`/`X-Rentalrescue-*`/`X-Rental24-*`/`X-Leasenavi-*`/`X-Leasecenter-*`/`X-Leaseshop-*`/`X-Leasepro-*`/`X-Leasedoctor-*`/`X-Leaserescue-*`/`X-Lease24-*`/`X-Rentrun-*`/`X-Rentarehouse-*`/`X-Rentlarenavi-*`/`X-Rentlarecenter-*`/`X-Rentlareshop-*`/`X-Rentlarepro-*`/`X-Kenkirenavi-*`/`X-Kenkirecenter-*`/`X-Kenkireshop-*`/`X-Kenkirepro-*`/`X-Kenkidoctor-*`/`X-Kenkirescue-*`/`X-Kenki24-*`/`X-Aktio-*`/`X-Soukaconavi-*`/`X-Soukaconcenter-*`/`X-Soukaconshop-*`/`X-Soukacopro-*`/`X-Rentalmart-*`/`X-Rentalplus-*`/`X-Rentalsmart-*`/`X-Rentalfamily-*`/`X-Leasemart-*`/`X-Leaseplus-*`/`X-Leasesmart-*`/`X-Leasefamily-*`/`X-Kanamotonavi-*`/`X-Kanamotocenter-*`/`X-Kanamotoshop-*`/`X-Kanamotopro-*`/`X-Rentalinavi-*`/`X-Rentalicenter-*`/`X-Rentalishop-*`/`X-Rentalipro-*`/`X-Ofishunavi-*`/`X-Ofishucenter-*`/`X-Ofishushop-*`/`X-Ofishupro-*`/`X-Eventresenavi-*`/`X-Eventresecenter-*`/`X-Eventreshop-*`/`X-Eventrepro-*`/`X-Kyoushitsu-*`/`X-Kyoushitsunavi-*`/`X-Kyoushitsucenter-*`/`X-Kyoushitsushop-*`/`X-Kyoushitsupro-*`/`X-Supportinavi-*`/`X-Supporticenter-*`/`X-Supportishop-*`/`X-Supportipro-*` 等 は貸機の通知記録 — 送信側が書くことは自称。レンタル料金・延滞金・返却通知・リース契約更新の偽装はレンタル詐欺の典型手口。(カーシェア機は D521)
- **修正**: `Envelope` に `rental_marks` + `has_rental_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 貸印の自署を問え。

### Security — D646: `X-Souko-*`/`X-Soukonavi-*`/`X-Soukocenter-*` 等の倉庫・物流センター印自称が未検査

- **問題**: `X-Souko-*`/`X-Soukonavi-*`/`X-Soukocenter-*`/`X-Soukoshop-*`/`X-Soukopro-*`/`X-Soukodoctor-*`/`X-Soukorescue-*`/`X-Souko24-*`/`X-Logisticsnavi-*`/`X-Logisticscenter-*`/`X-Logisticsshop-*`/`X-Logisticspro-*`/`X-Logisticsdoctor-*`/`X-Logisticsrescue-*`/`X-Logistics24-*`/`X-Rojiweednavi-*`/`X-Rojiweedcenter-*`/`X-Rojiweedshop-*`/`X-Rojiweedpro-*`/`X-Rojisuteidonavi-*`/`X-Rojisuteidocenter-*`/`X-Rojisuteidoshop-*`/`X-Rojisuteidopro-*`/`X-Oroukurinavi-*`/`X-Oroukuricenter-*`/`X-Oroukurishop-*`/`X-Oroukuripro-*`/`X-Trc-*`/`X-Trunkroom-*`/`X-Trunk-*`/`X-Hakamadare-*`/`X-Todai-*`/`X-Soukomart-*`/`X-Soukoplus-*`/`X-Soukosmart-*`/`X-Soukofamily-*`/`X-Logisticsmart-*`/`X-Logisticsplus-*`/`X-Logisticssmart-*`/`X-Logisticsfamily-*`/`X-Hokannavi-*`/`X-Hokancenter-*`/`X-Hokanshop-*`/`X-Hokanpro-*`/`X-Hokandoctor-*`/`X-Hokanrescue-*`/`X-Hokan24-*`/`X-Azukarinavi-*`/`X-Azukaricenter-*`/`X-Azukarishop-*`/`X-Azukaripro-*`/`X-Azukaridoctor-*`/`X-Azukarirescue-*`/`X-Azukari24-*`/`X-Minikuronavi-*`/`X-Minikurocenter-*`/`X-Minikuroshop-*`/`X-Minikuropro-*`/`X-Kurashikonavi-*`/`X-Kurashikocenter-*`/`X-Kurashikoshop-*`/`X-Kurashikopro-*`/`X-Daikannavi-*`/`X-Daikancenter-*`/`X-Daikanshop-*`/`X-Daikanpro-*`/`X-Yamatekinnavi-*`/`X-Yamatekincenter-*`/`X-Yamatekinshop-*`/`X-Yamatekinpro-*` 等 は倉機の通知記録 — 送信側が書くことは自称。保管料・トランクルーム契約・荷物保管・在庫保管の偽装は保管詐欺の典型手口。(貨物機は D545、ストレージ機は D548)
- **修正**: `Envelope` に `warehouse_marks` + `has_warehouse_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 倉印の自署を問え。

### Security — D641: `X-Senkyo-*`/`X-Electionnavi-*`/`X-Electioncenter-*` 等の選挙・政党印自称が未検査

- **問題**: `X-Senkyo-*`/`X-Electionnavi-*`/`X-Electioncenter-*`/`X-Electionshop-*`/`X-Electionpro-*`/`X-Electiondoctor-*`/`X-Electionrescue-*`/`X-Election24-*`/`X-Jimintou-*`/`X-Rikken-*`/`X-Koumei-*`/`X-Ishin-*`/`X-Kyousan-*`/`X-Kokumindou-*`/`X-Reiwa-*`/`X-Shamin-*`/`X-Senkyonavi-*`/`X-Senkyocenter-*`/`X-Senkyoshop-*`/`X-Senkyopro-*`/`X-Senkyodoctor-*`/`X-Senkyorescue-*`/`X-Senkyo24-*`/`X-Seijinavi-*`/`X-Seijicenter-*`/`X-Seijishop-*`/`X-Seijipro-*`/`X-Seijidoctor-*`/`X-Seijirescue-*`/`X-Seiji24-*`/`X-Seitonavi-*`/`X-Seitocenter-*`/`X-Seitoshop-*`/`X-Seitopro-*`/`X-Seitodoctor-*`/`X-Seitorescue-*`/`X-Seito24-*`/`X-Voterregistration-*`/`X-Kanboxnavi-*`/`X-Touhyounavi-*`/`X-Touhyoucenter-*`/`X-Touhyoushop-*`/`X-Touhyoupro-*`/`X-Electionmart-*`/`X-Electionplus-*`/`X-Electionsmart-*`/`X-Electionfamily-*`/`X-Senkyomart-*`/`X-Senkyoplus-*`/`X-Senkyosmart-*`/`X-Senkyofamily-*`/`X-Giinnavi-*`/`X-Giincenter-*`/`X-Giinshop-*`/`X-Giinpro-*`/`X-Giindoctor-*`/`X-Giinrescue-*`/`X-Giin24-*`/`X-Kouhoshanavi-*`/`X-Kouhoshacenter-*`/`X-Kouhoshashop-*`/`X-Kouhoshapro-*`/`X-Shuukainavi-*`/`X-Shuukaicenter-*`/`X-Shuukaishop-*`/`X-Shuukaipro-*` 等 は選機の通知記録 — 送信側が書くことは自称。投票案内・街頭演説・党費・政治献金の偽装は選挙期詐欺の典型手口。(政府機は D518)
- **修正**: `Envelope` に `election_marks` + `has_election_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 選印の自署を問え。

### Security — D642: `X-Rengou-*`/`X-Zenroren-*`/`X-Ishikai-*` 等の士業・職業団体・労働組合印自称が未検査

- **問題**: `X-Rengou-*`/`X-Zenroren-*`/`X-Ishikai-*`/`X-Shikaishikai-*`/`X-Yakuzai-*`/`X-Kango-*`/`X-Bengoshi-*`/`X-Kaihoken-*`/`X-Zeirishikai-*`/`X-Shakenshi-*`/`X-Gyouseishoshi-*`/`X-Unionnavi-*`/`X-Unioncenter-*`/`X-Unionshop-*`/`X-Unionpro-*`/`X-Uniondoctor-*`/`X-Unionrescue-*`/`X-Union24-*`/`X-Rodokumiai-*`/`X-Shokugyounavi-*`/`X-Shokugyoucenter-*`/`X-Shokugyoushop-*`/`X-Shokugyoupro-*`/`X-Kumainavi-*`/`X-Kumaicenter-*`/`X-Kumaishop-*`/`X-Kumaipro-*`/`X-Kumaidoctor-*`/`X-Kumairescue-*`/`X-Kumai24-*`/`X-Kyoushokai-*`/`X-Nichitei-*`/`X-Nichishikai-*`/`X-Nichikan-*`/`X-Shokuren-*`/`X-Kanzei-*`/`X-Koukuukai-*`/`X-Unionmart-*`/`X-Unionplus-*`/`X-Unionsmart-*`/`X-Unionfamily-*`/`X-Kumaimart-*`/`X-Kumaiplus-*`/`X-Kumaismart-*`/`X-Kumaifamily-*`/`X-Bengoshinavi-*`/`X-Bengoshicenter-*`/`X-Bengoshishop-*`/`X-Bengoshipro-*`/`X-Zeirishinavi-*`/`X-Zeirishicenter-*`/`X-Zeirishishop-*`/`X-Zeirishipro-*`/`X-Shakaineren-*`/`X-Jichiren-*`/`X-Kyoushokuin-*`/`X-Yubinkyoku-*`/`X-Koenkainavi-*`/`X-Koenkaicenter-*`/`X-Koenkaishop-*`/`X-Koenkaipro-*` 等 は士機の通知記録 — 送信側が書くことは自称。弁護士会費・組合費・学会年会費・協会資格更新の偽装は会費詐欺の典型手口。(債務整理機は D586、税務機は D598)
- **修正**: `Envelope` に `union_marks` + `has_union_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 士印の自署を問え。

### Security — D643: `X-Drivingnavi-*`/`X-Drivingcenter-*`/`X-Drivingshop-*` 等の自動車教習所・免許印自称が未検査

- **問題**: `X-Drivingnavi-*`/`X-Drivingcenter-*`/`X-Drivingshop-*`/`X-Drivingpro-*`/`X-Drivingdoctor-*`/`X-Drivingrescue-*`/`X-Driving24-*`/`X-Kyousyuujonavi-*`/`X-Kyousyuujocenter-*`/`X-Kyousyuujoshop-*`/`X-Kyousyuujopro-*`/`X-Kyousyuujodoctor-*`/`X-Kyousyuujorescue-*`/`X-Kyousyuujo24-*`/`X-Gasshukunavi-*`/`X-Gasshukucenter-*`/`X-Gasshukushop-*`/`X-Gasshukupro-*`/`X-Gasshukudoctor-*`/`X-Gasshukurescue-*`/`X-Gasshuku24-*`/`X-Menkyonavi-*`/`X-Menkyocenter-*`/`X-Menkyoshop-*`/`X-Menkyopro-*`/`X-Menkyodoctor-*`/`X-Menkyorescue-*`/`X-Menkyo24-*`/`X-Jidoushagakkounavi-*`/`X-Jidoushagakkoucenter-*`/`X-Jidoushagakkoushop-*`/`X-Jidoushagakkoupro-*`/`X-Untenshuuryoujounavi-*`/`X-Untenshuuryoujocenter-*`/`X-Untenshuuryoujoshop-*`/`X-Untenshuuryoujopro-*`/`X-Kyourikimajo-*`/`X-Alcc-*`/`X-Fujidriving-*`/`X-Drivingmart-*`/`X-Drivingplus-*`/`X-Drivingsmart-*`/`X-Drivingfamily-*`/`X-Menkyomart-*`/`X-Menkyoplus-*`/`X-Menkyosmart-*`/`X-Menkyofamily-*`/`X-Kyousyuujomart-*`/`X-Kyousyuujoplus-*`/`X-Kyousyuujosmart-*`/`X-Kyousyuujofamily-*`/`X-Mikaeshinavi-*`/`X-Mikaeshicenter-*`/`X-Mikaeshishop-*`/`X-Mikaeshipro-*`/`X-Hayaorinavi-*`/`X-Hayaoricenter-*`/`X-Hayaorishop-*`/`X-Hayaoripro-*`/`X-Shutokennavi-*`/`X-Shutokencenter-*`/`X-Shutokenshop-*`/`X-Shutokenpro-*`/`X-Kousokunavi-*`/`X-Kousokucenter-*`/`X-Kousokushop-*`/`X-Kousokupro-*` 等 は習機の通知記録 — 送信側が書くことは自称。合宿免許申込・免許更新通知・教習料金支払いの偽装は免許詐欺の典型手口。(自動車機は D521)
- **修正**: `Envelope` に `drivingschool_marks` + `has_drivingschool_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 習印の自署を問え。

### Security — D638: `X-Museumnavi-*`/`X-Museumcenter-*`/`X-Museumshop-*` 等の美術館・博物館印自称が未検査

- **問題**: `X-Museumnavi-*`/`X-Museumcenter-*`/`X-Museumshop-*`/`X-Museumpro-*`/`X-Museumdoctor-*`/`X-Museumrescue-*`/`X-Museum24-*`/`X-Kokuhaku-*`/`X-Tokyokokuritsu-*`/`X-Uenomuseum-*`/`X-Moma-*`/`X-Louvremuseum-*`/`X-Metmuseum-*`/`X-Britishmuseum-*`/`X-Bijutsukannavi-*`/`X-Bijutsukancenter-*`/`X-Bijutsukanshop-*`/`X-Bijutsukanpro-*`/`X-Bijutsukandoctor-*`/`X-Bijutsukanrescue-*`/`X-Bijutsukan24-*`/`X-Hakubutsukannavi-*`/`X-Hakubutsukancenter-*`/`X-Hakubutsukanshop-*`/`X-Hakubutsukanpro-*`/`X-Gallerynavi-*`/`X-Gallerycenter-*`/`X-Galleryshop-*`/`X-Gallerypro-*`/`X-Gallerydoctor-*`/`X-Galleryrescue-*`/`X-Gallery24-*`/`X-Artmuseumnavi-*`/`X-Artmuseumcenter-*`/`X-Artmuseumshop-*`/`X-Artmuseumpro-*`/`X-Exhibnavi-*`/`X-Exhibcenter-*`/`X-Exhibshop-*`/`X-Exhibpro-*`/`X-Exhibdoctor-*`/`X-Exhibrescue-*`/`X-Exhib24-*`/`X-Ghiblimuseum-*`/`X-Fujikomuseum-*`/`X-Museummart-*`/`X-Museumplus-*`/`X-Museumsmart-*`/`X-Museumfamily-*`/`X-Bijutsukanmart-*`/`X-Bijutsukanplus-*`/`X-Bijutsukansmart-*`/`X-Bijutsukanfamily-*`/`X-Tenjikannavi-*`/`X-Tenjikancenter-*`/`X-Tenjikanshop-*`/`X-Tenjikanpro-*`/`X-Bunkazainavi-*`/`X-Bunkazaicenter-*`/`X-Bunkazaishop-*`/`X-Bunkazaipro-*` 等 は博機の通知記録 — 送信側が書くことは自称。美術館・博物館の特別展チケット・会員更新・図録販売の偽装は展覧会詐欺の典型手口。(骨董機は D623、チケット機は D534)
- **修正**: `Envelope` に `museum_marks` + `has_museum_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 博印の自署を問え。

### Security — D639: `X-Takarazuka-*`/`X-Revue-*`/`X-Shiki-*` 等の劇場・ミュージカル・歌舞伎印自称が未検査

- **問題**: `X-Takarazuka-*`/`X-Revue-*`/`X-Shiki-*`/`X-Imperialtheatre-*`/`X-Theatrenavi-*`/`X-Theatrecenter-*`/`X-Theatreshop-*`/`X-Theatrepro-*`/`X-Theatredoctor-*`/`X-Theatrerescue-*`/`X-Theatre24-*`/`X-Gekidannavi-*`/`X-Gekidancenter-*`/`X-Gekidanshop-*`/`X-Gekidanpro-*`/`X-Gekidandoctor-*`/`X-Gekidanrescue-*`/`X-Gekidan24-*`/`X-Meijiza-*`/`X-Kabukiza-*`/`X-Minamiza-*`/`X-Shochikuza-*`/`X-Newnational-*`/`X-Bunraku-*`/`X-Kabukinavi-*`/`X-Kabukicenter-*`/`X-Kabukishop-*`/`X-Kabukipro-*`/`X-Kabukidoctor-*`/`X-Kabukirescue-*`/`X-Kabuki24-*`/`X-Musicalnavi-*`/`X-Musicalcenter-*`/`X-Musicalshop-*`/`X-Musicalpro-*`/`X-Musicaldoctor-*`/`X-Musicalrescue-*`/`X-Musical24-*`/`X-Balletnavi-*`/`X-Balletcenter-*`/`X-Balletshop-*`/`X-Balletpro-*`/`X-Balletdoctor-*`/`X-Balletrescue-*`/`X-Ballet24-*`/`X-Operanavi-*`/`X-Operacenter-*`/`X-Operashop-*`/`X-Operapro-*`/`X-Operadoctor-*`/`X-Operarescue-*`/`X-Opera24-*`/`X-Nogaku-*`/`X-Rakugo-*`/`X-Yose-*`/`X-Engekinavi-*`/`X-Engekicenter-*`/`X-Engekishop-*`/`X-Engekipro-*`/`X-Theatremart-*`/`X-Theatreplus-*`/`X-Theatresmart-*`/`X-Theatrefamily-*`/`X-Musicalmart-*`/`X-Musicalplus-*`/`X-Musicalsmart-*`/`X-Musicalfamily-*` 等 は劇機の通知記録 — 送信側が書くことは自称。劇場・宝塚・四季・歌舞伎のチケット当選・S席販売・公演中止の偽装は演劇詐欺の典型手口。(チケット機は D534、娯楽機は D536)
- **修正**: `Envelope` に `theater_marks` + `has_theater_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 劇印の自署を問え。

### Security — D640: `X-Johnnys-*`/`X-Sakamichi-*`/`X-Akb48-*` 等のアイドル・声優・ファンクラブ印自称が未検査

- **問題**: `X-Johnnys-*`/`X-Sakamichi-*`/`X-Akb48-*`/`X-Nogizaka-*`/`X-Sakurazaka-*`/`X-Hinatazaka-*`/`X-Momiro-*`/`X-Lovelive-*`/`X-Umamusume-*`/`X-Proseka-*`/`X-Idolmaster-*`/`X-Idolnavi-*`/`X-Idolcenter-*`/`X-Idolshop-*`/`X-Idolpro-*`/`X-Idoldoctor-*`/`X-Idolrescue-*`/`X-Idol24-*`/`X-Seiyunavi-*`/`X-Seiyucenter-*`/`X-Seiyushop-*`/`X-Seiyupro-*`/`X-Seiyudoctor-*`/`X-Seiyurescue-*`/`X-Seiyu24-*`/`X-Fankurabu-*`/`X-Fcnavi-*`/`X-Fccenter-*`/`X-Fcshop-*`/`X-Fcpro-*`/`X-Fcdoctor-*`/`X-Fcrescue-*`/`X-Fc24-*`/`X-Fanclubnavi-*`/`X-Fanclubcenter-*`/`X-Fanclubshop-*`/`X-Fanclubpro-*`/`X-Fanclubdoctor-*`/`X-Fanclubrescue-*`/`X-Fanclub24-*`/`X-Oshikatsu-*`/`X-Oshinavi-*`/`X-Oshicenter-*`/`X-Oshishop-*`/`X-Oshipro-*`/`X-Oshidoctor-*`/`X-Oshirescue-*`/`X-Oshi24-*`/`X-Chekinavi-*`/`X-Chekicenter-*`/`X-Chekishop-*`/`X-Chekipro-*`/`X-Anstagram-*`/`X-Anistanavi-*`/`X-Anistacenter-*`/`X-Anistashop-*`/`X-Idolmart-*`/`X-Idolplus-*`/`X-Idolsmart-*`/`X-Idolfamily-*`/`X-Voternavi-*`/`X-Votercenter-*`/`X-Votershop-*`/`X-Voterpro-*`/`X-Handshakenavi-*`/`X-Handshakecenter-*`/`X-Handshakeshop-*`/`X-Handshakepro-*`/`X-Livemeetingnavi-*`/`X-Livemeetingcenter-*`/`X-Livemeetingshop-*`/`X-Livemeetingpro-*` 等 は推機の通知記録 — 送信側が書くことは自称。ファンクラブ会費・イベント当選・握手会・グッズ抽選の偽装はファンを狙う典型手口。(芸能事務所機は D553、玩具機は D558)
- **修正**: `Envelope` に `idol_marks` + `has_idol_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 推印の自署を問え。

### Security — D635: `X-Sekimagoroku-*`/`X-Kaihocho-*`/`X-Sakaihocho-*` 等の刃物・包丁・調理道具印自称が未検査

- **問題**: `X-Sekimagoroku-*`/`X-Kaihocho-*`/`X-Sakaihocho-*`/`X-Globalknife-*`/`X-Henckels-*`/`X-Wusthof-*`/`X-Zwilling-*`/`X-Knifenavi-*`/`X-Knifecenter-*`/`X-Knifeshop-*`/`X-Knifepro-*`/`X-Knifedoctor-*`/`X-Kniferescue-*`/`X-Knife24-*`/`X-Houchounavi-*`/`X-Houchoucenter-*`/`X-Houchoushop-*`/`X-Houchoupro-*`/`X-Houchoudoctor-*`/`X-Houchourescue-*`/`X-Houchou24-*`/`X-Hamononavi-*`/`X-Hamonocenter-*`/`X-Hamonoshop-*`/`X-Hamonopro-*`/`X-Hamonodoctor-*`/`X-Hamonorescue-*`/`X-Hamono24-*`/`X-Togishi-*`/`X-Togishinavi-*`/`X-Togishicenter-*`/`X-Togishishop-*`/`X-Togishipro-*`/`X-Togishidoctor-*`/`X-Togishirescue-*`/`X-Togishi24-*`/`X-Kitchentoolnavi-*`/`X-Kitchentoolcenter-*`/`X-Kitchentoolshop-*`/`X-Kitchentoolpro-*`/`X-Knifehaven-*`/`X-Sharpnavi-*`/`X-Sharppro-*`/`X-Knifemart-*`/`X-Knifeplus-*`/`X-Knifesmart-*`/`X-Knifefamily-*`/`X-Houchoumart-*`/`X-Houchouplus-*`/`X-Houchousmart-*`/`X-Houchoufamily-*`/`X-Hamonomart-*`/`X-Hamonoplus-*`/`X-Hamonosmart-*`/`X-Hamonofamily-*`/`X-Santokunavi-*`/`X-Santokucenter-*`/`X-Santokushop-*`/`X-Santokupro-*`/`X-Gyutonavi-*`/`X-Gyutocenter-*`/`X-Gyutoshop-*`/`X-Gyutopro-*`/`X-Pettynavi-*`/`X-Pettycenter-*`/`X-Pettyshop-*`/`X-Pettypro-*`/`X-Debanavi-*`/`X-Debacenter-*`/`X-Debashop-*`/`X-Debapro-*` 等 は刃機の通知記録 — 送信側が書くことは自称。包丁・刃物の通信販売・研ぎサービス・職人訪問の偽装は刃物詐欺の典型手口。(調理教室機は D625、工具機は D613)
- **修正**: `Envelope` に `knife_marks` + `has_knife_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 刃印の自署を問え。

### Security — D636: `X-Tataminavi-*`/`X-Tatamicenter-*`/`X-Tatamishop-*` 等の畳・襖・表具印自称が未検査

- **問題**: `X-Tataminavi-*`/`X-Tatamicenter-*`/`X-Tatamishop-*`/`X-Tatamipro-*`/`X-Tatamidoctor-*`/`X-Tatamirescue-*`/`X-Tatami24-*`/`X-Fusumanavi-*`/`X-Fusumacenter-*`/`X-Fusumashop-*`/`X-Fusumapro-*`/`X-Fusumadoctor-*`/`X-Fusumarescue-*`/`X-Fusuma24-*`/`X-Shoujinavi-*`/`X-Shoujicenter-*`/`X-Shoujishop-*`/`X-Shoujipro-*`/`X-Shoujidoctor-*`/`X-Shoujirescue-*`/`X-Shouji24-*`/`X-Hyouguya-*`/`X-Hyougunavi-*`/`X-Hyougucenter-*`/`X-Hyougushop-*`/`X-Hyougupro-*`/`X-Hyougudoctor-*`/`X-Hyougurescue-*`/`X-Hyougu24-*`/`X-Kakejikunavi-*`/`X-Kakejikucenter-*`/`X-Kakejikupro-*`/`X-Buddhistfit-*`/`X-Washitsunavi-*`/`X-Washitsucenter-*`/`X-Washitsushop-*`/`X-Washitsupro-*`/`X-Tatamiya-*`/`X-Tatamiyasan-*`/`X-Igusanavi-*`/`X-Igusacenter-*`/`X-Igusashop-*`/`X-Igusapro-*`/`X-Igusadoctor-*`/`X-Igusarescue-*`/`X-Igusa24-*`/`X-Gomazainavi-*`/`X-Gomazaicenter-*`/`X-Gomazaishop-*`/`X-Gomazaipro-*`/`X-Shittannavi-*`/`X-Shittancenter-*`/`X-Shittanshop-*`/`X-Shittanpro-*`/`X-Yukadanavi-*`/`X-Yukadancenter-*`/`X-Yukadanshop-*`/`X-Yukadanpro-*`/`X-Jitaunavi-*`/`X-Jitaucenter-*`/`X-Jitaushop-*`/`X-Jitaupro-*`/`X-Tatamimart-*`/`X-Tatamiplus-*`/`X-Tatamismart-*`/`X-Tatamifamily-*`/`X-Fusumamart-*`/`X-Fusumaplus-*`/`X-Fusumasmart-*`/`X-Fusumafamily-*` 等 は畳機の通知記録 — 送信側が書くことは自称。畳替え・襖張替え・表具修復の見積・訪問営業の偽装は和室改修詐欺の典型手口。(住宅機は D579、掛軸は D623)
- **修正**: `Envelope` に `tatami_marks` + `has_tatami_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 畳印の自署を問え。

### Security — D637: `X-Onsennavi-*`/`X-Onsencenter-*`/`X-Onsenshop-*` 等の温泉・銭湯・入浴印自称が未検査

- **問題**: `X-Onsennavi-*`/`X-Onsencenter-*`/`X-Onsenshop-*`/`X-Onsenpro-*`/`X-Onsenrescue-*`/`X-Onsen24-*`/`X-Onsendoctor-*`/`X-Onsenmart-*`/`X-Onsenplus-*`/`X-Onsensmart-*`/`X-Onsenfamily-*`/`X-Sentonavi-*`/`X-Sentocenter-*`/`X-Sentoshop-*`/`X-Sentopro-*`/`X-Sentodoctor-*`/`X-Sentorescue-*`/`X-Sento24-*`/`X-Yunavi-*`/`X-Yucenter-*`/`X-Yushop-*`/`X-Yupro-*`/`X-Yudoctor-*`/`X-Yurescue-*`/`X-Yu24-*`/`X-Nyuyokunavi-*`/`X-Nyuyokucenter-*`/`X-Nyuyokushop-*`/`X-Nyuyokupro-*`/`X-Nyuyokudoctor-*`/`X-Nyuyokurescue-*`/`X-Nyuyoku24-*`/`X-Hotspringnavi-*`/`X-Hotspringcenter-*`/`X-Hotspringshop-*`/`X-Hotspringpro-*`/`X-Hotspringdoctor-*`/`X-Hotspringrescue-*`/`X-Hotspring24-*`/`X-Rotennavi-*`/`X-Rotencenter-*`/`X-Rotenshop-*`/`X-Rotenpro-*`/`X-Saunanavi-*`/`X-Saunacenter-*`/`X-Saunashop-*`/`X-Saunapro-*`/`X-Saunadoctor-*`/`X-Saunarescue-*`/`X-Sauna24-*`/`X-Badeinnavi-*`/`X-Badeincenter-*`/`X-Badeinshop-*`/`X-Badeinpro-*`/`X-Spa24navi-*`/`X-Spa24center-*`/`X-Spa24shop-*`/`X-Spa24pro-*`/`X-Supersentonavi-*`/`X-Supersentocenter-*`/`X-Supersentoshop-*`/`X-Supersentopro-*`/`X-Ofuronavi-*`/`X-Ofurocenter-*`/`X-Ofuroshop-*`/`X-Ofuropro-*`/`X-Kakeyunavi-*`/`X-Kakeyucenter-*`/`X-Kakeyushop-*`/`X-Kakeyupro-*`/`X-Hakuzennavi-*`/`X-Hakuzencenter-*`/`X-Hakuzenshop-*`/`X-Hakuzenpro-*` 等 は湯機の通知記録 — 送信側が書くことは自称。温泉宿・銭湯・日帰り入浴施設のクーポン・回数券・会員更新の偽装は入浴施設詐欺の典型手口。(宿泊機は D535、娯楽機は D536)
- **修正**: `Envelope` に `onsen_marks` + `has_onsen_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 湯印の自署を問え。

### Security — D632: `X-Nishikawa-*`/`X-Francebed-*`/`X-Simmonsbed-*` 等の寝具・マットレス印自称が未検査

- **問題**: `X-Nishikawa-*`/`X-Francebed-*`/`X-Simmonsbed-*`/`X-Airweave-*`/`X-Iwatabed-*`/`X-Romancebed-*`/`X-Beddingpro-*`/`X-Beddingnavi-*`/`X-Beddingcenter-*`/`X-Beddingshop-*`/`X-Beddingrescue-*`/`X-Bedding24-*`/`X-Futonnavi-*`/`X-Futoncenter-*`/`X-Futonshop-*`/`X-Futonpro-*`/`X-Futondoctor-*`/`X-Futonrescue-*`/`X-Futon24-*`/`X-Mattressnavi-*`/`X-Mattresscenter-*`/`X-Mattressshop-*`/`X-Mattresspro-*`/`X-Mattressdoctor-*`/`X-Mattressrescue-*`/`X-Mattress24-*`/`X-Makuranavi-*`/`X-Makuracenter-*`/`X-Makurashop-*`/`X-Makurapro-*`/`X-Sleepnavi-*`/`X-Sleepcenter-*`/`X-Sleepshop-*`/`X-Sleeppro-*`/`X-Sleepdoctor-*`/`X-Sleeprescue-*`/`X-Sleep24-*`/`X-Tempurpillow-*`/`X-Tempurshop-*`/`X-Cozyblanket-*`/`X-Nishikawaliving-*`/`X-Showanishikawa-*`/`X-Suidnavi-*`/`X-Suidcenter-*`/`X-Suidshop-*`/`X-Suidpro-*`/`X-Suiddoctor-*`/`X-Suidrescue-*`/`X-Suid24-*`/`X-Bedmart-*`/`X-Bedplus-*`/`X-Bedsmart-*`/`X-Bedfamily-*`/`X-Bedcenter-*`/`X-Bedshop-*`/`X-Bedpro-*`/`X-Beddoctor-*`/`X-Bedrescue-*`/`X-Bed24-*`/`X-Bednavi-*`/`X-Futonmart-*`/`X-Futonplus-*`/`X-Futonsmart-*`/`X-Futonfamily-*`/`X-Mattressmart-*`/`X-Mattressplus-*`/`X-Mattresssmart-*`/`X-Mattressfamily-*` 等 は寝機の通知記録 — 送信側が書くことは自称。寝具・マットレスの通信販売・セール・睡眠相談の偽装は寝具詐欺の典型手口。(家具機は D526)
- **修正**: `Envelope` に `bedding_marks` + `has_bedding_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 寝印の自署を問え。

### Security — D633: `X-Hamanaka-*`/`X-Clovercraft-*`/`X-Yuzawaya-*` 等の手芸・毛糸・ミシン印自称が未検査

- **問題**: `X-Hamanaka-*`/`X-Clovercraft-*`/`X-Yuzawaya-*`/`X-Okadaya-*`/`X-Craftnavi-*`/`X-Craftcenter-*`/`X-Craftshop-*`/`X-Craftpro-*`/`X-Craftdoctor-*`/`X-Craftrescue-*`/`X-Craft24-*`/`X-Handicraftnavi-*`/`X-Handicraftcenter-*`/`X-Handicraftshop-*`/`X-Handicraftpro-*`/`X-Handicraftdoctor-*`/`X-Handicraftrescue-*`/`X-Handicraft24-*`/`X-Keitonavi-*`/`X-Keitocenter-*`/`X-Keitoshop-*`/`X-Keitopro-*`/`X-Sewinavi-*`/`X-Sewicenter-*`/`X-Sewishop-*`/`X-Sewipro-*`/`X-Sewingnavi-*`/`X-Sewingcenter-*`/`X-Sewingshop-*`/`X-Sewingpro-*`/`X-Sewingdoctor-*`/`X-Sewingrescue-*`/`X-Sewing24-*`/`X-Shugeinavi-*`/`X-Shugeicenter-*`/`X-Shugeishop-*`/`X-Shugeipro-*`/`X-Shugeidoctor-*`/`X-Shugeirescue-*`/`X-Shugei24-*`/`X-Quiltnavi-*`/`X-Quiltcenter-*`/`X-Quiltshop-*`/`X-Quiltpro-*`/`X-Yarncenter-*`/`X-Yarnshop-*`/`X-Yarnpro-*`/`X-Patchworknavi-*`/`X-Leathercraftnavi-*`/`X-Beadworknavi-*`/`X-Crossstitchnavi-*`/`X-Embroiderynavi-*`/`X-Sewingmachinenavi-*`/`X-Janomecenter-*`/`X-Craftmart-*`/`X-Craftplus-*`/`X-Craftsmart-*`/`X-Craftfamily-*`/`X-Shugeimart-*`/`X-Shugeiplus-*`/`X-Shugeismart-*`/`X-Shugeifamily-*`/`X-Sashikonavi-*`/`X-Sashikocenter-*`/`X-Sashikoshop-*`/`X-Sashikopro-*`/`X-Amiurunavi-*`/`X-Amiurucenter-*`/`X-Amiurushop-*`/`X-Amiurupro-*`/`X-Knitnavi-*`/`X-Knitcenter-*`/`X-Knitshop-*`/`X-Knitpro-*`/`X-Amimononavi-*`/`X-Amimonocenter-*`/`X-Amimonoshop-*`/`X-Amimonopro-*` 等 は裁機の通知記録 — 送信側が書くことは自称。手芸店・ミシン販売・毛糸セット・手芸教室の偽装は手芸愛好家を狙う典型手口。(ホビーショップ機は D559、ミシン機械は D626)
- **修正**: `Envelope` に `craft_marks` + `has_craft_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 裁印の自署を問え。

### Security — D634: `X-Kumiai-*`/`X-Takii-*`/`X-Sakata-*` 等の農業資材・種苗・肥料印自称が未検査

- **問題**: `X-Kumiai-*`/`X-Takii-*`/`X-Sakata-*`/`X-Nanto-*`/`X-Farmnavi-*`/`X-Farmcenter-*`/`X-Farmshop-*`/`X-Farmpro-*`/`X-Farmdoctor-*`/`X-Farmrescue-*`/`X-Farm24-*`/`X-Noukasonavi-*`/`X-Noukacenter-*`/`X-Noukashop-*`/`X-Noukapro-*`/`X-Noukadoctor-*`/`X-Noukarescue-*`/`X-Nouka24-*`/`X-Nouzinavi-*`/`X-Nouzincenter-*`/`X-Nouzinshop-*`/`X-Nouzipro-*`/`X-Nouzidoctor-*`/`X-Nouzirescue-*`/`X-Nouzi24-*`/`X-Syubyou-*`/`X-Syubyounavi-*`/`X-Syubyoucenter-*`/`X-Syubyoushop-*`/`X-Syubyoupro-*`/`X-Hiryou-*`/`X-Hiryoucenter-*`/`X-Hiroushop-*`/`X-Hiroupro-*`/`X-Nouyakunavi-*`/`X-Nouyakucenter-*`/`X-Nouyakushop-*`/`X-Nouyakupro-*`/`X-Nouyakudoctor-*`/`X-Nouyakurescue-*`/`X-Nouyaku24-*`/`X-Agricenter-*`/`X-Agrishop-*`/`X-Agripro-*`/`X-Agrinavi-*`/`X-Agrirescue-*`/`X-Agri24-*`/`X-Farmmart-*`/`X-Farmplus-*`/`X-Farmsmart-*`/`X-Farmfamily-*`/`X-Zarainavi-*`/`X-Zenno-*`/`X-Jccu-*`/`X-Farmotec-*`/`X-Nevon-*`/`X-Nougyou-*`/`X-Nougyounavi-*`/`X-Nougyoucenter-*`/`X-Nougyoushop-*`/`X-Nougyoupro-*`/`X-Nougyoudoctor-*`/`X-Nougyourescue-*`/`X-Nougyou24-*`/`X-Saibainavi-*`/`X-Saibaicenter-*`/`X-Saibaishop-*`/`X-Saibaipro-*`/`X-Kajuennavi-*`/`X-Kajuencenter-*`/`X-Kajuenshop-*`/`X-Kajuenpro-*`/`X-Engeinavi-*`/`X-Engeicenter-*`/`X-Engeishop-*`/`X-Engeipro-*`/`X-Engeidoctor-*`/`X-Engeirescue-*`/`X-Engei24-*` 等 は農機の通知記録 — 送信側が書くことは自称。種苗・肥料・農薬の注文・補助金案内・収穫祭案内の偽装は農家を狙う典型手口。(農機機械は D538、造園機は D619)
- **修正**: `Envelope` に `farm_marks` + `has_farm_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 農印の自署を問え。

### Security — D629: `X-Sekkotsuin-*`/`X-Seitai-*`/`X-Shinkyu-*` 等の接骨院・鍼灸・整体印自称が未検査

- **問題**: `X-Sekkotsuin-*`/`X-Seitai-*`/`X-Shinkyu-*`/`X-Bonesetter-*`/`X-Chirorin-*`/`X-Karada-*`/`X-Perfectbody-*`/`X-Genin-*`/`X-Sekkotsuinnavi-*`/`X-Sekkotsuincenter-*`/`X-Sekkotsuinshop-*`/`X-Sekkotsuinpro-*`/`X-Sekkotsuindoctor-*`/`X-Sekkotsuinrescue-*`/`X-Sekkotsuin24-*`/`X-Seitaiinnavi-*`/`X-Seitaiincenter-*`/`X-Seitaiinshop-*`/`X-Seitaiinpro-*`/`X-Seitaiindoctor-*`/`X-Seitaiinrescue-*`/`X-Seitaiin24-*`/`X-Shinkyunavi-*`/`X-Shinkyucenter-*`/`X-Shinkyushop-*`/`X-Shinkyupro-*`/`X-Shinkyudoctor-*`/`X-Shinkyurescue-*`/`X-Shinkyu24-*`/`X-Hari-*`/`X-Harist-*`/`X-Kyuto-*`/`X-Moxa-*`/`X-Anma-*`/`X-Massagepro-*`/`X-Massagenavi-*`/`X-Massagecenter-*`/`X-Massageshop-*`/`X-Massagerescue-*`/`X-Massage24-*`/`X-Kaifukunavi-*`/`X-Kaifukucenter-*`/`X-Kaifukushop-*`/`X-Kaifukupro-*`/`X-Kaifukudoctor-*`/`X-Kaifukurescue-*`/`X-Kaifuku24-*`/`X-Geninnavi-*`/`X-Genincenter-*`/`X-Geninshop-*`/`X-Geninpro-*`/`X-Genindoctor-*`/`X-Geninrescue-*`/`X-Genin24-*`/`X-Chirorinnavi-*`/`X-Chirorincenter-*`/`X-Chirorinshop-*`/`X-Chirorinpro-*`/`X-Chirorindoctor-*`/`X-Chirorinrescue-*`/`X-Chirorin24-*`/`X-Karadanavi-*`/`X-Karadacenter-*`/`X-Karadashop-*`/`X-Karadapro-*`/`X-Karadadoctor-*`/`X-Karadarescue-*`/`X-Karada24-*`/`X-Ryoujinnavi-*`/`X-Ryoujincenter-*`/`X-Ryoujinshop-*`/`X-Ryoujinpro-*` 等 は整機の通知記録 — 送信側が書くことは自称。整骨院・接骨院・鍼灸院・整体院の予約・保険請求・回数券販売の偽装は整骨院詐欺の典型手口。(リラク機は D594、ヨガ機は D602)
- **修正**: `Envelope` に `bonesetter_marks` + `has_bonesetter_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 整印の自署を問え。

### Security — D630: `X-Animalhospital-*`/`X-Vetnavi-*`/`X-Vetcenter-*` 等の動物病院・ペット医療印自称が未検査

- **問題**: `X-Animalhospital-*`/`X-Vetnavi-*`/`X-Vetcenter-*`/`X-Vetshop-*`/`X-Vetpro-*`/`X-Vetdoctor-*`/`X-Vetrescue-*`/`X-Vet24-*`/`X-Animaldoctor-*`/`X-Animalclinic-*`/`X-Animalnavi-*`/`X-Animalcenter-*`/`X-Animalshop-*`/`X-Animalrescue-*`/`X-Animal24-*`/`X-Petvet-*`/`X-Petclinic-*`/`X-Petdoctor-*`/`X-Petshospital-*`/`X-Petmedical-*`/`X-Jui-*`/`X-Dobutsu-*`/`X-Byouin-*`/`X-Ahb-*`/`X-Juinavi-*`/`X-Juicenter-*`/`X-Juishop-*`/`X-Juipro-*`/`X-Juidoctor-*`/`X-Juirescue-*`/`X-Jui24-*`/`X-Dobutsunavi-*`/`X-Dobutsucenter-*`/`X-Dobutsushop-*`/`X-Dobutsupro-*`/`X-Dobutsudoctor-*`/`X-Dobutsurescue-*`/`X-Dobutsu24-*`/`X-Petmedicalnavi-*`/`X-Petmedicalcenter-*`/`X-Petmedicalshop-*`/`X-Petmedicalpro-*`/`X-Petmedicaldoctor-*`/`X-Petmedicalrescue-*`/`X-Petmedical24-*`/`X-Ahbnavi-*`/`X-Ahbcenter-*`/`X-Ahbshop-*`/`X-Ahbpro-*`/`X-Ahbdoctor-*`/`X-Ahbrescue-*`/`X-Ahb24-*`/`X-Wanwannavi-*`/`X-Wanwancenter-*`/`X-Wanwanshop-*`/`X-Wanwanpro-*`/`X-Nyannyannavi-*`/`X-Nyannyancenter-*`/`X-Nyannyanshop-*`/`X-Nyannyanpro-*`/`X-Petcarenavi-*`/`X-Petcarecenter-*`/`X-Petcareshop-*`/`X-Petcarepro-*`/`X-Petcaredoctor-*`/`X-Petcarerescue-*`/`X-Petcare24-*`/`X-Vetcarenavi-*`/`X-Vetcarecenter-*`/`X-Vetcareshop-*`/`X-Vetcarepro-*` 等 は獣機の通知記録 — 送信側が書くことは自称。動物病院の診察予約・ワクチン接種・手術費用の偽装はペット飼主を狙う典型手口。(ペット保険機は D561、ペットサービス機は D561)
- **修正**: `Envelope` に `animalhospital_marks` + `has_animalhospital_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 獣印の自署を問え。

### Security — D631: `X-Fuyohin-*`/`X-Ihin-*`/`X-Sodaya-*` 等の不用品回収・遺品整理・粗大ゴミ印自称が未検査

- **問題**: `X-Fuyohin-*`/`X-Ihin-*`/`X-Sodaya-*`/`X-Soudai-*`/`X-Kaishuun-*`/`X-Hasten-*`/`X-Wastepro-*`/`X-Junkpro-*`/`X-Gomigo-*`/`X-Fuyohinnavi-*`/`X-Fuyohincenter-*`/`X-Fuyohinshop-*`/`X-Fuyohinpro-*`/`X-Fuyohindoctor-*`/`X-Fuyohinrescue-*`/`X-Fuyohin24-*`/`X-Ihinnavi-*`/`X-Ihincenter-*`/`X-Ihinshop-*`/`X-Ihinpro-*`/`X-Ihindoctor-*`/`X-Ihinrescue-*`/`X-Ihin24-*`/`X-Soudainavi-*`/`X-Soudaicenter-*`/`X-Soudaishop-*`/`X-Soudaipro-*`/`X-Soudaidoctor-*`/`X-Soudairescue-*`/`X-Soudai24-*`/`X-Kaishuunnavi-*`/`X-Kaishuuncenter-*`/`X-Kaishuunshop-*`/`X-Kaishuunpro-*`/`X-Kaishuundoctor-*`/`X-Kaishuunrescue-*`/`X-Kaishuun24-*`/`X-Wastenavi-*`/`X-Wastecenter-*`/`X-Wasteshop-*`/`X-Wasterescue-*`/`X-Waste24-*`/`X-Junknavi-*`/`X-Junkcenter-*`/`X-Junkshop-*`/`X-Junkrescue-*`/`X-Junk24-*`/`X-Gomigonavi-*`/`X-Gomigocenter-*`/`X-Gomigoshop-*`/`X-Gomigopro-*`/`X-Gomigodoctor-*`/`X-Gomigorescue-*`/`X-Gomigo24-*`/`X-Seirinnavi-*`/`X-Seirincenter-*`/`X-Seirinshop-*`/`X-Seirinpro-*`/`X-Seirindoctor-*`/`X-Seirinrescue-*`/`X-Seirin24-*`/`X-Katadukenavi-*`/`X-Katadukecenter-*`/`X-Katadukeshop-*`/`X-Katadukepro-*`/`X-Katadukedoctor-*`/`X-Katadukerescue-*`/`X-Kataduke24-*`/`X-Hikiagerescue-*`/`X-Hikiagenavi-*`/`X-Hikiagecenter-*`/`X-Hikiageshop-*`/`X-Hikiagepro-*`/`X-Hikiage24-*`/`X-Migimawari-*`/`X-Migawari-*`/`X-Maichodo-*`/`X-Benriya-*`/`X-Benriyanavi-*`/`X-Benriyacenter-*`/`X-Benriyashop-*`/`X-Benriyapro-*` 等 は廃機の通知記録 — 送信側が書くことは自称。不用品回収・遺品整理の見積・高額請求・遺品買取の偽装は高齢者を狙う典型手口。(買取機は D576、葬儀機は D580)
- **修正**: `Envelope` に `bulkwaste_marks` + `has_bulkwaste_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 廃印の自署を問え。

### Security — D626: `X-AirConRepair-*`/`X-KadenShuuri-*`/`X-ApplianceFix-*` 等の家電・住宅設備修理印自称が未検査

- **問題**: `X-AirConRepair-*` (エアコン修理)、`X-KadenShuuri-*` (家電修理)、`X-ApplianceFix-*` (家電修理)、`X-FridgeFix-*`/`X-WasherRepair-*`/`X-TvRepair-*`/`X-KadenRepair-*`/`X-HomeAppliance-*`/`X-AppliancePro-*`/`X-ApplianceDoctor-*`/`X-ApplianceNavi-*`/`X-ApplianceCenter-*`/`X-ApplianceShop-*`/`X-ApplianceRescue-*`/`X-Appliance24-*`/`X-KadenDoctor-*`/`X-KadenPro-*`/`X-KadenNavi-*`/`X-KadenCenter-*`/`X-KadenShop-*`/`X-KadenRescue-*`/`X-Kaden24-*`/`X-KadenMart-*`/`X-KadenPlus-*`/`X-KadenSmart-*`/`X-KadenFamily-*`/`X-HitachiApp-*`/`X-PanasonicApp-*`/`X-ToshibaApp-*`/`X-SharpApp-*`/`X-MitsubishiApp-*`/`X-ElectroluxApp-*`/`X-TotoApp-*`/`X-DaikinApp-*`/`X-RinnaiApp-*`/`X-NoritzApp-*`/`X-InaxApp-*`/`X-ZojirushiApp-*`/`X-TigerApp-*`/`X-BalmudaApp-*`/`X-PalomaApp-*`/`X-HisenseApp-*`/`X-GreeApp-*`/`X-MideaApp-*`/`X-SanyoApp-*`/`X-VictorApp-*`/`X-JvcApp-*`/`X-JanomeApp-*`/`X-SingerApp-*`/`X-BerninaApp-*`/`X-HusqvarnaApp-*`/`X-TajimaApp-*`/`X-ElnaApp-*`/`X-JukiApp-*` 等 は家機の通知記録 — 送信側が書くことは自称。家電故障の出張修理・リコール・点検通知の偽装は家電修理詐欺の典型手口。(PC 修理機は D615、緊急修理機は D617、メーカー機は D496/D539)
- **修正**: `Envelope` に `appliancerepair_marks` + `has_appliancerepair_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 家印の自署を問え。

### Security — D627: `X-KidsLine-*`/`X-HoikuenNavi-*`/`X-GakudouNavi-*` 等のベビーシッター・保育・学童印自称が未検査

- **問題**: `X-KidsLine-*` (キッズライン)、`X-HoikuenNavi-*` (保育園ナビ)、`X-GakudouNavi-*` (学童ナビ)、`X-SmartSitter-*`/`X-PigeonSitter-*`/`X-PoppinsSitter-*`/`X-BabysitterPro-*`/`X-BabysitterNavi-*`/`X-BabysitterCenter-*`/`X-BabysitterShop-*`/`X-BabysitterRescue-*`/`X-Babysitter24-*`/`X-BabysitterSmart-*`/`X-BabysitterFamily-*`/`X-BabysitterPlus-*`/`X-BabysitterMart-*`/`X-HoikuenCenter-*`/`X-HoikuenShop-*`/`X-HoikuPro-*`/`X-HoikuDoctor-*`/`X-HoikuRescue-*`/`X-Hoiku24-*`/`X-HoikuMart-*`/`X-HoikuPlus-*`/`X-HoikuSmart-*`/`X-HoikuFamily-*`/`X-GakudouCenter-*`/`X-GakudouShop-*`/`X-GakudoPro-*`/`X-GakudoDoctor-*`/`X-GakudoRescue-*`/`X-Gakudo24-*`/`X-FamiSapo-*`/`X-Kodomoen-*`/`X-Hoikugo-*`/`X-Sodate-*`/`X-Honya-*`/`X-Honyaba-*`/`X-SitterNavi-*`/`X-SitterCenter-*`/`X-SitterShop-*`/`X-SitterPro-*`/`X-SitterDoctor-*`/`X-SitterRescue-*`/`X-Sitter24-*`/`X-NannyNavi-*`/`X-NannyCenter-*`/`X-NannyShop-*`/`X-NannyPro-*`/`X-NannyDoctor-*`/`X-NannyRescue-*`/`X-Nanny24-*`/`X-Kidsclub-*`/`X-KidsNavi-*`/`X-KidsCenter-*`/`X-KidsShop-*`/`X-KidsPro-*`/`X-KidsDoctor-*`/`X-KidsRescue-*`/`X-Kids24-*`/`X-NurseryNavi-*`/`X-NurseryCenter-*`/`X-NurseryShop-*`/`X-NurseryPro-*`/`X-NurseryDoctor-*`/`X-NurseryRescue-*`/`X-Nursery24-*`/`X-YochienNavi-*`/`X-YochienCenter-*`/`X-YochienShop-*`/`X-YochienPro-*`/`X-ChildcareNavi-*`/`X-ChildcareCenter-*`/`X-ChildcareShop-*`/`X-ChildcarePro-*` 等 は育機の通知記録 — 送信側が書くことは自称。保育料・学童費・シッター手配料の偽装は子育て世帯を狙う典型手口。(塾機は D605、ベビー用品機は D582)
- **修正**: `Envelope` に `babysitter_marks` + `has_babysitter_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 育印の自署を問え。

### Security — D628: `X-Gengo-*`/`X-HonyakuPro-*`/`X-TuuyakuPro-*` 等の翻訳・通訳印自称が未検査

- **問題**: `X-Gengo-*` (Gengo)、`X-HonyakuPro-*` (翻訳プロ)、`X-TuuyakuPro-*` (通訳プロ)、`X-Wip-*`/`X-HonyakuGaisha-*`/`X-HonyakuNavi-*`/`X-HonyakuCenter-*`/`X-HonyakuShop-*`/`X-HonyakuRescue-*`/`X-Honyaku24-*`/`X-HonyakuMart-*`/`X-HonyakuPlus-*`/`X-HonyakuSmart-*`/`X-HonyakuFamily-*`/`X-TuuyakuNavi-*`/`X-TuuyakuCenter-*`/`X-TuuyakuShop-*`/`X-TuuyakuRescue-*`/`X-Tuuyaku24-*`/`X-Tsuyaku-*`/`X-TranslatePro-*`/`X-TranslateDoctor-*`/`X-TranslateNavi-*`/`X-TranslateCenter-*`/`X-TranslateShop-*`/`X-TranslateRescue-*`/`X-Translate24-*`/`X-Jyuuinsai-*`/`X-Gengo24-*`/`X-LocalizationPro-*`/`X-LocalizeShop-*`/`X-LocalizationNavi-*`/`X-InterpreterNavi-*`/`X-InterpreterCenter-*`/`X-InterpreterShop-*`/`X-InterpreterPro-*`/`X-InterpreterDoctor-*`/`X-InterpreterRescue-*`/`X-Interpreter24-*`/`X-TranslatorNavi-*`/`X-TranslatorCenter-*`/`X-TranslatorShop-*`/`X-TranslatorPro-*`/`X-TranslatorDoctor-*`/`X-TranslatorRescue-*`/`X-Translator24-*`/`X-Unbabel-*`/`X-Smartcat-*`/`X-Lionbridge-*`/`X-Transperfect-*`/`X-SdlTranslate-*`/`X-KeywordsStudios-*`/`X-RwsGroup-*`/`X-Alconost-*`/`X-BestEnglish-*`/`X-Togoal-*`/`X-Intergroup-*`/`X-TranslationMall-*`/`X-Osimira-*`/`X-FeloStaff-*`/`X-Juuroku-*`/`X-TenPrint-*`/`X-Koboweb-*`/`X-HonyakuPlan-*`/`X-Sunflare-*`/`X-Sanki-*`/`X-Daikaigo-*`/`X-Multipath-*`/`X-Occam-*`/`X-CascadeTranslations-*`/`X-HonyakuMart-*`/`X-TokyoHonyaku-*`/`X-OsakaHonyaku-*`/`X-NagoyaHonyaku-*`/`X-FukuokaHonyaku-*`/`X-HokkaidoHonyaku-*`/`X-SendaiHonyaku-*`/`X-HiroshimaHonyaku-*`/`X-KobeHonyaku-*`/`X-KyotoHonyaku-*`/`X-YokohamaHonyaku-*` 等 は訳機の通知記録 — 送信側が書くことは自称。翻訳発注・通訳手配・見積依頼の偽装はフリーランサーを狙う典型手口。(語学スクール機は D611、コンサル機は D546)
- **修正**: `Envelope` に `translation_marks` + `has_translation_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 訳印の自署を問え。

### Security — D623: `X-Kottou-*`/`X-Bijutsu-*`/`X-Antique-*` 等の骨董・美術品印自称が未検査

- **問題**: `X-Kottou-*` (骨董)、`X-Bijutsu-*` (美術)、`X-Antique-*` (アンティーク)、`X-ArtDealer-*`/`X-ArtAuction-*`/`X-ArtShop-*`/`X-ArtNavi-*`/`X-ArtCenter-*`/`X-ArtPro-*`/`X-ArtDoctor-*`/`X-ArtRescue-*`/`X-Art24-*`/`X-Komentou-*`/`X-Kobijutsu-*`/`X-Chadougu-*`/`X-Touken-*`/`X-BijutsuSou-*`/`X-ArtGallery-*`/`X-ArtMart-*`/`X-ArtPlus-*`/`X-ArtSmart-*`/`X-Kanteisho-*`/`X-KanteiPro-*`/`X-KanteiDoctor-*`/`X-KanteiNavi-*`/`X-KanteiCenter-*`/`X-KanteiShop-*`/`X-KanteiRescue-*`/`X-Kantei24-*`/`X-KottouPro-*`/`X-KottouDoctor-*`/`X-KottouNavi-*`/`X-KottouCenter-*`/`X-KottouShop-*`/`X-KottouRescue-*`/`X-Kottou24-*`/`X-AntiquePro-*`/`X-AntiqueDoctor-*`/`X-AntiqueNavi-*`/`X-AntiqueCenter-*`/`X-AntiqueShop-*`/`X-AntiqueRescue-*`/`X-Antique24-*`/`X-BijutsuPro-*`/`X-BijutsuDoctor-*`/`X-BijutsuNavi-*`/`X-BijutsuCenter-*`/`X-BijutsuShop-*`/`X-BijutsuRescue-*`/`X-Bijutsu24-*`/`X-UkiyoeShop-*`/`X-PrintShop-*`/`X-ScrollShop-*`/`X-CalligraphyShop-*`/`X-PotteryShop-*`/`X-PorcelainShop-*`/`X-LacquerShop-*`/`X-BronzeShop-*`/`X-SwordShop-*`/`X-KatanaShop-*`/`X-ArmorShop-*`/`X-NetsukeShop-*`/`X-KakejikuShop-*` 等 は骨機の通知記録 — 送信側が書くことは自称。無料鑑定・買取査定・展示会案内の偽装は骨董詐欺の典型手口。(買取機は D576、宝石機は D552)
- **修正**: `Envelope` に `antique_marks` + `has_antique_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 骨印の自署を問え。

### Security — D624: `X-Kimono-*`/`X-Furisode-*`/`X-Hakama-*` 等の着物・和装印自称が未検査

- **問題**: `X-Kimono-*` (着物)、`X-Furisode-*` (振袖)、`X-Hakama-*` (袴)、`X-Wasou-*`/`X-KimonoGa-*`/`X-KimonoShop-*`/`X-KimonoNavi-*`/`X-KimonoCenter-*`/`X-KimonoPro-*`/`X-KimonoDoctor-*`/`X-KimonoRescue-*`/`X-Kimono24-*`/`X-KimonoMart-*`/`X-KimonoPlus-*`/`X-KimonoSmart-*`/`X-KimonoFamily-*`/`X-Gofuku-*`/`X-Gofukuya-*`/`X-Wagara-*`/`X-Kitsuke-*`/`X-KitsukeKouza-*`/`X-KitsukeNavi-*`/`X-KitsukePro-*`/`X-KitsukeDoctor-*`/`X-KitsukeCenter-*`/`X-KitsukeShop-*`/`X-Kitsuke24-*`/`X-KitsukeRescue-*`/`X-FurisodePro-*`/`X-Furisode24-*`/`X-HakamaPro-*`/`X-HakamaNavi-*`/`X-HakamaCenter-*`/`X-HakamaShop-*`/`X-HakamaRescue-*`/`X-Hakama24-*`/`X-WasouPro-*`/`X-WasouNavi-*`/`X-WasouCenter-*`/`X-WasouShop-*`/`X-WasouRescue-*`/`X-Wasou24-*`/`X-YukataShop-*`/`X-YukataNavi-*`/`X-YukataCenter-*`/`X-YukataPro-*`/`X-ObiShop-*`/`X-ObiNavi-*`/`X-ObiCenter-*`/`X-ObiPro-*`/`X-TomesodeShop-*`/`X-HoumongiShop-*`/`X-TsukesageShop-*`/`X-KomonShop-*`/`X-TsumugiShop-*`/`X-OshimaShop-*`/`X-YuzenShop-*`/`X-ShiboriShop-*` 等 は装機の通知記録 — 送信側が書くことは自称。成人式・卒業式の着付け予約・振袖販売・箪笥買取の偽装は着物詐欺の典型手口。(エステ機は D608、呉服買取は骨董機 D623)
- **修正**: `Envelope` に `kimono_marks` + `has_kimono_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 装印の自署を問え。

### Security — D625: `X-Shodou-*`/`X-AbcCooking-*`/`X-CultureNavi-*` 等のカルチャー教室印自称が未検査

- **問題**: `X-Shodou-*` (書道)、`X-AbcCooking-*` (ABCクッキング)、`X-CultureNavi-*` (カルチャーナビ)、`X-Shodo-*`/`X-Sadou-*`/`X-Kadou-*`/`X-ShodouKyoshitsu-*`/`X-SadouKouza-*`/`X-KadouKouza-*`/`X-ShodouNavi-*`/`X-ShodouCenter-*`/`X-ShodouShop-*`/`X-ShodouPro-*`/`X-ShodouDoctor-*`/`X-ShodouRescue-*`/`X-Shodou24-*`/`X-BetterHome-*`/`X-CookpadKyoshitsu-*`/`X-CookingNavi-*`/`X-CookingCenter-*`/`X-CookingShop-*`/`X-CookingPro-*`/`X-CookingDoctor-*`/`X-CookingRescue-*`/`X-Cooking24-*`/`X-CultureCenter-*`/`X-CultureShop-*`/`X-CulturePro-*`/`X-CultureCenter24-*`/`X-CultureSalon-*`/`X-CulturAcademy-*`/`X-CultureSchool-*`/`X-CultureClass-*`/`X-CultureGakuin-*`/`X-CultureDojo-*`/`X-SadouPro-*`/`X-SadouNavi-*`/`X-SadouCenter-*`/`X-SadouShop-*`/`X-SadouRescue-*`/`X-Sadou24-*`/`X-KadouPro-*`/`X-KadouNavi-*`/`X-KadouCenter-*`/`X-KadouShop-*`/`X-KadouRescue-*`/`X-Kadou24-*`/`X-KotoSchool-*`/`X-ShamisenSchool-*`/`X-KotoClass-*`/`X-ShamisenClass-*`/`X-WagakkiClass-*`/`X-NihonOngaku-*`/`X-KotoNavi-*`/`X-ShamisenNavi-*`/`X-FlowerClass-*`/`X-FlowerSchool-*`/`X-IkebanaSchool-*`/`X-IkebanaClass-*`/`X-IkebanaNavi-*`/`X-ChaClass-*`/`X-TeaClass-*`/`X-CalligraphyClass-*`/`X-SchoolCulture-*`/`X-OkeikoClass-*`/`X-KarutaClass-*`/`X-GoClass-*`/`X-ShogiClass-*`/`X-PianoOkeiko-*`/`X-ViolinClass-*`/`X-BalletClass-*`/`X-DanceSchool-*` 等 は箏機の通知記録 — 送信側が書くことは自称。入会金・月謝・教材費の偽装はカルチャースクール詐欺の典型手口。(塾機は D605、資格機は D611、IT機は D618)
- **修正**: `Envelope` に `cultureschool_marks` + `has_cultureschool_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 箏印の自署を問え。

### Security — D620: `X-Hachikujo-*`/`X-Shiroari-*`/`X-NezumiKujo-*` 等の害虫・害獣駆除印自称が未検査

- **問題**: `X-Hachikujo-*` (蜂駆除)、`X-Shiroari-*` (シロアリ)、`X-NezumiKujo-*` (ねずみ駆除)、`X-GaijuuKujo-*`/`X-MukadeKujo-*`/`X-GokiKujo-*`/`X-PestControl24-*`/`X-KujoPro-*`/`X-KujoDoctor-*`/`X-KujoNavi-*`/`X-KujoCenter-*`/`X-KujoShop-*`/`X-Hachisu-*`/`X-Nezumi110-*`/`X-Kujo110-*`/`X-KujoRescue-*`/`X-Kujo24-*`/`X-HachiRescue-*`/`X-HachiDoctor-*`/`X-HachiPro-*`/`X-HachiNavi-*`/`X-HachiCenter-*`/`X-HachiShop-*`/`X-Hachi110-*`/`X-Suzumebachi-*`/`X-Ashinagabachi-*`/`X-MitsubachiCare-*`/`X-Hachi24-*`/`X-ShiroariPro-*`/`X-ShiroariDoctor-*`/`X-ShiroariNavi-*`/`X-ShiroariCenter-*`/`X-ShiroariShop-*`/`X-ShiroariRescue-*`/`X-Shiroari24-*`/`X-Shiroari110-*`/`X-TermitePro-*`/`X-TermiteDoctor-*`/`X-TermiteRescue-*`/`X-NezumiPro-*`/`X-NezumiDoctor-*`/`X-NezumiNavi-*`/`X-NezumiCenter-*`/`X-NezumiShop-*`/`X-NezumiRescue-*`/`X-Nezumi24-*`/`X-RodentPro-*`/`X-RodentRescue-*`/`X-GaijuuPro-*`/`X-GaijuuDoctor-*`/`X-GaijuuNavi-*`/`X-GaijuuCenter-*`/`X-GaijuuShop-*`/`X-GaijuuRescue-*`/`X-Gaijuu24-*`/`X-Gaijuu110-*`/`X-Hakubishin-*`/`X-AnagumaKujo-*`/`X-InoshishiKujo-*`/`X-SaruKujo-*`/`X-KarasuKujo-*`/`X-MukadePro-*`/`X-GokiPro-*`/`X-Nomitori-*`/`X-DaniKujo-*` 等 は駆機の通知記録 — 送信側が書くことは自称。蜂の巣・シロアリ・ねずみ・害獣駆除費用の偽装は駆除業者詐欺の典型手口。(警備機は D548、清掃機は D601)
- **修正**: `Envelope` に `pest_marks` + `has_pest_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 駆印の自署を問え。

### Security — D621: `X-Reien-*`/`X-Hakaishi-*`/`X-Butsudan-*` 等の霊園・墓石・仏壇印自称が未検査

- **問題**: `X-Reien-*` (霊園)、`X-Hakaishi-*` (墓石)、`X-Butsudan-*` (仏壇)、`X-Butsugu-*`/`X-Kaimyou-*`/`X-Noukotsudou-*`/`X-EidaiKuyou-*`/`X-Houchi-*`/`X-Haji-*`/`X-Sougishiki-*`/`X-Ohakamairi-*`/`X-OhakaCare-*`/`X-HakaDoctor-*`/`X-HakaNavi-*`/`X-HakaCenter-*`/`X-HakaShop-*`/`X-HakaPro-*`/`X-HakaRescue-*`/`X-Haka24-*`/`X-ButsudanPro-*`/`X-ButsudanDoctor-*`/`X-ButsudanNavi-*`/`X-ButsudanCenter-*`/`X-ButsudanShop-*`/`X-ButsudanStore-*`/`X-ButsuguPro-*`/`X-ButsuguShop-*`/`X-ButsuguStore-*`/`X-ButsuguNavi-*`/`X-KaimyouPro-*`/`X-KaimyouNavi-*`/`X-KaimyouCenter-*`/`X-KaimyouShop-*`/`X-NoukotsuPro-*`/`X-NoukotsuNavi-*`/`X-NoukotsuCenter-*`/`X-NoukotsuShop-*`/`X-EidaiPro-*`/`X-EidaiNavi-*`/`X-EidaiCenter-*`/`X-EidaiShop-*`/`X-ReienPro-*`/`X-ReienDoctor-*`/`X-ReienNavi-*`/`X-ReienCenter-*`/`X-ReienShop-*`/`X-ReienRescue-*`/`X-Reien24-*`/`X-MemorialPark-*`/`X-MemorialHall-*`/`X-MemorialStone-*`/`X-MemorialShop-*`/`X-MemorialPro-*`/`X-MemorialNavi-*`/`X-GraveStone-*`/`X-GraveShop-*`/`X-GraveNavi-*`/`X-TombStone-*`/`X-CemeteryPro-*`/`X-CemeteryNavi-*`/`X-OsoujiHaka-*`/`X-HakaSouji-*`/`X-OhakaSouji-*`/`X-HakaClean-*` 等 は墓機の通知記録 — 送信側が書くことは自称。墓石建立・改葬・仏壇購入・永代供養費の偽装は墓地仏壇詐欺の典型手口。(葬儀機は D580、社寺機は D596)
- **修正**: `Envelope` に `cemetery_marks` + `has_cemetery_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 墓印の自署を問え。

### Security — D622: `X-Taiyoukou-*`/`X-Chikuden-*`/`X-Enefarm-*` 等の太陽光・蓄電池・エネルギー設備印自称が未検査

- **問題**: `X-Taiyoukou-*` (太陽光)、`X-Chikuden-*` (蓄電池)、`X-Enefarm-*` (エネファーム)、`X-Hems-*`/`X-Uriden-*`/`X-SolarPro-*`/`X-PvPower-*`/`X-SmartHems-*`/`X-TyoriKiden-*`/`X-TaiyoukouPro-*`/`X-TaiyoukouDoctor-*`/`X-TaiyoukouNavi-*`/`X-TaiyoukouCenter-*`/`X-TaiyoukouShop-*`/`X-TaiyoukouRescue-*`/`X-Taiyoukou24-*`/`X-SolarDoctor-*`/`X-SolarNavi-*`/`X-SolarCenter-*`/`X-SolarShop-*`/`X-SolarRescue-*`/`X-Solar24-*`/`X-SolarMart-*`/`X-SolarPlus-*`/`X-SolarSmart-*`/`X-ChikudenPro-*`/`X-ChikudenDoctor-*`/`X-ChikudenNavi-*`/`X-ChikudenCenter-*`/`X-ChikudenShop-*`/`X-ChikudenRescue-*`/`X-Chikuden24-*`/`X-BatteryPro-*`/`X-BatteryShop-*`/`X-BatteryNavi-*`/`X-BatteryCenter-*`/`X-PvShop-*`/`X-PvNavi-*`/`X-PvCenter-*`/`X-PvPro-*`/`X-PvDoctor-*`/`X-PvRescue-*`/`X-Pv24-*`/`X-GreenPowerShop-*`/`X-GreenEnergy-*`/`X-RenewEnergy-*`/`X-RenewableShop-*`/`X-EcoPower-*`/`X-EcoSolar-*`/`X-EcoEnergy-*`/`X-EnergyPro-*`/`X-EnergyShop-*`/`X-EnergyNavi-*`/`X-EnergyCenter-*`/`X-EnergyDoctor-*`/`X-EnergyRescue-*`/`X-Energy24-*`/`X-UridenPro-*`/`X-UridenNavi-*`/`X-UridenCenter-*`/`X-UridenShop-*`/`X-FitNavi-*`/`X-FitCenter-*`/`X-V2HShop-*`/`X-V2HNavi-*`/`X-EvChargerShop-*`/`X-EvChargerNavi-*`/`X-WallBattery-*` 等 は蓄機の通知記録 — 送信側が書くことは自称。無料点検・補助金申請・パネル販売の偽装は太陽光詐欺の典型手口。(電気・ガス料金機は D520、建機は D538)
- **修正**: `Envelope` に `solar_marks` + `has_solar_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 蓄印の自署を問え。

### Security — D617: `X-SuidouKyukyu-*`/`X-Mizumore-*`/`X-ToiletFix-*` 等の水道・電気・ガス緊急修理印自称が未検査

- **問題**: `X-SuidouKyukyu-*` (水道救急)、`X-Mizumore-*` (水漏れ)、`X-ToiletFix-*` (トイレ修理)、`X-Senkyu-*`/`X-GasDenkyu-*`/`X-DenkiKoji-*`/`X-Breaker110-*`/`X-Suidou110-*`/`X-MizuTrouble-*`/`X-SuidouDoctor-*`/`X-SuidouPro-*`/`X-WaterRepair-*`/`X-Rokanare-*`/`X-Amenoarare-*`/`X-Suidou24-*`/`X-SuidouRescue-*`/`X-Denki24-*`/`X-GasRepair-*`/`X-WaterPro-*`/`X-SuidouCenter-*`/`X-SuidouShop-*`/`X-SuidouNavi-*`/`X-SuidouHome-*`/`X-SuidouSmart-*`/`X-SuidouFamily-*`/`X-ToiletRescue-*`/`X-ToiletDoctor-*`/`X-ToiletPro-*`/`X-Toilet24-*`/`X-FaucetFix-*`/`X-FaucetPro-*`/`X-PipeRepair-*`/`X-PipeDoctor-*`/`X-PipePro-*`/`X-DrainFix-*`/`X-DrainPro-*`/`X-DrainRescue-*`/`X-DrainDoctor-*`/`X-Drain24-*`/`X-LeakFix-*`/`X-LeakPro-*`/`X-LeakRescue-*`/`X-LeakDoctor-*`/`X-Leak24-*`/`X-DenkiRescue-*`/`X-DenkiDoctor-*`/`X-DenkiPro-*`/`X-DenkiNavi-*`/`X-DenkiCenter-*`/`X-DenkiShop-*`/`X-DenkiHome-*`/`X-GasDoctor-*`/`X-GasPro-*`/`X-GasNavi-*`/`X-GasCenter-*`/`X-GasShop-*`/`X-GasHome-*`/`X-GasStationKoji-*`/`X-KyutoRescue-*`/`X-KyutoDoctor-*`/`X-KyutoPro-*` 等 は配機の通知記録 — 送信側が書くことは自称。水漏れ・トイレ詰まり・ガス漏れ・ブレーカー修理の偽装は緊急修理詐欺の典型手口。(水道・電気・ガス料金機は D520)
- **修正**: `Envelope` に `emergency_marks` + `has_emergency_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 配印の自署を問え。

### Security — D618: `X-TechAcademy-*`/`X-DmmWebcamp-*`/`X-SamuraiEngineer-*` 等のプログラミング・ITスクール印自称が未検査

- **問題**: `X-TechAcademy-*` (テックアカデミー)、`X-DmmWebcamp-*` (DMM WEBCAMP)、`X-SamuraiEngineer-*` (侍エンジニア)、`X-Potepan-*`/`X-TechCamp-*`/`X-Daitura-*`/`X-CodeCamp-*`/`X-Runteq-*`/`X-ZeroIchi-*`/`X-TechPark-*`/`X-GrowWith-*`/`X-LinuxAcademy-*`/`X-KinoEdu-*`/`X-ProEngineer-*`/`X-TechDojo-*`/`X-CodeVillage-*`/`X-ProgrammingGym-*`/`X-AppDojo-*`/`X-WebPro-*`/`X-KidsDoor-*`/`X-TechBase-*`/`X-Terakoya-*`/`X-CodeZemi-*`/`X-GizTech-*`/`X-TechSchool-*`/`X-WebEngineerSchool-*`/`X-Progate-*`/`X-Dotinstall-*`/`X-Aidemy-*`/`X-UdemyTutor-*`/`X-DiveDigital-*`/`X-TechIan-*`/`X-CodeCrafter-*`/`X-Techful-*`/`X-CodeStar-*`/`X-CodeShip-*`/`X-CodeLabo-*`/`X-CodeLab-*`/`X-CodingSchool-*`/`X-CodingBootcamp-*`/`X-TechBootcamp-*`/`X-DevBootcamp-*`/`X-CodeAcademy-*`/`X-ProgrammingSchool-*`/`X-ItSchool-*`/`X-ItAcademy-*`/`X-SeSchool-*`/`X-SeAcademy-*`/`X-EngineerGakuin-*`/`X-EngineerSchool-*`/`X-EngineerDojo-*`/`X-ProgrammerSchool-*`/`X-WebDesignerSchool-*`/`X-VideoEditorSchool-*`/`X-AnimeSchool-*`/`X-GameSchool-*`/`X-AiSchool-*`/`X-DataSchool-*`/`X-CloudSchool-*`/`X-SecuritySchool-*` 等 は算機の通知記録 — 送信側が書くことは自称。受講料・転職保証・教材費の偽装はプログラミングスクール詐欺の典型手口。(塾・予備校機は D605、資格機は D611)
- **修正**: `Envelope` に `codingschool_marks` + `has_codingschool_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 算印の自署を問え。

### Security — D619: `X-Zouen-*`/`X-Sakutei-*`/`X-Bassai-*` 等の造園・剪定・伐採印自称が未検査

- **問題**: `X-Zouen-*` (造園)、`X-Sakutei-*` (剪定)、`X-Bassai-*` (伐採)、`X-Niwashi-*`/`X-Uekiya-*`/`X-Gaikou-*`/`X-TreeCare-*`/`X-Logging-*`/`X-ForestWorks-*`/`X-TreeCut-*`/`X-Engei-*`/`X-PlantCare-*`/`X-SodCut-*`/`X-MowerWorks-*`/`X-TurfWorks-*`/`X-LawnCare-*`/`X-GreenKeep-*`/`X-GardenPro-*`/`X-GardenMaster-*`/`X-NiwaDoctor-*`/`X-TreeClinic-*`/`X-NiwaClinic-*`/`X-GardenRescue-*`/`X-GaikouPro-*`/`X-ProEnka-*`/`X-EngeiShop-*`/`X-GardeningNavi-*`/`X-GardenNavi-*`/`X-GardenDoctor-*`/`X-GardenCenter-*`/`X-GardenShop-*`/`X-GardenStore-*`/`X-GardenStation-*`/`X-NiwaNavi-*`/`X-NiwaCenter-*`/`X-NiwaShop-*`/`X-NiwaStore-*`/`X-NiwaStation-*`/`X-NiwaPro-*`/`X-NiwaMaster-*`/`X-NiwaRescue-*`/`X-Niwa24-*`/`X-TreeDoctor-*`/`X-TreePro-*`/`X-TreeRescue-*`/`X-TreeNavi-*`/`X-TreeCenter-*`/`X-TreeShop-*`/`X-TreeStore-*`/`X-BassaiPro-*`/`X-BassaiDoctor-*`/`X-BassaiNavi-*`/`X-BassaiCenter-*`/`X-BassaiShop-*`/`X-BassaiRescue-*`/`X-KoubokuCut-*`/`X-TachikiCut-*`/`X-ZouenPro-*`/`X-ZouenDoctor-*`/`X-ZouenNavi-*`/`X-ZouenCenter-*`/`X-ZouenShop-*`/`X-ZouenStore-*`/`X-ZouenRescue-*` 等 は樹機の通知記録 — 送信側が書くことは自称。見積・点検・剪定費用の偽装は造園業者詐欺の典型手口。(リフォーム機は D579)
- **修正**: `Envelope` に `garden_marks` + `has_garden_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 樹印の自署を問え。
