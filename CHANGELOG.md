...
### Security — D716: `X-Tatami-*`/`X-Igusa-*`/`X-TatamiPro-*`/`X-Washitsu-*` 等の畳・い草印自称が未検査

- **問題**: `X-Tatami-*`/`X-TatamiYasan-*`/`X-TatamiPro-*`/`X-TatamiTeam-*`/`X-TatamiKensa-*`/`X-TatamiManten-*`/`X-TatamiNomi-*`/`X-TatamiJP-*`/`X-TatamiSenmon-*`/`X-TatamiMitsumori-*`/`X-TatamiChousa-*`/`X-TatamiTeiki-*`/`X-TatamiShuri-*`/`X-TatamiDoctors-*`/`X-TatamiSagyou-*`/`X-TatamiRescue-*`/`X-TatamiTeikyu-*`/`X-TatamiOrder-*`/`X-TatamiSho-*`/`X-TatamiTen-*`/`X-TatamiSeisaku-*`/`X-TatamiKoubou-*`/`X-TatamiKougyou-*`/`X-TatamiUrikae-*`/`X-TatamiGae-*`/`X-TatamiBank-*`/`X-Igusa-*`/`X-IgusaYasan-*`/`X-IgusaPro-*`/`X-IgusaTeam-*`/`X-IgusaKensa-*`/`X-IgusaManten-*`/`X-IgusaNomi-*`/`X-IgusaJP-*`/`X-IgusaSenmon-*`/`X-IgusaMitsumori-*`/`X-IgusaChousa-*`/`X-IgusaTeiki-*`/`X-IgusaShuri-*`/`X-IgusaSho-*`/`X-IgusaTen-*`/`X-Washitsu-*`/`X-WashitsuYasan-*`/`X-WashitsuPro-*`/`X-WashitsuTeam-*`/`X-WashitsuKensa-*`/`X-WashitsuKoubou-*` 等 は畳機の通知記録 — 送信側が書くことは自称。畳・い草・和室リフォーム店の偽装は、表替え料金・裏返し費用・新畳見積を装ったなりすましの典型手口。(内装は housing 機、絨毯は carpet 機で検出済み)
- **修正**: `Envelope` に `tatami_marks` + `has_tatami_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 畳印の自署を問え。

### Security — D717: `X-WatchRepairPros-*`/`X-OverhaulPros-*`/`X-Tokei-*`/`X-WatchPros-*` 等の時計修理印自称が未検査

- **問題**: `X-WatchRepairPros-*`/`X-WatchRepairTeam-*`/`X-WatchRepairWorks-*`/`X-WatchRepairForce-*`/`X-WatchRepairNation-*`/`X-WatchRepairExperts-*`/`X-WatchRepairDoctors-*`/`X-WatchRepairMasters-*`/`X-WatchRepairSvc-*`/`X-WatchRepairHQ-*`/`X-WatchPros-*`/`X-WatchTeam-*`/`X-WatchWorks-*`/`X-WatchForce-*`/`X-WatchNation-*`/`X-WatchExperts-*`/`X-WatchDoctors-*`/`X-WatchMasters-*`/`X-WatchSvc-*`/`X-WatchHQ-*`/`X-OverhaulPros-*`/`X-OverhaulTeam-*`/`X-OverhaulWorks-*`、JP は `X-TokeiShuri-*`/`X-Tokei-*`/`X-TokeiYasan-*`/`X-TokeiPro-*`/`X-TokeiTeam-*`/`X-TokeiKensa-*`/`X-TokeiManten-*`/`X-TokeiNomi-*`/`X-TokeiJP-*`/`X-TokeiSenmon-*`/`X-TokeiMitsumori-*`/`X-TokeiChousa-*`/`X-TokeiTeiki-*`/`X-TokeiShuriw-*`/`X-TokeiRescue-*`/`X-TokeiDoctors-*`/`X-TokeiSagyou-*`/`X-TokeiTeikyu-*`/`X-TokeiOrder-*`/`X-Udokei-*`/`X-UdokeiYasan-*`/`X-TokeiSho-*`/`X-TokeiTen-*`/`X-TokeiKoubou-*`/`X-TokeiOroshi-*`/`X-TokeiBank-*` 等 は時機の通知記録 — 送信側が書くことは自称。時計修理・オーバーホール・腕時計工房の偽装は、修理費用・部品代・鑑定料を装ったなりすましの典型手口。(貴金属買取は reuse 機、眼鏡は optical 機で検出済み)
- **修正**: `Envelope` に `watchrepair_marks` + `has_watchrepair_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 時印の自署を問え。

### Security — D718: `X-Butsudan-*`/`X-Butsugu-*`/`X-ButsudanPro-*`/`X-Altar-*` 等の仏壇・仏具印自称が未検査

- **問題**: `X-Butsudan-*`/`X-ButsudanYasan-*`/`X-ButsudanPro-*`/`X-ButsudanTeam-*`/`X-ButsudanKensa-*`/`X-ButsudanManten-*`/`X-ButsudanNomi-*`/`X-ButsudanJP-*`/`X-ButsudanSenmon-*`/`X-ButsudanMitsumori-*`/`X-ButsudanChousa-*`/`X-ButsudanTeiki-*`/`X-ButsudanShuri-*`/`X-ButsudanDoctors-*`/`X-ButsudanSagyou-*`/`X-ButsudanRescue-*`/`X-ButsudanTeikyu-*`/`X-ButsudanOrder-*`/`X-ButsudanSho-*`/`X-ButsudanTen-*`/`X-ButsudanKoubou-*`/`X-ButsudanUrikae-*`/`X-ButsudanKaitori-*`/`X-ButsudanBank-*`/`X-ButsudanMart-*`/`X-ButsudanTenchi-*`/`X-ButsudanPros-*`/`X-ButsudanWorks-*`/`X-Butsugu-*`/`X-ButsuguYasan-*`/`X-ButsuguPro-*`/`X-ButsuguTeam-*`/`X-ButsuguKensa-*`/`X-ButsuguManten-*`/`X-ButsuguNomi-*`/`X-ButsuguJP-*`/`X-ButsuguSenmon-*`/`X-ButsuguMitsumori-*`/`X-ButsuguChousa-*`/`X-ButsuguTeiki-*`/`X-ButsuguShuri-*`/`X-ButsuguSho-*`/`X-ButsuguTen-*`/`X-ButsuguKoubou-*`/`X-ButsuguMart-*`/`X-Altar-*`/`X-AltarPros-*` 等 は仏機の通知記録 — 送信側が書くことは自称。仏壇・仏具・祭壇店の偽装は、仏壇購入・お仏壇クリーニング・下台処分費を装ったなりすましの典型手口。(葬儀社は funeral 機、神社仏閣は shrine 機で検出済み)
- **修正**: `Envelope` に `butsudan_marks` + `has_butsudan_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 仏印の自署を問え。
