...
### Security — D758: `X-Shugei-*`/`X-Handmade-*`/`X-Beads-*`/`X-CraftClass-*` 等の手芸・クラフト教室印自称が未検査

- **問題**: `X-Shugei-*`/`X-ShugeiYasan-*`/`X-ShugeiPro-*`/`X-ShugeiTeam-*`/`X-ShugeiKensa-*`/`X-ShugeiManten-*`/`X-ShugeiNomi-*`/`X-ShugeiJP-*`/`X-ShugeiSenmon-*`/`X-ShugeiMitsumori-*`/`X-ShugeiChousa-*`/`X-ShugeiTeiki-*`/`X-ShugeiShuri-*`/`X-ShugeiSchool-*`/`X-ShugeiKoubou-*`/`X-ShugeiMart-*`/`X-ShugeiBank-*`/`X-Handmade-*`/`X-HandmadePro-*`/`X-HandmadeTeam-*`/`X-HandmadeKoubou-*`/`X-HandmadeSenmon-*`/`X-HandmadeSchool-*`/`X-HandmadeLesson-*`/`X-HandmadeLessonPros-*`/`X-HandmadeLessonTeam-*`/`X-Beads-*`/`X-BeadsYasan-*`/`X-BeadsPro-*`/`X-BeadsTeam-*`/`X-BeadsKoubou-*`/`X-BeadsSenmon-*`/`X-BeadsSchool-*`/`X-BeadsMarche-*`/`X-CraftClassPros-*`/`X-CraftClassTeam-*`/`X-CraftClassWorks-*`/`X-CraftClassExperts-*`/`X-CraftClassSvc-*`/`X-CraftClassHQ-*`/`X-CraftClassSchool-*`/`X-ShugeiPros-*`/`X-ShugeiWorks-*`/`X-ShugeiExperts-*`/`X-ShugeiSvc-*`/`X-ShugeiHQ-*`/`X-ShugeiDoctors-*`/`X-ShugeiRescue-*`/`X-HandmadePros-*`/`X-HandmadeDoctors-*`/`X-HandmadeRescue-*`/`X-BeadsPros-*`/`X-BeadsDoctors-*`/`X-BeadsRescue-*` 等 は芸機の通知記録 — 送信側が書くことは自称。手芸・ビーズ・ハンドメイド教室の偽装は、受講料・材料費・キット費を装ったなりすましの典型手口。(語学塾は cram 機で検出済み)
- **修正**: `Envelope` に `shugei_marks` + `has_shugei_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 芸印の自署を問え。

### Security — D759: `X-Mokkou-*`/`X-Woodworking-*`/`X-Kigumi-*`/`X-Nichiyoumokkou-*` 等の木工・木組み教室印自称が未検査

- **問題**: `X-Mokkou-*`/`X-MokkouYasan-*`/`X-MokkouPro-*`/`X-MokkouTeam-*`/`X-MokkouKensa-*`/`X-MokkouManten-*`/`X-MokkouNomi-*`/`X-MokkouJP-*`/`X-MokkouSenmon-*`/`X-MokkouMitsumori-*`/`X-MokkouChousa-*`/`X-MokkouTeiki-*`/`X-MokkouShuri-*`/`X-MokkouSchool-*`/`X-MokkouKoubou-*`/`X-MokkouMart-*`/`X-MokkouBank-*`/`X-Woodworking-*`/`X-WoodworkingPro-*`/`X-WoodworkingTeam-*`/`X-WoodworkingKoubou-*`/`X-WoodworkingSenmon-*`/`X-WoodworkingSchool-*`/`X-WoodworkLesson-*`/`X-WoodworkLessonPros-*`/`X-WoodworkLessonTeam-*`/`X-Kigumi-*`/`X-KigumiYasan-*`/`X-KigumiPro-*`/`X-KigumiKoubou-*`/`X-KigumiSenmon-*`/`X-KigumiSchool-*`/`X-Nichiyoumokkou-*`/`X-NichiyoumokkouPro-*`/`X-NichiyoumokkouKoubou-*`/`X-MokkouPros-*`/`X-MokkouWorks-*`/`X-MokkouExperts-*`/`X-MokkouSvc-*`/`X-MokkouHQ-*`/`X-MokkouDoctors-*`/`X-MokkouRescue-*`/`X-WoodworkingPros-*`/`X-WoodworkingWorks-*`/`X-WoodworkingExperts-*`/`X-WoodworkingSvc-*`/`X-WoodworkingHQ-*`/`X-WoodworkingDoctors-*`/`X-WoodworkingRescue-*` 等 は工機の通知記録 — 送信側が書くことは自称。木工・日曜大工教室の偽装は、受講料・材料費・工具販売を装ったなりすましの典型手口。(動力工具は diytool 機、建機は kensetsu 機で検出済み)
- **修正**: `Envelope` に `mokkou_marks` + `has_mokkou_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 工印の自署を問え。

### Security — D760: `X-Leathercraft-*`/`X-Leatherwork-*`/`X-Kawazaiku-*`/`X-Hikakuzaiku-*` 等のレザークラフト・革細工教室印自称が未検査

- **問題**: `X-Leathercraft-*`/`X-LeathercraftYasan-*`/`X-LeathercraftPro-*`/`X-LeathercraftTeam-*`/`X-LeathercraftKensa-*`/`X-LeathercraftManten-*`/`X-LeathercraftNomi-*`/`X-LeathercraftJP-*`/`X-LeathercraftSenmon-*`/`X-LeathercraftMitsumori-*`/`X-LeathercraftChousa-*`/`X-LeathercraftTeiki-*`/`X-LeathercraftShuri-*`/`X-LeathercraftSchool-*`/`X-LeathercraftKoubou-*`/`X-LeathercraftMart-*`/`X-LeathercraftBank-*`/`X-Leatherwork-*`/`X-LeatherworkPro-*`/`X-LeatherworkTeam-*`/`X-LeatherworkKoubou-*`/`X-LeatherworkSenmon-*`/`X-LeatherworkSchool-*`/`X-LeatherworkLesson-*`/`X-LeatherworkLessonPros-*`/`X-LeatherworkLessonTeam-*`/`X-Kawazaiku-*`/`X-KawazaikuYasan-*`/`X-KawazaikuPro-*`/`X-KawazaikuKoubou-*`/`X-KawazaikuSenmon-*`/`X-KawazaikuSchool-*`/`X-Hikakuzaiku-*`/`X-HikakuzaikuPro-*`/`X-HikakuzaikuKoubou-*`/`X-LeathercraftPros-*`/`X-LeathercraftWorks-*`/`X-LeathercraftExperts-*`/`X-LeathercraftSvc-*`/`X-LeathercraftHQ-*`/`X-LeathercraftDoctors-*`/`X-LeathercraftRescue-*`/`X-LeatherworkPros-*`/`X-LeatherworkDoctors-*`/`X-LeatherworkRescue-*`/`X-KawazaikuPros-*`/`X-KawazaikuDoctors-*`/`X-KawazaikuRescue-*` 等 は革機の通知記録 — 送信側が書くことは自称。革細工・レザークラフト教室の偽装は、受講料・革材料費・工具販売を装ったなりすましの典型手口。(鞄修理は kaban 機で検出済み)
- **修正**: `Envelope` に `leathercraft_marks` + `has_leathercraft_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 革印の自署を問え。
