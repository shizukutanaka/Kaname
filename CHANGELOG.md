...
### Security — D722: `X-CoinLaundry-*`/`X-Laundromat-*`/`X-CoinLan-*`/`X-CoinRandori-*` 等のコインランドリー印自称が未検査

- **問題**: `X-CoinLaundryPros-*`/`X-CoinLaundryTeam-*`/`X-CoinLaundryWorks-*`/`X-CoinLaundryForce-*`/`X-CoinLaundryNation-*`/`X-CoinLaundryExperts-*`/`X-CoinLaundryDoctors-*`/`X-CoinLaundryMasters-*`/`X-CoinLaundrySvc-*`/`X-CoinLaundryHQ-*`/`X-LaundromatPros-*`/`X-LaundromatTeam-*`/`X-LaundromatWorks-*`/`X-LaundromatExperts-*`/`X-LaundromatSvc-*`/`X-LaundromatHQ-*`/`X-LaundromatMart-*`/`X-LaundromatBank-*`/`X-CoinRandori-*`/`X-CoinLaundry-*`/`X-CoinLan-*`/`X-CoinLanYasan-*`/`X-CoinLanPro-*`/`X-CoinLanTeam-*`/`X-CoinLanKensa-*`/`X-CoinLanManten-*`/`X-CoinLanNomi-*`/`X-CoinLanJP-*`/`X-CoinLanSenmon-*`/`X-CoinLanMitsumori-*`/`X-CoinLanChousa-*`/`X-CoinLanTeiki-*`/`X-CoinLanShuri-*`/`X-CoinLanSho-*`/`X-CoinLanTen-*`/`X-CoinLanKoubou-*`/`X-CoinLanMart-*`/`X-CoinLanBank-*`/`X-CoinLanSarai-*`/`X-CoinLanKaiten-*`/`X-LaundryBank-*`/`X-LaundryMart-*`/`X-LaundrySho-*`/`X-LaundryTen-*`/`X-LaundryKoubou-*`/`X-LaundryJP-*`/`X-LaundrySenmon-*` 等 は洗機の通知記録 — 送信側が書くことは自称。コインランドリー・ランドリーマットの偽装は、洗濯代行料金・機器メンテ費・フランチャイズ加盟金を装ったなりすましの典型手口。(クリーニング店は cleaning 機の `x-sentakuya-` で検出済みのため `x-sentaku-` 語幹は未収録)
- **修正**: `Envelope` に `coinlaundry_marks` + `has_coinlaundry_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 洗印の自署を問え。

### Security — D723: `X-Kanpo-*`/`X-KampoPros-*`/`X-HerbShop-*`/`X-ToyoYaku-*` 等の漢方薬局印自称が未検査

- **問題**: `X-KanpoYasan-*`/`X-Kanpo-*`/`X-KanpoPro-*`/`X-KanpoTeam-*`/`X-KanpoKensa-*`/`X-KanpoManten-*`/`X-KanpoNomi-*`/`X-KanpoJP-*`/`X-KanpoSenmon-*`/`X-KanpoMitsumori-*`/`X-KanpoChousa-*`/`X-KanpoTeiki-*`/`X-KanpoShuri-*`/`X-KanpoSho-*`/`X-KanpoTen-*`/`X-KanpoKoubou-*`/`X-KanpoMart-*`/`X-KanpoBank-*`/`X-KanpoYakkyoku-*`/`X-KampoPros-*`/`X-KampoTeam-*`/`X-KampoWorks-*`/`X-KampoExperts-*`/`X-KampoDoctors-*`/`X-KampoSvc-*`/`X-KampoHQ-*`/`X-HerbShopPros-*`/`X-HerbShopTeam-*`/`X-HerbShopWorks-*`/`X-HerbShopExperts-*`/`X-HerbShopSvc-*`/`X-HerbShopHQ-*`/`X-TcmPros-*`/`X-TcmTeam-*`/`X-TcmWorks-*`/`X-TcmExperts-*`/`X-TcmSvc-*`/`X-TcmHQ-*`/`X-ToyoYaku-*`/`X-ToyoYakuYasan-*`/`X-ToyoYakuPro-*`/`X-ToyoYakuTeam-*`/`X-ToyoYakuKensa-*`/`X-ToyoYakuManten-*`/`X-ToyoYakuNomi-*`/`X-ToyoYakuJP-*`/`X-ToyoYakuSenmon-*`/`X-ToyoYakuMitsumori-*`/`X-ToyoYakuChousa-*`/`X-ToyoYakuTeiki-*`/`X-ToyoYakuShuri-*` 等 は漢機の通知記録 — 送信側が書くことは自称。漢方薬局・東洋医学クリニック・ハーブショップの偽装は、漢方薬購入・煎じ薬代・健康相談料を装ったなりすましの典型手口。(薬局は drugstore 機、鍼灸は acupuncture 機で検出済み)
- **修正**: `Envelope` に `kampo_marks` + `has_kampo_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 漢印の自署を問え。

### Security — D724: `X-Hansoku-*`/`X-KinenHin-*`/`X-NoveltyPros-*`/`X-PromoGoods-*` 等の販促品・記念品印自称が未検査

- **問題**: `X-NoveltyPros-*`/`X-NoveltyTeam-*`/`X-NoveltyWorks-*`/`X-NoveltyForce-*`/`X-NoveltyNation-*`/`X-NoveltyExperts-*`/`X-NoveltyDoctors-*`/`X-NoveltyMasters-*`/`X-NoveltySvc-*`/`X-NoveltyHQ-*`/`X-PromoItemPros-*`/`X-PromoItemTeam-*`/`X-PromoItemWorks-*`/`X-PromoItemExperts-*`/`X-PromoGoodsPros-*`/`X-PromoGoodsTeam-*`/`X-PromoGoodsWorks-*`/`X-PromoGoodsExperts-*`/`X-PromoGoodsSvc-*`/`X-PromoGoodsHQ-*`/`X-Hansoku-*`/`X-HansokuHin-*`/`X-HansokuYasan-*`/`X-HansokuPro-*`/`X-HansokuTeam-*`/`X-HansokuKensa-*`/`X-HansokuManten-*`/`X-HansokuNomi-*`/`X-HansokuJP-*`/`X-HansokuSenmon-*`/`X-HansokuMitsumori-*`/`X-HansokuChousa-*`/`X-HansokuTeiki-*`/`X-HansokuShuri-*`/`X-HansokuSho-*`/`X-HansokuTen-*`/`X-HansokuKoubou-*`/`X-HansokuMart-*`/`X-HansokuBank-*`/`X-KinenHin-*`/`X-KinenHinYasan-*`/`X-KinenHinPro-*`/`X-KinenHinTeam-*`/`X-KinenHinKensa-*`/`X-KinenHinManten-*`/`X-KinenHinNomi-*`/`X-KinenHinJP-*`/`X-KinenHinSenmon-*`/`X-KinenHinMitsumori-*`/`X-KinenHinChousa-*`/`X-KinenHinTeiki-*` 等 は促機の通知記録 — 送信側が書くことは自称。販促品・ノベルティ・記念品製作の偽装は、名入れグッズ発注・周年記念品・展示会ノベルティ費を装ったなりすましの典型手口。(印刷は printing 機、看板は signshop 機で検出済み)
- **修正**: `Envelope` に `promo_marks` + `has_promo_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 促印の自署を問え。
