...
### Security — D752: `X-Saihou-*`/`X-Souyou-*`/`X-Sewing-*`/`X-SewingClass-*`/`X-Dressmaking-*` 等の裁縫・洋裁教室印自称が未検査

- **問題**: `X-Saihou-*`/`X-SaihouYasan-*`/`X-SaihouPro-*`/`X-SaihouTeam-*`/`X-SaihouKensa-*`/`X-SaihouManten-*`/`X-SaihouNomi-*`/`X-SaihouJP-*`/`X-SaihouSenmon-*`/`X-SaihouMitsumori-*`/`X-SaihouChousa-*`/`X-SaihouTeiki-*`/`X-SaihouShuri-*`/`X-SaihouSchool-*`/`X-SaihouKoubou-*`/`X-SaihouMart-*`/`X-SaihouBank-*`/`X-Souyou-*`/`X-SouyouYasan-*`/`X-SouyouPro-*`/`X-SouyouKoubou-*`/`X-SouyouSenmon-*`/`X-SouyouSchool-*`/`X-Sewing-*`/`X-SewingPro-*`/`X-SewingTeam-*`/`X-SewingKoubou-*`/`X-SewingSenmon-*`/`X-SewingSchool-*`/`X-SewingLesson-*`/`X-SewingLessonPros-*`/`X-SewingLessonTeam-*`/`X-SewingClass-*`/`X-SewingClassPros-*`/`X-SewingClassTeam-*`/`X-SewingClassWorks-*`/`X-SewingClassExperts-*`/`X-SewingClassSvc-*`/`X-SewingClassHQ-*`/`X-DressmakingPros-*`/`X-DressmakingTeam-*`/`X-DressmakingWorks-*`/`X-DressmakingExperts-*`/`X-SaihouPros-*`/`X-SaihouWorks-*`/`X-SaihouExperts-*`/`X-SaihouSvc-*`/`X-SaihouHQ-*`/`X-SaihouDoctors-*`/`X-SaihouRescue-*`/`X-SouyouPros-*`/`X-SouyouDoctors-*`/`X-SouyouRescue-*` 等 は裁機の通知記録 — 送信側が書くことは自称。裁縫・洋裁教室の偽装は、受講料・材料費・資格認定料を装ったなりすましの典型手口。(語学塾は cram 機で検出済み)
- **修正**: `Envelope` に `saihou_marks` + `has_saihou_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 裁印の自署を問え。

### Security — D753: `X-Koto-*`/`X-Shamisen-*`/`X-Soukyoku-*`/`X-Nihongakki-*` 等の琴・三味線・邦楽器教室印自称が未検査

- **問題**: `X-Koto-*`/`X-KotoYasan-*`/`X-KotoPro-*`/`X-KotoTeam-*`/`X-KotoKensa-*`/`X-KotoManten-*`/`X-KotoNomi-*`/`X-KotoJP-*`/`X-KotoSenmon-*`/`X-KotoMitsumori-*`/`X-KotoChousa-*`/`X-KotoTeiki-*`/`X-KotoShuri-*`/`X-KotoSchool-*`/`X-KotoKoubou-*`/`X-KotoMart-*`/`X-KotoBank-*`/`X-Shamisen-*`/`X-ShamisenYasan-*`/`X-ShamisenPro-*`/`X-ShamisenTeam-*`/`X-ShamisenKensa-*`/`X-ShamisenManten-*`/`X-ShamisenNomi-*`/`X-ShamisenJP-*`/`X-ShamisenSenmon-*`/`X-ShamisenMitsumori-*`/`X-ShamisenKoubou-*`/`X-ShamisenSchool-*`/`X-ShamisenMart-*`/`X-Soukyoku-*`/`X-SoukyokuYasan-*`/`X-SoukyokuPro-*`/`X-SoukyokuKoubou-*`/`X-SoukyokuSenmon-*`/`X-Nihongakki-*`/`X-NihongakkiSenmon-*`/`X-NihongakkiKoubou-*`/`X-KotoPros-*`/`X-KotoWorks-*`/`X-KotoExperts-*`/`X-KotoSvc-*`/`X-KotoHQ-*`/`X-KotoDoctors-*`/`X-KotoRescue-*`/`X-ShamisenPros-*`/`X-ShamisenExperts-*`/`X-ShamisenDoctors-*`/`X-ShamisenRescue-*` 等 は琴機の通知記録 — 送信側が書くことは自称。琴・三味線・邦楽器教室の偽装は、月謝・免状料・楽器購入費を装ったなりすましの典型手口。(音楽教室は musiclesson 機、楽器販売は instrument 機で検出済み)
- **修正**: `Envelope` に `koto_marks` + `has_koto_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 琴印の自署を問え。

### Security — D754: `X-Aroma-*`/`X-Aromatherapy-*`/`X-AromaKentei-*`/`X-MedicalAroma-*` 等のアロマテラピー・香り教室印自称が未検査

- **問題**: `X-Aroma-*`/`X-AromaYasan-*`/`X-AromaPro-*`/`X-AromaTeam-*`/`X-AromaKensa-*`/`X-AromaManten-*`/`X-AromaNomi-*`/`X-AromaJP-*`/`X-AromaSenmon-*`/`X-AromaMitsumori-*`/`X-AromaChousa-*`/`X-AromaTeiki-*`/`X-AromaShuri-*`/`X-AromaSchool-*`/`X-AromaKoubou-*`/`X-AromaMart-*`/`X-AromaBank-*`/`X-Aromatherapy-*`/`X-AromatherapyPros-*`/`X-AromatherapyTeam-*`/`X-AromatherapyWorks-*`/`X-AromatherapyExperts-*`/`X-AromatherapySvc-*`/`X-AromatherapyHQ-*`/`X-AromatherapySchool-*`/`X-AromatherapyLesson-*`/`X-AromaKentei-*`/`X-AromaKenteiPro-*`/`X-AromaKenteiTeam-*`/`X-MedicalAroma-*`/`X-MedicalAromaPros-*`/`X-MedicalAromaTeam-*`/`X-MedicalAromaWorks-*`/`X-MedicalAromaExperts-*`/`X-AromaPros-*`/`X-AromaWorks-*`/`X-AromaExperts-*`/`X-AromaSvc-*`/`X-AromaHQ-*`/`X-AromaDoctors-*`/`X-AromaRescue-*`/`X-AromatherapyPro-*`/`X-AromatherapyDoctors-*`/`X-AromatherapyRescue-*` 等 は香機の通知記録 — 送信側が書くことは自称。アロマテラピー教室・資格講座の偽装は、受講料・認定料・精油販売を装ったなりすましの典型手口。(漢方薬局は kampo 機、エステは esthe 機で検出済み)
- **修正**: `Envelope` に `aroma_marks` + `has_aroma_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 香印の自署を問え。
