...
### Security — D755: `X-Somemono-*`/`X-Shibori-*`/`X-Katazome-*`/`X-Yuzen-*`/`X-Dyeing-*` 等の染物・草木染め工房印自称が未検査

- **問題**: `X-Somemono-*`/`X-SomemonoYasan-*`/`X-SomemonoPro-*`/`X-SomemonoTeam-*`/`X-SomemonoKensa-*`/`X-SomemonoManten-*`/`X-SomemonoNomi-*`/`X-SomemonoJP-*`/`X-SomemonoSenmon-*`/`X-SomemonoMitsumori-*`/`X-SomemonoChousa-*`/`X-SomemonoTeiki-*`/`X-SomemonoShuri-*`/`X-SomemonoSchool-*`/`X-SomemonoKoubou-*`/`X-SomemonoMart-*`/`X-SomemonoBank-*`/`X-Shibori-*`/`X-ShiboriYasan-*`/`X-ShiboriPro-*`/`X-ShiboriTeam-*`/`X-ShiboriKoubou-*`/`X-ShiboriSenmon-*`/`X-ShiboriSchool-*`/`X-Katazome-*`/`X-KatazomePro-*`/`X-KatazomeKoubou-*`/`X-KatazomeSenmon-*`/`X-Yuzen-*`/`X-YuzenPro-*`/`X-YuzenKoubou-*`/`X-Dyeing-*`/`X-DyeingPros-*`/`X-DyeingTeam-*`/`X-DyeingWorks-*`/`X-DyeingExperts-*`/`X-DyeingSvc-*`/`X-DyeingHQ-*`/`X-DyeingStudio-*`/`X-DyeingStudioPros-*`/`X-SomemonoPros-*`/`X-SomemonoWorks-*`/`X-SomemonoExperts-*`/`X-SomemonoSvc-*`/`X-SomemonoHQ-*`/`X-SomemonoDoctors-*`/`X-SomemonoRescue-*`/`X-ShiboriPros-*`/`X-ShiboriDoctors-*`/`X-ShiboriRescue-*` 等 は染機の通知記録 — 送信側が書くことは自称。染物・草木染め工房の偽装は、体験料・材料費・受注製作費を装ったなりすましの典型手口。(着物販売は kimono 機、クリーニングは cleaning 機で検出済み)
- **修正**: `Envelope` に `somemono_marks` + `has_somemono_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 染印の自署を問え。

### Security — D756: `X-Penji-*`/`X-Ballpenji-*`/`X-Penmanship-*`/`X-Kouhitsu-*` 等のボールペン字・硬筆教室印自称が未検査

- **問題**: `X-Penji-*`/`X-PenjiYasan-*`/`X-PenjiPro-*`/`X-PenjiTeam-*`/`X-PenjiKensa-*`/`X-PenjiManten-*`/`X-PenjiNomi-*`/`X-PenjiJP-*`/`X-PenjiSenmon-*`/`X-PenjiMitsumori-*`/`X-PenjiChousa-*`/`X-PenjiTeiki-*`/`X-PenjiShuri-*`/`X-PenjiSchool-*`/`X-PenjiKoubou-*`/`X-PenjiMart-*`/`X-PenjiBank-*`/`X-Ballpenji-*`/`X-BallpenjiYasan-*`/`X-BallpenjiPro-*`/`X-BallpenjiTeam-*`/`X-BallpenjiKoubou-*`/`X-BallpenjiSenmon-*`/`X-BallpenjiSchool-*`/`X-PenmanshipPros-*`/`X-PenmanshipTeam-*`/`X-PenmanshipWorks-*`/`X-PenmanshipExperts-*`/`X-PenmanshipSvc-*`/`X-PenmanshipHQ-*`/`X-PenmanshipSchool-*`/`X-PenmanshipLesson-*`/`X-PenjiPros-*`/`X-PenjiWorks-*`/`X-PenjiExperts-*`/`X-PenjiSvc-*`/`X-PenjiHQ-*`/`X-PenjiDoctors-*`/`X-PenjiRescue-*`/`X-BallpenjiPros-*`/`X-BallpenjiDoctors-*`/`X-BallpenjiRescue-*`/`X-Kouhitsu-*`/`X-KouhitsuYasan-*`/`X-KouhitsuPro-*`/`X-KouhitsuSenmon-*`/`X-KouhitsuSchool-*` 等 は硬機の通知記録 — 送信側が書くことは自称。ボールペン字・硬筆教室の偽装は、受講料・検定料・教材費を装ったなりすましの典型手口。(書道は shodo 機、語学塾は cram 機で検出済み)
- **修正**: `Envelope` に `penji_marks` + `has_penji_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 硬印の自署を問え。

### Security — D757: `X-Panya-*`/`X-Bakery-*`/`X-Breadmaking-*`/`X-Pankou-*` 等のパン・製パン教室印自称が未検査

- **問題**: `X-Panya-*`/`X-PanyaYasan-*`/`X-PanyaPro-*`/`X-PanyaTeam-*`/`X-PanyaKensa-*`/`X-PanyaManten-*`/`X-PanyaNomi-*`/`X-PanyaJP-*`/`X-PanyaSenmon-*`/`X-PanyaMitsumori-*`/`X-PanyaChousa-*`/`X-PanyaTeiki-*`/`X-PanyaShuri-*`/`X-PanyaSchool-*`/`X-PanyaKoubou-*`/`X-PanyaMart-*`/`X-PanyaBank-*`/`X-Bakery-*`/`X-BakeryPro-*`/`X-BakeryTeam-*`/`X-BakeryKoubou-*`/`X-BakerySenmon-*`/`X-BakerySchool-*`/`X-BakeryLesson-*`/`X-BakeryLessonPros-*`/`X-BakeryLessonTeam-*`/`X-BreadmakingPros-*`/`X-BreadmakingTeam-*`/`X-BreadmakingWorks-*`/`X-BreadmakingExperts-*`/`X-BreadmakingSvc-*`/`X-BreadmakingHQ-*`/`X-BreadmakingSchool-*`/`X-Pankou-*`/`X-PankouPro-*`/`X-PankouKoubou-*`/`X-PankouSenmon-*`/`X-PankouSchool-*`/`X-PanyaPros-*`/`X-PanyaWorks-*`/`X-PanyaExperts-*`/`X-PanyaSvc-*`/`X-PanyaHQ-*`/`X-PanyaDoctors-*`/`X-PanyaRescue-*`/`X-BakeryPros-*`/`X-BakeryDoctors-*`/`X-BakeryRescue-*` 等 は麦機の通知記録 — 送信側が書くことは自称。パン教室・製パン工房の偽装は、受講料・材料費・開業講座費を装ったなりすましの典型手口。(料理教室は cooking 機、ケータリングは catering 機で検出済み)
- **修正**: `Envelope` に `bakery_marks` + `has_bakery_marks` 追加; `commands.rs` で render_risks 兆候報告。
