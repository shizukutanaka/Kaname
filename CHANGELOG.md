...
### Security — D728: `X-Kanyou-*`/`X-PlantRental-*`/`X-OfficePlant-*`/`X-GreenRental-*` 等の観葉植物印自称が未検査

- **問題**: `X-KanyouShokubutsu-*`/`X-Kanyou-*`/`X-KanyouYasan-*`/`X-KanyouPro-*`/`X-KanyouTeam-*`/`X-KanyouKensa-*`/`X-KanyouManten-*`/`X-KanyouNomi-*`/`X-KanyouJP-*`/`X-KanyouSenmon-*`/`X-KanyouMitsumori-*`/`X-KanyouChousa-*`/`X-KanyouTeiki-*`/`X-KanyouShuri-*`/`X-KanyouSho-*`/`X-KanyouTen-*`/`X-KanyouKoubou-*`/`X-KanyouMart-*`/`X-KanyouBank-*`/`X-KanyouRental-*`/`X-PlantRentalPros-*`/`X-PlantRentalTeam-*`/`X-PlantRentalWorks-*`/`X-PlantRentalExperts-*`/`X-PlantRentalSvc-*`/`X-PlantRentalHQ-*`/`X-OfficePlantPros-*`/`X-OfficePlantTeam-*`/`X-OfficePlantWorks-*`/`X-OfficePlantExperts-*`/`X-OfficePlantSvc-*`/`X-OfficePlantHQ-*`/`X-InteriorPlantPros-*`/`X-InteriorPlantTeam-*`/`X-InteriorPlantWorks-*`/`X-InteriorPlantExperts-*`/`X-GreenRental-*`/`X-GreenWorks-*`/`X-GreenShokubutsu-*`/`X-RentalGreens-*`/`X-PlantLeaseTeam-*`/`X-PlantLeasePros-*`/`X-PlantLeaseSvc-*`/`X-FoliagePros-*`/`X-FoliageTeam-*`/`X-FoliageWorks-*`/`X-OfficeGreenTeam-*`/`X-OfficeGreenPros-*`/`X-OfficeGreenWorks-*`/`X-PlantHQ-*` 等 は観機の通知記録 — 送信側が書くことは自称。観葉植物レンタル・オフィスグリーンの偽装は、月額レンタル料・植替え費・メンテナンス料を装ったなりすましの典型手口。(造園は garden 機、花は flower 機で検出済み)
- **修正**: `Envelope` に `kanyou_marks` + `has_kanyou_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 観印の自署を問え。

### Security — D729: `X-KaigoTaxi-*`/`X-FukushiTaxi-*`/`X-Hansou-*`/`X-PatientTransport-*` 等の介護タクシー・患者搬送印自称が未検査

- **問題**: `X-KaigoTaxi-*`/`X-KaigoTaxiYa-*`/`X-KaigoTaxiPro-*`/`X-KaigoTaxiTeam-*`/`X-KaigoTaxiKensa-*`/`X-KaigoTaxiManten-*`/`X-KaigoTaxiNomi-*`/`X-KaigoTaxiJP-*`/`X-KaigoTaxiSenmon-*`/`X-KaigoTaxiMitsumori-*`/`X-KaigoTaxiChousa-*`/`X-KaigoTaxiTeiki-*`/`X-KaigoTaxiShuri-*`/`X-KaigoTaxiSho-*`/`X-KaigoTaxiTen-*`/`X-KaigoTaxiKoubou-*`/`X-KaigoTaxiMart-*`/`X-KaigoTaxiBank-*`/`X-FukushiTaxi-*`/`X-FukushiTaxiYa-*`/`X-FukushiTaxiPro-*`/`X-FukushiTaxiTeam-*`/`X-FukushiTaxiKensa-*`/`X-FukushiTaxiManten-*`/`X-FukushiTaxiNomi-*`/`X-FukushiTaxiJP-*`/`X-FukushiTaxiSenmon-*`/`X-FukushiTaxiMitsumori-*`/`X-FukushiTaxiChousa-*`/`X-FukushiTaxiTeiki-*`/`X-FukushiTaxiShuri-*`/`X-Hansou-*`/`X-HansouYa-*`/`X-HansouPro-*`/`X-HansouTeam-*`/`X-HansouKensa-*`/`X-HansouManten-*`/`X-HansouNomi-*`/`X-HansouJP-*`/`X-HansouSenmon-*`/`X-HansouMitsumori-*`/`X-HansouChousa-*`/`X-HansouTeiki-*`/`X-HansouShuri-*`/`X-KankyaHansou-*`/`X-PatientTransportPros-*`/`X-PatientTransportTeam-*`/`X-MedicalTransportPros-*`/`X-MedicalTransportTeam-*`/`X-MedicalTransportWorks-*`/`X-WelfareTaxi-*`/`X-WelfareCab-*` 等 は衛機の通知記録 — 送信側が書くことは自称。介護タクシー・福祉輸送・患者搬送の偽装は、送迎料金・搬送費・介護タクシー予約金を装ったなりすましの典型手口。(タクシーは taxi 機、介護は eldercare 機で検出済み)
- **修正**: `Envelope` に `welfaretaxi_marks` + `has_welfaretaxi_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 衛印の自署を問え。

### Security — D730: `X-Shishosho-*`/`X-PmbPros-*`/`X-PrivateBox-*`/`X-MailAgent-*` 等の私書箱・郵便受取代行印自称が未検査

- **問題**: `X-Shishosho-*`/`X-ShishoshoYasan-*`/`X-ShishoshoPro-*`/`X-ShishoshoTeam-*`/`X-ShishoshoKensa-*`/`X-ShishoshoManten-*`/`X-ShishoshoNmi-*`/`X-ShishoshoChousa-*`/`X-ShishoshoJP-*`/`X-ShishoshoSenmon-*`/`X-ShishoshoMitsumori-*`/`X-ShishoshoTeiki-*`/`X-ShishoshoShuri-*`/`X-ShishoshoSho-*`/`X-ShishoshoTen-*`/`X-ShishoshoKoubou-*`/`X-ShishoshoMart-*`/`X-ShishoshoBank-*`/`X-MailboxRentalPros-*`/`X-MailboxRentalTeam-*`/`X-MailboxRentalWorks-*`/`X-MailboxRentalExperts-*`/`X-PmbPros-*`/`X-PmbTeam-*`/`X-PmbWorks-*`/`X-PmbExperts-*`/`X-PmbSvc-*`/`X-PmbHQ-*`/`X-PrivateBoxPros-*`/`X-PrivateBoxTeam-*`/`X-PrivateBoxWorks-*`/`X-PrivateBoxExperts-*`/`X-PostBoxPros-*`/`X-PostBoxTeam-*`/`X-PostBoxWorks-*`/`X-PostBoxExperts-*`/`X-MailReceivingPros-*`/`X-MailReceivingTeam-*`/`X-MailReceive-*`/`X-MailAgent-*`/`X-MailAgentYasan-*`/`X-MailAgentPro-*`/`X-YuubinUkeuke-*`/`X-YuubinYasan-*`/`X-YuubinPro-*`/`X-MailAgentTeam-*`/`X-MailAgentKensa-*`/`X-MailAgentManten-*`/`X-MailAgentNomi-*`/`X-MailAgentJP-*` 等 は箱機の通知記録 — 送信側が書くことは自称。私書箱・郵便受取代行・PMBの偽装は、私書箱契約料・転送手数料・受取代行費を装ったなりすましの典型手口。(倉庫は storage 機、コワーキングは coworking 機で検出済み)
- **修正**: `Envelope` に `mailbox_marks` + `has_mailbox_marks` 追加; `commands.rs` で render_risks 兆候報告。
- **教訓**: 通知の記録は通知機が記す — 箱印の自署を問え。
