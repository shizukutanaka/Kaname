...
pub async fn analyze_raw_email(bytes: &[u8]) -> Result<ImportedEmail, String> {
    ...
    // D650: 福祉・児童相談所・生活保護印自称
    if env.welfare_marks {
        render_risks.push(
            "X-FukushiNavi-*/X-JidoSoushodan-*/X-ShakaiFukushi-*/X-SeikatsuHogo-*/X-Kyougikai-*/X-Kodomo-*/X-KodomoNavi-*/X-KazokuNavi-* 等 — 福機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }

    // D651: 外壁塗装・屋根修理印自称
    if env.roofing_marks {
        render_risks.push(
            "X-GaihekuNavi-*/X-YaneNavi-*/X-Amamori-*/X-Tosou-*/X-Shiringu-*/X-Roofing-*/X-RoofNavi-*/X-Waterproof-* 等 — 塗機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    ...
    if env.hvac_marks {
        render_risks.push(
            "X-Aircon-*/X-AirconNavi-*/X-Hvac-*/X-HvacNavi-*/X-Reidanbou-*/X-Kankisen-*/X-Eakon-*/X-EakonNavi-* 等 — 空機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    ...
    // D656: バス・タクシー・ハイヤー印自称
    if env.bus_marks {
        render_risks.push(
            "X-Taxi-*/X-TaxiNavi-*/X-Haiya-*/X-HaiyaNavi-*/X-KousokuBasu-*/X-KankouBasu-*/X-JapanTaxi-*/X-MeitetsuTaxi-* 等 — 乗機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    ...
    if env.window_marks {
        render_risks.push(
            "X-Mado-*/X-MadoNavi-*/X-Sashim-*/X-GlassNavi-*/X-DoorNavi-*/X-Amido-*/X-Garasu-*/X-GarasuNavi-* 等 — 窓機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }

    // D658: スキー・ゲレンデ・スノボ印自称
    if env.ski_marks {
        render_risks.push(
            "X-Sukii-*/X-Gerende-*/X-GerendeNavi-*/X-Sunobo-*/X-SunoboNavi-*/X-RifutoNavi-*/X-Ski-*/X-SkiNavi-* 等 — 滑機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    ...
    if env.sauna_marks {
        render_risks.push(
            "X-Sauna-*/X-Onyoku-*/X-OnyokuNavi-*/X-Supa-*/X-SupaNavi-*/X-Totonoi-*/X-Totorou-*/X-Kenkouland-* 等 — 浴機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }

    // D660: カラオケ・ネットカフェ印自称
    if env.karaoke_marks {
        render_risks.push(
            "X-Karaoke-*/X-KaraokeNavi-*/X-Manekineko-*/X-Nekafee-*/X-NekafeeNavi-*/X-Kaikatsu-*/X-InternetCafe-*/X-MediaCafe-* 等 — 歌機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }

    // D661: ボウリング・ダーツ・ビリヤード印自称
    if env.bowling_marks {
        render_risks.push(
            "X-Bowling-*/X-BowlingNavi-*/X-RoundOne-*/X-Darts-*/X-DartsNavi-*/X-DartsLive-*/X-Billiard-*/X-Batting-* 等 — 投機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }

    // D662: ペットショップ・トリミング印自称
    if env.petshop_marks {
        render_risks.push(
            "X-Petshop-*/X-PetshopNavi-*/X-Trimming-*/X-Pethotel-*/X-Breeder-*/X-Onechan-*/X-Wanchan-*/X-Nyanchan-* 等 — 毛機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    ...
    if env.dental_marks {
        render_risks.push(
            "X-Dental-*/X-DentalNavi-*/X-Shika-*/X-ShikaNavi-*/X-Kyousei-*/X-Whitening-*/X-Implant-*/X-Haisha-* 等 — 歯機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    ...
    if env.shaken_marks {
        render_risks.push(
            "X-Shaken-*/X-ShakenNavi-*/X-CarInspection-*/X-Bankin-*/X-BankinNavi-*/X-Tire-*/X-TireNavi-*/X-CarCheck-* 等 — 車機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    ...
    if env.nail_marks {
        render_risks.push(
            "X-Nail-*/X-NailNavi-*/X-Matsuge-*/X-Matsueku-*/X-Gelnail-*/X-Biyouin-*/X-Salon-*/X-Lash-* 等 — 爪機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }

    // D666: 居酒屋・バー・焼鳥印自称
    if env.izakaya_marks {
        render_risks.push(
            "X-Izakaya-*/X-IzakayaNavi-*/X-BarNavi-*/X-Yakitori-*/X-Tavern-*/X-Dining-*/X-Nomiya-*/X-Sakaba-* 等 — 酌機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }

    // D667: ロードサービス・レッカー印自称
    if env.roadside_marks {
        render_risks.push(
            "X-Jaf-*/X-JafNavi-*/X-Roadservice-*/X-Roadside-*/X-RoadsideNavi-*/X-Rekkya-*/X-Wrecker-*/X-Towing-* 等 — 牽機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    ...
    // D671: 金券・チケットショップ印自称
    if env.ticketshop_marks {
        render_risks.push(
            "X-Kinken-*/X-KinkenNavi-*/X-Ticketshop-*/X-Shouken-*/X-Voucher-*/X-Giftcard-*/X-Joshaken-*/X-TicketNavi-* 等 — 紙機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }

    // D672: ライブハウス・クラブ印自称
    if env.livehouse_marks {
        render_risks.push(
            "X-Livehouse-*/X-LivehouseNavi-*/X-Live-*/X-Zepp-*/X-Club-*/X-Ondoku-*/X-Livehall-*/X-Musicbox-* 等 — 奏機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    ...
    if env.barber_marks {
        render_risks.push(
            "X-Barber-*/X-BarberNavi-*/X-Riyou-*/X-Tokoya-*/X-Qbhouse-*/X-Plaisir-*/X-Sanpatsu-*/X-Haircut-* 等 — 髭機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    ...
    // D677: コインランドリー・洗濯印自称
    if env.laundry_marks {
        render_risks.push(
            "X-Coinlaundry-*/X-Laundry-*/X-LaundryNavi-*/X-Sentaku-*/X-Washing-*/X-Hakuchou-*/X-Fuwafuwa-*/X-Laundromat-* 等 — 洗機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }

    // D678: ゲームセンター・eスポーツ印自称
    if env.gamecenter_marks {
        render_risks.push(
            "X-Gamecenter-*/X-GamecenterNavi-*/X-Geesen-*/X-Gameworks-*/X-Esports-*/X-Purikura-*/X-Ufocatcher-*/X-Namco-* 等 — 遊機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }

    // D679: シェアハウス・ゲストハウス印自称
    if env.sharehouse_marks {
        render_risks.push(
            "X-Sharehouse-*/X-Guesthouse-*/X-GuesthouseNavi-*/X-Oakhouse-*/X-Borderless-*/X-Weekly-*/X-Monthlymansion-*/X-Roomshare-* 等 — 舎機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D680: 証券・投資信託印自称
    ...
    // D686: 奨学金・教育ローン印自称
    if env.shogaku_marks {
        render_risks.push(
            "X-Jasso-*/X-Shogakukin-*/X-Eduloan-*/X-Studentloan-*/X-Salliemae-*/X-Ashinaga-*/X-Scholarship-*/X-Earnest-* 等 — 奨機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D687: 副業・在宅ワーク・情報商材印自称
    if env.fukugyou_marks {
        render_risks.push(
            "X-Fukugyou-*/X-Zaitaku-*/X-Naishoku-*/X-Sidejob-*/X-Johoshozai-*/X-Sidehustle-*/X-Affiliate-*/X-Netjob-* 等 — 副機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D688: MLM・ネットワークビジネス印自称
    if env.mlm_marks {
        render_risks.push(
            "X-Mlm-*/X-Networkbusiness-*/X-Pyramid-*/X-Referral-*/X-Doterra-*/X-Jeunesse-*/X-Monat-*/X-Arbonne-* 等 — 連機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D689: ETC・高速道路印自称
    ...
    // D695: ダイビング・マリンスポーツ印自称
    if env.diving_marks {
        render_risks.push(
            "X-Diving-*/X-Dive-*/X-Surf-*/X-Marine-*/X-Sup-*/X-Padi-*/X-Snorkeling-*/X-Wakeboard-* 等 — 潜機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D696: メンズエステ・リフレ・JKビジネス印自称
    if env.menseste_marks {
        render_risks.push(
            "X-Menseste-*/X-Refre-*/X-Jkrefre-*/X-Massage-*/X-Mensmassage-*/X-Aroma-*/X-Kaishun-*/X-Seikan-* 等 — 摩機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D697: 免税店・旅行土産印自称
    if env.dutyfree_marks {
        render_risks.push(
            "X-Dutyfree-*/X-Menzei-*/X-Laox-*/X-Dfs-*/X-Kingpower-*/X-Omiyage-*/X-Souvenir-*/X-Taxfree-* 等 — 免機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D698: ネットカフェ・漫画喫茶印自称
    ...
    if env.sabage_marks {
        render_risks.push(
            "X-Sabage-*/X-Airgun-*/X-Paintball-*/X-Airsoft-*/X-Tokyomarui-*/X-Survival-*/X-Camo-*/X-Ghillie-* 等 — 撃機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D708: 瞑想・スピリチュアル・レイキ印自称
    if env.spiritual_marks {
        render_risks.push(
            "X-Reiki-*/X-Qigong-*/X-Meditation-*/X-Meiso-*/X-Hikiyose-*/X-Kaiun-*/X-Fengshui-*/X-Chakra-* 等 — 霊機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D709: 祭り・花火大会・縁日印自称
    if env.matsuri_marks {
        render_risks.push(
            "X-Matsuri-*/X-Hanabi-*/X-Ennichi-*/X-Yatai-*/X-Mikoshi-*/X-Nebuta-*/X-Awaodori-*/X-Yosakoi-* 等 — 祭機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D710: 猫カフェ・動物カフェ印自称
    ...
    if env.rugby_marks {
        render_risks.push(
            "X-Rugby-*/X-Jrfu-*/X-Top14-*/X-Premrugby-*/X-Allblacks-*/X-Springboks-*/X-Sungoliath-*/X-Crusaders-* 等 — 蹴機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D714: モータースポーツ印自称
    if env.motorsport_marks {
        render_risks.push(
            "X-Motorsport-*/X-Motogp-*/X-Nascar-*/X-Supergt-*/X-Formula1-*/X-Wrc-*/X-Imsa-*/X-Indycar-* 等 — 走機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D715: 山岳・トレッキング印自称
    if env.trekking_marks {
        render_risks.push(
            "X-Trekking-*/X-Hiking-*/X-Mountaineering-*/X-Tozan-*/X-Sangaku-*/X-Yama-*/X-Expedition-*/X-Sawanobori-* 等 — 山機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D716: 格安SIM・MVNO印自称
    ...
    if env.nouen_marks {
        render_risks.push(
            "X-Shiminnouen-*/X-Nouen-*/X-Farm-*/X-Sharehatake-*/X-Myfarm-*/X-Kateisaien-*/X-Hatake-*/X-Allotment-* 等 — 畑機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D720: トクホ・機能性食品・健康食品印自称
    if env.tokuho_marks {
        render_risks.push(
            "X-Tokuho-*/X-Foshu-*/X-Kinousei-*/X-Kouso-*/X-Enzyme-*/X-Collagen-*/X-Glucosamine-*/X-Aojiru-* 等 — 療機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D721: 天文・プラネタリウム印自称
    if env.planetarium_marks {
        render_risks.push(
            "X-Planetarium-*/X-Astronomy-*/X-Observatory-*/X-Telescope-*/X-Tenmon-*/X-Hoshizora-*/X-Celestron-*/X-Vixen-* 等 — 星機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D722: 音楽フェス印自称
    if env.fujirock_marks {
        render_risks.push(
            "X-Fujirock-*/X-Summersonic-*/X-Rockin-*/X-Risingsun-*/X-Umf-*/X-Edc-*/X-Coachella-*/X-Lollapalooza-* 等 — 演機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D723: コールセンター・電話代行印自称
    if env.callcenter_marks {
        render_risks.push(
            "X-Callcenter-*/X-Telemarketing-*/X-Bell24-*/X-Transcosmos-*/X-Teleperformance-*/X-Taskus-*/X-Sitel-*/X-Denwa-* 等 — 電機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D724: 貸し会議室・レンタルスペース印自称
    if env.rentalspace_marks {
        render_risks.push(
            "X-Kashikaigi-*/X-Virtualoffice-*/X-Servicedoffice-*/X-Rentalspace-*/X-Crosscoop-*/X-Fabbit-*/X-Meetingroom-*/X-Eventspace-* 等 — 室機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D725: マラソン・駅伝・ランニング印自称
    if env.marathon_marks {
        render_risks.push(
            "X-Marathon-*/X-Tokyomarathon-*/X-Bostonmarathon-*/X-Berlinmarathon-*/X-Ekiden-*/X-Hakone-*/X-Running-*/X-Ultramarathon-* 等 — 奔機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D726: 福祉用具・介護用品印自称
    if env.fukushiyogu_marks {
        render_risks.push(
            "X-Fukushiyogu-*/X-Kaigoyohin-*/X-Wheelchair-*/X-Hosogu-*/X-Barrierfree-*/X-Grouphome-*/X-Handrail-*/X-Caregoods-* 等 — 椅機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D727: アウトドア・アドベンチャー印自称
    if env.adventure_marks {
        render_risks.push(
            "X-Rafting-*/X-Canyoning-*/X-Canoe-*/X-Zipline-*/X-Paraglider-*/X-Skydiving-*/X-Atv-*/X-Caving-* 等 — 険機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D728: 鉄道模型・ドール印自称
    if env.modeltrain_marks {
        render_risks.push(
            "X-Tomytec-*/X-Greenmax-*/X-Modeltrain-*/X-Kato-*/X-Tomix-*/X-Doll-*/X-Bjd-*/X-Mini4wd-* 等 — 形機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D729: プロテイン・筋トレサプリ印自称
    if env.protein_marks {
        render_risks.push(
            "X-Protein-*/X-Myprotein-*/X-Valx-*/X-Belegend-*/X-Xtend-*/X-Dns-*/X-Creatine-*/X-Whey-* 等 — 筋機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D730: ハンドメイド作家・クラフトマーケット印自称
    if env.handmade_marks {
        render_risks.push(
            "X-Creema-*/X-Minne-*/X-Handmade-*/X-Iichi-*/X-Tetote-*/X-Craftie-*/X-Pinkoi-*/X-Bigcartel-* 等 — 作機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D731: キッチンカー・移動販売印自称
    ...
    // D737: ソーシャルレンディング・先物取引印自称
    if env.sociallending_marks {
        render_risks.push(
            "X-Sociallending-*/X-P2plending-*/X-Commodity-*/X-Futures-*/X-Options-*/X-Cfd-*/X-Margin-*/X-Bullion-* 等 — 融機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D738: ファスティング・断食・湯治印自称
    if env.fasting_marks {
        render_risks.push(
            "X-Danjiki-*/X-Touji-*/X-Fasting-*/X-Detox-*/X-Juicefast-*/X-Intermittent-*/X-Cleansing-*/X-Macrobiotic-* 等 — 断機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D739: 海外スポーツリーグ印自称
    if env.cricket_marks {
        render_risks.push(
            "X-Cricket-*/X-Ipl-*/X-Nfl-*/X-Xleague-*/X-Cfl-*/X-Afl-*/X-T20-*/X-Superbowl-* 等 — 競機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    ...
    // D749: ウインタースポーツ印自称
    if env.wintersport_marks {
        render_risks.push(
            "X-Wintersport-*/X-Skating-*/X-Curling-*/X-Biathlon-*/X-Bobsleigh-*/X-Skijump-*/X-Speedskate-*/X-Hockey-* 等 — 冬機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D750: 猟銃・射撃・ハンティング印自称
    if env.hunting_marks {
        render_risks.push(
            "X-Hunting-*/X-Rifle-*/X-Shotgun-*/X-Ammo-*/X-Remington-*/X-Winchester-*/X-Beretta-*/X-Glock-* 等 — 猟機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
    // D751: 重量挙・パワーリフティング印自称
    if env.powerlifting_marks {
        render_risks.push(
            "X-Weightlifting-*/X-Powerlifting-*/X-Strongman-*/X-Crossfit-*/X-Ipf-*/X-Usapl-*/X-Benchpress-*/X-Deadlift-* 等 — 挙機の通知記録を送信側が自称する兆候です"
                .to_string(),
        );
    }
