...
pub mod preflight;
pub use preflight::{preflight_untrusted, Finding, PreflightResult};

// 公開 API は dual_llm に集約
pub use dual_llm::{
    ActionType, AiError, AnalysisReport, BoundedString, Bridge, BridgeError, BridgePolicy, Content,
    LanguageCode, PrivilegedLlm, Provenance, QuarantinedLlm, TopicTag, Trusted, Untrusted, Verdict,
};
